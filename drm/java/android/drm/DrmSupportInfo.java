...
public class DrmSupportInfo {
    private Vector<String> mFileSuffixList = new Vector<String>();
    private Vector<String> mMimeTypeList = new Vector<String>();
    ...
    /* package */ boolean isSupportedMimeType(String mimeType) {
        if(null != mimeType && !mimeType.equals("")) {
            for(int i = 0; i < mMimeTypeList.size(); i++) {
                String completeMimeType = mMimeTypeList.elementAt(i);
