...
/**
 * The java application will instantiate this class and accesses DRM Framework
...
public class DrmManagerClient {
	...
	public interface OnInfoListener {
		 ...
		 */
		public void onInfo(DrmManagerClient client, InfoEvent event);
	}
	...
	public static void notify(Object thisReference, int uniqueId, int infoType, String message) {
		...
		if(null != instance && instance.mEventHandler != null) {
			Message m = instance.mEventHandler.obtainMessage(EventHandler.INFO_EVENT_TYPE, uniqueId, infoType, message);
	...
	private class EventHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case EventHandler.INFO_EVENT_TYPE:
				...
				if(infoType == InfoEvent.Type.REMOVE_RIGHTS) {
					try {
				...
				if(null != mOnInfoListener) {
					InfoEvent event = new InfoEvent(uniqueId, infoType, message);
	 ...
	 */	
	public void saveRights(DrmRights drmRights, String rightsPath, String contentPath) throws IOException {
		if(null == drmRights || !drmRights.isValid() || null == contentPath || contentPath.equals("")) {
		...
		if(null != rightsPath && !rightsPath.equals("")) {
			try {
				...
				throw new IOException("Failed to save the rights information: " + rightsPath);
			}
		}
	...
	private native void _saveRights(int uniqueId, DrmRights drmRights, String rightsPath, String contentPath);
