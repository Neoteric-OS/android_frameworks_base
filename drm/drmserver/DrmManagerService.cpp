...
void DrmManagerService::instantiate() {
    ...
    if ((FAILURE != mkdir("/data/drm/plugins", DRM_DIRECTORY_PERMISSION)) &&
        (FAILURE != mkdir("/data/drm/plugins/native", DRM_DIRECTORY_PERMISSION)) &&
        (FAILURE != mkdir("/data/drm/plugins/native/databases", DRM_DIRECTORY_PERMISSION))) {
