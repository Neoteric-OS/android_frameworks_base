...
/**
 * Runner used for a quick sanity check of Forward Lock.
 */
public class FLSanityRunner extends InstrumentationTestRunner {
    @Override
    ...
    public ClassLoader getLoader() {
        return FLSanityRunner.class.getClassLoader();
    }
}
