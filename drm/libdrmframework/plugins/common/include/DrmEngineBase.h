 ...
 *  	keyword, template method pattern
 *  	cf.) http://en.wikipedia.org/wiki/Template_method_pattern
...
protected:
	...
	virtual status_t onSetOnInfoListener(
					int uniqueId,
					const IDrmEngine::OnInfoListener* infoListener) = 0;
	 ...
	 */
	virtual DrmInfoStatus* onProcessDrmInfo(
					int uniqueId,
	 ...
	 *			instance as a result of processing given input
	 */
	virtual DrmInfo* onAcquireDrmInfo(
					int uniqueId,
	 ...
	 */
	virtual String8 onGetOriginalMimeType(
					int uniqueId,
					const String8& path) = 0;
	 ...
	 */
	virtual int onCheckRightsStatus(
					int uniqueId,
					const String8& path,
					int action) = 0;
	 ...
	 */
	virtual void onOpenConvertSession(
					int uniqueId,
					int convertId) = 0;
	 ...
	 *			should be appended.
	 */
	virtual DrmConvertedStatus* onCloseConvertSession(
					int uniqueId,
					int convertId) = 0;
	 ...
	 */
	virtual DecryptHandle* onOpenDecryptSession(
					int uniqueId,
					int fd,
					int offset,
					int length) = 0;
	 ...
	 */
	virtual void onInitializeDecryptUnit(
					int uniqueId,
					DecryptHandle* decryptHandle,
					int decryptUnitId,
