...
protected:
     ...
     */
    virtual int onGetDrmObjectType(int uniqueId, const String8& path, const String8& mimeType) = 0;
     ...
     */
    virtual DecryptHandle* onOpenDecryptSession(int uniqueId, int fd, int offset, int length) = 0;
