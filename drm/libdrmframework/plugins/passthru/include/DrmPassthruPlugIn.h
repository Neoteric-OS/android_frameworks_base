...
protected:
    DrmConstraints* onGetConstraints(int uniqueId, const String8* path, const int action);
    ...
    DecryptHandle* onOpenDecryptSession(int uniqueId, int fd, int offset, int length);
