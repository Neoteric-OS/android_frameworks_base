...
public:
    ...
    virtual DrmConstraints* getConstraints(int uniqueId, const String8* path, const int action) = 0;
    ...
    virtual bool validateAction(
            int uniqueId, const String8& path, int action, const ActionDescription& description) = 0;
