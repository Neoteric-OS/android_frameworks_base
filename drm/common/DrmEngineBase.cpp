...
DrmConstraints* DrmEngineBase::getConstraints(int uniqueId, const String8* path, const int action) {
...
DecryptHandle* DrmEngineBase::openDecryptSession(int uniqueId, int fd, int offset, int length) {
