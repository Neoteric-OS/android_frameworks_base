...
DrmInfoStatus* DrmEngineBase::processDrmInfo(
					int uniqueId,
...
DrmInfo* DrmEngineBase::acquireDrmInfo(
					int uniqueId,
...
String8 DrmEngineBase::getOriginalMimeType(
					int uniqueId, 
					const String8& path) {
...
int DrmEngineBase::getDrmObjectType(
					int uniqueId,
					const String8& path,
...
int DrmEngineBase::checkRightsStatus(
					int uniqueId,
					const String8& path,
					int action) {
...
void DrmEngineBase::removeRights(
					int uniqueId,
					const String8& path) {
...
void DrmEngineBase::openConvertSession(
					int uniqueId,
					int convertId) {
...
DrmConvertedStatus* DrmEngineBase::closeConvertSession(
					int uniqueId,
					int convertId) {
...
DecryptHandle* DrmEngineBase::openDecryptSession(
					int uniqueId,
					int fd,
					int offset,
					int length) {

	return onOpenDecryptSession(uniqueId, fd, offset, length);
}

void DrmEngineBase::closeDecryptSession(
					int uniqueId,
					DecryptHandle* decryptHandle) {
