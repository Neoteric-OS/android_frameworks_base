...
DrmInfoRequest::KeyIterator::KeyIterator(const DrmInfoRequest::KeyIterator& keyIterator) : 
	mDrmInfoRequest(keyIterator.mDrmInfoRequest), mIndex(keyIterator.mIndex) {	
...
DrmInfoRequest::KeyIterator& DrmInfoRequest::KeyIterator::operator=(const DrmInfoRequest::KeyIterator& keyIterator) {
...
DrmInfoRequest::Iterator& DrmInfoRequest::Iterator::operator=(const DrmInfoRequest::Iterator& iterator) {
