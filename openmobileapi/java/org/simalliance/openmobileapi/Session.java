...
public class Session {
     ...
     *             the reader or the secure element.
    ...
    public Channel openBasicChannel(byte[] aid) throws IOException {
        ...
        synchronized (_channels) {
            ...
            Channel basicChannel = _reader.getSEService().openBasicChannel(this, aid);
     ...
     *             access to this AID or the default application on this
     *             session.
     * @param aid the AID of the application to be selected on this channel, as a
     *            byte array.
     * @return an instance of Channel.
     */
    public Channel openLogicalChannel(byte[] aid) throws IOException {
        ...
        synchronized (_channels) {
            ...
            Channel logicalChannel = _reader.getSEService().openLogicalChannel(this, aid);
