...
{
    // FIXME: this function performs no validation of input data (on the
    // other hand, at this stage, it is not possible to distinguish a
    // correct idmap from random garbage)

    // FIXME: of course, we could just conveniently include the original
    // package's ID in the idmap...
    (void)mapSize;
