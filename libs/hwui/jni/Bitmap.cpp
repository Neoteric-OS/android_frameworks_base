...
{
    static jmethodID gBitmap_reinitMethodID = 0;
    if (gBitmap_reinitMethodID == 0) {
...
jobject createBitmap(JNIEnv* env, Bitmap* bitmap,
        ...
        int density) {
    static jmethodID gBitmap_constructorMethodID = 0;
    if (gBitmap_constructorMethodID == 0) {
        gBitmap_constructorMethodID = GetMethodIDOrDie(env, gBitmap_class,
...
static jlong getNativePtr(JNIEnv* env, jobject bitmap) {
    static jfieldID gBitmap_nativePtr = 0;
    if (gBitmap_nativePtr == 0) {
