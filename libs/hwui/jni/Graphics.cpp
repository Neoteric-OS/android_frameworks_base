...
jobject GraphicsJNI::getColorSpace(JNIEnv* env, SkColorSpace* decodeColorSpace,
    ...
    if (gColorSpace_class == nullptr) {
        gColorSpace_class =
                MakeGlobalRefOrDie(env, FindClassOrDie(env, "android/graphics/ColorSpace"));
        ...
        gColorSpace_Named_sRGBFieldID = GetStaticFieldIDOrDie(
                env, gColorSpace_Named_class, "SRGB", "Landroid/graphics/ColorSpace$Named;");
        gColorSpace_Named_ExtendedSRGBFieldID =
                GetStaticFieldIDOrDie(env, gColorSpace_Named_class, "EXTENDED_SRGB",
