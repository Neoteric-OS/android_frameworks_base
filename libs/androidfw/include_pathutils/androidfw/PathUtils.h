...
inline String8& appendPath(String8& str, const String8& leaf) { return appendPath(str, leaf.c_str()); }
...
inline String8 appendPathCopy(String8 str, const String8& leaf) { return appendPath(str, leaf.c_str()); }
