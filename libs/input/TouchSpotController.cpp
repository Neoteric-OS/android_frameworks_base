...
TouchSpotController::TouchSpotController(int32_t displayId,
...
void TouchSpotController::setSpots(const PointerCoords* spotCoords, const uint32_t* spotIdToIndex,
                                   BitSet32 spotIdBits, PointerController* mPointerController) {
    ...
    for (BitSet32 idBits(spotIdBits); !idBits.isEmpty();) {
        ...
        if (!spot) {
            spot = createAndAddSpotLocked(id, mLocked.displaySpots,
                                          mPointerController->mSpriteController);
        }
...
TouchSpotController::Spot* TouchSpotController::createAndAddSpotLocked(
        uint32_t id, std::vector<Spot*>& spots, sp<SpriteController> mSpriteController) {
...
void TouchSpotController::fadeOutAndReleaseSpotLocked(Spot* spot,
