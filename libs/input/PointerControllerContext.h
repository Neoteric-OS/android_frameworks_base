...
public:
    ...
    void registerCallback(std::function<bool(nsecs_t)> callback);
...
private:
    ...
    public:
        ...
        void addCallback(std::function<bool(nsecs_t)> callback);
    ...
    private:
        struct Locked {
            ...
            std::vector<std::function<bool(nsecs_t)>> callbacks;
