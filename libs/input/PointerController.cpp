...
PointerController::PointerController(const sp<PointerControllerPolicyInterface>& policy,
        ...
        mHandler(new MessageHandler()), mCallback(new LooperCallback()) {

    mCursorController = new MouseCursorController(mSpriteController, mPolicy);
...
PointerController::~PointerController() {
    ...
    for (auto it : mLocked.spotControllers) {
        TouchSpotController* mSpotController = it.second;
        delete mSpotController;
    }
...
void PointerController::setInactivityTimeout(PointerController::InactivityTimeout inactivityTimeout) {
    AutoMutex _l(mLock);
...
void PointerController::doAnimate(nsecs_t timestamp) {
    ...
    for(auto it = mLocked.spotControllers.begin(); it != mLocked.spotControllers.end();) {
        TouchSpotController* mSpotController = it->second;
        keepFading = mSpotController->doFadingAnimation(timestamp, keepFading, mLocked.animationTime);
