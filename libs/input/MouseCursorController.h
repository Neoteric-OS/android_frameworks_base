...
public:
    MouseCursorController(sp<SpriteController> mSpriteController, sp<PointerControllerPolicyInterface> mPolicy);
    ~MouseCursorController();

    bool getBounds(float* outMinX, float* outMinY,
    ...
    bool doFadingAnimation(nsecs_t timestamp, bool keepAnimating, PointerController* mPointerController);
...
private:
    ...
    void loadResourcesLocked(sp<PointerControllerPolicyInterface> mPolicy, PointerController::Presentation presentation);
};
