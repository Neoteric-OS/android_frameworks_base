...
public class SmsMessage extends SmsMessageBase {
    ...
    */
     ...
     * @hide
     */
    public final SmsMessage doCreateFromPdu(byte[] pdu) {
     ...
     * @hide
     */
    public final SmsMessage doNewFromCMT(String[] lines) {
        return newFromCMT(lines);
    }

    /** {@inheritDoc}
     * @hide
     */
    public final SmsMessage doNewFromCMTI(String line) {
        return newFromCMTI(line);
    }

    /** {@inheritDoc}
     * @hide
     */
    public final SmsMessage doNewFromCDS(String line) {
        return newFromCDS(line);
    }

    /** {@inheritDoc}
     * @hide
     */
    public final SmsMessage doNewFromParcel(Parcel p){
        return newFromParcel(p);
    }

    /** {@inheritDoc}
     * @hide
     */
    public final SmsMessage doCreateFromEfRecord(int index, byte[] data) {
        return createFromEfRecord(index, data);
    }

    /** {@inheritDoc}
     * @hide
     */
    public final int doGetTPLayerLengthForPDU(String pdu) {
        return getTPLayerLengthForPDU(pdu);
    }      

    /** {@inheritDoc}
     * @hide
     */
    public final SubmitPdu doGetSubmitPdu(String scAddress,
            String destinationAddress, String message,
