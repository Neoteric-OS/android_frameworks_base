...
public final class RuimRecords extends IccRecords {
    ...
    public void dispose() {
        ...
        this.removeMessages(EVENT_GET_DEVICE_IDENTITY_DONE);
        this.removeMessages(EVENT_GET_CDMA_SUBSCRIPTION_DONE);
        this.removeMessages(EVENT_GET_ICCID_DONE);
        this.removeMessages(EVENT_UPDATE_DONE);
        this.removeMessages(EVENT_RUIM_REFRESH);
    ...
    public void setVoiceCallForwardingFlag(int line, boolean enable) {
        Log.e(LOG_TAG, "method setVoiceCallForwardingFlag is NOT supported in CDMA!");
    }
    ...
    protected void onAllRecordsLoaded() {
        ...
        phone.mRuimCard.broadcastRuimStateChangedIntent(
