...
final class CdmaServiceStateTracker extends ServiceStateTracker {
    ...
    public void dispose() {
        ...
        this.removeMessages(EVENT_NETWORK_STATE_CHANGED_CDMA);
        this.removeMessages(EVENT_GET_SIGNAL_STRENGTH_CDMA);
        this.removeMessages(EVENT_GET_LOC_DONE_CDMA);
        this.removeMessages(EVENT_NV_LOADED);
        this.removeMessages(EVENT_POLL_STATE_OPERATOR_CDMA);
        this.removeMessages(EVENT_POLL_STATE_NETWORK_SELECTION_MODE_CDMA);
        this.removeMessages(EVENT_POLL_STATE_REGISTRATION_CDMA);
        this.removeMessages(EVENT_POLL_SIGNAL_STRENGTH_CDMA);
        this.removeMessages(EVENT_SIGNAL_STRENGTH_UPDATE_CDMA);
        this.removeMessages(EVENT_RUIM_RECORDS_LOADED);
