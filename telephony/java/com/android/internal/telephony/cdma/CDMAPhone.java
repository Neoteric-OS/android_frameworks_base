...
public class CDMAPhone extends PhoneBase {
    ...
    private boolean mIsRadioTechnologyChangeOngoing;
    ...
    public CDMAPhone(Context context, CommandsInterface ci, PhoneNotifier notifier, 
        ...
        mIsRadioTechnologyChangeOngoing = false;
    ...
    public void dispose() {
        synchronized(PhoneProxy.lockForRadioTechnologyChange) {
            mIsRadioTechnologyChangeOngoing = true;
...
//      throw new RuntimeException(); 
    ...
    class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if(mIsRadioTechnologyChangeOngoing) {
                ...
                Log.d(LOG_TAG, "RadioTechnologyChangeOngoing...ignoring message: " + msg.what);
                return;
            }
    ...
    public boolean isRadioTechnologyChangeOngoing() {
        return mIsRadioTechnologyChangeOngoing;
    }
}
