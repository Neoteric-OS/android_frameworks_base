...
//    static final int NOTIFICATION_ID_ICC_STATUS = 33456;
    ...
    public void dispose() {
        ...
        this.removeMessages(EVENT_RUIM_READY);
        this.removeMessages(EVENT_RUIM_LOCKED_OR_ABSENT);
        this.removeMessages(EVENT_GET_RUIM_STATUS_DONE);
        ...
        this.removeMessages(EVENT_CHANGE_RUIM_PASSWORD_DONE);
