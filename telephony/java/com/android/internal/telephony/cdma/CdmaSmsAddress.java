...
public class CdmaSmsAddress extends SmsAddress {
     ...
     */
    @VisibleForTesting
    static byte[] parseToDtmf(String address) {
    ...
    public static CdmaSmsAddress parse(String address) {
        ...
        if (address.contains("+") || filteredAddr == null) {
            ...
            if (address.contains("@")) {
                ...
                // 3GPP2 C.S0015-B section 3.4.3.3 Address Parameters
                // digit mode is set to 1 and number mode is set to 0, type of number should 
                // correspond to the value in 3GPP2 C.S005-D, table2.7.1.3.2.4-2
