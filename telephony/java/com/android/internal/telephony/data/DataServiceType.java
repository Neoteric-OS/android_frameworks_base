...
enum DataServiceType {
    ...
    static public DataServiceType apnTypeStringToServiceType(String type) {
        if (TextUtils.equals(type, DataInterface.APN_TYPE_DEFAULT)) {
            return SERVICE_TYPE_DEFAULT;
        } else if (TextUtils.equals(type, DataInterface.APN_TYPE_MMS)) {
            return SERVICE_TYPE_MMS;
        } else if (TextUtils.equals(type, DataInterface.APN_TYPE_SUPL)) {
            return SERVICE_TYPE_SUPL;
        } else if (TextUtils.equals(type, DataInterface.APN_TYPE_DUN)) {
            return SERVICE_TYPE_DUN;
        } else if (TextUtils.equals(type, DataInterface.APN_TYPE_HIPRI)) {
    ...
    protected String toApnTypeString() {
        switch (this) {
            case SERVICE_TYPE_DEFAULT:
                return DataInterface.APN_TYPE_DEFAULT;
            case SERVICE_TYPE_MMS:
                return DataInterface.APN_TYPE_MMS;
            case SERVICE_TYPE_SUPL:
                return DataInterface.APN_TYPE_SUPL;
            case SERVICE_TYPE_DUN:
                return DataInterface.APN_TYPE_DUN;
            case SERVICE_TYPE_HIPRI:
                return DataInterface.APN_TYPE_HIPRI;
            default:
                return null;
        }
    }
