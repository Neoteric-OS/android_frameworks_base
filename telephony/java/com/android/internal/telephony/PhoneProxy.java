...
public class PhoneProxy extends Handler implements Phone{
    ...
    public void handleMessage(Message msg) {
        ...
        case EVENT_RADIO_TECHNOLOGY_CHANGED:
            ...
            Log.d(LOG_TAG, "Switching phone from " + mOutgoingPhone + "Phone to " +
                    (mOutgoingPhone.equals("GSM") ? "CDMAPhone" : "GSMPhone") );
            if(mOutgoingPhone.equals("GSM")) {
                //Set this variable to indicate that we are during a radio technology change
                //The indication will be reset in the finalize function 
                //of the appropriate destroyed phone.
                PhoneProxy.setRadioTechnologyChangeGsmToCdma(true);

                Log.d(LOG_TAG, "Make a new CDMAPhone and destroy the old GSMPhone.");
                ...
                //Indicate that we are during a radio technology change
                //The indication will be reset in the finalize function 
                //of the appropriate destroyed phone.
                PhoneProxy.setRadioTechnologyChangeCdmaToGsm(true);

                Log.d(LOG_TAG, "Make a new GSMPhone and destroy the old CDMAPhone.");
            ...
            //Give the garbage collector again a hint to start the 
            //garbage collection after setting the new interfaces
            System.gc();
    ...
    public static synchronized boolean getRadioTechnologyChangeCdmaToGsm() {
        return PhoneProxy.radioTechnologyChangeCdmaToGsm;
    }

    public static synchronized void setRadioTechnologyChangeCdmaToGsm(boolean b) {
        PhoneProxy.radioTechnologyChangeCdmaToGsm = b;
    }

    public static synchronized boolean getRadioTechnologyChangeGsmToCdma() {
        return PhoneProxy.radioTechnologyChangeGsmToCdma;
    }

    public static synchronized void setRadioTechnologyChangeGsmToCdma(boolean b) {
        PhoneProxy.radioTechnologyChangeGsmToCdma = b;
    }
