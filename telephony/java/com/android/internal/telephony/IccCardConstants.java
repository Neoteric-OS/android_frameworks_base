...
public class IccCardConstants {
    ...
    public static final String INTENT_VALUE_ICC_UNKNOWN = Intent.INTENT_VALUE_SIM_STATE_UNKNOWN;
    /* NOT_READY means the ICC interface is not ready (eg, radio is off or powering on) */
    public static final String INTENT_VALUE_ICC_NOT_READY = Intent.INTENT_VALUE_SIM_STATE_NOT_READY;
    /* ABSENT means ICC is missing */
    public static final String INTENT_VALUE_ICC_ABSENT = Intent.INTENT_VALUE_SIM_STATE_ABSENT;
    /* PRESENT means ICC is present */
    public static final String INTENT_VALUE_ICC_PRESENT = Intent.INTENT_VALUE_SIM_STATE_PRESENT;
    /* CARD_IO_ERROR means for three consecutive times there was SIM IO error */
    static public final String INTENT_VALUE_ICC_CARD_IO_ERROR =
            Intent.INTENT_VALUE_SIM_STATE_CARD_IO_ERROR;
    /* CARD_RESTRICTED means card is present but not usable due to carrier restrictions */
    static public final String INTENT_VALUE_ICC_CARD_RESTRICTED =
            Intent.INTENT_VALUE_SIM_STATE_CARD_RESTRICTED;
    /* LOCKED means ICC is locked by pin or by network */
    public static final String INTENT_VALUE_ICC_LOCKED = Intent.INTENT_VALUE_SIM_STATE_LOCKED;
    /* READY means ICC is ready to access */
    public static final String INTENT_VALUE_ICC_READY = Intent.INTENT_VALUE_SIM_STATE_READY;
    /* IMSI means ICC IMSI is ready in property */
    public static final String INTENT_VALUE_ICC_IMSI = Intent.INTENT_VALUE_SIM_STATE_IMSI;
    /* LOADED means all ICC records, including IMSI, are loaded */
    public static final String INTENT_VALUE_ICC_LOADED = Intent.INTENT_VALUE_SIM_STATE_LOADED;
    /* The extra data for broadcasting intent INTENT_ICC_STATE_CHANGE */
    public static final String INTENT_KEY_LOCKED_REASON = Intent.EXTRA_SIM_LOCKED_REASON;
    /* PIN means ICC is locked on PIN1 */
    public static final String INTENT_VALUE_LOCKED_ON_PIN = Intent.INTENT_VALUE_SIM_LOCKED_ON_PIN;
    /* PUK means ICC is locked on PUK1 */
    public static final String INTENT_VALUE_LOCKED_ON_PUK = Intent.INTENT_VALUE_SIM_LOCKED_ON_PUK;
    /* NETWORK means ICC is locked on NETWORK PERSONALIZATION */
    public static final String INTENT_VALUE_LOCKED_NETWORK = Intent.INTENT_VALUE_SIM_LOCKED_NETWORK;
    /* PERM_DISABLED means ICC is permanently disabled due to puk fails */
    public static final String INTENT_VALUE_ABSENT_ON_PERM_DISABLED =
            Intent.INTENT_VALUE_SIM_ABSENT_ON_PERM_DISABLED;
