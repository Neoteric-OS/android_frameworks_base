...
public class MSimGSMPhone extends GSMPhone {
    ...
    private void onSubscriptionActivated() {
        ...
        log("SUBSCRIPTION ACTIVATED : " + mSubscriptionData.toShortString());
    ...
    // --msim--: Should have a check here - this method should get called only after setting the mSubscription.
    // Currently this will get called from the base class constructor also!
