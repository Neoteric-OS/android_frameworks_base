...
*/
    ...
    /** {@inheritDoc} */
    public SmsMessageBase doCreateFromPdu(byte[] pdu) {
        return createFromPdu(pdu);
    }

    /** {@inheritDoc} */
    public SmsMessageBase doNewFromCMT(String[] lines) {
        return newFromCMT(lines);
    }

    /** {@inheritDoc} */
    public SmsMessageBase doNewFromCMTI(String line) {
     ...
     */
    public SmsMessageBase doNewFromParcel(Parcel p){
        Log.w(LOG_TAG, "newFromParcel: is not supported in GSM mode.");
        return null;
    }

    /** {@inheritDoc} */
    public SmsMessageBase doNewFromCDS(String line) {
        return newFromCDS(line);
    }

    /** {@inheritDoc} */
    public SmsMessageBase doCreateFromEfRecord(int index, byte[] data) {
        return createFromEfRecord(index, data);
    }

    /** {@inheritDoc} */
    public int doGetTPLayerLengthForPDU(String pdu) {
        return getTPLayerLengthForPDU(pdu);
    }

    /** {@inheritDoc} */
    public SubmitPdu doGetSubmitPdu(String scAddress,
            String destinationAddress, String message,
            boolean statusReportRequested, byte[] header) {
        return getSubmitPdu(scAddress, destinationAddress, message,
                statusReportRequested, header);
    }
    ...
    public SubmitPdu doGetSubmitPdu(String scAddress,
            String destinationAddress, short destinationPort, byte[] data,
            boolean statusReportRequested) {
        return getSubmitPdu(scAddress, destinationAddress, destinationPort,
