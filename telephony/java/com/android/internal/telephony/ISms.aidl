...
interface ISms {
     ...
     * @return list of SmsRawData of all sms on ICC
     */
    List<SmsRawData> getAllMessagesFromIccEfUsingSub(in long subscription, String callingPkg);
     ...
     *
     */
     boolean updateMessageOnIccEfUsingSub(in long subscription, String callingPkg,
     ...
     *
     */
    boolean copyMessageToIccEfUsingSub(in long subscription, String callingPkg, int status,
     ...
     * @param subscription the subscription id.
     */
    void sendDataUsingSub(long subscription, String callingPkg, in String destAddr,
     ...
     */
    void sendTextUsingSub(in long subscription, String callingPkg, in String destAddr,
     ...
     * @param subscription the subscription on which the SMS has to be sent.
     */
    void sendMultipartTextUsingSub(in long subscription, String callingPkg,
     ...
     * @see #disableCellBroadcast(int)
     */
    boolean enableCellBroadcastUsingSub(in long subscription, int messageIdentifier);
     ...
     * @see #enableCellBroadcast(int)
     */
    boolean disableCellBroadcastUsingSub(in long subscription, int messageIdentifier);
     ...
     * @see #disableCellBroadcastRange(int, int)
     */
    boolean enableCellBroadcastRangeUsingSub(long subscription, int startMessageId, int endMessageId);
     ...
     */
    boolean disableCellBroadcastRangeUsingSub(long subscription, int startMessageId,
            int endMessageId);
     ...
     * Requires system permission.
     */
    int getPremiumSmsPermissionUsingSub(long subscription, String packageName);
     ...
     * Requires system permission.
     */
    void setPremiumSmsPermissionUsingSub(long subscription, String packageName, int permission);
     ...
     * @see #getImsSmsFormat()
     */
    boolean isImsSmsSupportedUsingSub(long subscription);
     ...
     * @see #isImsSmsSupported()
     */
    String getImsSmsFormatUsingSub(long subscription);
