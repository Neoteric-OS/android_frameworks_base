...
interface IPhoneSubInfo {
     ...
     * for GSM phones.
     */
    String getDeviceIdUsingSub(long subscription);
     ...
     */
    String getSubscriberIdUsingSub(long subscription);
    ...
    /**
     * Retrieves the Group Identifier Level1 for GSM phones of a subscription.
     */
    String getGroupIdLevel1UsingSub(long subscription);
     ...
     */
    String getIccSerialNumberUsingSub(long subscription);
     ...
     */
    String getLine1NumberUsingSub(long subscription);
     ...
     */
    String getLine1AlphaTagUsingSub(long subscription);
     ...
     */
    String getMsisdnUsingSub(long subscription);
     ...
     */
    String getVoiceMailNumberUsingSub(long subscription);
     ...
     */
    String getCompleteVoiceMailNumberUsingSub(long subscription);
     ...
     * of a subscription.
     */
    String getVoiceMailAlphaTagUsingSub(long subscription);
