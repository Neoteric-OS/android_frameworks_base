...
public class MSimProxyManager {
    ...
    public static MSimProxyManager getInstance(Context context, Phone[] phoneProxy,
        ...
        if (sMSimProxyManager == null) {
            sMSimProxyManager = new MSimProxyManager(context, phoneProxy, ci);
        }
    ...
    private MSimProxyManager(Context context, Phone[] phoneProxy,
            CommandsInterface[] ci) {
        ...
        mCardSubscriptionManager = CardSubscriptionManager.getInstance(context, ci);
        mSubscriptionManager = SubscriptionManager.getInstance(context, ci);
