...
interface IEuiccCardController {
    oneway void getAllProfiles(String callingPackage, String cardString,
        in IGetAllProfilesCallback callback);
    oneway void getProfile(String callingPackage, String cardString, String iccid,
        in IGetProfileCallback callback);
    oneway void disableProfile(String callingPackage, String cardString, String iccid,
            boolean refresh, in IDisableProfileCallback callback);
    oneway void switchToProfile(String callingPackage, String cardString, String iccid,
            boolean refresh, in ISwitchToProfileCallback callback);
    oneway void setNickname(String callingPackage, String cardString, String iccid, String nickname,
        in ISetNicknameCallback callback);
    oneway void deleteProfile(String callingPackage, String cardString, String iccid,
        in IDeleteProfileCallback callback);
    oneway void resetMemory(String callingPackage, String cardString, int options,
            in IResetMemoryCallback callback);
    oneway void getDefaultSmdpAddress(String callingPackage, String cardString,
        in IGetDefaultSmdpAddressCallback callback);
    oneway void getSmdsAddress(String callingPackage, String cardString,
        in IGetSmdsAddressCallback callback);
    oneway void setDefaultSmdpAddress(String callingPackage, String cardString, String address,
        in ISetDefaultSmdpAddressCallback callback);
    oneway void getRulesAuthTable(String callingPackage, String cardString,
        in IGetRulesAuthTableCallback callback);
    oneway void getEuiccChallenge(String callingPackage, String cardString,
        in IGetEuiccChallengeCallback callback);
    oneway void getEuiccInfo1(String callingPackage, String cardString,
        in IGetEuiccInfo1Callback callback);
    oneway void getEuiccInfo2(String callingPackage, String cardString,
        in IGetEuiccInfo2Callback callback);
    oneway void authenticateServer(String callingPackage, String cardString, String matchingId,
    ...
    oneway void prepareDownload(String callingPackage, String cardString, in byte[] hashCc,
        in byte[] smdpSigned2, in byte[] smdpSignature2, in byte[] smdpCertificate,
        in IPrepareDownloadCallback callback);
    oneway void loadBoundProfilePackage(String callingPackage, String cardString,
        in byte[] boundProfilePackage, in ILoadBoundProfilePackageCallback callback);
    oneway void cancelSession(String callingPackage, String cardString, in byte[] transactionId,
        int reason, in ICancelSessionCallback callback);
    oneway void listNotifications(String callingPackage, String cardString, int events,
        in IListNotificationsCallback callback);
    oneway void retrieveNotificationList(String callingPackage, String cardString, int events,
        in IRetrieveNotificationListCallback callback);
    oneway void retrieveNotification(String callingPackage, String cardString, int seqNumber,
        in IRetrieveNotificationCallback callback);
    oneway void removeNotificationFromList(String callingPackage, String cardString, int seqNumber,
