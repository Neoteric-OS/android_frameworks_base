...
interface ITelephony {
    ...
    */
     ...
     *  interface.
     */
    void registerMmTelFeatureListener(int slotId, in IImsServiceFeatureCallback callback);

    /**
     * Unregister a callback that was previously registered through
     * {@link #registerMmTelFeatureListener} or {@link #registerRcsFeatureListener}. This should
     * always be called when the callback is no longer being used.
     */
