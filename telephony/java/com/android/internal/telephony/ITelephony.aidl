...
interface ITelephony {
    ...
    */
     ...
     *
     * The ATR from the card is returned when an electrical reset of the card's
     * chip by the card reader. It is a message output, which provides information
     * about the communication parameters proposed by the card, as well as it's
     * nature and state.
