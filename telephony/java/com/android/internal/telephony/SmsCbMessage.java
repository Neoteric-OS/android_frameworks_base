...
public class SmsCbMessage implements Parcelable {
     ...
     * operator policy. If the device is unable to determine its position meeting operator policy
     * within the GeoFencing Maximum Wait Time, it shall present the alert to the user and
