...
public class MbmsDownloadSession implements AutoCloseable {
     ...
     * app provided via {@link DownloadRequest.Builder#Builder(Uri, Uri)}.
     *
    ...
    private MbmsDownloadSession(Context context, MbmsDownloadSessionCallback callback,
            int subscriptionId, Executor executor) {
        mContext = context;
     ...
     * See {@link #create(Context, int, Executor, MbmsDownloadSessionCallback)}
     */
    ...
    public static @Nullable MbmsDownloadSession create(@NonNull Context context,
        ...
        MbmsDownloadSession session =
                new MbmsDownloadSession(context, callback, subscriptionId, executor);
     ...
     *
     * It is safe to call {@link #create(Context, int, Executor, MbmsDownloadSessionCallback)} to
