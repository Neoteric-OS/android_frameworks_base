...
public class MbmsDownloadSession implements AutoCloseable {
     ...
     *
     * Another DownloadRequest should be sent to try the download again.
     */
    public static final int RESULT_IO_ERROR = 4;

    /**
     * Indicates that the Service ID specified in the DownloadRequest is incorrect due to the Id
     * being incorrect, stale, expired, or similar.
     */
    public static final int RESULT_SERVICE_ID_NOT_DEFINED = 5;

    /**
     * Indicates that there was an error while downloading files, such as a file repair or decoding
     * error.
     */
    public static final int RESULT_DOWNLOAD_FAILURE = 6;

    /**
     * Indicates that the file system is full and can the DownloadRequest can not complete. Either
     * space must be made on the current file system or the temp file root location must be changed
     * to a location that is not full to download the temp files.
     */
