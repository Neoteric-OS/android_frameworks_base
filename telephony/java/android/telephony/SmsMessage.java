...
public class SmsMessage {
    ...
    private static final String LOG_TAG = "SmsMessageProxy";
    ...
    */
    ...
    public static SmsMessage newFromCMT(String[] lines){
        SmsMessageBase wrappedMessage = getSmsFacility().doNewFromCMT(lines);
        return new SmsMessage(wrappedMessage);
    }

    /** @hide */
    protected static SmsMessage newFromCMTI(String line) {
        SmsMessageBase wrappedMessage = getSmsFacility().doNewFromCMTI(line);
        return new SmsMessage(wrappedMessage);
    }

    /** @hide */
    public static SmsMessage newFromCDS(String line) {
        SmsMessageBase wrappedMessage = getSmsFacility().doNewFromCDS(line);
        return new SmsMessage(wrappedMessage);
    }

    /** @hide */
    public static SmsMessage newFromParcel(Parcel p) {
        SmsMessageBase wrappedMessage = getSmsFacility().doNewFromParcel(p);
        return new SmsMessage(wrappedMessage);
    }
    ...
    public static SmsMessage createFromEfRecord(int index, byte[] data) {
        SmsMessageBase wrappedMessage = getSmsFacility().doCreateFromEfRecord(index, data);
        return new SmsMessage(wrappedMessage);
    }
    ...
    public static int getTPLayerLengthForPDU(String pdu) {
        return getSmsFacility().doGetTPLayerLengthForPDU(pdu);
    }
    ...
    public static int[] calculateLength(String messageBody, boolean use7bitOnly) {
        return getSmsFacility().doCalculateLength(messageBody, use7bitOnly);
    }
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
        ...
        SubmitPduBase spb = getSmsFacility().doGetSubmitPdu(scAddress,
