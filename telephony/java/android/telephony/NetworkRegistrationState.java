...
public final class NetworkRegistrationState implements Parcelable {
    ...
    //TODO: Move to AccessNetworkConstants.java
    /**
     * Wireless transportation type
     * @hide
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(prefix = "TRANSPORT_TYPE_", value = {TRANSPORT_TYPE_WWAN, TRANSPORT_TYPE_WLAN})
    ...
    private final List<Integer> mAvailableServices;

    private final CellIdentity mCellIdentity;


    /**
     * @param transportType Transport type. Must be {@link #TRANSPORT_TYPE_WWAN} or
     * {@link #TRANSPORT_TYPE_WLAN}.
    ...
    public NetworkRegistrationState(int transportType, int domain, int regState,
            ...
            List<Integer> availableServices, CellIdentity cellIdentity) {
     ...
     */
    public boolean isEmergenceEnabled() { return mEmergencyOnly; }

    /**
     * @return List of available service types.
     */
    public List<Integer> getAvailableServices() { return new ArrayList(mAvailableServices); }
