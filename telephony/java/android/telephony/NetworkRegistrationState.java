...
public class NetworkRegistrationState implements Parcelable {
     ...
     * the definition in 3GPP TS 24.008, 10.5.3.6 and Annex G.
     * @hide
     */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(prefix = "REJECT_CAUSE_",
            value = {REJECT_CAUSE_IMSI_UNKNOWN_IN_HLR, REJECT_CAUSE_ILLEGAL_MS,
                    ...
                    REJECT_CAUSE_ILLEGAL_ME, REJECT_CAUSE_PLMN_NOT_ALLOWED,
                    ...
                    REJECT_CAUSE_NETWORK_FAILURE, REJECT_CAUSE_MAC_FAILURE,
                    REJECT_CAUSE_SYNCH_FAILURE, REJECT_CAUSE_CONGESTION,
