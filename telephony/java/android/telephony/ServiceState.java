...
public class ServiceState implements Parcelable {
    ...
    public void fillInNotifierBundle(Bundle m) {
        ...
        m.putBoolean("manual", Boolean.parseBoolean(mIsManualNetworkSelection));
        ...
        m.putBoolean("emergencyOnly", Boolean.parseBoolean(mIsEmergencyOnly));
        m.putBoolean("isDataRoamingFromRegistration",
                Boolean.parseBoolean(mIsDataRoamingFromRegistration));
    }
