...
public final class EpsBearerQosSessionAttributes implements QosSessionAttributes, Parcelable {
    ...
    /**
     * List of remote addresses associated with the Qos Session and therefore the uplink bit rates.
     * In the event that the list is empty, it is assumed that the uplink bit rates apply to all
     * remote addresses except for those in other Qos Sessions.
     *
