...
public final class CellSignalStrengthWcdma extends CellSignalStrength implements Parcelable {
    ...
    private int mEcNo; // CellInfo.UNAVAILABLE if unknown
    private int mLevel;
    ...
    /**
     * Get the signal level as an asu value between 0..96, 255 is unknown
     * Asu is calculated based on 3GPP RSRP. Refer to 3GPP 27.007 (Ver 10.3.0) Sec 8.69
     */
    @Override
    public int getAsuLevel() {
        if (mRscp != CellInfo.UNAVAILABLE) return mRscp + 120;
        if (mRssi != CellInfo.UNAVAILABLE) return (mRssi + 113) / 2;
        return 255;
    }
