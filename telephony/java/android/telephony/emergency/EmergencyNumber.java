...
public final class EmergencyNumber implements Parcelable {
    ...
    @IntDef(flag = true, prefix = { "EMERGENCY_SERVICE_CATEGORY_" }, value = {
            ...
            EMERGENCY_SERVICE_CATEGORY_BRIGADE,
    ...
    /** Emergency Service Category for general emergency call, all categories. */
    ...
    public static final int EMERGENCY_SERVICE_CATEGORY_BRIGADE =
    ...
    /** Emergency Service Category for Manually Initiated eCall (MIeC) */
    public static final int EMERGENCY_SERVICE_CATEGORY_MIEC = EmergencyServiceCategory.MIEC;
    /** Emergency Service Category for Automatically Initiated eCall (AIeC) */
    ...
    static {
        ...
        EMERGENCY_SERVICE_CATEGORY_SET.add(EMERGENCY_SERVICE_CATEGORY_BRIGADE);
    ...
    /**
     * Indicates the number is available as default.
     *
     * Per "3gpp 22.101, Section 10 - Emergency Calls", 112, 911 must always be available;
     ...
     */
    public boolean serviceUnspecified() {
     ...
     */
    public boolean inServiceCategory(@EmergencyServiceCategories int categories) {
    ...
    /**
     * Returns the sources {@link EmergencyNumberSources} of the emergency number.
     *
     * @return a list of the sources {@link EmergencyNumberSources}
     */
    public List<Integer> getEmergencyNumberSources() {
        List<Integer> categories = new ArrayList<>();
        for (Integer source : EMERGENCY_NUMBER_SOURCE_SET) {
            if ((mEmergencyServiceCategoryBitmask & source) == source) {
     ...
     *
     * @param sources - emergency number sources {@link EmergencyNumberSources}
     */
    public boolean fromSources(@EmergencyNumberSources int sources) {
