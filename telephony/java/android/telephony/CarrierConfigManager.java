...
public class CarrierConfigManager {
    ...
    /**
     * Boolean indicating if default data account should show 4G+ icon when in LTE.
     * @hide
     */
    public static final String KEY_SHOW_4G_PLUS_FOR_LTE_DATA_ICON_BOOL =
            "show_4g_plus_for_lte_data_icon_bool";
   ...
   /**
    ...
    static {
        ...
        sDefaults.putBoolean(KEY_SHOW_4G_PLUS_FOR_LTE_DATA_ICON_BOOL, false);
