  ...
  public static final String KEY_OPPORTUNISTIC_TIME_TO_SCAN_AFTER_CAPABILITY_SWITCH_TO_PRIMARY_LONG
    ...
    */
    ...
    public static final class Iwlan {
         ...
         */
        private static final int UNKNOWN_ERROR_TYPE = 0;
         ...
         *     Exchange (IKEv2) Protocol </a> for global errors and carrier specific requirements
         *     for other carrier specific error codes. ErrorDetails defined for this type is always
         *     in numeric form representing the error codes. Examples: "24", "9000-9050"
         */
        private static final int IKE_PROTOCOL_ERROR_TYPE = 3;

        /** @hide */
        @IntDef({
                UNKNOWN_UNTHROTTLING_EVENT,
         ...
         * parsing the error type.
         */
        private static final int UNKNOWN_UNTHROTTLING_EVENT = 0;

        /** Wifi turned off or disabled. */
        public static final int WIFI_DISABLE_UNTHROTTLING_EVENT = 1;

        /** Airplane mode turned off or disabled. */
        public static final int APM_DISABLE_UNTHROTTLING_EVENT = 2;

        /** Airplame mode turned on or enabled */
        public static final int APM_ENABLE_UNTHROTTLING_EVENT = 3;

        /** Wifi AccessPoint changed. */
        public static final int WIFI_AP_CHANGED_UNTHROTTLING_EVENT = 4;

        /** Wifi calling turned off or disabled */
        public static final int WIFI_CALLING_DISABLE_UNTHROTTLING_EVENT = 5;
