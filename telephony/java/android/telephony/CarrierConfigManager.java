  ...
  public static final String KEY_OPPORTUNISTIC_TIME_TO_SCAN_AFTER_CAPABILITY_SWITCH_TO_PRIMARY_LONG
    ...
    */
    ...
    public static final class Iwlan {
         ...
         * <ul>
         *   <li>"capabilities": Array of apn names specifics for which the policy needs to be
         *       applied to.</li>
         *   <li>"error_type": The type of error in String. Possible error types are:
         *     <ol>
         ...
         *           carrier specific requirements for other carrier specific error codes.</li>
         ...
         *     </ol>
         *   </li>
         *   <li>"error_details": Array of errors specifics for which the policy needs to be applied
         *       to. Note: Array can be a mix of number, range and string formats. Following are the
         *       currently supported formats of elements in the array:
         *     <ol>
         *       <li>Number or Code: "24" - Number specific to the error.</li>
         *       <li>Range: "9000-9050" - Range of specific errors.</li>
         *       <li>Any: "*" value represents that this can be applied to all ErrorDetails when
         *           there is no specific match. This will be a single element array.</li>
         ...
         *           "TUNNEL_TRANSFORM_FAILED"</li>
         *     </ol>
         *     <p>"IKE_PROTOCOL_EXCEPTION" ErrorType expects the "error_detail" to be
         *        defined only in numbers or range of numbers. Examples: "24" or "9000-9050" or
         *        "7|14000-14050"</p>
         *     <p>"GENERIC_ERROR_TYPE" or "*" ErrorType expects only the following to be in
         *        "error_detail" - "IO_EXCEPTION", "TIMEOUT_EXCEPTION",
         *        "SERVER_SELECTION_FAILED", "TUNNEL_TRANSFORM_FAILED" and "*". Example:
         *        "IO_EXCEPTION|TIMEOUT_EXCEPTION" or "*"</p>
         *     </ul>
         *   </li>
         *   <li>"retry_array": Array of retry times (in secs) represented in string format.
         *       Following formats are currently supported:
         *     <ol>
         *       <li>"0|0|0" Retry immediately for maximum 3 times and then fail.</li>
         *       <li>"" Empty array means to fail whenever the error happens.</li>
         *       <li>"2|4|8" Retry times are 2 secs, 4secs and 8 secs - fail after that.</li>
         *       <li>"5|10|15|-1" Here the "-1" represents infinite retires with the retry time "15"
         *           (the last retry number).</li>
         *       <li>"2+r15" 2 seconds + random time below 15 seconds, fail after that</li>
         *     </ol>
         *     <p>When fails, by default throttle for 24 hours.</p>
         *   <li>"unthrottling_events": Events for which the retry time can be unthrottled in
         *       string. Possible unthrottling events are:
         *     <ol>
         *       <li>"WIFI_DISABLE_EVENT": Wifi on to off toggle.</li>
         *       <li>"APM_DISABLE_EVENT": APM on to off toggle.</li>
         *       <li>"APM_ENABLE_EVENT": APM off to on toggle.</li>
         *       <li>"WIFI_AP_CHANGED_EVENT": Wifi is connected to an AP with different SSID.</li>
         *       <li>"WIFI_CALLING_DISABLE_EVENT": Wifi calling button on to off toggle.</li>
         *     </ol>
         *   </li>
         *   <li>"handover_attempt_count": Integer to specify the number of handover request
         *       attempts before using initial attach instead. It is an optional field.
         *       <p>"handover_attempt_count" should only be defined in the string when handover
         ...
         *          not be defined in the string.</p>
         *   </li>
         * </ul>
         *
         * <p>Note: When the value is "*" for any of "capabilities" or "error_type" or
         *    "error_details", it means that the config definition applies to rest of the errors for
         *    which the config is not defined. For example, if "capabilities" is "ims" and the
         *    "error_type" is defined as "*" - this policy will be applied to the error that doesn't
         *    fall into other error types defined under "ims".</p>
         *
         ...
         *     <item value="capabilities=*, error_type=IKE_PROTOCOL_ERROR_TYPE, error_details=*,
        ...
        private static PersistableBundle getDefaults() {
            ...
            defaults.putStringArray(KEY_ERROR_POLICY_CONFIG_STRING_ARRAY, new String[]{
                    ...
                    "capabilities=*, error_type=GENERIC_ERROR_TYPE, "
                            + "error_details=SERVER_SELECTION_FAILED, "
                            + "retry_array=10|20|40|80|160, "
                            + "unthrottling_events=APM_ENABLE_EVENT|WIFI_DISABLE_EVENT"
                            + "|WIFI_AP_CHANGED_EVENT",
                    "capabilities=*, error_type=IKE_PROTOCOL_ERROR_TYPE, error_details=24|9002, "
                            + "retry_array=10|20|40|80|160, "
                            + "unthrottling_events=APM_ENABLE_EVENT|WIFI_DISABLE_EVENT"
