...
/**
  ...
  public static final String KEY_OPPORTUNISTIC_TIME_TO_SCAN_AFTER_CAPABILITY_SWITCH_TO_PRIMARY_LONG
    ...
    */
     ...
     * disabled while finding the network. It depends on a modem capability whether it needs to
     * disable mobile data or not. If a modem doesn't need to do it, this configuration will be
     * ignored.
     *
