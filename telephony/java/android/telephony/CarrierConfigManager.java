...
public class CarrierConfigManager {
   ...
   /**
     ...
     * may not represent the configuration for an identified carrier. It should be noted that it
     * does not necessarily mean the configuation belongs to current carrier when this function
     * return true because it may belongs to another previous identified carrier. Users should
     ...
     * use this method to confirm whether any carrier configuration has been applied.
     * </p>
     *
     * @param bundle the configuration bundle to be checked.
     * @return boolean true if any carrier configuration bundle has been applied, false if
     * the bundle is the default one or is null.
     */
