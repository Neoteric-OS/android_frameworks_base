...
public class CarrierConfigManager {
    ...
    */
     ...
     *
     * 2. If download fails again then, retry after either BACKOFF_TIMER_VALUE,
     * 2xBACKOFF_TIMER_VALUE, or 3xBACKOFF_TIMER_VALUE seconds.
     *
     * 3. In general after the cth failed attempt, retry after k * BACKOFF_TIMER_VALUE
     * seconds, where k is a random integer between 1 and 2^c − 1.
     */
    ...
    */
    ...
    static {
        ...
        sDefaults.putInt(KEY_ESIM_DOWNLOAD_RETRY_BACKOFF_TIMER_VALUE_INT, 60);
