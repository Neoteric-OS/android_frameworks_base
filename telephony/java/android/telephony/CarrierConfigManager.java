...
public class CarrierConfigManager {
    ...
    /**
     * When checking if a given number is the voicemail number
     * (See PhoneNumberUtils.isVoiceMailNumber(Context, int, String), if this flag is true
     ...
     */
    public static final String KEY_TREAT_MDN_AS_ADDITIONAL_VOICEMAIL_NUMBER_BOOL =
            "treat_mdn_as_additional_voicemail_number_bool";
    ...
    static {
        ...
        sDefaults.putBoolean(KEY_TREAT_MDN_AS_ADDITIONAL_VOICEMAIL_NUMBER_BOOL, false);
