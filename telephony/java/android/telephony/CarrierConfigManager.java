...
public class CarrierConfigManager {
    ...
    */
    ...
    /**
    * Controls SS-RSRP threshold in dBm below which 5G opportunistic network available will be not
    ...
    */
    ...
    /**
    * Controls SS-RSRQ threshold in dB below which 5G opportunistic network available will be not
    * be considered good enough for internet data.
    *
    * @hide
    */
    ...
    */
    ...
    /**
     * Controls hysteresis time in milli seconds for which will be waited before switching
    ...
    /**
     * Controls hysteresis time in milli seconds for which will be waited before switching from
     ...
     * @hide
     */
    public static final String KEY_ENABLE_4G_OPPORTUNISTIC_NETWORK_SCAN =
            "enabled_4g_opportunistic_network_scan";
    ...
    */
    ...
    static {
        ...
        sDefaults.putInt(KEY_OPPORTUNISTIC_NETWORK_ENTRY_THRESHOLD_SS_RSRQ_DOUBLE, -18.5);
        /* Default value is -120 dBm. */
        sDefaults.putInt(KEY_OPPORTUNISTIC_NETWORK_EXIT_THRESHOLD_SS_RSRP_INT, -120);
        /* Default value is -18.5 dB. */
        sDefaults.putInt(KEY_OPPORTUNISTIC_NETWORK_EXIT_THRESHOLD_SS_RSRQ_DOUBLE, -18.5);
        /* Default value is 10 seconds. */
        ...
        sDefaults.putBoolean(KEY_ENABLE_4G_OPPORTUNISTIC_NETWORK_SCAN, true);
