...
public class CarrierConfigManager {
     ...
     * @hide
     */
    public static final String KEY_LTE_RSRP_BOOST_INT = "lte_rsrp_boost_int";

    /**
     * List of EARFCN (E-UTRA Absolute Radio Frequency Channel Number,
     * Reference: 3GPP TS 36.104 5.4.3) ranges on which lte_rsrp_boost_int will be applied.
    ...
    static {
        ...
        sDefaults.putInt(KEY_LTE_RSRP_BOOST_INT, 0);
