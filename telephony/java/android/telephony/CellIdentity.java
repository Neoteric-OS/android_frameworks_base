...
/**
 * CellIdentity is a collection of CellIdentityXxx
 */
public abstract class CellIdentity implements Parcelable {
    ...
    @IntDef({TYPE_GSM, TYPE_CDMA, TYPE_LTE, TYPE_WCDMA, TYPE_TDSCDMA})
            ...
            new Creator<CellIdentity>() {
                ...
                public CellIdentity createFromParcel(Parcel in) {
                    ...
                    switch (type) {
                        ...
                        default: throw new RuntimeException("Bad Cell identity Parcel");
                    }
                }
