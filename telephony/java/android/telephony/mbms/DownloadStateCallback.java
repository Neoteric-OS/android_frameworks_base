...
public class DownloadStateCallback {
     ...
     * @param filterFlags A bitmask of {@link FilterFlag} flags that will specify which callbacks
     *     this instance is interested in.
     */
    ...
    /**
     * Returns true if a {@link FilterFlag} flag is set for a particular callback method. If the
     * flag is set, the callback will be delivered to the listening process.
     * @param flag A {@link FilterFlag} flag specifying whether or not a callback method is
