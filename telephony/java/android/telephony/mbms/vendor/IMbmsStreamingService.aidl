...
interface IMbmsStreamingService
{
     ...
     */
    void getStreamingServices(String appName, int subId, in List<String> serviceClasses);
     ...
     */
    List<StreamingServiceInfo> getActiveStreamingServices(String appName, int subId);
