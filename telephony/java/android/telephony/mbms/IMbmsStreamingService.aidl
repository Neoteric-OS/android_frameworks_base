...
interface IMbmsStreamingService
{
     ...
     */
    void initialize(IMbmsStreamingManagerListener listener, String appName, int subId);
     ...
     */
    void getStreamingServices(String appName, int subId, List<String> serviceClasses);
    ...
    /**
     * Lists all Services being streamed by this uid/appName/subId
     */
    List<StreamingServiceInfo> getActiveStreamingServices(String appName, subId);
     ...
     * an callbacks registered for this uid/appName/subId and the callbacks registered through
     * startStreaming.
     */
