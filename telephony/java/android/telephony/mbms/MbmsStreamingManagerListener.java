...
public class MbmsStreamingManagerListener extends IMbmsStreamingManagerListener.Stub {
     ...
     *
     * This will only be called after the application has requested
     * a list of downloadable File Services and specified a service
     * class list of interest AND the results of a subsequent
     * getFileServices call with the same service class list would
    ...
    /**
     * Called to indicate this instance will no longer be called.
     *
     * Used to give a synchronized idea of the end of life for this
     * class.
     */
