...
public class SubscriptionManager {
     ...
     * 1) {@link #INVALID_SUBSCRIPTION_ID} if the supplied subscriptionId is invalid,
     * 2) {@link #SIM_NOT_INSERTED} if sim is not inserted,
     * 3) {@link #INVALID_SIM_SLOT_INDEX} if the supplied subscriptionId doesn't have an associated
     * slot index.
     */
