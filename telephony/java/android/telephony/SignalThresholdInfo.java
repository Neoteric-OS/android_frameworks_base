...
/**
 * Defines signal measurement type and the corresponding threshold values of the signal strength.
 */
public final class SignalThresholdInfo implements Parcelable {
    ...
    /**
     * Default value when set by application, indicating the isEnabled is not used.
     *
     * @hide
     */
     ...
     * @hide
     */
    public static final int SIGNAL_RSRQ_MIN_VALUE = -20;
     ...
     * @hide
     */
    public static final int SIGNAL_SSRSRQ_MIN_VALUE = -20;
     ...
     * @hide
     */
    public static final int SIGNAL_SSRSRQ_MAX_VALUE = -3;
     ...
     *
     * @return array of integer that represent the signal thresholds
     */
    @Nullable
