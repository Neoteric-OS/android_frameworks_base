...
public final class SignalThresholdInfo implements Parcelable {
     ...
     *                  unit must reference specific SignalMeasurementType. Thresholds will sort
     *                   into ascending numerical order.
     *
     * @throws IllegalArgumentException if the signal measurement type is invalid, the thresholds
     * array is null or empty, any value in the thresholds is out of range, or the ran is not
     * allowed to set with the signal measurement type.
     *
     ...
     *
     * @see {@link AccessNetworkConstants.RadioAccessNetworkType}
     *
    ...
    /**
     * Return true if the radio access type value is allowed to set with the measurement type.
     */
    private static boolean isValidRanWithMeasurementType(
        ...
        switch (type) {
            ...
            case SIGNAL_RSRP: // fail through
            case SIGNAL_RSRQ: // fail through
            case SIGNAL_RSSNR:
                return ran == AccessNetworkConstants.AccessNetworkType.EUTRAN;
            case SIGNAL_SSRSRP: // fail through
            case SIGNAL_SSRSRQ: // fail through
            case SIGNAL_SSSINR:
