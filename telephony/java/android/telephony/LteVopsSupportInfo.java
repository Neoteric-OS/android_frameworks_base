...
public final class LteVopsSupportInfo implements Parcelable {
    ...
    public LteVopsSupportInfo() {
        mVopsSupport = LTE_STATUS_NOT_AVAILABLE;
        mEmcBearerSupport = LTE_STATUS_NOT_AVAILABLE;
    }

    public LteVopsSupportInfo(boolean vops, boolean emergency) {
        if (vops) {
            mVopsSupport = LTE_STATUS_SUPPORTED;
        } else {
            mVopsSupport = LTE_STATUS_NOT_SUPPORTED;
        }

        if (emergency) {
            mEmcBearerSupport = LTE_STATUS_SUPPORTED;
        } else {
            mEmcBearerSupport = LTE_STATUS_NOT_SUPPORTED;
        }
    }
