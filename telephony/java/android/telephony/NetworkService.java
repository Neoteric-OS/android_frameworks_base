 ...
 * "android.permission.BIND_NETWORK_SERVICE". The network service definition in the manifest must follow
...
public abstract class NetworkService extends Service {
    ...
    public static final String NETWORK_SERVICE_EXTRA_SLOT_ID =
            "android.telephony.NetworkService.extra.SLOT_ID";
    ...
    public class NetworkServiceProvider {
        ...
        protected final void notifyNetworkRegistrationStateChanged() {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                case NETWORK_SERVICE_INTERNAL_REQUEST_INITIALIZE_SERVICE:
                    service = createNetworkService(message.arg1);
                    if (service != null) {
    ...
    /**
     * Create the actual implementation of network service object {@link NetworkServiceProvider}.
     *
     * @param slotId SIM slot id the network service associated with.
     * @return network service object
     */
    protected abstract NetworkServiceProvider createNetworkService(int slotId);
