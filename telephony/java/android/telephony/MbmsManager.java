...
public class MbmsManager {
     ...
     */
    public List<StreamingServiceInfo> getStreamServices(List<Sting> serviceClasses);
     ...
     * fileServiceInfo indicates which file to download from which service
     ...
     */
    public int download(FileServiceInfo fileInfo, int requestTtl, Uri destination,
