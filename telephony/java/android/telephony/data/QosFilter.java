...
public class QosFilter implements Parcelable {
    ...
    public static QosFilter create(@NonNull android.hardware.radio.V1_6.QosFilter qosFilter) {
        ...
        if (qosFilter.localPort != null) {
            if (qosFilter.localPort.getDiscriminator()
                    == android.hardware.radio.V1_6.Port.hidl_discriminator.range) {
    ...
    static class PortRange implements Parcelable {
        int start;
        int end;
