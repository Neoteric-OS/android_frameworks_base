...
public class ApnSetting implements Parcelable {
    ...
    public static ApnSetting makeApnSetting(int id, String operatorNumeric, String entryName,
        ...
        return makeApnSetting(id, operatorNumeric, entryName, apnName, proxyAddress, proxyPort,
            ...
            Carriers.NO_APN_SET_ID, TelephonyManager.UNKNOWN_CARRIER_ID, -1);
    }
    ...
    public static ApnSetting makeApnSetting(Cursor cursor) {
        ...
        return makeApnSetting(
            ...
            cursor.getInt(cursor.getColumnIndexOrThrow(Carriers.SKIP464XLAT)));
    }
    ...
    public static ApnSetting fromString(String data) {
        ...
        int skip464xlat = -1; // should not set 0
        if (version == 1) {
    ...
    public static class Builder{
         ...
         *
         * NOTE: This should be handled as boolean(1:true, 0:false), but other values will be
         * returned to detect default setting.
         *
