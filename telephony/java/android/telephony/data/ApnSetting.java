...
public class ApnSetting implements Parcelable {
    ...
    public static ApnSetting makeApnSetting(int id, String operatorNumeric, String entryName,
            String apnName, InetAddress proxyAddress, int proxyPort, Uri mmsc,
            InetAddress mmsProxyAddress, int mmsProxyPort, String user, String password,
    ...
    public static ApnSetting fromString(String data) {
        ...
        return makeApnSetting(-1, a[10] + a[11], a[0], a[1], inetAddressFromString(a[2]),
            portFromString(a[3]), UriFromString(a[7]), inetAddressFromString(a[8]),
    ...
    public ContentValues toContentValues() {
        ...
        apnValue.put(Telephony.Carriers.PROXY, nullToEmpty(inetAddressToString(mProxyAddress)));
