...
public class QosSession implements Parcelable{
    ...
    int qosSessionId;
    Qos qos;
    List<QosFilter> qosFilterList;

    QosSession(int qosSessionId, Qos qos, List<QosFilter> qosFilterList) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(qos, flags);
        dest.writeList(qosFilterList);
    }

    public static QosSession create(@NonNull android.hardware.radio.V1_6.QosSession qosSession) {
