...
public class LinkCapacityEstimate implements Parcelable {
    ...
    public boolean equals (Object o) {
        ...
        if (!(o instanceof LinkCapacityEstimate)) return false;

        LinkCapacityEstimate other = (LinkCapacityEstimate) o;
        return this.downlinkCapacityKbps == other.downlinkCapacityKbps
                && this.uplinkCapacityKbps == other.uplinkCapacityKbps
    ...
    @Override
    public int hashCode() {
        return Objects.hash(downlinkCapacityKbps, uplinkCapacityKbps, confidence, status);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeInt(downlinkCapacityKbps);
        dest.writeInt(uplinkCapacityKbps);
    ...
    public static final Parcelable.Creator<LinkCapacityEstimate> CREATOR =
            new Parcelable.Creator<LinkCapacityEstimate>() {
                @Override
                public LinkCapacityEstimate createFromParcel(Parcel source) {
                    return new LinkCapacityEstimate(source);
                }
