...
public final class DisconnectCause {
    ...
    public static final int INCOMING_MISSED = 200;
    ...
    /** Not presently used */
    public static final int MMI = 203;

    /** Cannot reach the peer */
    public static final int NUMBER_UNREACHABLE = 204;

    /** Cannot reach the server */
    public static final int SERVER_UNREACHABLE = 205;

    /** Invalid credentials */
    public static final int INVALID_CREDENTIALS = 206;

    /** Calling from out of network is not allowed */
    public static final int OUT_OF_NETWORK = 207;

    /** Server error */
    public static final int SERVER_ERROR = 208;

    /** Client went out of network range */
    public static final int LOST_SIGNAL = 209;

    /** An incoming call that was rejected */
    public static final int INCOMING_REJECTED = 210;

    /** Radio is turned off explicitly */
    public static final int POWER_OFF = 211;

    /** Out of service */
    public static final int OUT_OF_SERVICE = 212;

    /** No ICC, ICC locked, or other ICC error */
    public static final int ICC_ERROR = 213;

    /** Call was blocked by restricted all voice access */
    public static final int CS_RESTRICTED = 214;

    /** Call was blocked by restricted normal voice access */
    public static final int CS_RESTRICTED_NORMAL = 215;

    /** Call was blocked by restricted emergency voice access */
    public static final int CS_RESTRICTED_EMERGENCY = 216;
     ...
     */
    public static final int IMS_ACCESS_BLOCKED = 260;
    ...
    public static final int EMERGENCY_ONLY = 400;

    /**
     * The supplied CALL Intent didn't contain a valid phone number.
     */
    public static final int NO_PHONE_NUMBER_SUPPLIED = 401;

    /**
     * Our initial phone number was actually an MMI sequence.
     */
    public static final int DIALED_MMI = 402;

    /**
     * We tried to call a voicemail: URI but the device has no voicemail number configured.
     */
    public static final int VOICEMAIL_NUMBER_MISSING = 403;
     ...
     * @hide
     */
    public static final int CDMA_CALL_LOST = 404;
     ...
     */
    public static final int DIALED_CALL_FORWARDING_WHILE_ROAMING = 411;

    /**
     * Stk Call Control modified DIAL request to video DIAL request.
     */
    public static final int DIAL_MODIFIED_TO_DIAL_VIDEO = 412;

    /**
     * Stk Call Control modified Video DIAL request to SS request.
     */
    public static final int DIAL_VIDEO_MODIFIED_TO_SS = 413;

    /**
     * Stk Call Control modified Video DIAL request to USSD request.
     */
    public static final int DIAL_VIDEO_MODIFIED_TO_USSD = 414;

    /**
     * Stk Call Control modified Video DIAL request to DIAL request.
     */
    public static final int DIAL_VIDEO_MODIFIED_TO_DIAL = 415;

    /**
     * Stk Call Control modified Video DIAL request to Video DIAL request.
     */
    public static final int DIAL_VIDEO_MODIFIED_TO_DIAL_VIDEO = 416;
     ...
     */
    public static final int DIAL_LOW_BATTERY = 1206;

    /**
     * Indicates that the call is dropped due to RTCP inactivity, primarily due to media path
     * disruption.
     */
    public static final int MEDIA_TIMEOUT = 1401;
