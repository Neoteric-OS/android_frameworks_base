...
public class ChannelUtils {
    ...
    /**
     * Get the EUTRAN Operating band for an EARFCN.
     *
     * <p>See 36.101 sec 5.7.3-1 for calculation.
     *
     * @param earfcn The channel number
     * @return Operating band number, or -1 if no corresponding band exists
     */
    public static int getOperatingBandForEarfcn(int earfcn) {
        if (earfcn > 67535) {
            return -1; // INVALID
        } else if (earfcn >= 67366) {
            return -1; // band 67 only for CarrierAgg
            ...
            return -1; // band 32 only for CarrierAgg
        } else if (earfcn >= 9870) {
            return EutranBand.BAND_31;
        } else if (earfcn >= 9770) {
            return EutranBand.BAND_30;
        } else if (earfcn >= 9660) {
            return -1; // band 29 only for CarrierAgg
        } else if (earfcn >= 9210) {
