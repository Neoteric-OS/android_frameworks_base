...
public class MbmsGroupCallSession implements AutoCloseable {
    ...
    public static @Nullable MbmsGroupCallSession create(@NonNull Context context,
            int subscriptionId, final @NonNull MbmsGroupCallSessionCallback callback,
     ...
     * See {@link #create(Context, int, MbmsGroupCallSessionCallback, Executor)}.
     */
    public static MbmsGroupCallSession create(@NonNull Context context,
            @NonNull MbmsGroupCallSessionCallback callback, @NonNull Executor executor) {
        return create(context, SubscriptionManager.getDefaultSubscriptionId(), callback, executor);
    }
     ...
     *
     * It is safe to call {@link #create(Context, int, MbmsGroupCallSessionCallback, Executor)} to
