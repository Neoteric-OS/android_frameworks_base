...
public class MbmsStreamingSession implements AutoCloseable {
     ...
     * See {@link #create(Context, int, Executor, MbmsStreamingSessionCallback)}.
     */
     ...
     *
     * It is safe to call {@link #create(Context, int, Executor, MbmsStreamingSessionCallback)} to
