...
public class TelephonyManager {
   ...
   public int getNetworkType(int subId) {
    ...
    /**
     * Extra included in {@link Intent.ACTION_SIM_CARD_STATE_CHANGED} and
     * {@link Intent.ACTION_SIM_APPLICATION_STATE_CHANGED} to indicate if its a rebroadcast after
     * user unlock.
     *
     * @hide
     */
    @SystemApi
    public static final String REBROADCAST_ON_USER_UNLOCK = "rebroadcastOnUserUnlock";
