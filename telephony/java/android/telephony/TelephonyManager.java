...
public class TelephonyManager {
    ...
    */
     ...
     * carrier with a canonical integer a.k.a. carrier id. Carrier id assignments are published as
     * an on-device file under TelephonyProvider/assets/carrier_list.textpb.
     *
     * <p>Apps which have carrier-specific configurations or business logic can have a database
     * for that and use carrier id as the key to look up.
     *
