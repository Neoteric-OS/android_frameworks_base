...
public class TelephonyManager {
    ...
    */
     ...
     * @return {@link #CHANGE_ICC_LOCK_SUCCESS} if enable/disable IccLock successfully.
     * If failed it will return 0 or a positive integer as the attempts remaining value.
     *
     * @throws SecurityException if the caller doesn't have the permission.
     *
     * @hide
