...
public class TelephonyManager {
     ...
     */
    /** {@hide} */
    public String getDeviceId(long subscription) {

        try {
            return getSubscriberInfo().getDeviceIdUsingSub(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            return null;
     ...
     */
    /** @hide */
    public void enableLocationUpdates(long subscription) {
        try {
            getITelephony().enableLocationUpdatesUsingSub(subscription);
        } catch (RemoteException ex) {
        } catch (NullPointerException ex) {
        }
    }
    ...
    /** @hide */
    public void disableLocationUpdates(long subscription) {
        try {
            getITelephony().disableLocationUpdatesUsingSub(subscription);
        } catch (RemoteException ex) {
        } catch (NullPointerException ex) {
        }
    }
     ...
     */
    /** {@hide} */
    public int getCurrentPhoneType(long subscription) {

        try{
            ITelephony telephony = getITelephony();
            if (telephony != null) {
                return telephony.getActivePhoneTypeUsingSub(subscription);
            } else {
    ...
    /** {@hide} */
    private int getPhoneTypeFromProperty(long subscription) {
        String type =
    ...
    /** {@hide} */
    private int getPhoneTypeFromNetworkType(long subscription) {
     ...
     */
    /** {@hide} */
    public String getNetworkOperatorName(long subscription) {
     ...
     */
    /** {@hide} */
   public String getNetworkOperator(long subscription) {
     ...
     */
    /** {@hide} */
    public boolean isNetworkRoaming(long subscription) {
     ...
     */
    /** {@hide} */
    public String getNetworkCountryIso(long subscription) {
     ...
     */
    /** {@hide} */
   public int getNetworkType(long subscription) {
       try {
           ITelephony telephony = getITelephony();
           if (telephony != null) {
               return telephony.getNetworkTypeUsingSub(subscription);
           } else {
               // This can happen when the ITelephony interface is not up yet.
     ...
     */
    /** {@hide} */
    public int getDataNetworkType(long subscription) {
        try{
            ITelephony telephony = getITelephony();
            if (telephony != null) {
                return telephony.getDataNetworkTypeUsingSub(subscription);
            } else {
                // This can happen when the ITelephony interface is not up yet.
                return NETWORK_TYPE_UNKNOWN;
            }
    ...
    /**
     * Returns the NETWORK_TYPE_xxxx for voice for a subscription
     *
     */
    /** {@hide} */
    public int getVoiceNetworkType(long subscription) {
        try{
            ITelephony telephony = getITelephony();
            if (telephony != null) {
                return telephony.getVoiceNetworkTypeUsingSub(subscription);
            } else {
                // This can happen when the ITelephony interface is not up yet.
                return NETWORK_TYPE_UNKNOWN;
            }
    ...
    public boolean hasIccCard(long slotId) {
        ...
        try {
            return getITelephony().hasIccCardUsingSub(slotId);
        } catch (RemoteException ex) {
     ...
     */
    /** {@hide} */
    public String getSimOperator(long subscription) {
     ...
     */
    /** {@hide} */
    public String getSimOperatorName(long subscription) {
     ...
     */
    /** {@hide} */
    public String getSimCountryIso(long subscription) {
     ...
     */
    /** {@hide} */
    public String getSimSerialNumber(long subscription) {
        try {
            return getSubscriberInfo().getIccSerialNumberUsingSub(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
     ...
     * the mode may be unknown.
     *
     * @param subscription for which radio is LTE on CDMA is returned
     * @return {@link PhoneConstants#LTE_ON_CDMA_UNKNOWN}, {@link PhoneConstants#LTE_ON_CDMA_FALSE}
     * or {@link PhoneConstants#LTE_ON_CDMA_TRUE}
     *
     */
    /** {@hide} */
    public int getLteOnCdmaMode(long subscription) {
        try {
            return getITelephony().getLteOnCdmaModeUsingSub(subscription);
        } catch (RemoteException ex) {
            // Assume no ICC card if remote exception which shouldn't happen
     ...
     */
    /** {@hide} */
    public String getSubscriberId(long subscription) {
        try {
            return getSubscriberInfo().getSubscriberIdUsingSub(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
     ...
     */
    /** {@hide} */
    public String getLine1Number(long subscription) {
        try {
            return getSubscriberInfo().getLine1NumberUsingSub(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
     ...
     */
    /** {@hide} */
    public String getLine1AlphaTag(long subscription) {
        try {
            return getSubscriberInfo().getLine1AlphaTagUsingSub(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
     ...
     */
    /** {@hide} */
    public String getMsisdn(long subscription) {
        try {
            return getSubscriberInfo().getMsisdnUsingSub(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
     ...
     */
    /** {@hide} */
    public String getVoiceMailNumber(long subscription) {
        try {
            return getSubscriberInfo().getVoiceMailNumberUsingSub(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
     ...
     */
    /** {@hide} */
    public String getCompleteVoiceMailNumber(long subscription) {
        try {
            return getSubscriberInfo().getCompleteVoiceMailNumberUsingSub(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
     ...
     */
    /** {@hide} */
    public int getVoiceMessageCount(long subscription) {
        try {
            return getITelephony().getVoiceMessageCountUsingSub(subscription);
        } catch (RemoteException ex) {
            return 0;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
     ...
     */
    /** {@hide} */
    public String getVoiceMailAlphaTag(long subscription) {
        try {
            return getSubscriberInfo().getVoiceMailAlphaTagUsingSub(subscription);
        } catch (RemoteException ex) {
            return null;
        } catch (NullPointerException ex) {
            // This could happen before phone restarts due to crashing
    ...
    */
     ...
     */
    /** {@hide} */
    public int getCallState(long subscription) {
        try {
            return getITelephony().getCallStateUsingSub(subscription);
        } catch (RemoteException ex) {
    ...
    */
    ...
    public void listen(PhoneStateListener listener, int events) {
        ...
        try {
            ...
            sRegistry.listenUsingSub(listener.mSubscription, pkgForDebug, listener.callback, events, notifyNow);
        } catch (RemoteException ex) {
            // system process dead
        } catch (NullPointerException ex) {
            // system process dead
     ...
     */
    /** {@hide} */
    public int getCdmaEriIconIndex(long subscription) {
        try {
            return getITelephony().getCdmaEriIconIndexUsingSub(subscription);
        } catch (RemoteException ex) {
            // the phone process is restarting.
            return -1;
        } catch (NullPointerException ex) {
     ...
     */
    /** {@hide} */
    public int getCdmaEriIconMode(long subscription) {
        try {
            return getITelephony().getCdmaEriIconModeUsingSub(subscription);
        } catch (RemoteException ex) {
            // the phone process is restarting.
            return -1;
        } catch (NullPointerException ex) {
     ...
     */
    /** {@hide} */
    public String getCdmaEriText(long subscription) {
        try {
            return getITelephony().getCdmaEriTextUsingSub(subscription);
        } catch (RemoteException ex) {
            // the phone process is restarting.
            return null;
        } catch (NullPointerException ex) {
    ...
    public static int getDefaultSubscription() {
        ITelephony mITelephony = ITelephony.Stub.asInterface(ServiceManager.getService(Context.TELEPHONY_SERVICE));
        try {
            return mITelephony.getDefaultSubscription();
        } catch (RemoteException ex) {
            return PhoneConstants.DEFAULT_SUBSCRIPTION;
        } catch (NullPointerException ex) {
            return PhoneConstants.DEFAULT_SUBSCRIPTION;
        }
    }
    ...
    public int getPreferredDataSubscription() {
        try {
            return getITelephony().getPreferredDataSubscription();
        } catch (RemoteException ex) {
            return PhoneConstants.DEFAULT_SUBSCRIPTION;
        } catch (NullPointerException ex) {
            return PhoneConstants.DEFAULT_SUBSCRIPTION;
     ...
     */
    /** {@hide} */
    public boolean setPreferredDataSubscription(long subscription) {
        try {
            return getITelephony().setPreferredDataSubscription(subscription);
        } catch (RemoteException ex) {
            return false;
        } catch (NullPointerException ex) {
            return false;
    ...
    public int getPreferredVoiceSubscription() {
        try {
            return getITelephony().getPreferredVoiceSubscription();
        } catch (RemoteException ex) {
            return PhoneConstants.DEFAULT_SUBSCRIPTION;
        } catch (NullPointerException ex) {
            return PhoneConstants.DEFAULT_SUBSCRIPTION;
     ...
     * @hide
     */
    public static String getTelephonyProperty(String property, long index, String defaultVal) {
        String propVal = null;
        int slotIndex =(int)index;
        String prop = SystemProperties.get(property);
         if ((prop != null) && (prop.length() > 0)) {
            String values[] = prop.split(",");
            if ((slotIndex >= 0) && (slotIndex < values.length) && (values[slotIndex] != null)) {
                propVal = values[slotIndex];
            }
        }
