...
public class TelephonyManager {
   ...
   /**
     ...
     *               {@link #CALL_COMPOSER_STATUS_OFF}, or
    ...
    public void setCallComposerStatus(@CallComposerStatus int status) {
        if (status < CALL_COMPOSER_STATUS_OFF
                || status > CALL_COMPOSER_STATUS_ON_NO_PICTURES) {
     ...
     * {@link #CALL_COMPOSER_STATUS_ON}, {@link #CALL_COMPOSER_STATUS_OFF},
