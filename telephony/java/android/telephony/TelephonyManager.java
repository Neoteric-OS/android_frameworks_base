...
public class TelephonyManager {
    ...
    /**
     * Dials the given character as a DTMF tone for the current active call.
     * The tone automatically stops after a short time. While a DTMF tone is
     * in play dial requests are queued.
     * If the active call ends or gets inactive before the tone could be
     * played, then the request will be canceled.
     *
     * @param c The DTMF character to be send over the network. Valid
     * characters are the the digits 0 to 9, # and *.
     * @return True in the case the given character is a valid DTMF twelve key
     * character and an active call exists.
     * <p>
     * Requires Permission:
