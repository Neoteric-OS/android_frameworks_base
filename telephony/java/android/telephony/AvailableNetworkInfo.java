...
public final class AvailableNetworkInfo implements Parcelable {
     ...
     * @hide
     */
    public List<RadioAccessSpecifiers>  getRadioAccessSpecifiers() {
        return (List<RadioAccessSpecifiers>) mRadioAccessSpecifiers.clone();
    }
    ...
    private AvailableNetworkInfo(Parcel in) {
        ...
        in.readList(mRadioAccessSpecifiers, RadioAccessSpecifiers.class.getClassLoader());
    }

    public AvailableNetworkInfo(int subId, int priority, @NonNull List<String> mccMncs,
            @NonNull List<Integer> bands) {
        AvailableNetworkInfo(subId, priority, mccMncs, bands, new ArrayList<>());
    }
    ...
    public AvailableNetworkInfo(int subId, int priority, @NonNull List<String> mccMncs,
        ...
        mRadioAccessSpecifier = radioAccessSpecifier;
    }
    ...
    public static final class Builder {
        ...
        public @NonNull Builder setMccMncs(@NonNull ArrayList<String> mccMncs) {
            Objects.requireNonNull(mccMncs, "A non-null ArrayList of mccmncs must be set. An empty"
                    + " list is still accepted. Please read documenation in AvailableNetworkService"
                    + " to see consequences of an empty arraylist.");
            mMccMncs = mccMncs;
            return this;
        }

        public @NonNull Builder setRadioAccessSpecifiers(
                @NonNull ArrayList<RadioAccessSpecifiers> radioAccessSpecifiers) {
            Objects.requireNonNull(radioAccessSpecifiers, "A non-null ArrayList of "
                    ...
                    + "read documenation in AvailableNetworkService to see consequences of an empty"
                    + " arraylist.");
        ...
        public @NonNull AvailableNetworkInfo build() {
            ...
            return AvailableNetworkInfo(mSubId, mPriority, mMccMncs, mBands,
