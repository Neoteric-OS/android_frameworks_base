 ...
 * created using the default eUICC (see {@link TelephonyManager#getCardIdForDefaultEuicc()}).
 *
 * <p>To get the EuiccManager for the default eUICC, call
 * {@code context.getSystemService(Context.EUICC_SERVICE)}.
 *
...
public class EuiccManager {
    ...
    public EuiccManager(Context context) {
        mContext = context;
        mCardId = TelephonyManager.getCardIdForDefaultEuicc();
    }
    ...
    public void updateSubscriptionNickname(int cardId,
        ...
        try {
            getIEuiccController().updateSubscriptionNickname(cardId,
