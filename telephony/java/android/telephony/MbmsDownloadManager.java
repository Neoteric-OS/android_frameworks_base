...
//        return mdm;
     ...
     */
    public void getFileServices(List<String> serviceClasses) {
    }
     ...
     */
    public DownloadRequest download(FileServiceInfo fileServiceInfo, Uri sourceUri,
            Uri destinationUri, PendingIntent resultIntent, DownloadListener listener) {
        return null;
    }
