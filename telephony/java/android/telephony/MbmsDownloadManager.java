...
public class MbmsDownloadManager {
     ...
     *
     * @param classList A list of service classes which the app wishes to receive callbacks about.
     *                  Subsequent calls to this method will replace this list of service
