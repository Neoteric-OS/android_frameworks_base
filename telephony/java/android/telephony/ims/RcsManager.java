...
public class RcsManager {
     ...
     * manager.
     */
    private RcsManager(int subId) {
        mSubId = subId;
    }

    /**
     * Create an instance of RcsManager for the subscription id specified.
     *
     * @param context The context to create this RcsManager instance within.
     * @param subId The ID of the subscription that this RcsManager will use.
     ...
     */
    @NonNull
    public static RcsManager createForSubscriptionId(Context context, int subId) {
        if (!SubscriptionManager.isValidSubscriptionId(subId)
                || !getSubscriptionManager(context).isActiveSubscriptionId(subId)) {
            throw new IllegalArgumentException("Invalid subscription ID");
        }

        return new RcsManager(subId);
    }
    ...
    /**
     * @return A new {@link RcsUceManager} used for User Capability Exchange operations for this
     * subscription.
     */
    @NonNull
    public RcsUceManager createUceManager() {
        return new RcsUceManager(mSubId);
    }
