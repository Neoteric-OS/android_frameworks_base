 ...
 *
 * @see android.telephony.ims.RcsManager
 * @hide
 */
@SystemApi
public class RcsUceManager {
     ...
     * {@link android.telephony.ims.RcsManager#createForSubscriptionId(Context, int)} and
     * {@link RcsManager#createUceManager()} to instantiate this manager class.
     */
    RcsUceManager(int subId) {
        mSubId = subId;
    }
     ...
     * <p>
     * Be sure to check the availability of this feature using {@link RcsManager#isAvailable(int)}
     * and ensuring {@link RcsFeature.RcsImsCapabilities#CAPABILITY_TYPE_OPTIONS_UCE} or
     ...
     * {@link RcsManager#isCapable(int)} will return false for
