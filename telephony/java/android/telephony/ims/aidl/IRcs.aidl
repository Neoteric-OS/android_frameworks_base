...
interface IRcs {
    ...
    /////////////////////////
    RcsThreadQueryResultDescriptor getRcsThreads(in RcsThreadQueryParams queryParams, String callingPackage);
    ...
    RcsParticipantQueryResultDescriptor getParticipants(in RcsParticipantQueryParams queryParams, String callingPackage);

    RcsParticipantQueryResultDescriptor getParticipantsWithToken(
        in RcsQueryContinuationToken continuationToken, String callingPackage);

    RcsMessageQueryResultDescriptor getMessages(in RcsMessageQueryParams queryParams, String callingPackage);
