...
/**
 * The ICapabilityExchangeEventListener wrapper class is to store the listener which register by
 * the framework. This wrapper class is also deliver the request to the framework when receive the
...
public class CapabilityExchangeAidlWrapper implements CapabilityExchangeEventListener {
     ...
     */
    public void onRemoteCapabilityRequest(Uri contactUri, List<String> remoteCapabilities,
            OptionsRequestCallback callback) {
