...
interface IImsRcsController {
    ...
    void registerUcePublishStateListener(int subId, IRcsUcePublishStateListener c);
    void unregisterUcePublishStateListener(int subId, IRcsUcePublishStateListener c);
