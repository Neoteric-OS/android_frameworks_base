...
public class ImsRcsManager implements RegistrationManager {
    ...
    public void addOnAvailabilityChangedListener(@NonNull @CallbackExecutor Executor executor,
        ...
        AvailabilityCallbackAdapter adapter = addAvailabilityChangedCallback(executor, listener);
        try {
    ...
    public void removeOnAvailabilityChangedListener(
        ...
        AvailabilityCallbackAdapter callback = removeAvailabilityChangedCallback(listener);
        if (callback == null) {
            return;
        }
     ...
     * @param radioTech The radio technology associated with the capability to query.
     ...
     */
    private AvailabilityCallbackAdapter addAvailabilityChangedCallback(@NonNull Executor executor,
            @NonNull OnAvailabilityChangedListener listener) {
    ...
    /**
     * Remove the existing {@link OnAvailabilityChangedListener}.
     ...
     * {@link OnAvailabilityChangedListener}.
     */
    private AvailabilityCallbackAdapter removeAvailabilityChangedCallback(
            @NonNull OnAvailabilityChangedListener listener) {
        synchronized (mAvailabilityChangedCallbacks) {
