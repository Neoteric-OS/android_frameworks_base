...
public interface DelegateStateCallback {
    ...
    /**
     * This must be called after the framework calls{@link SipTransportImplBase#destroySipDelegate}
     * to notify the framework and remote application that the procedure to destroy the
     * {@link SipDelegate} has been completed.
