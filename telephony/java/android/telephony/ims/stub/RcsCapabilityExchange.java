...
/**
 * Base class for different types of Capability exchange (presence or SIP OPTIONS).
 *
 * @hide
 */
@SystemApi
public class RcsCapabilityExchange {
    ...
    public static final int COMMAND_CODE_SUCCESS = 0;
    ...
    public static final int COMMAND_CODE_NO_CHANGE_IN_CAP = 10;
    /**  Service is unknown. */
    public static final int COMMAND_CODE_SERVICE_UNKNOWN = 11;
