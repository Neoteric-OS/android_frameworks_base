 ...
 * the following:
 * - a new incoming SIP message associated with the feature tags the SipDelegate registered with has
 * been received or an in-dialog request to this SipDelegate has been received,
 * - acknowledge that an outgoing SIP message from the RCS application has been sent successfully or
 * notify the application of the reason why it was not sent
 *
 * @hide
 */
