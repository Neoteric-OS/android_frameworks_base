...
public interface CapabilityExchangeEventListener {
    ...
    public interface OptionsRequestCallback {
         ...
         * @param reason A non-null String containing the reason associated with
         * the SIP code.
         */
     ...
     * {@link RcsFeature} has not received the {@link ImsFeature#onFeatureReady()}
     * callback. This may also happen in rare cases when the
     * Telephony stack has crashed.
     */
     ...
     * @throws ImsException If this {@link RcsPresenceExchangeImplBase} instance is not
