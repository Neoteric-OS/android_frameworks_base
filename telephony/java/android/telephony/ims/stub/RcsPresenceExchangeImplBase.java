 ...
 * this service must implement the stub methods {@link #requestCapabilities(Uri[], int)} and
...
public class RcsPresenceExchangeImplBase extends RcsCapabilityExchange {
     ...
     * {@link #requestCapabilities(Uri[], int)} operations.
     ...
     * using {@link #requestCapabilities(Uri[], int)}.
     */
    public final void onCapabilityRequestResponse(@NonNull RcsContactUceCapability[] infos,
            int operationToken) {
        throw new UnsupportedOperationException();
    }
     ...
     * {@link #onCapabilityRequestResponse(RcsContactUceCapability[], int)} should be called with
     * the presence information for the contacts specified.
     * @param uris An arraylist of the URIs that the framework is requesting the UCE capabilities
     *          for.
     ...
     *         {@link #onCapabilityRequestResponse(RcsContactUceCapability[], int)} must
     *         use the same operation token in response.
     */
    public void requestCapabilities(@NonNull Uri[] uris, int operationToken) {
