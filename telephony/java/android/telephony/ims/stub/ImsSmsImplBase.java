...
public class ImsSmsImplBase {
     ...
     */
    public void sendSms(int token, @IntRange(from = 0, to = 255) int messageRef,
     ...
     */
    public void acknowledgeSms(int token, @IntRange(from = 0, to = 255)  int messageRef,
     ...
     * @param result result of delivering the message.
     */
    public void acknowledgeSmsReport(int token, @IntRange(from = 0, to = 255) int messageRef,
     ...
     * should be aborted.
     */
    public final void onSendSmsResultSuccess(int token, @SmsMessage.Format int messageRef)
            throws RuntimeException {
        synchronized (mLock) {
            if (mListener == null) {
                throw new RuntimeException("Feature not ready.");
     ...
     */
    @Deprecated
    public final void onSendSmsResult(int token, @SmsMessage.Format int messageRef,
     ...
     * should be aborted.
     */
    public final void onSendSmsResultError(int token, @IntRange(from = 0, to = 255) int messageRef,
            @SendStatusResult int status, @SmsManager.Result int reason, int networkErrorCode)
            throws RuntimeException {
        synchronized (mLock) {
            if (mListener == null) {
                throw new RuntimeException("Feature not ready.");
    ...
    public final void onSmsStatusReportReceived(int token,
            @IntRange(from = 0, to = 255) int messageRef, @SmsMessage.Format String format,
