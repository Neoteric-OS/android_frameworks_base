...
public class ImsSmsImplBase {
     ...
     */
    public void acknowledgeSms(int token, @DeliverStatusResult int result) {
     ...
     *
     * @param token token provided in {@link #onSmsStatusReportReceived(int, String, byte[])}
     * @param result result of delivering the message. Valid values are:
     *  {@link #STATUS_REPORT_STATUS_OK},
     *  {@link #STATUS_REPORT_STATUS_ERROR}
     */
    public void acknowledgeSmsReport(int token, @StatusReportResult int result) {
     ...
     * the platform is not available, {@link #acknowledgeSms(int, int)} will be called with the
    ...
    public final void onSmsReceived(int token, String format, byte[] pdu) throws RuntimeException {
        synchronized (mLock) {
            ...
            try {
                ...
                acknowledgeSms(token, DELIVER_STATUS_ERROR_GENERIC);
            }
        }
    }
    ...
    public final void onSmsStatusReportReceived(int token, int messageRef, String format,
        ...
        synchronized (mLock) {
            ...
            try {
                ...
                acknowledgeSmsReport(token, STATUS_REPORT_STATUS_ERROR);
            }
        }
    }
