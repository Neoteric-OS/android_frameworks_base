...
public final class RcsContactUceCapability implements Parcelable {
    ...
    public static class Builder {
         ...
         * that service. This is mainly used for capabilities that may use a URI separate from the
         * contact's URI, for example the URI to use for VT calls.
        ...
        public Builder add(@CapabilityFlag int type, @NonNull Uri serviceUri) {
            mCapabilities.mServiceMap.put(type, serviceUri);
            return this;
        }
    ...
    /**
     * @return a String containing the URI associated with the service tag or null if not capable or
     * the capability does not require a separate service URI.
     */
    public @Nullable Uri getServiceUri(@CapabilityFlag int type) {
        return mServiceMap.getOrDefault(type, null);
    }
