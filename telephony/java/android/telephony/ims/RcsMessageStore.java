...
public class RcsMessageStore {
     ...
     *
     * @param continuationToken A token to continue the query to get the next chunk. This is
     *                          obtained through {@link RcsParticipantQueryResult#nextChunkToken}.
     * @throws RcsMessageStoreException if the query could not be completed on the storage
     */
    @WorkerThread
    @NonNull
     ...
     *
     * @param continuationToken A token to continue the query to get the next chunk. This is
     *                          obtained through {@link RcsMessageQueryResult#nextChunkToken}.
     * @throws RcsMessageStoreException if the query could not be completed on the storage
     */
    @WorkerThread
    @NonNull
    public RcsMessageQueryResult getRcsMessages(
            RcsMessageQueryContinuationToken continuationToken) throws RcsMessageStoreException {
     ...
     *
     * @param continuationToken A token to continue the query to get the next chunk. This is
     *                          obtained through {@link RcsEventQueryResult#nextChunkToken}.
     * @throws RcsMessageStoreException if the query could not be completed on the storage
     */
    @WorkerThread
    @NonNull
    public RcsEventQueryResult getRcsEvents(
            RcsEventQueryContinuationToken continuationToken) throws RcsMessageStoreException {
