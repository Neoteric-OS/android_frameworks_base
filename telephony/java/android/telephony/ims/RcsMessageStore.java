...
public class RcsMessageStore {
    ...
    public RcsThreadQueryResult getRcsThreads(@Nullable RcsThreadQueryParams queryParameters)
        ...
        return new RcsThreadQueryResult(
                makeNonNullQuery(iRcs -> iRcs.getRcsThreads(queryParameters)));
    }
    ...
    public RcsThreadQueryResult getRcsThreads(@NonNull RcsQueryContinuationToken continuationToken)
            throws RcsMessageStoreException {
        return new RcsThreadQueryResult(
                makeNonNullQuery(iRcs -> iRcs.getRcsThreadsWithToken(continuationToken)));
    }
    ...
    @NonNull
    private <T> T makeNonNullQuery(RcsControllerCall.RcsServiceCall<T> rcsServiceCall)
            throws RcsMessageStoreException {
        T result = RcsControllerCall.call(rcsServiceCall);
        if (result == null) {
            throw new RcsMessageStoreException("Query failed");
        }
        return result;
    }
}
