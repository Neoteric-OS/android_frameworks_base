...
public class RcsFeature extends ImsFeature {
    ...
    private static final class RcsFeatureBinder extends IImsRcsFeature.Stub {
        ...
        @Override
        public void requestCapabilities(Uri[] uris, int operationToken) throws RemoteException {
        ...
        private <T> T executeMethodAsyncForResult(FunctionalUtils.ThrowingSupplier<T> r,
            ...
            try {
                ...
                Log.w(LOG_TAG, "RcsFeatureBinder - getFeatureState exception: " + e.getMessage());
                throw new RemoteException(e.getMessage());
            }
        }
    }
    ...
    private IRcsFeatureListener getListener() {
        synchronized (mLock) {
