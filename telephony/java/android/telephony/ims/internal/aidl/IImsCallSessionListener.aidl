...
oneway interface IImsCallSessionListener {
    ...
    void callSessionStarted(in ImsCallProfile profile);
    void callSessionStartFailed(in ImsReasonInfo reasonInfo);
     ...
     */
    void callSessionMergeStarted(in IImsCallSession newSession, in ImsCallProfile profile);
     ...
     */
    void callSessionConferenceExtended(in IImsCallSession newSession, in ImsCallProfile profile);
    void callSessionConferenceExtendFailed(in ImsReasonInfo reasonInfo);
    void callSessionConferenceExtendReceived(in IImsCallSession newSession,
