...
public class SmsImplBase {
   ...
   * over IMS.
   *
   * @param format the format of the message. Valid values are defined in {@link Format}
   * @param messageRef the message reference.
   * @param isRetry whether it is a retry of an already attempted message or not.
   * @param pdu PDUs representing the contents of the message.
   */
  public void sendSms(@Format int format, int messageRef, boolean isRetry, byte[] pdu) {
   ...
   */
  public final void onSmsReceived(@Format int format, byte[] pdu) throws IllegalStateException {
    synchronized (mLock) {
      if (mListener == null) {
   ...
   * @param result result of sending the SMS. Valid values are defined in {@link SendStatusResult}
   * @throws IllegalStateException if called before {@link MmTelFeature#onFeatureReady()}
   ...
   */
  public final void onSendSmsResult(int messageRef, @SendStatusResult int result)
   ...
   * @throws IllegalStateException if called before {@link MmTelFeature#onFeatureReady()}
   */
  public final void onSmsStatusReportReceived(int messageRef, @Format int format, byte[] pdu) {
    synchronized (mLock) {
      if (mListener == null) {
        throw new IllegalStateException("Feature not ready.");
      }
   ...
   * Provider.
   *
   * @return  the format of the message. Valid values are defined in {@link Format}
   */
  public @Format int getSmsFormat() {
