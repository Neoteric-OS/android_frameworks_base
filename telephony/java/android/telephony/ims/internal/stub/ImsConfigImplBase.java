 ...
 * IMS configuration constants, see ImsConfig.
 *
 * @hide
 */
...
public class ImsConfigImplBase {
    ...
    public class Callback extends IImsConfigCallback.Stub {
        ...
        @Override
        public final void onIntValueChanged(int item, int value) throws RemoteException {
            onProvisionedValueChanged(item, value);
        }

        @Override
        public final void onStringValueChanged(int item, String value) throws RemoteException {
            onProvisionedValueChanged(item, value);
        }
    ...
    private RemoteCallbackList<IImsConfigCallback> mCallbacks = new RemoteCallbackList<>();
     ...
     */
    final void addImsConfigCallback(IImsConfigCallback c) {
        mCallbacks.register(c);
    }
    /**
     * Removes a {@link Callback} to the list of callbacks notified when a value in the configuration
     * changes.
     *
     * @param c Callback to remove.
     */
    final void removeImsConfigCallback(IImsConfigCallback c) {
     ...
     * @return as defined in com.android.ims.ImsConfig#OperationStatusConstants.
     */
    public int setProvisionedValue(int item, String value) {
        return -1;
    }
