...
public class MmTelFeature extends ImsFeature {
    ...
    private final IImsMmTelFeature mImsMMTelBinder = new IImsMmTelFeature.Stub() {
        ...
        @Override
        public void queryCapabilityConfiguration(long capability, int radioTech,
    ...
    public static class MmTelCapabilities extends Capabilities {
         ...
         */
        public static final long CAPABILITY_TYPE_VOICE = (long) 1 << 0;

        /**
         * This MmTelFeature supports Video (IR.94)
         */
        public static final long CAPABILITY_TYPE_VIDEO = (long) 1 << 1;

        /**
         * This MmTelFeature supports XCAP over Ut for supplementary services. (IR.92)
         */
        public static final long CAPABILITY_TYPE_UT = (long) 1 << 2;
    ...
    private void queryCapabilityConfigurationInternal(long capability, int radioTech,
            IImsCapabilityCallback c) {
     ...
     */
    public boolean queryCapabilityConfiguration(@MmTelCapabilities.MmTelCapability long capability,
