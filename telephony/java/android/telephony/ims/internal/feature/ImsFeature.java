...
public abstract class ImsFeature {
    ...
    public static class CapabilityCallback extends IImsCapabilityCallback.Stub {
         ...
         */
        @Override
        public void onQueryCapabilityConfiguration(long capability, int radioTech,
                boolean isEnabled) {
         ...
         */
        @Override
        public void onChangeCapabilityConfigurationError(long capability, int radioTech,
                int reason) {
        }
    ...
    public static class Capabilities {
        ...
        protected Capabilities(long capabilities) {
