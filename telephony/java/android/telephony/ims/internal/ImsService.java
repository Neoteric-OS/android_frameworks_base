 ...
 * - SMS_FEATURE: This ImsService implements SMS over IMS.
 *   @hide
 */
public class ImsService extends Service {
    ...
    private IImsMMTelFeature createMMTelFeatureInternal(int slotId,
        ...
        MMTelFeature f = onCreateMMTelFeature(slotId);
        if (f != null) {
    ...
    /**
     * When called, the framework is requesting that a new MMTelFeature is created for the slot
     * identified.
     *
     ...
     * supported.
     */
    public MMTelFeature onCreateMMTelFeature(int slotId) {
        return null;
    }

    /**
     * When called, the framework is requesting that a new RcsFeature is created for the slot
     * identified.
     *
     ...
     * @return ImsConfig implementation that is associated with the slot specified.
     */
