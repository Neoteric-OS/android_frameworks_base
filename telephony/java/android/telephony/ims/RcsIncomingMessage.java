...
public class RcsIncomingMessage extends RcsMessage {
     ...
     */
    @WorkerThread
    public void setNotifiedTimestamp(long notifiedTimestamp) throws RcsMessageStoreException {
        RcsControllerCall.callWithNoReturn(
                iRcs -> iRcs.setMessageNotifiedTimestamp(mId, true, notifiedTimestamp));
    }
     ...
     */
    @WorkerThread
    public long getNotifiedTimestamp() throws RcsMessageStoreException {
        return RcsControllerCall.call(iRcs -> iRcs.getMessageNotifiedTimestamp(mId, true));
    }
