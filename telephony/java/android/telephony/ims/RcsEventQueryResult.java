...
public class RcsEventQueryResult implements Parcelable {
    private RcsEventQueryContinuationToken mContinuationToken;
    ...
    public RcsEventQueryResult(
            RcsEventQueryContinuationToken continuationToken,
     ...
     * {@link RcsMessageStore#getRcsEvents(RcsEventQueryContinuationToken)}
     * to get the next batch of {@link RcsEvent}s.
     */
    public RcsEventQueryContinuationToken nextChunkToken() {
        return mContinuationToken;
    }

    /**
     * Returns all the {@link RcsEvent}s in the current query result. Call {@link
     * RcsMessageStore#getRcsEvents(RcsEventQueryContinuationToken)} to get the next batch
     * of {@link RcsEvent}s.
     */
