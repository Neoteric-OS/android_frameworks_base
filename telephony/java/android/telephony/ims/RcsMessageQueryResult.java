...
public final class RcsMessageQueryResult {
    ...
    RcsMessageQueryResult(RcsMessageQueryResultDescriptor rcsMessageQueryResultDescriptor) {
    ...
    public List<RcsMessage> getMessages() {
        return mRcsMessageQueryResultDescriptor.mMessageTypeIdPairs.stream()
