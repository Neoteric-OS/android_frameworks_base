...
public class RcsMessageQueryResult implements Parcelable {
    ...
    private RcsMessageQueryContinuationToken mContinuationToken;
    ...
    public RcsMessageQueryResult(
            RcsMessageQueryContinuationToken continuationToken,
     ...
     * {@link RcsMessageStore#getRcsMessages(RcsMessageQueryContinuationToken)}
     * to get the next batch of {@link RcsMessage}s.
     */
    @Nullable
    public RcsMessageQueryContinuationToken nextChunkToken() {
        return mContinuationToken;
    }

    /**
     * Returns all the {@link RcsMessage}s in the current query result. Call {@link
     * RcsMessageStore#getRcsMessages(RcsMessageQueryContinuationToken)} to get the next batch
    ...
    protected RcsMessageQueryResult(Parcel in) {
        mContinuationToken = in.readParcelable(
                RcsMessageQueryContinuationToken.class.getClassLoader());
