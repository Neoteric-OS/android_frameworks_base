...
public final class SipDelegateImsConfiguration implements Parcelable {
    ...
    public SipDelegateConfiguration toNewConfig() {
        String ipTypeString = getString(KEY_SIP_CONFIG_IPTYPE_STRING);
        int ipType = (ipTypeString != null && ipTypeString.equals(IPTYPE_IPV6))
                ? SipDelegateConfiguration.IPTYPE_IPV6 :  SipDelegateConfiguration.IPTYPE_IPV4;
        ...
        SipDelegateConfiguration.Builder builder = new SipDelegateConfiguration.Builder(mVersion,
                ipType, transportType, getString(KEY_SIP_CONFIG_UE_DEFAULT_IPADDRESS_STRING),
                getInt(KEY_SIP_CONFIG_UE_DEFAULT_PORT_INT, -1),
                getString(KEY_SIP_CONFIG_SERVER_DEFAULT_IPADDRESS_STRING),
        ...
        builder.setMaxPayloadSizeBytesOnUdp(getInt(KEY_SIP_CONFIG_MAX_PAYLOAD_SIZE_ON_UDP_INT, -1));
        ...
        builder.setSipSecurityVerifyHeader(getString(KEY_SIP_CONFIG_SECURITY_VERIFY_HEADER_STRING));
        ...
        if (getBoolean(KEY_SIP_CONFIG_IS_GRUU_ENABLED_BOOL, false)) {
            builder.setPublicGruuUri(getString(KEY_SIP_CONFIG_UE_PUBLIC_GRUU_STRING));
        }
        ...
        if (getBoolean(KEY_SIP_CONFIG_IS_NAT_ENABLED_BOOL, false)) {
            builder.setNatConfiguration(new SipDelegateConfiguration.NatConfiguration(
