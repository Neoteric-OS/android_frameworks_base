...
public class SipDelegateImsConfiguration implements Parcelable {
    ...
    /**
     * UE's public IPaddress when UE is behind a NAT. null when NAT is disabled.
     */
    ...
    /**
     * UE's public SIP port when UE is behind a NAT. -1 when NAT is disabled.
     */
    public static final String KEY_SIP_CONFIG_UE_PUBLIC_PORT_WITH_NAT_INT =
            "sip_config_ue_public_port_with_nat_int";

    /**
     * Flag specifying if Globally routable user-agent uri is enabled as per TS 23.808
     */
    public static final String KEY_SIP_CONFIG_IS_GRUU_ENABLED_BOOL =
            "sip_config_is_gruu_enabled_bool";

    /**
     * UE's Globally routable user-agent uri if GRUU is enabled. null when GRUU is disabled.
     */
    ...
    /**
     * UE's SIP port used to send traffic when IPSec is enabled. -1 when IPSec is disabled.
     */
    public static final String KEY_SIP_CONFIG_UE_IPSEC_CLIENT_PORT_INT =
            "sip_config_ue_ipsec_client_port_int";

    /**
     * UE's SIP port used to receive traffic when IPSec is enabled. -1 when IPSec is disabled.
     */
     ...
     * -1 when IPSec is disabled.
     */
    public static final String KEY_SIP_CONFIG_UE_IPSEC_OLD_CLIENT_PORT_INT =
            "sip_config_ue_ipsec_old_client_port_int";

    /**
     * Port number used by the SIP server to send SIP traffic when IPSec is enabled. -1 when IPSec
     * is disabled.
     */
     ...
     * association when IPSec is enabled. -1 when IPSec is disabled.
     */
    ...
    /**Default SipDelegate configuration */
    ...
    public static class Builder {
        ...
        /**
         * Creates an implementation of SipDelegateImsConfiguration with all default values defined.
        ...
        public Builder(int version) {
            mVersion = version;
            mBundle = new PersistableBundle(sDefaults);
        }
        /**
    ...
    /**
     * @return the Integer value associated with a given key or {@link Integer#MIN_VALUE} if the
     * value doesn't exist.
     */
    public int getInt(String key) {
        return mBundle.getInt(key, Integer.MIN_VALUE);
    }
    /**
