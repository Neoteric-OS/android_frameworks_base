...
public class RcsParticipantQueryResult implements Parcelable {
    ...
    private RcsParticipantQueryContinuationToken mContinuationToken;
    ...
    public RcsParticipantQueryResult(
            RcsParticipantQueryContinuationToken continuationToken,
     ...
     * {@link RcsMessageStore#getRcsParticipants(RcsParticipantQueryContinuationToken)}
     * to get the next batch of {@link RcsParticipant}s.
     */
    @Nullable
    public RcsParticipantQueryContinuationToken nextChunkToken() {
        return mContinuationToken;
    }

    /**
     * Returns all the {@link RcsParticipant}s in the current query result. Call {@link
     * RcsMessageStore#getRcsParticipants(RcsParticipantQueryContinuationToken)} to get the next
    ...
    protected RcsParticipantQueryResult(Parcel in) {
        mContinuationToken = in.readParcelable(
                RcsParticipantQueryContinuationToken.class.getClassLoader());
    }
