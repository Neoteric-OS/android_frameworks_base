...
public abstract class RcsMessage {
     ...
     * now being retried.
     */
    public static final @RcsMessageStatus int RETRYING = 5;

    /**
     * The status to indicate that this {@link RcsMessage} has permanently failed to send.
     */
    public static final @RcsMessageStatus int FAILED = 6;

    /**
     * The status to indicate that this {@link RcsMessage} was successfully received.
     */
    public static final @RcsMessageStatus int RECEIVED = 7;

    protected int mId;

    @IntDef({
            DRAFT, QUEUED, SENDING, SENT, RETRYING, FAILED, RECEIVED
    })
