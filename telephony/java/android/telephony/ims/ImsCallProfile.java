...
public final class ImsCallProfile implements Parcelable {
    ...
    private ArraySet<RtpHeaderExtensionType> mOfferedRtpHeaderExtensionTypes = new ArraySet<>();

    private ArraySet<RtpHeaderExtensionType> mAcceptedRtpHeaderExtensionTypes = new ArraySet<>();
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeArraySet(mOfferedRtpHeaderExtensionTypes);
        out.writeArraySet(mAcceptedRtpHeaderExtensionTypes);
    }
    ...
    private void readFromParcel(Parcel in) {
        ...
        mOfferedRtpHeaderExtensionTypes = (ArraySet<RtpHeaderExtensionType>) in.readArraySet(
                RtpHeaderExtensionType.class.getClassLoader());
        mAcceptedRtpHeaderExtensionTypes = (ArraySet<RtpHeaderExtensionType>) in.readArraySet(
                RtpHeaderExtensionType.class.getClassLoader());
    }
     ...
     * types for an outgoing call can be found in the {@link ImsCallProfile} passed to
     * {@link com.android.ims.MmTelFeatureConnection#createCallSession(ImsCallProfile)}.
