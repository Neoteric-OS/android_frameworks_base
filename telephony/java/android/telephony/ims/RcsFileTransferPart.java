...
public class RcsFileTransferPart {
     ...
     */
    public static final @RcsFileTransferStatus int NOT_SET = 0;
     ...
     */
    @WorkerThread
    public void setContentType(String contentType) throws RcsMessageStoreException {
        RcsControllerCall.callWithNoReturn(
                iRcs -> iRcs.setFileTransferContentType(mId, contentType));
    }
    ...
    @WorkerThread
    @Nullable
    public String getContentType() throws RcsMessageStoreException {
     ...
     */
    @WorkerThread
    public String getPreviewType() throws RcsMessageStoreException {
     ...
     */
    @WorkerThread
    public void setPreviewType(String previewType) throws RcsMessageStoreException {
        RcsControllerCall.callWithNoReturn(
                iRcs -> iRcs.setFileTransferPreviewType(mId, previewType));
    }
}
