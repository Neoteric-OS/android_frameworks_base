...
public class SipDelegateManager {
    ...
    /**
     * The remote service associated with this SipDelegate has died and the message was not properly
     * sent/received.
     * <p>
     ...
     * <p>
     * This message should be retried when connectivity to the network is re-established.
     * @hide
     */
     ...
     * IMS at this time.
     * <p>
     * This is considered a permanent failure, the message should not be retried until an IMS
     * registration change callback is received.
     * @hide
     */
    public static final int MESSAGE_FAILURE_REASON_NOT_REGISTERED = 9;

    /**
     * The outgoing SIP message has not been sent because the SipDelegateImsConfiguration version
     * associated with the outgoing SipMessage is now stale and has failed validation checks.
     * <p>
     * The SipMessage should be recreated using the newest SipDelegateImsConfiguration and sent
     * again.
     * @hide
     */
    ...
    /**
     * This feature tag is allowed to be used by this SipDelegate, but it is in use by another
     * SipDelegateConnection and can not be associated with this delegate. The feature tag will stay
     * in this state until the feature tag is release by the other application.
     * @hide
     */
    ...
    /**
     * The SipDelegateConnection is being destroyed for an unknown reason.
     * @hide
     */
    public static final int DELEGATE_CONNECTION_DESTROY_REASON_UNKNOWN = 0;

    /**
     * The SipDelegateConnection is being destroyed due to it not being needed anymore.
     * @hide
     */
    public static final int DELEGATE_CONNECTION_DESTROY_REASON_NOT_NEEDED = 1;

    /**
     * The SipDelegateConnection is being destroyed due the user disabling RCS.
     * @hide
     */
    public static final int DELEGATE_CONNECTION_DESTROY_REASON_USER_DISABLED_RCS = 2;

    /** @hide */
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(prefix = "DELEGATE_CONNECTION_DESTROY_REASON", value = {
            DELEGATE_CONNECTION_DESTROY_REASON_UNKNOWN,
            DELEGATE_CONNECTION_DESTROY_REASON_NOT_NEEDED,
            DELEGATE_CONNECTION_DESTROY_REASON_USER_DISABLED_RCS
    })
    public @interface DelegateConnectionDestroyReason {}
     ...
     * <p>
     * If SIP delegates are not supported on this gdevice or the carrier associated with this
     ...
     *
     * @see CarrierConfigManager.Ims#KEY_RCS_SINGLE_REGISTRATION_REQUIRED_BOOL
     */
