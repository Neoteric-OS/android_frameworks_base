 ...
 * @hide
 */
public class DelegateRegistrationState implements Parcelable {
     ...
     *changing.
     * All open SIP dialogs need to be closed with {@link SipDelegateConnection#closeDialog} before
     * the PDN change can proceed.
     */
     ...
     * <p>
     * All open SIP dialogs associated with the new deprovisioned feature tag need to be closed with
     * {@link SipDelegateConnection#closeDialog} before the IMS registration modification can
     * proceed.
     */
    ...
    public class Builder {
         ...
         * @return The in-progress Builder instance for RegistrationState.
         */
        public Builder addRegisteredFeatureTags(@NonNull List<String> featureTags) {
            mState.mRegisteredTags.addAll(featureTags);
            return this;
        }

        /**
         * Add a feature tag that is currently in the current network IMS Registration, but is in
         * the progress of being deregistered and requires action from the RCS application before
         * the IMS registration can be modified.
         *
     ...
     * @return A list of feature tags that the SipDelegate has associated with that are included in
     * the network IMS registration.
     */
    public List<String> getRegisteredFeatureTags() {
        return new ArrayList<>(mRegisteredTags);
    }
     ...
     */
    public List<FeatureTagState> getDeregisteringFeatureTags() {
        return new ArrayList<>(mDeregisteringTags);
    }
     ...
     * the network IMS registration.
     */
    public List<FeatureTagState> getDeregisteredFeatureTags() {
        return new ArrayList<>(mDeregisteredTags);
    }
