...
public class RcsMessageQueryResultDescriptor implements Parcelable {
    ...
    protected RcsMessageQueryResult createRcsMessageQueryResult(
            RcsControllerCall rcsControllerCall) {
        return new RcsMessageQueryResult(rcsControllerCall, this);
    }

    protected RcsMessageQueryResultDescriptor(Parcel in) {
