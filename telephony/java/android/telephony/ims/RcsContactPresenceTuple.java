...
public final class RcsContactPresenceTuple implements Parcelable {
    ...
    /**
     * The service id of the Geolocation Push
     * @hide
     */
    ...
    /**
     * The service id of the Geolocation Push via SMS
     * @hide
     */
    ...
    /**
     * The service id of the Post Call
     * @hide
     */
    ...
    /**
     * The service id of the Shared Map
     * @hide
     */
    ...
    /**
     * The service id of the Shared Sketch
     * @hide
     */
    ...
    /**
     * The service id of the Chatbot using Session
     * @hide
     */
    ...
    /**
     * The service id of the Chatbot using Standalone Messaging
     * @hide
     */
    ...
    /**
     * The service id of the Chatbot Role
     * @hide
     */
    ...
    public static final class Builder {
         ...
         * @param status The status associated with the service capability. See the RFC3863.
