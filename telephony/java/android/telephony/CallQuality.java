...
public final class CallQuality implements Parcelable {
    ...
    // getters
    /**
     * Returns the download {@link #CallQualityLevel} for a given ongoing call.
     */
    @CallQualityLevel
    public int getDownloadCallQualityLevel() {
        return mDownlinkCallQualityLevel;
    }

    /**
     * Returns the upload {@link #CallQualityLevel} for a given ongoing call.
     */
    @CallQualityLevel
    public int getUploadCallQualityLevel() {
    ...
    /**
     * Returns the number of RTP packets which were sent by tthe other party but were lost in the
     ...
     * in interarrival time of packets, for example, if two packets are sent 2 millisecond apart but
     * received 3 milliseconds apart, the relative jitter between those packets is 1 millisecond.
     *
     ...
     * variance in interarrival time of packets, for example, if two packets are sent 2 millisecond
    ...
    /**
     * Returns the call ID which the CallQuality pertains to.
     */
    ...
    public String toString() {
        return "downloadCallQualityLevel=" + mDownlinkCallQualityLevel
                + " uploadCallQualityLevel=" + mUplinkCallQualityLevel
