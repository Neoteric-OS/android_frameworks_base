...
public class PhoneStateListener {
    ...
    /**
     *  Listen for changes to the cellular data indicator
     *
     *  @see #onCellularDataIndicatorChanged
     */
    public static final int LISTEN_CELLULAR_DATA_INDICATOR = 0x00080000;
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case LISTEN_DATA_ACTIVATION_STATE:
                        ...
                        break;
                    case LISTEN_CELLULAR_DATA_INDICATOR:
                        PhoneStateListener.this.onCellularDataIndicatorChanged((boolean)msg.obj);
                        break;
    ...
    private static class IPhoneStateListenerStub extends IPhoneStateListener.Stub {
        ...
        public void onCellularDataIndicatorChanged(boolean enabled) {
            send(LISTEN_CELLULAR_DATA_INDICATOR, 0, 0, enabled);
        }
