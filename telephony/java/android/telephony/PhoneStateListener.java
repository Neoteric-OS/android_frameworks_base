...
public class PhoneStateListener {
    ...
    public PhoneStateListener(Integer subId, Looper looper) {
        this(subId, new HandlerExecutor(looper));
    }
     ...
     * own non-null Looper use PhoneStateListener(int subId, Looper looper) below.
     */
    public PhoneStateListener(Executor e) {
        this(null, e);
    }
    ...
    private static class IPhoneStateListenerStub extends IPhoneStateListener.Stub {
        ...
        public void onVoLteServiceStateChanged(VoLteServiceState volteState) {
            PhoneStateListener psl = mPhoneStateListenerWeakRef.get();
            if (psl == null) return;

            Binder.withCleanCallingIdentity(
                    () -> mExecutor.execute(() -> psl.onVoLteServiceStateChanged(volteState)));
        }
