...
public class SignalStrength implements Parcelable {
    ...
    public SignalStrength(boolean gsmFlag) {
        this(new CellSignalStrengthCdma(), new CellSignalStrengthGsm(),
                ...
                0, gsmFlag, false, MEASUREMENT_TYPE_RSCP);
    }
    ...
    public SignalStrength(
        ...
        mWcdmaDefaultSignalMeasurement = TextUtils.isEmpty(wcdmaDefaultMeasurement) ?
                MEASUREMENT_TYPE_RSCP : wcdmaDefaultMeasurement;
   ...
   /**
    ...
    public int hashCode() {
        ...
        return ((mGsmSignalStrength * primeNum)
                ...
                + (mWcdmaRscp * primeNum) + (mUseOnlyRsrpForLteLevel ? 1 : 0)
