...
public class PreciseCallState implements Parcelable {
    ...
    private int mDisconnectCause = DisconnectCause.DISCONNECT_CAUSE_NOT_VALID;
    private int mPreciseDisconnectCause = PreciseDisconnectCause.PRECISE_DISCONNECT_CAUSE_NOT_VALID;
