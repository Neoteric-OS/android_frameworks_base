...
public class MbmsStreamingManager {
     ...
     * <li>ERROR_MSDC_UNABLE_TO_START_SERVICE</li>
    ...
    public void getStreamingServices(List<String> classList) throws MbmsException {
        ...
        try {
            mService.getStreamingServices(mAppName, mSubscriptionId, classList);
        } catch (RemoteException e) {
            if (e instanceof MbmsException) {
                throw (MbmsException) e;
            }
