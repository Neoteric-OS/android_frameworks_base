...
public class PhoneNumberUtils
{
    ...
    public static boolean isVoiceMailNumber(Context context, int subId, String number) {
        ...
        // check if the carrier considers +1<MDN> to be an additional voicemail number
            ...
            if (configManager != null) {
                ...
                if (b != null) {
                    compareWithMdn = b.getBoolean(CarrierConfigManager.
                            KEY_TREAT_MDN_AS_ADDITIONAL_VOICEMAIL_NUMBER_BOOL);
                    if (DBG) log("isVoiceMailNumber compareWithMdn: " + compareWithMdn.toString());
                }
            }
        }
