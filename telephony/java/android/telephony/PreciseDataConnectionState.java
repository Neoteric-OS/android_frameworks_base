 ...
 *   <li>Data connection interface description.
 *   <li>Data connection fail cause.
 * </ul>
 */
public class PreciseDataConnectionState implements Parcelable {

    private static final String LOG_TAG = "PreciseDataConnectionState";
     ...
     */
    public String getDataConnectionmAPN() {
        return mAPN;
    }
    ...
    /**
     * Get data connection interface properties including IP, DNSs, Routes and Proxyes.
     */
    public String getDataConnectionInterface() {
        return mIface;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((mIface == null) ? 0 : mIface.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (mFailCause == null) {
            ...
            return false;
        if (mIface == null) {
            if (other.mIface != null)
                return false;
        } else if (!mIface.equals(other.mIface))
            return false;
