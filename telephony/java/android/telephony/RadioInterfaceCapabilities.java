...
public class RadioInterfaceCapabilities {
    ...
    /**
     * Creates an a radio interface capabilities setting all capabilities active by default.
     */
    public static RadioInterfaceCapabilities createFullyAvailable() {
        RadioInterfaceCapabilities radioInterfaceCapabilities = new RadioInterfaceCapabilities();
        //radioInterfaceCapabilities
        //  .addAvailableCapability(TelephonyManager.RADIO_INTERFACE_CAPABILITY_CAP1);
        return radioInterfaceCapabilities;
    }
