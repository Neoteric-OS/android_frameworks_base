...
public final class Telephony {
     ...
     * @hide
     */
    public interface RcsColumns extends BaseColumns {
        /**
         ...
         */
        interface Rcs1To1ThreadColumns {
            /**
             * The path that should be used for referring to
         ...
         */
        interface RcsGroupThreadColumns {
            /**
             * The path that should be used for referring to
        ...
        interface RcsMessageColumns {
            ...
            /**
             * The globally unique RCS identifier for the message.
             */
         ...
         * gets persisted to.
         */
        interface RcsIncomingMessageColumns {
            /**
             The path that should be used for referring to
             ...
             */
            Uri INCOMING_MESSAGE_URI = CONTENT_AND_AUTHORITY.buildUpon().appendPath(
                    INCOMING_MESSAGE_URI_PART).build();

            /**
             * The ID of the {@link android.telephony.ims.RcsParticipant} that sent this message
             */
            String SENDER_PARTICIPANT_COLUMN = "sender_participant";
            ...
            /**
             * The timestamp of notification for this message.
             */
            String NOTIFIED_TIMESTAMP_COLUMN = "notified_timestamp";
        }
         ...
         * gets persisted to.
         */
        interface RcsOutgoingMessageColumns {
            /**
             * The path that should be used for referring to
             ...
             * content provider
             */
            Uri OUTGOING_MESSAGE_URI = CONTENT_AND_AUTHORITY.buildUpon().appendPath(
                    OUTGOING_MESSAGE_URI_PART).build();
        }

        /**
         * The delivery information of an {@link android.telephony.ims.RcsOutgoingMessage}
         */
        interface RcsMessageDeliveryColumns {
            /**
             * The path that should be used for referring to
        ...
        interface RcsUnifiedMessageColumns extends RcsIncomingMessageColumns,
             ...
             */
            Uri UNIFIED_MESSAGE_URI = Uri.withAppendedPath(CONTENT_AND_AUTHORITY, "message");
        ...
        interface RcsFileTransferColumns {
            ...
            /**
             * The RCS session ID for this file transfer
             */
            ...
            /**
             * The file type of this file transfer
             */
             ...
             */
            String TRANSFER_OFFSET_COLUMN = "transfer_offset";
            ...
            /**
             * The length of the content in milliseconds if this file transfer contains multi-media
             */
            String LENGTH_COLUMN = "length";
            ...
            /**
             * The type of the preview of the content of this file transfer
             */
        ...
        interface RcsThreadEventColumns {
             ...
             */
            String ORIGINATING_PARTICIPANT_COLUMN = "originating_participant";
             ...
             */
            String DESTINATION_PARTICIPANT_COLUMN = "destination_participant";

            /**
             * The URI for the old icon of the group thread if this was an
             * {@link android.telephony.ims.RcsGroupThreadIconChangedEvent}
             */
            String OLD_ICON_URI_COLUMN = "old_icon_uri";
            ...
            /**
             * The URI for the old name of the group thread if this was an
             * {@link android.telephony.ims.RcsGroupThreadNameChangedEvent}
             */
            String OLD_NAME_COLUMN = "old_name";
        ...
        interface RcsParticipantEventColumns {
            ...
            /**
             * The old alias of the participant
             */
            String OLD_ALIAS_COLUMN = "old_alias";
