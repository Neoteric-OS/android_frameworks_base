...
public final class Telephony {
    ...
    public static final class Carriers implements BaseColumns {
         ...
         * <P>Type: TEXT</P>
         * @deprecated Use {@link #SIM_APN_LIST} to query APN instead, this API will return matching
         * APNs based on current subscription carrier, thus no need to specify MCC and other carrier
         * matching information. In the future, Android will not support MCC for APN query.
         */
        public static final String MCC = "mcc";
