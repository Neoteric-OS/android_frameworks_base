...
public final class Telephony {
    ...
    public static final class Carriers implements BaseColumns {
        ...
        /**
         * The wait time for retry of the APN. wait time in ms.
         * <p>Type: INTEGER</p>
         *@hide
         */
        @SystemApi
         ...
         * set. If the user manually selects an APN with invalid set id, there is no need to
         * prioritize any specific APN set ids.
         * <p>Type: INTEGER</p>
         * @hide
         */
        @SystemApi
        public static final int INVALID_APN_SET_ID = 0;
