...
public class IccUtilsTest {
    ...
    public void testHexStringToBytes() {
        ...
        // The last character is ignored when the length is uneven.
        assertArrayEquals(
                new byte[] {-1, 0x12, -2, 0x34, -3, 0x56, -4, 0x78},
                IccUtils.hexStringToBytes("FF12FE34FD56FC780"));
    }
    ...
    public void testBcdToBytes() {
        assertArrayEquals(new byte[] {}, IccUtils.testBcdToBytes(""));
        assertArrayEquals(new byte[] {0}, IccUtils.testBcdToBytes("00"));
        assertArrayEquals(new byte[] {0x21, 0x43, 0x65}, IccUtils.testBcdToBytes("123456"));
        assertArrayEquals(new byte[] {0x21, 0x43, 0x05}, IccUtils.testBcdToBytes("12345"));

        byte[] output;
        output = new byte[3];
        IccUtils.testBcdToBytes("123456", output);
        ...
        output = new byte[4];
        IccUtils.testBcdToBytes("12345", output);
