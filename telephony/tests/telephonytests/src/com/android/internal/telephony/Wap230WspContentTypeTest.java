...
public class Wap230WspContentTypeTest extends TestCase {
    ...
    public void testHasExpectedNumberOfLongMimeTypes() {
        final int EXPECTED_NUMBER_OF_LONG_MIME_TYPES = 40;
        assertEquals(EXPECTED_NUMBER_OF_LONG_MIME_TYPES, WELL_KNOWN_LONG_MIME_TYPES.size());
    }
    ...
    public void testWellKnownShortIntegerMimeTypeValues() {
        ...
        for (int value : Wap230WspContentTypeTest.WELL_KNOWN_SHORT_MIME_TYPES.keySet()) {
            WspTypeDecoder unit = new WspTypeDecoder(HexDump
                                            .toByteArray((byte) (value | WSP_SHORT_INTEGER_MASK)));
    ...
    public void testDecodeReturnsFalse_WhenOnlyAZeroBytePresent() throws Exception {
    ...
    public void testGeneralFormShortLengthWellKnownShortIntegerWithUnknownValue() throws Exception {
    ...
    public void testGeneralFormShortLengthWellKnownLongIntegerWithUnknownValue() throws Exception {
    ...
    public void testGeneralFormLengthQuoteWellKnownShortIntegerWithUnknownValue() throws Exception {
    ...
    public void testGeneralFormLengthQuoteWellKnownLongIntegerWithUnknownValue() throws Exception {
