...
/**
 * Handle the subcommand to convert policy files to annotations.
 */
class PtaProcessor : SubcommandHandler {
    override fun handle(args: List<String>) {
        ...
        val scriptWriter: BufferedWriter = BufferedWriter(OutputStreamWriter(
...
private class TextPolicyToAnnotationConverter(
    ...
    private inner class Processor : PolicyFileProcessor {
        ...
        override fun onSimpleMethodPolicy(
            ...
            val annot = annotations.get(policy.policy, Annotations.Target.Method) ?: return
