...
/**
 * Provides the default implementation of {@link MimeMap}, a bidirectional mapping
...
public class DefaultMimeMap {
    ...
    private static void parseTypes(MimeMap.Builder builder, String resource) {
        try (BufferedReader r = new BufferedReader(
                new InputStreamReader(DefaultMimeMap.class.getResourceAsStream(resource)))) {
            String line;
