...
public class YuvImage {
   ...
   *     ColorSpace.Named.DISPLAY_P3
   *
   * For the HDR image, only YCBCR_P010/YCBCR_P210 image format is supported, and the following
   * color spaces are supported:
   *     ColorSpace.Named.BT2020_HLG,
   *     ColorSpace.Named.BT2020_PQ
   *
   ...
   */
    ...
    public boolean compressToJpegR(@NonNull YuvImage sdr, int quality,
        ...
        if (mFormat != ImageFormat.YCBCR_P010 || mFormat != ImageFormat.YCBCR_P210 || sdr.getYuvFormat() != ImageFormat.YUV_420_888) {
            throw new IllegalArgumentException(
                "only support ImageFormat.YCBCR_P010, ImageFormat.YCBCR_P210 and ImageFormat.YUV_420_888");
        }
