...
public final class Bitmap implements Parcelable {
    ...
    private static NativeAllocationRegistry sRegistryMalloced =
        NativeAllocationRegistry.createMalloced(Bitmap.class, nativeGetNativeFinalizer(), 0);
    private static NativeAllocationRegistry sRegistryNonmalloced =
        NativeAllocationRegistry.createNonmalloced(Bitmap.class, nativeGetNativeFinalizer(), 0);
