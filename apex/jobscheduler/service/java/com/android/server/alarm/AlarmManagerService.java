...
public class AlarmManagerService extends SystemService {
    ...
    /**
     * b/246256335: @Keep ensures that the native definition is kept even when the optimizer can
     * tell no calls will be made. Allowing this to be optimized away breaks
     * loadLibrary("alarm_jni") at boot time.
     */
    @Keep
