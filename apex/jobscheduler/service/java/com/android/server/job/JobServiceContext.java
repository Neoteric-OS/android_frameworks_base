...
public final class JobServiceContext implements ServiceConnection {
    ...
    public static final long EXECUTING_TIMESLICE_MILLIS =
            10 * 60 * 1000 * Build.TIMEOUT_MULTIPLIER; // 10mins.
    /** Amount of time the JobScheduler waits for the initial service launch+bind. */
    private static final long OP_BIND_TIMEOUT_MILLIS = 18 * 1000 * Build.TIMEOUT_MULTIPLIER;
    /** Amount of time the JobScheduler will wait for a response from an app for a message. */
    private static final long OP_TIMEOUT_MILLIS = 8 * 1000 * Build.TIMEOUT_MULTIPLIER;
