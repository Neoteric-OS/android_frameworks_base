...
public class AndroidKeyStoreSpiTest {
    ...
    public void testKeystoreKeysAdhereToContractBetweenEqualsAndHashCode() throws Exception {
        ...
        assertThat("Identity should yield same hash codes", key1.hashCode() == key1.hashCode());
        assertThat("Identity should yield true", key2.equals(key2));
        assertThat("Identity should yield same hash codes", key2.hashCode() == key2.hashCode());
        assertThat("Different keys should differ", !key1.equals(key2));
        assertThat("Different keys should have different hash codes",
        ...
        assertThat("Same keys should yield same hash codes",
    ...
    public void testKeystorePublicKeysAdhereToContractBetweenEqualsAndHashCode() throws Exception {
        ...
        assertThat("Identity should yield same hash codes", key3.hashCode() == key3.hashCode());
        assertThat("Different keys should differ", !key1.equals(key2));
        assertThat("Different keys should have different hash codes",
                key1.hashCode() != key2.hashCode());
