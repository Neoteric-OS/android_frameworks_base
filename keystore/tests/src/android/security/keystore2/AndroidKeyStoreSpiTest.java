...
public class AndroidKeyStoreSpiTest {
    ...
    @Test
    public void testEngineAliasesCorrectlyListsZeroEntries() throws Exception {
    ...
    public void testEngineAliasesCorrectlyListsEntriesInASingleBatch() throws Exception {
        ...
        Assert.assertEquals("First element is expected to be test alias 1", aliases.nextElement(),
                alias1);
        assertThat("Should have more elements before second.", aliases.hasMoreElements());
        Assert.assertEquals("First element is expected to be test alias 2", aliases.nextElement(),
                alias2);
        assertThat("Should have more elements before third.", aliases.hasMoreElements());
        Assert.assertEquals("First element is expected to be test alias 3", aliases.nextElement(),
                alias3);
