...
public class AndroidKeyStoreMaintenance {
    ...
    * Called by RecoverySystem before rebooting to recovery in order to delete all synthetic
    * password protector keys. This ensures that FBE-encrypted data is unrecoverable even if the
