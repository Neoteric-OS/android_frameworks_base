...
class KeyStoreCryptoOperationChunkedStreamer implements KeyStoreCryptoOperationStreamer {
    ...
    KeyStoreCryptoOperationChunkedStreamer(Stream operation, int chunkSizeThreshold,
        ...
        mChunkSizeThreshold = chunkSizeThreshold > chunkSizeMax ? chunkSizeMax : chunkSizeThreshold;
    ...
    public byte[] update(byte[] input, int inputOffset, int inputLength) throws KeyStoreException {
        ...
        while (inputLength > 0) {
            int inputConsumed = ArrayUtils.fill(mChunk, mChunkLength, input,
            ...
            if (mChunkLength > mChunkSizeMax) {
            ...
            else if (mChunkLength >= mChunkSizeThreshold) {
                ...
                if (mChunkLength > 0) {
                    ...
                    ArrayUtils.fill(mChunk, 0, mChunk, opResult.inputConsumed, mChunkLength);
                }
