...
public final class KeyGenParameterSpec implements AlgorithmParameterSpec, UserAuthArgs {
    ...
    private final @NonNull @KeyProperties.DigestEnum Collection<String> mMgf1Digests;
    ...
    public KeyGenParameterSpec(
            ...
            @KeyProperties.DigestEnum Collection<String> mgf1Digests,
    ...
    public @KeyProperties.DigestEnum Collection<String> getMgf1Digests() {
        if (mMgf1Digests.isEmpty()) {
            throw new IllegalStateException("Mask generation function (MGF) not specified");
        }
        return new ArrayList(mMgf1Digests);
    }
    ...
    public final static class Builder {
        ...
        private @NonNull @KeyProperties.DigestEnum Collection<String> mMgf1Digests =
        ...
        public Builder setMgf1Digests(@Nullable @KeyProperties.DigestEnum String... mgf1Digests) {
            mMgf1Digests = List.of(mgf1Digests);
            return this;
        }
