...
public final class KeyGenParameterSpec implements AlgorithmParameterSpec, UserAuthArgs {
    ...
    /**
     * Gets the set of mask generation function digest algorithms (e.g., {@code SHA-256},
     * {@code SHA-384}) with which the key can be used.
     *
     * <p>See {@link KeyProperties}.{@code DIGEST} constants.
     *
     * @throws IllegalStateException if this set has not been specified.
    ...
    /**
     * Returns {@code true} if the set of mask generation function digest algorithms with which the
     * key can be used has been specified.
     *
     * @see #getMgfDigests()
     */
    ...
    public final static class Builder {
        ...
        public Builder(@NonNull KeyGenParameterSpec sourceSpec) {
            ...
            if (sourceSpec.isMgfDigestsSpecified()) {
                mMgfDigests = sourceSpec.getMgfDigests();
            }
        ...
        /**
         * Sets the set of mask generation function digest algorithms (e.g., {@code SHA-256},
         * {@code SHA-384}) with which the RSA key can be used. Attempts to use the key with any
         * other mask generation function digest algorithm will be rejected except default mask
         * generation function digest SHA-1.
         *
         * <p>This must be specified for encryption/decryption keys used with RSA OAEP padding
         * scheme because these operations involve mask generation function digest.
         *
         * <p>See {@link KeyProperties}.{@code DIGEST} constants.
         */
        @NonNull
