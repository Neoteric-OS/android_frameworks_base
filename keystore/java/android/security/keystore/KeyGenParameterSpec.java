...
public final class KeyGenParameterSpec implements AlgorithmParameterSpec, UserAuthArgs {
    ...
    public final static class Builder {
         ...
         *
         * Note that some secure hardware may not support this feature at all, in which case it
         * will be enforced in the software. Some secure hardware may support it but only with
         * maxUsageCount = 1 at present.
         *
