...
public final class KeyProtection implements ProtectionParameter, UserAuthArgs {
    ...
    public final static class Builder {
         ...
         * {@link PackageManager.FEATURE_KEYSTORE_SINGLE_USE_KEY} and
         * {@link PackageManager.FEATURE_KEYSTORE_LIMITED_USE_KEY} can be used to check whether the
         * secure hardware cannot enforce this feature, can only enforce it with maxUsageCount = 1,
