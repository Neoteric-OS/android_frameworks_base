...
public final class KeyStoreManager {
    ...
    /**
     * When passed into getAttestationInput, getAttestationInput returns the DER-encoded structure
     * corresponding to the `Modules` schema described in the KeyMint HAL's KeyCreationResult.aidl.
     * The SHA-256 hash of this encoded structure is what's included with the tag in attestations.
     */
