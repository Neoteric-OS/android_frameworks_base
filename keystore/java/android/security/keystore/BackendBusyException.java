...
public class BackendBusyException extends ProviderException {
     ...
     * no cause.
     */
    public BackendBusyException(long backOffHintMs, @NonNull String message) {
        super(message);
        this.mBackOffHintMs = backOffHintMs;
    }
     ...
     */
    public long getBackOffHintMs() {
        return mBackOffHintMs;
    }
}
