...
public class KeyStore {
    ...
    public boolean put(String key, byte[] value) {
        try {
            return mBinder.insert(key, value) == 0;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return false;
        }
    ...
    public boolean password(String password) {
        try {
            return mBinder.password(password) == 0;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return false;
        }
    ...
    public boolean importKey(String keyName, byte[] key) {
        try {
            return mBinder.import_key(keyName, key) == 0;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return false;
        }
    ...
    public boolean verify(String key, byte[] data, byte[] signature) {
        try {
            return mBinder.verify(key, data, signature) == 0;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return false;
        }
    ...
    public boolean grant(String key, int uid) {
        try {
            return mBinder.grant(key, uid) == 0;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return false;
        }
    ...
    public boolean ungrant(String key, int uid) {
        try {
            return mBinder.ungrant(key, uid) == 0;
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to keystore", e);
            return false;
        }
