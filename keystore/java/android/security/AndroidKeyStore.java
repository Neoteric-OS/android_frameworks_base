    ...
    private void setSecretKeyEntry(String entryAlias, SecretKey key, KeyStoreParameter params)
        ...
        if (params != null) {
            ...
            for (int keymasterPurpose :
                KeyStoreKeyConstraints.Purpose.allToKeymaster(params.getPurposes())) {
            ...
            if (!params.isUserAuthenticationRequired()) {
                args.addBoolean(KeymasterDefs.KM_TAG_NO_AUTH_REQUIRED);
            }
            if (params.getUserAuthenticators() != null) {
            ...
            if (params.getMaxSecondsSinceUserAuthentication() != null) {
                args.addInt(KeymasterDefs.KM_TAG_AUTH_TIMEOUT,
                        params.getMaxSecondsSinceUserAuthentication());
            }
