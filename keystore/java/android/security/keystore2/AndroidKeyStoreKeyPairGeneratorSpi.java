    ...
    private void initAlgorithmSpecificParameters() throws InvalidAlgorithmParameterException {
        ...
        switch (mKeymasterAlgorithm) {
            ...
            case KeymasterDefs.KM_ALGORITHM_EC:
                ...
                } else if (mKeySizeBits == 255) {
                    // Special-case handling for Curve 25519: Callers may specify only key sise of
                    // 255 and no ECGenParameterSpec.
                    // This is to comply with https://openjdk.java.net/jeps/324
                    // However, we need to pass the right key size in bits into KeyMint.
                    mKeySizeBits = 256;
                    mEcCurveName = CURVE_X_25519;
                } else if (algSpecificSpec != null) {
                    throw new InvalidAlgorithmParameterException(
