...
public class DiscoverySession {
     ...
     *
     * @return A {@link WifiAwareNetworkSpecifier} to be used to construct
     * {@link android.net.NetworkRequest.Builder#setNetworkSpecifier(NetworkSpecifier)} to pass to
     * {@link android.net.ConnectivityManager#requestNetwork(android.net.NetworkRequest,
     * android.net.ConnectivityManager.NetworkCallback)}
     * [or other varieties of that API].
     */
    public WifiAwareNetworkSpecifier createNetworkSpecifierOpen(@Nullable PeerHandle peerHandle) {
        if (mTerminated) {
     ...
     * [or other varieties of that API].
     */
    public WifiAwareNetworkSpecifier createNetworkSpecifierPassphrase(
     ...
     */
    @SystemApi
    public WifiAwareNetworkSpecifier createNetworkSpecifierPmk(@Nullable PeerHandle peerHandle,
            @NonNull byte[] pmk) {
