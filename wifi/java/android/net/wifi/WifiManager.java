...
public class WifiManager {
     ...
     *            the calling app must hold the
     *            {@link android.Manifest.permission#OVERRIDE_WIFI_CONFIG}
     *            permission, or be provisioned as the Profile or Device Owner.
     ...
     *            If the {@link WifiConfiguration} contains changes to the
     *            Http Proxy (including removal) the calling app must hold the
     *            {@link android.Manifest.permission#OVERRIDE_WIFI_CONFIG}
     *            permission, or be provisioned as the Profile or Device Owner.
