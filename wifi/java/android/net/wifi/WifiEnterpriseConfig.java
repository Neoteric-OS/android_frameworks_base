...
public class WifiEnterpriseConfig implements Parcelable {
     ...
     * {@link android.net.wifi.WifiEnterpriseConfig#setClientKeyEntry()} with a non-null
     * certificate instance, a single-element array containing the certificate will be
     * returned. If
     * {@link android.net.wifi.WifiEnterpriseConfig#setClientKeyEntryWithCertificateChain()}
     * was last called with a non-empty array, this array will be returned in the same order
     * as it was supplied.  Otherwise, {@code null} will be returned.
     *
