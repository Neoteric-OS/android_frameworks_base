...
public final class Credential implements Parcelable {
    ...
    /**
     * Value indicating an unknown vendor ID for EAP (Extensible Authentication Protocol).
     */
    public static final int EAP_VENDOR_ID_UNKNOWN = -1;

    /**
     * Value indicating an unknown vendor type for EAP (Extensible Authentication Protocol).
     */
    public static final int EAP_VENDOR_TYPE_UNKNOWN = -1;
    ...
    public static final class UserCredential implements Parcelable {
        ...
        public static final class ExpandedEAPMethod implements Parcelable {
             ...
             */
            public int eapVendorId = EAP_VENDOR_ID_UNKNOWN;

            /**
             * Vendor-Type for an expanded EAP (Extensible Authentication Protocol) method.
             */
            public int eapVendorType = EAP_VENDOR_TYPE_UNKNOWN;
            ...
            public boolean equals(Object thatObject) {
                ...
                return eapVendorId == that.eapVendorId &&
            ...
            public static final Creator<ExpandedEAPMethod> CREATOR =
                new Creator<ExpandedEAPMethod>() {
                    ...
                    public ExpandedEAPMethod createFromParcel(Parcel in) {
                        ExpandedEAPMethod method = new ExpandedEAPMethod();
                        method.eapVendorId = in.readInt();
                        method.eapVendorType = in.readInt();
                        return method;
                    }
        ...
        public ExpandedEAPMethod expandedEapMethod = null;
        ...
        public static final class InnerEAPMethod implements Parcelable {
            ...
            public boolean equals(Object thatObject) {
                ...
                InnerEAPMethod that = (InnerEAPMethod) thatObject;
                return eapType == that.eapType &&
            ...
            public static final Creator<InnerEAPMethod> CREATOR =
                new Creator<InnerEAPMethod>() {
                    ...
                    public InnerEAPMethod createFromParcel(Parcel in) {
                        InnerEAPMethod method = new InnerEAPMethod();
                        method.eapType = in.readInt();
                        method.eapVendorId = in.readInt();
                        method.eapVendorType = in.readInt();
                        return method;
                    }
        ...
        public InnerEAPMethod innerEapMethod = null;
        ...
        public boolean equals(Object thatObject) {
            ...
            return TextUtils.equals(username, that.username) &&
                    ...
                    expandedEapMethod == null ? that.expandedEapMethod == null :
                        expandedEapMethod.equals(that.expandedEapMethod) &&
                    innerEapMethod == null ? that.innerEapMethod == null :
                        innerEapMethod.equals(that.innerEapMethod) &&
