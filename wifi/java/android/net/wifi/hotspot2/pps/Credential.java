...
public final class Credential implements Parcelable {
    ...
    * Using Long.MIN_VALUE to indicate unset value.
    ...
    public static final class UserCredential implements Parcelable {
         ...
         * Using Integer.MIN_VALUE to indicate unset value.
         */
        public int eapVendorId = Integer.MIN_VALUE;

        /**
         * Vendor-Type for an expanded EAP (Extensible Authentication Protocol) method.
         * Using Integer.MIN_VALUE to indicate unset value.
         */
        public int eapVendorType = Integer.MIN_VALUE;
         ...
         * Using Integer.MIN_VALUE to indicate unset value.
         */
        public int innerEapType = Integer.MIN_VALUE;
         ...
         * Using Integer.MIN_VALUE to indicate unset value.
         */
        public int innerEapVendorId = Integer.MIN_VALUE;

        /**
         * Vendor-Type for an inner expanded EAP (Extensible Authentication Protocol) method.
         * Using Integer.MIN_VALUE to indicate unset value.
         */
        public int innerEapVendorType = Integer.MIN_VALUE;
