...
public class WifiManagerTest {
    ...
    /**
     * Test creation of a LocalOnlyHotspotReservation and verify.
     */
    @Test
    public void testCreationOfLocalOnlyHotspotReservation() throws Exception {
        try (WifiManager.LocalOnlyHotspotReservation res =
     ...
     */
    @Test
    public void testLocalOnlyHotspotReservationCallsStopProperly() throws Exception {
        try (WifiManager.LocalOnlyHotspotReservation res =
                mWifiManager.new LocalOnlyHotspotReservation(mApConfig)) {
            assertEquals(mApConfig, res.getConfig());
        }
    ...
    /**
     * Verify call to stopLocalOnlyHotspot goes to wifiServiceImpl
     */
    @Test
    public void testStopLocalOnlyHotspot() throws Exception {
        mWifiManager.stopLocalOnlyHotspot();
        verify(mWifiService).stopLocalOnlyHotspot();
    }
     ...
     */
    @Test(expected = SecurityException.class)
    public void testStopLocalOnlyHotspotThrowsSecurityException() throws Exception {
        doThrow(new SecurityException()).when(mWifiService).stopLocalOnlyHotspot();
        mWifiManager.stopLocalOnlyHotspot();
    }
    ...
    public void testCorrectLooperIsUsedForHandler() throws Exception {
        ...
        TestLocalOnlyHotspotCallback callback = new TestLocalOnlyHotspotCallback();
        when(mWifiService.startLocalOnlyHotspot()).thenReturn(null);
        mWifiManager.startLocalOnlyHotspot(callback, mHandler);
        mLooper.dispatchAll();
    ...
    public void testLocalOnlyHotspotCallbackFullOnNoChannelError() throws Exception {
        TestLocalOnlyHotspotCallback callback = new TestLocalOnlyHotspotCallback();
        when(mWifiService.startLocalOnlyHotspot()).thenReturn(mApConfig);
        mWifiManager.startLocalOnlyHotspot(callback, mHandler);
        mLooper.dispatchAll();
