...
public final class OemLogItems implements Parcelable {
    /**
     * Used when data is changed.
     */
    public static final int REPORT_DATA_CHANGED = 0X01;
    /**
     * Used when an API is called.
     */
     ...
     * @hide
     */
    @IntDef(prefix = { "REPORT_" }, value = {
            REPORT_DATA_CHANGED,
            REPORT_CALLING_API,
            REPORT_HOST_ROUTING_STATUS,
            REPORT_CHECK_RLD_STATUS,
            REPORT_TAG_DETECTED,
    })
    ...
    public OemLogItems(@LogAction int action, @LogEvent int event, int callingPid,
            byte[] commandApdus, byte[] responseApdus, long rfFieldOnTime,
            long simRouteTime, Tag tag) {
        mAction = action;
        mEvent = event;
        mTag = tag;
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeLong(mRfFieldOnTime);
        dest.writeLong(mSimRouteTime);
    ...
    public static class Builder {
        ...
        public Builder(@LogAction int type) {
            mItem = new OemLogItems(type, EVENT_UNSET, 0, new byte[0], new byte[0], -1, -1, null);
        }
        ...
        public OemLogItems.Builder setRfFieldOnTime(@CurrentTimeMillisLong long time) {
            mItem.mRfFieldOnTime = time;
            return this;
        }

        /** Setter of SIM route time. */
        public OemLogItems.Builder setSimRouteTime(@CurrentTimeMillisLong long time) {
    ...
    /**
     * Gets the calling Pid of this log.
     * @return calling Pid
     */
    ...
    /**
     * Gets the command APDUs of this log.
    ...
    /**
     * Gets the response APDUs of this log.
    ...
    /**
     * Gets the RF field on time in this log in millisecond.
     * @return RF field on time, or 0 if it's unset.
     */
    @CurrentTimeMillisLong
    public long getRfFieldOnTimeMillis() {
        return mRfFieldOnTime;
    }

    /**
     * Gets the SIM route time of this log.
     * @return SIM route time, or -1 if it's unset.
     */
    @CurrentTimeMillisLong
    public long getSimRouteTimeMillis() {
        return mSimRouteTime;
    }

    /**
     * Gets the tag of this log.
     * @return a detected {@link Tag} in {@link #REPORT_TAG_DETECTED} case. Return
     * null otherwise.
     */
    @Nullable
    public Tag getTag() {
    ...
    private OemLogItems(Parcel in) {
        ...
        this.mRfFieldOnTime = in.readLong();
        this.mSimRouteTime = in.readLong();
