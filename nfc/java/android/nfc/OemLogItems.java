...
public final class OemLogItems implements Parcelable {
    ...
    public static class Builder {
        ...
        public OemLogItems.Builder setCallingEvent(int event) {
            mItem.mEvent = event;
            return this;
        }
     ...
     * @return an byte array of command APDUs.
     */
    @Nullable
    ...
    /**
     * Gets the response APDU of this log.
     * @return an byte array of response APDUs.
     */
    @Nullable
    public byte[] getResponseApdus() {
        return mResponseApdus;
    }

    /**
     * Gets the RF field on time in this log.
     * @return RF field on time, or -1 if it's unset.
     */
