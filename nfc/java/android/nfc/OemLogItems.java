...
public final class OemLogItems implements Parcelable {
    ...
    /**
     * Gets the RF field event time in this log in millisecond.
     * @return RF field event time, or 0 if it's unset.
     */
    @CurrentTimeMillisLong
    public long getRfFieldEventTimeMillis() {
