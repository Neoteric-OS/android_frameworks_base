...
public class WrappedNetworkAgent {
    ...
    private int mStartKeepaliveEventReason = SocketKeepalive.ERROR_UNSUPPORTED;
    private int mStopKeepaliveEventReason = SocketKeepalive.NO_KEEPALIVE;
    private Integer mExpectedKeepaliveSlot = null;

    public WrappedNetworkAgent(int transport, LinkProperties linkProperties, Context context) {
    ...
    protected TestNetworkAgent makeNetworkAgent(LinkProperties linkProperties) {
        return new TestNetworkAgent(this, linkProperties);
    }

    public static class TestNetworkAgent extends NetworkAgent {
        private final WrappedNetworkAgent mWrapper;

        public TestNetworkAgent(WrappedNetworkAgent wrapper, LinkProperties lp) {
        ...
        public void startSocketKeepalive(Message msg) {
            ...
            onSocketKeepaliveEvent(slot, mWrapper.mStartKeepaliveEventReason);
        }

        @Override
        public void stopSocketKeepalive(Message msg) {
            onSocketKeepaliveEvent(msg.arg1, mWrapper.mStopKeepaliveEventReason);
        }
    ...
    public void setStartKeepaliveEvent(int reason) {
        mStartKeepaliveEventReason = reason;
    }

    public void setStopKeepaliveEvent(int reason) {
        mStopKeepaliveEventReason = reason;
    }
