...
public class VpnTest {
    ...
    public void testLockdownRuleReversibility() throws Exception {
        ...
        vpn.prepare(null, VpnConfig.SETTINGS_VPN);
    ...
    public void testProvisionVpnProfilePreconsented() throws Exception {
        ...
        assertTrue(vpn.provisionVpnProfile(TEST_VPN_PKG, mVpnProfile, mKeyStore));
    ...
    public void testProvisionVpnProfileNotPreconsented() throws Exception {
        ...
        assertFalse(vpn.provisionVpnProfile(TEST_VPN_PKG, mVpnProfile, mKeyStore));

        // Verify that the profile is still added to the keystore, and both appops were checked.
        verify(mKeyStore)
                .put(
                        eq(vpn.getProfileNameForPackage(TEST_VPN_PKG)),
                        eq(mVpnProfile.encode()),
    ...
    public void testSetPackageAuthorizationRevokeAuthorization() throws Exception {
        ...
        final int[] allTypes = new int[] {
                VpnManager.TYPE_IGNORED, VpnManager.TYPE_VPN_SERVICE, VpnManager.TYPE_PLATFORM_VPN};
