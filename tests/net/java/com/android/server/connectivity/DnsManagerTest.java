...
public class DnsManagerTest {
    ...
    private void assertResolverExperimentalOptionsEquals(
            @NonNull ResolverExperimentalOptionsParcel actual,
            @NonNull ResolverExperimentalOptionsParcel expected) {
        assertEquals(actual.hosts, expected.hosts);
        assertEquals(actual.tcMode, expected.tcMode);
        assertFieldCountEquals(2, ResolverExperimentalOptionsParcel.class);
    }
    ...
    private void assertResolverParamsEquals(@NonNull ResolverParamsParcel actual,
        ...
        assertResolverExperimentalOptionsEquals(actual.experimentalOptions,
                expected.experimentalOptions);
    ...
    public void testTrackedValidationUpdates() throws Exception {
        ...
        mDnsManager.noteLinkPropertiesForNetwork(TEST_NETID, lp);
        ...
        mDnsManager.noteLinkPropertiesForNetwork(TEST_NETID_ALTERNATE, lp);
        mDnsManager.flushVmDnsCache();
