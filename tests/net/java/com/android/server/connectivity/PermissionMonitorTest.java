...
public class PermissionMonitorTest {
    ...
    @Test
    public void testPackageInstallShareUid() throws Exception {
        final NetdServiceMonitor mNetdServiceMonitor = new NetdServiceMonitor(mNetdService);
        ...
        // Install another package with the same uid should not override the previous one.
    ...
    public void testPackageUninstallWithMultiplePackages() throws Exception {
        ...
        PackageInfo packageInfo = packageInfoWithPermissions(new String[] {INTERNET},
                PARTITION_SYSTEM);
