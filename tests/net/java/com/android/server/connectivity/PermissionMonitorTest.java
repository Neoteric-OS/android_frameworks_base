...
public class PermissionMonitorTest {
    ...
    public void testHasPermission() {
        ...
        setupPermissions(MOCK_UID1, CHANGE_NETWORK_STATE, NETWORK_STACK);
        ...
        setupPermissions(MOCK_UID2, CONNECTIVITY_USE_RESTRICTED_NETWORKS, CONNECTIVITY_INTERNAL);
        assertFalse(mPermissionMonitor.hasPermission(
                CONNECTIVITY_USE_RESTRICTED_NETWORKS, MOCK_UID1));
        assertFalse(mPermissionMonitor.hasPermission(CONNECTIVITY_INTERNAL, MOCK_UID1));
    ...
    public void testPackagePermissionUpdate() throws Exception {
        ...
        SparseArray<UidNetdPermissionInfo> uidNetdPerms = new SparseArray<>();
    ...
    public void testPackageUninstallWithMultiplePackages() throws Exception {
        ...
        when(mPackageManager.getPackagesForUid(MOCK_UID1)).thenReturn(new String[]{
                MOCK_PACKAGE2});
        removeAllPermissions(MOCK_UID1);
        setupPermissions(MOCK_UID1, INTERNET);
