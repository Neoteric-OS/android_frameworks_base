...
public class IpConnectivityMetricsTest {
    ...
    public void testDefaultNetworkEvents() throws Exception {
        ...
        long timeMs = mService.mDefaultNetworkMonitor.creationTimeMs;
        long durationMs = 1001;
        for (NetworkAgentInfo[] pair : defaultNetworks) {
            timeMs += durationMs;
            durationMs += durationMs;
            mService.mDefaultNetworkMonitor.logDefaultNetworkEvent(timeMs, pair[1], pair[0]);
        }
        ...
        String want = String.join("\n",
                ...
                "    initial_score: 0",
                "    ip_support: 0",
                "    no_default_network_duration_ms: 1001",
                ...
                "    initial_score: 0",
                "    ip_support: 0",
                "    no_default_network_duration_ms: 8008",
    ...
    public void testEndToEndLogging() throws Exception {
        ...
        mService.mDefaultNetworkMonitor.logDefaultNetworkEvent(timeMs + 200, cellNai, null);
        mService.mDefaultNetworkMonitor.logDefaultNetworkEvent(timeMs + 300, wifiNai, cellNai);
        ...
        String want = String.join("\n",
                ...
                "    initial_score: 0",
                "    ip_support: 0",
                "    no_default_network_duration_ms: 200",
                "    previous_default_network_link_layer: 0",
                "    previous_network_ip_support: 0",
                "    validation_duration_ms: 0",
                "  >",
