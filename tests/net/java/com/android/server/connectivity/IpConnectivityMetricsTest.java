...
public class IpConnectivityMetricsTest {
    ...
    public void testDefaultNetworkEvents() throws Exception {
        ...
        for (NetworkAgentInfo[] pair : defaultNetworks) {
            mService.mDefaultNetworkMonitor.logDefaultNetworkEvent(pair[1], pair[0]);
        }
    ...
    public void testEndToEndLogging() throws Exception {
        ...
        mService.mDefaultNetworkMonitor.logDefaultNetworkEvent(cellNai, null);
        mService.mDefaultNetworkMonitor.logDefaultNetworkEvent(wifiNai, cellNai);
