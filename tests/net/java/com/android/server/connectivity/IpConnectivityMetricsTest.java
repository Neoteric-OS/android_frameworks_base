...
public class IpConnectivityMetricsTest {
    ...
    public void testEndToEndLogging() throws Exception {
        ...
        mService.mDefaultNetworkMonitor.defaultNetworkTransition(timeMs + 200, cellNai, null);
        mService.mDefaultNetworkMonitor.defaultNetworkTransition(timeMs + 300, wifiNai, cellNai);
