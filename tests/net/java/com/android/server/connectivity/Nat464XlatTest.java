...
public class Nat464XlatTest {
    ...
    static final LinkAddress ADDR = new LinkAddress("192.0.2.5/24");
    ...
    public void setUp() throws Exception {
        ...
        mNai.linkProperties = new LinkProperties(null);
    ...
    public void testNormalStartAndStop() throws Exception {
        ...
        verify(mConnectivity).handleUpdateLinkProperties(eq(mNai), any());
