...
public final class NetworkStatsSubscriptionsMonitorTest {
    ...
    private void assertRatTypeChangedForSub(String subscriberId, int ratType) {
        ...
        // It will fail if the callback with an unexpected RAT type.
    ...
    public void testOnSubscriptionsChangedAndRatTypeListener() {
        ...
        mMonitor.start();
        // Insert sim1.
        // Verify RAT type is NETWORK_TYPE_UNKNOWN before receive onCollapsedRatTypeChanged()
        // and never get onCollapsedRatTypeChanged() callback.
        ...
        // Verify RAT type of sim1 after subscriber gets onCollapsedRatTypeChanged() callback
        ...
        // Verify RAT type of sim2 after subscriber gets onCollapsedRatTypeChanged() callback
        // and others remain untouched.
