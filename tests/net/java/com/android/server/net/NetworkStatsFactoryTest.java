...
public class NetworkStatsFactoryTest extends NetworkStatsBaseTest {
    ...
    @Test
    public void vpnWithOneUnderlyingIfaceAndTwoVpnIfaces() throws Exception {
        // WiFi and Cell networks are connected and VPN1 is using WiFi (which has TEST_IFACE) and
        // VPN2 is using Cell (which has TEST_IFACE2).
        ...
        // over VPN2.
        // VPN1 sent 1650 bytes (150 packets), and received 3300 (300 packets) over WiFi.
        // Of 1650 bytes sent over WiFi, expect 1000 bytes attributed to UID_RED, 500 bytes
        // attributed to UID_BLUE, and 150 bytes attributed to UID_VPN.
        // Of 3300 bytes received over WiFi, expect 2000 bytes attributed to UID_RED, 1000 bytes
        // attributed to UID_BLUE, and 300 bytes attributed to UID_VPN.
        // VPN2 sent 1045 bytes (95 packets), and received 3850 (350 packets) over Cell.
