...
public class IpSecServiceRefcountedResourceTest {
    ...
    private void assertResourceState(
            ...
            int releaseUnderlyingResourcesCallCount)
        ...
        verify(resource, times(releaseReferenceCallCount))
                .releaseReference();

        // Check call count of IResource
        verify(resource.getResource(), times(invalidateCallCount))
                .invalidate();
        verify(resource.getResource(), times(releaseUnderlyingResourcesCallCount))
