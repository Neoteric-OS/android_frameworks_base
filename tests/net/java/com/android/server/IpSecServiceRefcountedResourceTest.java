...
public class IpSecServiceRefcountedResourceTest {
    ...
    private void assertResourceState(
            ...
            int cleanupResourceArraysCallCount,
            int releaseKernelResourcesCallCount)
        ...
        verify(resource.getResource(), times(cleanupResourceArraysCallCount))
                .cleanupResourceArrays();
        verify(resource.getResource(), times(releaseKernelResourcesCallCount))
    ...
    public void testMultipleCallsToCleanupAndRelease() throws RemoteException {
        ...
        // Verify calling cleanupAndRelease multiple times does not trigger any other cleanup
        // methods
        refcountedResource.cleanupAndRelease();
        assertResourceState(refcountedResource, -1, 1, 1, 1, 1);
