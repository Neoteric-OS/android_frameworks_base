...
public class IpSecServiceTest {
    ...
    public void testOpenAndCloseUdpEncapsulationSocket() throws Exception {
        ...
        verify(mMockNetd).ipSecAddUdpEncapExemption(eq(udpEncapResp.port));

        mIpSecService.closeUdpEncapsulationSocket(udpEncapResp.resourceId);
        udpEncapResp.fileDescriptor.close();

        verify(mMockNetd).ipSecRemoveUdpEncapExemption(eq(udpEncapResp.port));
    ...
    public void testOpenUdpEncapsulationSocketPortRange() throws Exception {
        try {
            ...
            fail("IllegalArgumentException not thrown");
            verify(mMockNetd, never()).ipSecAddUdpEncapExemption(anyInt());
        } catch (IllegalArgumentException e) {
        }
    ...
    public void testOpenUdpEncapsulationSocketTwice() throws Exception {
        ...
        verify(mMockNetd, times(1)).ipSecAddUdpEncapExemption(eq(udpEncapResp.port));
    ...
    @Test
    public void testSetSockUid() throws Exception {
        int testUid = 12345;
        ...
        mIpSecService.setSockUid(recvFd, testUid);
    ...
    @Test
    public void testIpSecUdpEncapExemption() throws Exception {
        int localport = findUnusedPort();
        mIpSecService.openUdpEncapsulationSocket(localport, new Binder());

        verify(mMockNetd).ipSecSetSocketOwner(anyObject(), eq(Os.getuid()));
        verify(mMockNetd).ipSecAddUdpEncapExemption(eq(localport));
    }
        ...
        try {
            while (line != null) {
                ...
                if (headers.isEmpty()) {
                    ...
                    if (fields[headers.get("uid_tag_int")].equals(Integer.toString(uid))
                            && fields[headers.get("cnt_set")].equals("0")) {
