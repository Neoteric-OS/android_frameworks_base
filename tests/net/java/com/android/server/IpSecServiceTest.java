...
public class IpSecServiceTest {
    ...
    /**
     * Snapshot of xt_qtaguid's stats as of getQtaguidStats call
     */
    private static class QtaguidStats {
        private static final HashMap<String, Integer> fileHeaders = new HashMap<>();
        private static final String qtaguidStatsFilePath = "/proc/net/xt_qtaguid/stats";
        ...
        private static QtaguidStats getQtaguidStats(int uid) throws IOException {
            ...
            try (BufferedReader in = new BufferedReader(new FileReader(qtaguidStatsFilePath))) {
                String line = in.readLine(); // First line is never null; always contains headers
                ...
                for (line = in.readLine(); line != null; line = in.readLine()) {
                    ...
                    if (Integer.valueOf(fields[fileHeaders.get("uid_tag_int")]) == uid
    ...
    public void testSetSockStatsUid() throws Exception {
        ...
        // Code only used for IPv4 UDP encap sockets. IPv6 encap sockets not supported
        ...
        // Allocate an arbitrary amount of extra space to signal failure if too many bytes recv'd
        ...
        // Check that packets were attributed to other UID
