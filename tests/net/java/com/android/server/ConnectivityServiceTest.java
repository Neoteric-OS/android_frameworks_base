...
public class ConnectivityServiceTest {
    ...
    @Mock InterfaceConfigurationParcel mIfaceCfg;
   ...
   public void testIsActiveNetworkMeteredOverVpnSpecifyingUnderlyingNetworks() throws Exception {
     ...
     */
    private InterfaceConfigurationParcel getClatInterfaceConfig(String la, int prefixLen) {
    ...
    public void testStackedLinkProperties() throws Exception {
        ...
        final String myIpv4AddrStr = "1.2.3.4";
        int myIpv4PrefixLen = 24;
        final NetworkRequest networkRequest = new NetworkRequest.Builder()
                .addTransportType(TRANSPORT_CELLULAR)
                .addCapability(NET_CAPABILITY_INTERNET)
                .build();
        ...
        when(mMockNetd.interfaceGetCfg(CLAT_PREFIX + MOBILE_IFNAME))
                .thenReturn(getClatInterfaceConfig(myIpv4AddrStr, myIpv4PrefixLen));
