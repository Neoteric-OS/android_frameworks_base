...
import android.net.NetworkTemplate.buildTemplateCarrierWifi
...
class NetworkTemplateTest {
    ...
    fun testCarrierWifiMatches() {
        val templateCarrierWifiAll = buildTemplateCarrierWifi(null)
        val templateCarrierWifiImsi1 = buildTemplateCarrierWifi(TEST_IMSI1)
