...
public final class TcpKeepalivePacketDataTest {
    ...
    public void testV4TcpKeepalivePacket() {
        ...
        TcpSocketInfo testInfo = new TcpSocketInfo(
                srcAddr, srcPort, dstAddr, dstPort, seq, ack, wnd);
        try {
    ...
    public void testParcelUnparcel() {
        ...
        try {
            ...
            resultData = TcpKeepalivePacketData.fromStableParcelable(testData.toStableParcelable());
        } catch (InvalidPacketException e) {
            fail("InvalidPacketException" + e);
        }
