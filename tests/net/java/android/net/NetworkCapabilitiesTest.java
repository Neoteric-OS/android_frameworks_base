...
public class NetworkCapabilitiesTest {
    ...
    public void testSetAllowedUids() {
        ...
        assertFalse(netCap2.satisfiedByAllowedUids(netCap));
        assertFalse(netCap2.equalsAllowedUids(netCap));
        netCap2.setAllowedUids(uids);
        assertTrue(netCap2.satisfiedByAllowedUids(netCap));
        ...
        assertFalse(new NetworkCapabilities().satisfiedByAllowedUids(netCap));
        ...
        assertTrue(new NetworkCapabilities().satisfiedByAllowedUids(netCap));
    }
