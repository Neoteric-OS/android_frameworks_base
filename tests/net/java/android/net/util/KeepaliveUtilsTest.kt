...
class KeepaliveUtilsTest {
    ...
    private fun getMockedContextWithStringArrayRes(id: Int, res: Array<String>): Context {
    ...
    fun testGetSupportedKeepalives() {
        fun assertRunWithException(res: Array<String>) {
            try {
                val mockContext = getMockedContextWithStringArrayRes(
                        R.array.config_networkSupportedKeepaliveCount, res)
                KeepaliveUtils.getSupportedKeepalives(mockContext)
                fail("Expected KeepaliveDeviceConfigurationException|NumberFormatException")
    ...
    fun testGetSupportedKeepalivesForNetworkCapabilities() {
        ...
        assertEquals(6, KeepaliveUtils.getSupportedKeepalivesForNetworkCapabilities(cust, nc))
