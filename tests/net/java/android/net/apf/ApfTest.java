...
public class ApfTest extends AndroidTestCase {
    ...
    private static class TestApfFilter extends ApfFilter {
        ...
        private long mFixedTimeMs = SystemClock.elapsedRealtime();
        ...
        public long advanceCurTime(long timestepMs) {
            mFixedTimeMs += timestepMs;
    ...
    public void testApfFilterRa() throws Exception {
        ...
        testRaLifetime(apfFilter, ipManagerCallback, prefixOptionPacket, PREFIX_VALID_LIFETIME);
        ...
        verifyRaLifetime(program, prefixOptionPacket, PREFIX_VALID_LIFETIME);
