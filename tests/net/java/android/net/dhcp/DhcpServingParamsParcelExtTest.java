...
public class DhcpServingParamsParcelExtTest {
    ...
    @Test
    public void testNoDefaultRouter() {
        mParcel.withNoDefaultRouter();
        assertEmpty(mParcel.defaultRouters);
    }
    ...
    @Test
    public void testNoDnsServers() {
        mParcel.withNoDnsServer();
        assertEmpty(mParcel.dnsServers);
    }
