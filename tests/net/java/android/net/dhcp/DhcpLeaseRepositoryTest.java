...
public class DhcpLeaseRepositoryTest {
    ...
    public void testUpdateParams_LeaseCleanup() throws Exception {
        ...
        final DhcpLease reqAddrIn28Lease = mRepo.requestLease(
                CLIENTID_UNSPEC, TEST_MAC_1, INET4_ANY /* clientAddr */, INET4_ANY /* relayAddr */,
                reqAddrIn28, false, HOSTNAME_NONE);
        ...
        final DhcpLease reqAddrIn22Lease = mRepo.requestLease(
                CLIENTID_UNSPEC, TEST_MAC_3, INET4_ANY /* clientAddr */, INET4_ANY /* relayAddr */,
                reqAddrIn22, false, HOSTNAME_NONE);
        ...
        final DhcpLease reservedAddrLease = mRepo.requestLease(
                CLIENTID_UNSPEC, TEST_MAC_2, INET4_ANY /* clientAddr */, INET4_ANY /* relayAddr */,
                reservedAddr, false, HOSTNAME_NONE);
    ...
    @Test(expected = DhcpLeaseRepository.InvalidSubnetException.class)
    public void testRequestLease_RelayInInvalidSubnet() throws  Exception {
    ...
    public void testRequestLease_Renewing() throws Exception {
        ...
        final DhcpLease lease = mRepo.requestLease(CLIENTID_UNSPEC, TEST_MAC_1,
                TEST_INETADDR_1/* clientAddr */, TEST_INETADDR_1 /* relayAddr */,
