...
public class DhcpServingParamsTest {
    ...
    public void testParcelUnparcel() throws InvalidParameterException {
        ...
        final DhcpServingParamsParcel parcel = new DhcpServingParamsParcelExt()
                .setDefaultRouters(params.defaultRouters)
                .setDhcpLeaseTimeSecs(params.dhcpLeaseTimeSecs)
                .setDnsServers(params.dnsServers)
                .setServerAddr(params.serverAddr)
                .setLinkMtu(params.linkMtu)
                .setExcludedAddrs(params.excludedAddrs)
                .setMetered(params.metered);
