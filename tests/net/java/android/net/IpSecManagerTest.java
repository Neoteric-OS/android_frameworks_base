...
public class IpSecManagerTest extends AndroidTestCase {
    ...
    IpSecSpiResponse expectedSpiResp = new IpSecSpiResponse(IpSecManager.Status.OK, 0x1, DROID_SPI);
    ...
    protected void setUp() throws Exception {
        ...
        when(mockIpSecService.reserveSecurityParameterIndex(
                        anyInt(), anyString(), anyInt(), anyObject()))
                .thenReturn(expectedSpiResp);
        try {
    ...
    public void testBuildEncapsulationSocket()
    ...
    void setUpTestIpSecTransformBuilder() {
        IpSecTransform.setIpSecService(mockIpSecService);
        try {
    ...
    public void testIpSecTransformBuilder()
            throws IOException, IpSecManager.ResourceUnavailableException,
