...
public class IpSecManagerTest extends AndroidTestCase {
     ...
     * Close SPIs
     */
    public void testAllocSpi() throws IpSecManager.ResourceUnavailableException,
            IpSecManager.SpiUnavailableException {
        for (InetAddress addr : GOOGLE_DNS_LIST) {
            IpSecManager.SecurityParameterIndex randomSpi = null, droidSpi = null;
            randomSpi = mISM.reserveSecurityParameterIndex(IpSecTransform.DIRECTION_OUT, addr);

            assertNotEquals(randomSpi.getSpi(), IpSecManager.INVALID_SECURITY_PARAMETER_INDEX);
            droidSpi =
    ...
    public void testBuildEncapsulationSocket() throws IOException, IpSecManager.ResourceUnavailableException {
    ...
    public void testIpSecTransformBuilder() throws IOException, IpSecManager.ResourceUnavailableException,
            IpSecManager.SpiUnavailableException  {
