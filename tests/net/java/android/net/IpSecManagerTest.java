...
public class IpSecManagerTest extends AndroidTestCase {
    ...
    static final IpSecSpiResponse SPI_RESP = new IpSecSpiResponse(
            IpSecManager.Status.OK, 0x1, DROID_SPI);
    static final IpSecTransformResponse TSF_RESP = new IpSecTransformResponse(
            IpSecManager.Status.OK, 0x1);
