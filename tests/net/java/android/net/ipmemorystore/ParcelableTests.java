...
public class ParcelableTests {
    ...
    @Test
    public void testIPv6ProvisioningLossQuirkParcelable() throws Exception {
        final NetworkAttributes.Builder builder = new NetworkAttributes.Builder();
        ...
        builder.setIpv6ProvLossQuirk(parcelable);
        ...
        assertEquals(3, out.ipv6ProvLossQuirk.detectionCount);
        assertEquals(expiry, out.ipv6ProvLossQuirk.quirkExpiry);
    }
