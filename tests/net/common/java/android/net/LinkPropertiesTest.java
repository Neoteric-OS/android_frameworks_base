...
public class LinkPropertiesTest {
    ...
    public void testRouteAddWithSameKey() throws Exception {
        // This test case can run with targetSdkVersion < S
        // (i.e as part of the CtsNetTestCasesLatestSdk module)
        assumeTrue(CompatChanges.isChangeEnabled(LinkProperties.EXCLUDED_ROUTES));
