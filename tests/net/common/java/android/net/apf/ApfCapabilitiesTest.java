...
public class ApfCapabilitiesTest {
    ...
    public void testGetApfEtherTypeBlackList_S() {
        ...
        assertEquals("android.R.array.config_apfEthTypeBlackList has been modified, but starting "
                        + "from S its value is not used by IpClient. If the modification is "
                        + "intentional, use a runtime resource overlay for the NetworkStack "
                        + "package to overlay "
