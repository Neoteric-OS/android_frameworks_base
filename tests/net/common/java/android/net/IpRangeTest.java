...
public class IpRangeTest {
    ...
    public void testContainsRangeEqualRanges() {
        IpRange r1 = new IpRange(IPV6_ADDR, 35);
        IpRange r2 = new IpRange(IPV6_ADDR, 35);
    ...
    public void testContainsRangeSubset() {
        IpRange r1 = new IpRange(IPV6_ADDR, 100);
        IpRange r2 = new IpRange(address("2001:db8::0101"), 100);
    ...
    public void testContainsRangeSubsetSameStartAddr() {
        IpRange r1 = new IpRange(IPV6_ADDR, 35);
        IpRange r2 = new IpRange(IPV6_ADDR, 39);
    ...
    @Test
    public void testIsOverlappingRangeEqualRanges() {
        IpRange r1 = new IpRange(IPV6_ADDR, 35);
        IpRange r2 = new IpRange(IPV6_ADDR, 35);

        assertTrue(r1.isOverlappingRange(r2));
        assertTrue(r2.isOverlappingRange(r1));
        assertEquals(r1, r2);
    }
    ...
    public void testIsOverlappingRangeDisjoint() {
        ...
        assertFalse(r2.isOverlappingRange(r1));
        assertNotEquals(r1, r2);
    }

    @Test
    public void testIsOverlappingRangePartialOverlapLow() {
        IpRange r1 = new IpRange(address("2001:db9::"), 32);
        IpRange r2 = new IpRange(address("2001:db8::"), address("2001:db9::1"));
    ...
    @Test
    public void testIsOverlappingRangePartialOverlapHigh() {
        IpRange r1 = new IpRange(address("2001:db7::"), 32);
        IpRange r2 = new IpRange(address("2001:db7::ffff"), address("2001:db8::"));
