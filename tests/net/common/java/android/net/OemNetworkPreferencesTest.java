...
public class OemNetworkPreferencesTest {
    ...
    private OemNetworkPreferences.Builder mBuilder;

    @Before
    public void beforeEachTestMethod() {
        mPackages = new ArrayList<>();
        mPackages.add(TEST_PACKAGE);
        mBuilder = new OemNetworkPreferences.Builder();
    }
    ...
    public void getNetworkPreferencesReturnsCorrectValue() {
        SparseArray<List<String>> networkPreferences;
        int expectedNumberOfMappings = 1;
        mBuilder.addNetworkPreference(TEST_PREF, mPackages);
    ...
    public void getNetworkPreferencesReturnsUnmodifiableValue() {
        String newPackage = "new.com.google.apps.contacts";
        SparseArray<List<String>> networkPreferences;
        mBuilder.addNetworkPreference(TEST_PREF, mPackages);
    ...
    public void toStringReturnsCorrectValue() {
        String networkPreferencesString;
        mBuilder.addNetworkPreference(TEST_PREF, mPackages);

        networkPreferencesString = mBuilder.build().getNetworkPreferences().toString();
