...
public class PackageUpdateSetup implements ITargetPreparer {
    ...
    public void setUp(ITestDevice device, IBuildInfo buildInfo) throws TargetSetupError {
        ...
        if (packageUpdateBuildInfo.getPreInstallLoc() != null) {
            command.add("-l");
            command.add(packageUpdateBuildInfo.getPreInstallLoc());
        }
        ...
        try {
            ...
            if (exitValue != 0) {
                throw new TargetSetupError("PackageUpdate test (run_test.bash) was finished with non-zero status code. exitValue=" + exitValue,
