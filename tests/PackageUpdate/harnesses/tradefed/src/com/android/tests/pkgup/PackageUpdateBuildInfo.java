...
public class PackageUpdateBuildInfo extends BuildInfo {
    ...
    public String getPreInstallLoc() {
        return mPreInstallLoc;
    }

    public void setPreInstallLoc(String preInstallLoc) {
        mPreInstallLoc = preInstallLoc;
    }
