...
function flash() {
    ...
    for file in $(find . -maxdepth 1 -type f -name "*.img"); do
        local partition=$(basename "$file" .img)
        $FASTBOOT $flash_options flash "$partition" "$file" || \
