...
public class VcnManagerTest {
    ...
    public void testRegisterVcnStatusCallback() throws Exception {
        ...
        assertTrue(VcnManager.REGISTERED_STATUS_CALLBACKS.containsKey(mMockStatusCallback));
    ...
    public void testUnregisterVcnStatusCallback() throws Exception {
        ...
        assertFalse(VcnManager.REGISTERED_STATUS_CALLBACKS.containsKey(mMockStatusCallback));
