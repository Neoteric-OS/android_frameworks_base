...
public class VcnManagerTest {
    ...
    @Test
    public void testUnregisterVcnUnderlyingNetworkPolicyListener() throws Exception {
        mVcnManager.registerVcnUnderlyingNetworkPolicyListener(
                INLINE_EXECUTOR, mMockPolicyListener);

        mVcnManager.unregisterVcnUnderlyingNetworkPolicyListener(mMockPolicyListener);

        assertFalse(VcnManager.REGISTERED_POLICY_LISTENERS.containsKey(mMockPolicyListener));
        verify(mMockVcnManagementService)
                .registerVcnUnderlyingNetworkPolicyListener(
                        any(IVcnUnderlyingNetworkPolicyListener.class));
    }

    @Test
    public void testUnregisterVcnUnderlyingNetworkPolicyListenerUnknownListener() throws Exception {
        mVcnManager.unregisterVcnUnderlyingNetworkPolicyListener(mMockPolicyListener);
