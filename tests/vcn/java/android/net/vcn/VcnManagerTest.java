...
public class VcnManagerTest {
    ...
    public void testRegisterVcnStatusCallback() throws Exception {
        ...
        assertTrue(VcnManager.getAllStatusCallbacks().containsKey(mMockStatusCallback));
    ...
    public void testUnregisterVcnStatusCallback() throws Exception {
        ...
        assertFalse(VcnManager.getAllStatusCallbacks().containsKey(mMockStatusCallback));
