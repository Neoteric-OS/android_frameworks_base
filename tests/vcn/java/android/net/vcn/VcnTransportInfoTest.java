...
public class VcnTransportInfoTest {
    ...
    private void verifyParcelingForSysUi(VcnTransportInfo vcnTransportInfo) {
        // Set all other redactions; the only one we care about it NETWORK_SETTINGS.
        final VcnTransportInfo withSettingsNotRedacted =
                (VcnTransportInfo) vcnTransportInfo.makeCopy(0);
        final Parcel parcel = Parcel.obtain();
        withSettingsNotRedacted.writeToParcel(parcel, 0 /* flags */);
        parcel.setDataPosition(0);
