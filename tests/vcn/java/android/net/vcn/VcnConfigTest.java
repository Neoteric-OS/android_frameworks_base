...
public class VcnConfigTest {
    ...
    private static final List<VcnTunnelConfig> TUNNEL_CONFIGS =
            Arrays.asList(VcnTunnelConfigTest.buildTestTunnelConfig());
    ...
    public static VcnConfig buildTestConfig() {
        ...
        for (VcnTunnelConfig tunnelConfig : TUNNEL_CONFIGS) {
    ...
    public void testBuilderRequiresTunnelConfig() {
        try {
            ...
            fail("Expected exception due to no VcnTunnelConfigs provided");
        } catch (IllegalArgumentException e) {
        }
    }
