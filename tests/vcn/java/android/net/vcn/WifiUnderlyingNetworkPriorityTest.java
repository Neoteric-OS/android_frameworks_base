...
public class WifiUnderlyingNetworkPriorityTest {
    private static final String SSID = "TestWifi";
    private static final int INVALID_NETWORK_QUALITY = -1;

    private static WifiUnderlyingNetworkPriority getTestNetworkPriority() {
        return new WifiUnderlyingNetworkPriority.Builder()
    ...
    public void testBuilderAndGetters() {
        final WifiUnderlyingNetworkPriority networkPriority = getTestNetworkPriority();
    ...
    public void testBuilderAndGettersForDefaultValues() {
        final WifiUnderlyingNetworkPriority networkPriority =
                new WifiUnderlyingNetworkPriority.Builder().build();
    ...
    public void testBuildWithInvalidNetworkQuality() {
        try {
            new WifiUnderlyingNetworkPriority.Builder().setNetworkQuality(INVALID_NETWORK_QUALITY);
