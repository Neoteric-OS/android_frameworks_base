...
import android.net.vcn.persistablebundleutils.EncryptedTunnelParamsUtilsTest;
...
public class VcnGatewayConnectionConfigTest {
    ...
    public static final EncryptedTunnelParams ENCRYPTED_TUNNEL_PARAMS =
            EncryptedTunnelParamsUtilsTest.buildTestParams();
    ...
    public void testBuilderRequiresNonNullGatewayConnectionName() {
        try {
            new VcnGatewayConnectionConfig.Builder(
                            null /* gatewayConnectionName */, ENCRYPTED_TUNNEL_PARAMS)
                    .build();
