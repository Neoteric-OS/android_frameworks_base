...
public class VcnGatewayConnectionConfigTest {
    ...
    public static final int[] TUNNEL_CAPS =
            new int[] {
    ...
    public static final boolean IS_METERED = false; // Opposite from default
    public static final boolean IS_ROAMING = true; // Opposite from default
