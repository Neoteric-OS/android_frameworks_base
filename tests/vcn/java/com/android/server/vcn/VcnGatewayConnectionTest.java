...
public class VcnGatewayConnectionTest {
    ...
    public void testBuildNetworkCapabilities() throws Exception {
        ...
        for (int tunnelCap : VcnGatewayConnectionConfigTest.TUNNEL_CAPS) {
            assertTrue(caps.hasCapability(tunnelCap));
        }

        assertEquals(
                VcnGatewayConnectionConfigTest.IS_METERED,
                !caps.hasCapability(NET_CAPABILITY_NOT_METERED));
        assertEquals(
                VcnGatewayConnectionConfigTest.IS_ROAMING,
