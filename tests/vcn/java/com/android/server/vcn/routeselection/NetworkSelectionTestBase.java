...
public abstract class NetworkSelectionTestBase {
    ...
    public void setUp() {
        ...
        when(mFeatureFlags.networkMetricMonitor()).thenReturn(true);
        doReturn(mFeatureFlags).when(mVcnContext).getFeatureFlags();
        when(mCoreNetFeatureFlags.ipsecTransformState()).thenReturn(true);
