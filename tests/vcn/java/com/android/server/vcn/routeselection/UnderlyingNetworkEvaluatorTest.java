...
public class UnderlyingNetworkEvaluatorTest extends NetworkPrioritizationTestBase {
    ...
    public void setUp() {
        ...
        mNetworkEvaluator.setNetworkCapabilities(CELL_NETWORK_CAPABILITIES);
        mNetworkEvaluator.setLinkProperties(LINK_PROPERTIES);
        mNetworkEvaluator.setIsBlocked(false /* isBlocked */);
    }
