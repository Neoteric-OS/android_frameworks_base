...
import static android.net.vcn.VcnManager.VCN_NETWORK_SELECTION_PENALTY_TIMEOUT_MINUTE_LIST_KEY;
...
public class UnderlyingNetworkEvaluatorTest extends NetworkEvaluationTestBase {
    ...
    public void setUp() {
        ...
        when(mCarrierConfig.getIntArray(
                        eq(VCN_NETWORK_SELECTION_PENALTY_TIMEOUT_MINUTE_LIST_KEY), anyObject()))
    ...
    private void checkSetSelectedNetwork(boolean isSelected) {
        mNetworkEvaluator.setIsSelected(isSelected);
        verify(mIpSecPacketLossDetector).setIsSelected(isSelected);
    }
    ...
    public void testSetIpSecTransform_onSelectedNetwork() throws Exception {
        ...
        mNetworkEvaluator.setIsSelected(true);
        mNetworkEvaluator.setIpSecTransform(transform);

        verify(mIpSecPacketLossDetector).setIpSecTransform(transform);
    }

    @Test
    public void testSetIpSecTransform_onUnSelectedNetwork() throws Exception {
        mNetworkEvaluator.setIsSelected(false);
