...
public class VcnGatewayConnectionConnectedStateTest extends VcnGatewayConnectionTestBase {
    ...
    public void testMigration() throws Exception {
        ...
        final VcnChildSessionCallback childCallback = getChildSessionCallback();
        childCallback.setIkeConnectionInfo(newIkeConnectionInfo);
        childCallback.onIpSecTransformsMigrated(
                makeDummyIpSecTransform(), makeDummyIpSecTransform());
        mTestLooper.dispatchAll();
    ...
    private void triggerChildOpened(List<LinkAddress> internalAddresses, InetAddress dnsAddress) {
        ...
        getChildSessionCallback().setIkeConnectionInfo(mIkeConnectionInfo);
        getChildSessionCallback().onOpened(mMockChildSessionConfig, mIkeConnectionInfo);
    }
