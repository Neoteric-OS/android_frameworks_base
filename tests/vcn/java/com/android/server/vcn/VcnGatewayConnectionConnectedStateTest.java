...
public class VcnGatewayConnectionConnectedStateTest extends VcnGatewayConnectionTestBase {
    ...
    @Test
    public void testSetupCompleteRegistersNetwork() throws Exception {
        final ChildSessionConfiguration mMockChildSessionConfig =
                mock(ChildSessionConfiguration.class);
