...
public class VcnManagementServiceTest {
    ...
    private void triggerSubscriptionTrackerCallback(Set<ParcelUuid> activeSubscriptionGroups) {
        triggerSubscriptionTrackerCallback(activeSubscriptionGroups, Collections.EMPTY_MAP);
    }
    ...
    public void testGetUnderlyingNetworkPolicyTransportWifi() throws Exception {
        ...
        WifiInfo netCapWifiInfo = mock(WifiInfo.class);
        when(netCapWifiInfo.getSubscriptionId()).thenReturn(TEST_SUBSCRIPTION_ID);
        when(builderWifiInfo.makeCopy(anyBoolean())).thenReturn(netCapWifiInfo);
        NetworkCapabilities nc =
                new NetworkCapabilities.Builder()
