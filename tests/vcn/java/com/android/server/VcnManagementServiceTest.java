...
public class VcnManagementServiceTest {
    ...
    private TelephonySubscriptionSnapshot triggerSubscriptionTrackerCallback(
        ...
        return triggerSubscriptionTrackerCallback(activeSubscriptionGroups, Collections.emptyMap());
    }
    ...
    private void verifyMergedNetworkCapabilities(
        ...
        assertFalse(mergedCapabilities.hasCapability(NET_CAPABILITY_NOT_VCN_MANAGED));
    }
