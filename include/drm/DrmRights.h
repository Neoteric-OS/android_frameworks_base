 ...
 * 
 * Caller can instantiate DrmRights by invoking DrmRightsDrmRights(const DrmBuffer&, String)
 * constructor by using the result of DrmManagerClient::ProcessDrmInfo(const DrmInfo*) interface.
...
public:
     ...
     */
    DrmRights(const String8& rightsFilePath, 
     ...
     * @param[in] subscriptionId Subscription Id of the user
     */
    DrmRights(const DrmBuffer& rightsData, 
                    const String8& mimeType,
                    const String8& accountId = String8("_NO_USER"),
                    const String8& subscriptionId = String8(""));
