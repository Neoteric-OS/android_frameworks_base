...
RINGTONE_FILES := FreeFlight Ring_Classic_02 Ring_Digital_02 Ring_Synth_02 Ring_Synth_04
...
ifneq ($(MINIMAL_NEWWAVELABS),true)
	...
	NEWWAVELABS_RINGTONE_FILES := Big_Easy BirdLoop Bollywood BussaMove Cairo Calypso_Steel Champagne_Edition Club_Cubano CrayonRock \
		CurveBall DancinFool Ding DonMessWivIt Eastern_Sky Enter_the_Nexus EtherShake Funk_Yall Gimme_Mo_Town Glacial_Groove Growl \
		HalfwayHome LoopyLounge LoveFlute MidEvilJaunt MildlyAlarming Nairobi Nassau No_Limits OrganDub Paradise_Island Playa Road_Trip \
		Safari Seville Shes_All_That SilkyWay Steppin_Out Terminated Third_Eye TwirlAway World
