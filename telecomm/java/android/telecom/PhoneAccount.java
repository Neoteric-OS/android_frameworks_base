...
public final class PhoneAccount implements Parcelable {
    ...
    /**
     * Flag indicating that this {@link PhoneAccount} is capable of making an RTT connection.
     * When set, Telecom will attempt to open an RTT connection on outgoing calls that specify
     * that they should be placed with an RTT connection, and the in-call app will be displayed
     * with text entry fields for RTT. Likewise, the in-call app can request that an RTT
     * connection be opened during a call if this bit is set.
     * TODO: unhide
     * @hide
     */
