 ...
 * perform fast network queries or local database lookups to help determine if a call should be
 * screened or not; care should be taken to ensure the timeout is not repeatedly hit, causing
 * delays in the incoming call flow.
 * <p>
...
public abstract class CallScreeningService extends Service {
     ...
     * this time, the framework will unbind from the {@link CallScreeningService} and ignore it's
     * response.
     * <p>
