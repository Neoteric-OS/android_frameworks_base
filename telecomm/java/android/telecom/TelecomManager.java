...
public class TelecomManager {
    ...
    /**
     * Broadcast intent action indicating that the completion of an outgoing call or an incoming
     * call which was not blocked by the {@link CallScreeningService}, and which was NOT terminated
