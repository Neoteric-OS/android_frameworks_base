...
import static android.app.ActivityManager.INSTR_FLAG_DISABLE_TEST_API_ACCESS;
...
public class Instrument {
    ...
    public boolean disableTestApiAccess = false;
    ...
    public void run() throws Exception {
        ...
        try {
            ...
            if (disableTestApiAccess) {
                flags |= INSTR_FLAG_DISABLE_TEST_API_ACCESS;
            }
