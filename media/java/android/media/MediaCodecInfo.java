...
public final class MediaCodecInfo {
    ...
    public static final class CodecCapabilities {
        ...
        /**
         * <b>video decoder only</b>: codec supports switching to a null
         * output surface when in Surface mode.
         * <p> If true, the codec can be configured in Surface mode
         * without an actual surface.
         * @see MediaCodec#CONFIGURE_FLAG_NULL_SURFACE
         */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_NULL_OUTPUT_SURFACE)
        public static final String FEATURE_NullSurface = "null-surface";
        ...
        private static Feature[] getDecoderFeatures() {
            ...
            if (android.media.codec.Flags.nullOutputSurface()) {
                features.add(new Feature(FEATURE_NullSurface,      (1 << 9), true));
            }
