...
public final class MediaCodecInfo {
    ...
    public static final class CodecProfileLevel {
        ...
        public static final int APV422Profile10 =  0x01;

        /**
         * APV codec profile 422-12 as per IETF lim-apv-02, 10.1.3.1.2
         */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APV422Profile12 =  0x02;

        /**
         * APV codec profile 444-10 as per IETF lim-apv-02, 10.1.3.1.3
         */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APV444Profile10 =  0x04;

        /**
         * APV codec profile 444-12 as per IETF lim-apv-02, 10.1.3.1.4
         */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APV444Profile12 =  0x08;

        /**
         * APV codec profile 4444-10 as per IETF lim-apv-02, 10.1.3.1.5
         */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APV4444Profile10 = 0x10;

        /**
         * APV codec profile 4444-12 as per IETF lim-apv-02, 10.1.3.1.6
         */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APV4444Profile12 = 0x20;

        /**
         * APV codec profile 400-10 as per IETF lim-apv-02, 10.1.3.1.7
         */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APV400Profile10 =  0x40;

        /** APV Codec Level 1, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel1Band0 =  0x10;
        /** APV Codec Level 1, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel1Band1 =  0x11;
        /** APV Codec Level 1, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel1Band2 =  0x12;
        /** APV Codec Level 1, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel1Band3 =  0x13;
        /** APV Codec Level 1.1, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel11Band0 = 0x20;
        /** APV Codec Level 1.1, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel11Band1 = 0x21;
        /** APV Codec Level 1.1, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel11Band2 = 0x22;
        /** APV Codec Level 1.1, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel11Band3 = 0x23;
        /** APV Codec Level 2, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel2Band0 =  0x40;
        /** APV Codec Level 2, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel2Band1 =  0x41;
        /** APV Codec Level 2, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel2Band2 =  0x42;
        /** APV Codec Level 2, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel2Band3 =  0x43;
        /** APV Codec Level 2.1, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel21Band0 = 0x80;
        /** APV Codec Level 2.1, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel21Band1 = 0x81;
        /** APV Codec Level 2.1, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel21Band2 = 0x82;
        /** APV Codec Level 2.1, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel21Band3 = 0x83;
        /** APV Codec Level 3, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel3Band0 =  0x100;
        /** APV Codec Level 3, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel3Band1 =  0x101;
        /** APV Codec Level 3, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel3Band2 =  0x102;
        /** APV Codec Level 3, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel3Band3 =  0x103;
        /** APV Codec Level 3.1, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel31Band0 = 0x200;
        /** APV Codec Level 3.1, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel31Band1 = 0x201;
        /** APV Codec Level 3.1, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel31Band2 = 0x202;
        /** APV Codec Level 3.1, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel31Band3 = 0x203;
        /** APV Codec Level 4, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel4Band0 =  0x400;
        /** APV Codec Level 4, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel4Band1 =  0x401;
        /** APV Codec Level 4, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel4Band2 =  0x402;
        /** APV Codec Level 4, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel4Band3 =  0x403;
        /** APV Codec Level 4.1, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel41Band0 = 0x800;
        /** APV Codec Level 4.1, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel41Band1 = 0x801;
        /** APV Codec Level 4.1, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel41Band2 = 0x802;
        /** APV Codec Level 4.1, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel41Band3 = 0x803;
        /** APV Codec Level 5, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel5Band0 =  0x1000;
        /** APV Codec Level 5, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel5Band1 =  0x1001;
        /** APV Codec Level 5, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel5Band2 =  0x1002;
        /** APV Codec Level 5, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel5Band3 =  0x1003;
        /** APV Codec Level 5.1, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel51Band0 = 0x2000;
        /** APV Codec Level 5.1, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel51Band1 = 0x2001;
        /** APV Codec Level 5.1, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel51Band2 = 0x2002;
        /** APV Codec Level 5.1, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel51Band3 = 0x2003;
        /** APV Codec Level 6, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel6Band0 =  0x4000;
        /** APV Codec Level 6, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel6Band1 =  0x4001;
        /** APV Codec Level 6, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel6Band2 =  0x4002;
        /** APV Codec Level 6, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel6Band3 =  0x4003;
        /** APV Codec Level 6.1, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel61Band0 = 0x8000;
        /** APV Codec Level 6.1, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel61Band1 = 0x8001;
        /** APV Codec Level 6.1, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel61Band2 = 0x8002;
        /** APV Codec Level 6.1, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel61Band3 = 0x8003;
        /** APV Codec Level 7, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel7Band0 =  0x10000;
        /** APV Codec Level 7, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel7Band1 =  0x10001;
        /** APV Codec Level 7, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel7Band2 =  0x10002;
        /** APV Codec Level 7, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel7Band3 =  0x10003;
        /** APV Codec Level 7.1, Band 0 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel71Band0 = 0x20000;
        /** APV Codec Level 7.1, Band 1 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel71Band1 = 0x20001;
        /** APV Codec Level 7.1, Band 2 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel71Band2 = 0x20002;
        /** APV Codec Level 7.1, Band 3 as per IETF lim-apv-02, 10.1.4 */
        @SuppressLint("AllUpper")
        @FlaggedApi(FLAG_APV_SUPPORT)
        public static final int APVLevel71Band3 = 0x20003;
