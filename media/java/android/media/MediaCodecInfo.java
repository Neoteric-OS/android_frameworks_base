    ...
    public static final class AudioCapabilities {
        ...
        private void applyLevelLimits() {
            ...
            if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_MPEG)) {
                ...
                maxChannels = 8;
            } else if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_DTS_HD_PROFILE_MA)) {
                sampleRates = new int[] { 44100, 48000, 88200, 96000, 176400, 192000 };
                bitRates = Range.create(96000, 24500000);
                maxChannels = 8;
            } else if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_DTS_HD_PROFILE_LBR)) {
                ...
                bitRates = Range.create(96000, 24500000);
                maxChannels = 32;
            } else if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_AUDIO_DTS_UHD_PROFILE_P2)) {
                sampleRates = new int[] { 48000 };
