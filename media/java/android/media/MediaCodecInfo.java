...
public final class MediaCodecInfo {
    ...
    public static final class AudioCapabilities {
        ...
        /* package private */ static final class AudioCapsJavaImpl {
            ...
            public int[] getSupportedSampleRates() {
                return mSampleRates != null
                        ? Arrays.copyOf(mSampleRates, mSampleRates.length) : null;
            }
            ...
            public AudioCapsJavaImpl(MediaFormat info, CodecCapabilities parent) {
                mParent = parent;
        ...
        /* package private */ static final class AudioCapsNativeImpl {
            private long mNativeContext; // accessed by native methods
             ...
             * Constructor used by JNI.
             *
             * The Java AudioCapsNativeImpl object keeps these subobjects to avoid recontruction.
             */
        ...
        private AudioCapsJavaImpl mJavaImpl;
        private AudioCapsNativeImpl mNativeImpl;

        /**
         * Returns the range of supported bitrates in bits/second.
         */
        public Range<Integer> getBitrateRange() {
            return mIsNative ? mNativeImpl.getBitrateRange() : mJavaImpl.getBitrateRange();
        }
         ...
         */
        public int[] getSupportedSampleRates() {
            return mIsNative ? mNativeImpl.getSupportedSampleRates()
                            : mJavaImpl.getSupportedSampleRates();
        }
         ...
         */
        public Range<Integer>[] getSupportedSampleRateRanges() {
            return mIsNative ? mNativeImpl.getSupportedSampleRateRanges()
                            : mJavaImpl.getSupportedSampleRateRanges();
        }
        ...
        public int getMaxInputChannelCount() {
            return mIsNative ? mNativeImpl.getMaxInputChannelCount()
                            : mJavaImpl.getMaxInputChannelCount();
        }
        ...
        @IntRange(from = 1, to = 255)
        public int getMinInputChannelCount() {
            return mIsNative ? mNativeImpl.getMinInputChannelCount()
                            : mJavaImpl.getMinInputChannelCount();
        }
        ...
        @NonNull
        public Range<Integer>[] getInputChannelCountRanges() {
            return mIsNative ? mNativeImpl.getInputChannelCountRanges()
                            : mJavaImpl.getInputChannelCountRanges();
        }
         ...
         * Constructor used by JNI.
         */
        /* package private */ AudioCapabilities(AudioCapsNativeImpl audioCapsNativeImpl) {
            mNativeImpl = audioCapsNativeImpl;
            mIsNative = true;
        }

        // Only used by CodecCapabilities Java implementation.
        /** @hide */
        public static AudioCapabilities create(
            ...
            caps.initJavaImpl(info, parent);
            return caps;
        }

        private void initJavaImpl(MediaFormat info, CodecCapabilities parent) {
            mJavaImpl = new AudioCapsJavaImpl(info, parent);
            mIsNative = false;
        }
         ...
         */
        public boolean isSampleRateSupported(int sampleRate) {
            return mIsNative ? mNativeImpl.isSampleRateSupported(sampleRate)
                            : mJavaImpl.isSampleRateSupported(sampleRate);
        }

        /** @hide */
        public void getDefaultFormat(MediaFormat format) {
            mJavaImpl.getDefaultFormat(format);
        }

        /* package private */
        // must not contain KEY_PROFILE
        // Only used by CodecCapabilities Java Implementation
        static final Set<String> AUDIO_LEVEL_CRITICAL_FORMAT_KEYS
                = AudioCapsJavaImpl.AUDIO_LEVEL_CRITICAL_FORMAT_KEYS;

        /** @hide */
        // Only called by CodecCapabilities Java Implementation
        public boolean supportsFormat(MediaFormat format) {
            return mJavaImpl.supportsFormat(format);
        }
    }
    ...
    public static final class VideoCapabilities {
        ...
        public static final class PerformancePoint {
            ...
            static native String native_toString();
            ...
            static native boolean native_covers(PerformancePoint other);
            ...
            static native boolean native_equals(PerformancePoint other);
