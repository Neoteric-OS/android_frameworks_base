...
oneway interface ITvInputClient {
    ...
    void onAudioPresentationsChanged(in List<TvAudioPresentation> presentations, int seq);
    void onAudioPresentationSelected(in TvAudioPresentation presentation, int seq);
