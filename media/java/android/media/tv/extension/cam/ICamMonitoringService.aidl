...
interface ICamMonitoringService {
     ...
     *         KEY_CAM_PROFILE_NAME - CAM profile name of the specified slot if it supports OP.
     */
     ...
     * KEY_IS_CAM_INSERTED: The physical insertion state. 1 for inserted, 0 for not inserted.
     */
