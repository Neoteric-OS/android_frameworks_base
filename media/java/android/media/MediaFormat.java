 ...
 * <tr><td>{@link #KEY_QP_OFFSET_MAP}</td><td>String</td><td><b>encoder only</b>,
 *         optional</td></tr>
 * <tr><td>{@link #KEY_QP_OFFSET_RECTS}</td><td>String</td><td><b>encoder only</b>,
 *         optional</td></tr>
 * </table>
...
public final class MediaFormat {
    ...
    */
     ...
     * the configuration silently or return error.
     * <p>
     * The scope of this key is throughout the encoding session until it is reconfigured during
     * running state.
     * <p>
     * This key is ignored if the encoder is operating in surface input mode.
     */
    @FlaggedApi(FLAG_REGION_OF_INTEREST)
    public static final String KEY_QP_OFFSET_MAP = "qp-offset-map";
     ...
     */
    @FlaggedApi(FLAG_REGION_OF_INTEREST)
    public static final String KEY_QP_OFFSET_RECTS = "qp-offset-rects";
     ...
     * the LCUs belonging to the to the box.
     */
    @FlaggedApi(FLAG_REGION_OF_INTEREST)
    public static final class QpOffsetRect {
         ...
         * Helper function to insert key {@link #KEY_QP_OFFSET_RECTS} in MediaFormat
         */
        @NonNull
