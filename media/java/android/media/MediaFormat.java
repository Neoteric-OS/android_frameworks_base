...
public final class MediaFormat {
    ...
    */
    ...
    public static final class QpOffsetRect {
        private final Rect mContour;
        private final int mQpOffset;
        ...
        public String flattenToString() {
            return String.format(Locale.getDefault(), "%d,%d-%d,%d=%d;", mContour.top,
                        mContour.left, mContour.bottom, mContour.right, mQpOffset);
        }
