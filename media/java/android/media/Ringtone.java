                ...
                if (followSettingsUri) {
                    ...
                    switch (ringtoneType) {
                        case RingtoneManager.TYPE_NOTIFICATION:
                            title = context.getString(com.android.internal.R.string.notification_sound_default_with_actual, actualTitle);
                            break;

                        case RingtoneManager.TYPE_ALARM:
                            title = context.getString(com.android.internal.R.string.alarm_sound_default_with_actual, actualTitle);
                            break;
