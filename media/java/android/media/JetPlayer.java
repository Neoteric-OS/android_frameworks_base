 ...
 * <a href="https://developer.android.com/guide/topics/media/jet/jetcreator_manual">JET Creator
 * User Manual</a> for a presentation of the JET interactive music concept and how to use the
 * JetCreator tool to create content to be player by JetPlayer.
 *
 ...
 *    a mask (to change the mute state of multiple tracks at once).
 ...
 *    right time, as authored in the corresponding JET file.
 * </ul>
 *
