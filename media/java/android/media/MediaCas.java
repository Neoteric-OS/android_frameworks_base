...
public final class MediaCas implements AutoCloseable {
    ...
    private android.hardware.cas.V1_0.ICas mICasV10 = null;
    private android.hardware.cas.V1_1.ICas mICasV11 = null;
    private android.hardware.cas.V1_2.ICas mICasV12 = null;
    ...
    @IntDef(prefix = "SCRAMBLING_MODE_",
            ...
            SCRAMBLING_MODE_MULTI2, SCRAMBLING_MODE_AES128, SCRAMBLING_MODE_AES_CBC,
            SCRAMBLING_MODE_AES_ECB, SCRAMBLING_MODE_AES_SCTE52, SCRAMBLING_MODE_TDES_ECB,
    ...
    public static final int SCRAMBLING_MODE_DVB_CSA1 =
            android.hardware.cas.ScramblingMode.DVB_CSA1;
    /**
     * DVB CSA 2.
     */
    public static final int SCRAMBLING_MODE_DVB_CSA2 =
            android.hardware.cas.ScramblingMode.DVB_CSA2;
    /**
    ...
    public static final int SCRAMBLING_MODE_TDES_ECB =
            android.hardware.cas.ScramblingMode.TDES_ECB;
    /**
    ...
    public static final int SESSION_USAGE_PLAYBACK =
            android.hardware.cas.SessionIntent.PLAYBACK;
    /**
    ...
    public static final int SESSION_USAGE_TIMESHIFT =
            android.hardware.cas.SessionIntent.TIMESHIFT;
            ...
            try {
                if (mICas != null) {
                    ...
                    MediaCasException.throwExceptionIfNeeded(
                            mICasV10.setSessionPrivateData(
            ...
            try {
                if (mICas != null) {
                    ...
                    MediaCasStateException.throwExceptionIfNeeded(
                            mICasV10.closeSession(toByteArray(mSessionId)));
                }
                mIsClosed = true;
            ...
            if (service != null) {
                ...
                if (serviceV12 == null) {
                    ...
                    Log.d(TAG, "Used cas@1_0 interface to create plugin");
                        mICasV10 = serviceV10.createPlugin(casSystemId, mBinderHidl);
                    } else {
                    Log.d(TAG, "Used cas@1.1 interface to create plugin");
                        mICasV10 = mICasV11 = serviceV11.createPluginExt(casSystemId, mBinderHidl);
                    }
                } else {
    ...
    public void setPrivateData(@NonNull byte[] data) throws MediaCasException {
        ...
        try {
            if (mICas != null) {
                ...
                MediaCasException.throwExceptionIfNeeded(
                        mICasV10.setPrivateData(toByteArray(data, 0, data.length)));
            }
        } catch (RemoteException e) {
            cleanupAndRethrowIllegalState();
        }
    ...
    public void processEmm(@NonNull byte[] data, int offset, int length)
        ...
        try {
            if (mICas != null) {
                ...
                MediaCasException.throwExceptionIfNeeded(
                        mICasV10.processEmm(toByteArray(data, offset, length)));
            }
        } catch (RemoteException e) {
            cleanupAndRethrowIllegalState();
        }
    ...
    public void sendEvent(int event, int arg, @Nullable byte[] data)
        ...
        try {
            if (mICas != null) {
                ...
                MediaCasException.throwExceptionIfNeeded(
                        mICasV10.sendEvent(event, arg, toByteArray(data)));
            }
        } catch (RemoteException e) {
            cleanupAndRethrowIllegalState();
        }
   ...
   /**
    ...
    public void provision(@NonNull String provisionString) throws MediaCasException {
        ...
        try {
            if (mICas != null) {
                ...
                MediaCasException.throwExceptionIfNeeded(mICasV10.provision(provisionString));
            }
        } catch (RemoteException e) {
            cleanupAndRethrowIllegalState();
        }
    ...
    public void refreshEntitlements(int refreshType, @Nullable byte[] refreshData)
        ...
        try {
            if (mICas != null) {
                ...
                MediaCasException.throwExceptionIfNeeded(
                        mICasV10.refreshEntitlements(refreshType, toByteArray(refreshData)));
            }
        } catch (RemoteException e) {
            cleanupAndRethrowIllegalState();
        }
    ...
    public void close() {
        ...
        } else if (mICasV10 != null) {
            try {
                mICasV10.release();
            } catch (RemoteException e) {
            } finally {
                mICasV10 = mICasV11 = mICasV12 = null;
            }
        }
