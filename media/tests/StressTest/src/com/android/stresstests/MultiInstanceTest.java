...
public class MultiInstanceTest {
    ...
    public static class EncoderTest {
        ...
        public void testCodecMultiInstance()
            ...
            byte[] inputData;
            byte[] audioInputData =
                    setUpSource(CodecTestBase.mInpPrefix + CodecEncoderTestBase.mInputAudioFile);
            byte[] videoInputData =
                    setUpSource(CodecTestBase.mInpPrefix + CodecEncoderTestBase.mInputVideoFile);
            ...
            for (int numInstances = 0; numInstances < cores; ) {
                if (numInstances == 0) {
                    ...
                    cet.setUpParams(0);
                    if (cet.mIsAudio) inputData = audioInputData;
                    else inputData = videoInputData;
