...
class VisualizerInstanceSync implements VisualizerInstance {
    ...
    final Visualizer mVisualizer;
    final VisualizerTestHandler mVisualizerTestHandler;
    final VisualizerListener mVisualizerListener;
    ...
    static int[] dataToMinMaxCenter(byte[] data, int len) {
