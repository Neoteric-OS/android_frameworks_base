...
static jobject android_media_MediaCodec_querySupportedVendorParameters(
        JNIEnv *env, jobject thiz) {
    sp<JMediaCodec> codec = getMediaCodec(env, thiz);
...
static jobject android_media_MediaCodec_describeParameter(
...
static const JNINativeMethod gMethods[] = {
    ...
    { "native_querySupportedVendorParameters", "()Ljava/util/List;",
      (void *)android_media_MediaCodec_querySupportedVendorParameters },

    { "native_describeParameter",
      "(Ljava/lang/String;)Landroid/media/MediaCodec$ParameterDescriptor;",
      (void *)android_media_MediaCodec_describeParameter },
