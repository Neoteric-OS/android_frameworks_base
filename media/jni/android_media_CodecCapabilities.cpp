...
static jobject getJavaAudioCapabilitiesFromNative(
    ...
    jclass audioCapsNativeImplClazz
            = env->FindClass("android/media/MediaCodecInfo$AudioCapsNativeImpl");
    CHECK(audioCapsNativeImplClazz != NULL);
    jmethodID audioCapsNativeImplConstructID = env->GetMethodID(audioCapsNativeImplClazz, "<init>",
            "(Landroid/util/Range;"
            "[I"
            "[Landroid/util/Range;"
            "[Landroid/util/Range;)V");
    jobject jAudioCapsNativeImpl = env->NewObject(audioCapsNativeImplClazz, audioCapsNativeImplConstructID,
    ...
    jmethodID audioCapsConstructID = env->GetMethodID(audioCapsClazz, "<init>",
            "Landroid/media/MediaCodecInfo$AudioCapsIntf;");
...
static jobject getJavaVideoCapabilitiesFromNative(JNIEnv *env,
...
static jobject getJavaEncoderCapabilitiesFromNative(JNIEnv *env,
