...
void OMXCodec::onCmdComplete(OMX_COMMANDTYPE cmd, OMX_U32 data) {
    switch (cmd) {
        ...
        {
            if(mState == ERROR) {
                CODEC_LOGI("Ignoring OMX_CommandPortDisable in ERROR state");
                break;
            }
        ...
        case OMX_CommandPortEnable:
        {
            ...
            if(mState == ERROR) {
                CODEC_LOGI("Ignoring OMX_CommandPortEnable in ERROR state");
                break;
            }
            CHECK(mState == EXECUTING || mState == RECONFIGURING);
        ...
        case OMX_CommandFlush:
        {
            ...
            if(mState == ERROR) {
                CODEC_LOGI("Ignoring OMX_CommandFlush in ERROR state");
                break;
            }
            if (mState == RECONFIGURING) {
                CHECK_EQ(portIndex, kPortIndexOutput);
