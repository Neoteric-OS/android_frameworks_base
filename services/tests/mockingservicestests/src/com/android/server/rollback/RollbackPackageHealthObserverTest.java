...
public class RollbackPackageHealthObserverTest {
     ...
     */
    @Test
    public void execute_impactLevelLow_rollback() {
        mSetFlagsRule.enableFlags(Flags.FLAG_RECOVERABILITY_DETECTION);
        int rollbackId = 1;
        VersionedPackage appAFrom = new VersionedPackage(APP_A, VERSION_CODE_2);
        VersionedPackage appATo = new VersionedPackage(APP_A, VERSION_CODE);
        ...
        observer.execute(secondFailedPackage, 1, 1);
        verify(mRollbackManager).commitRollback(argument.capture(), any(), any());

        assertThat(argument.getValue()).isEqualTo(rollbackId);
    }
    ...
    public void execute_impactLevelLow_rollbackAll() {
        ...
        observer.execute(failedPackage, 1, 1);
    ...
    /**
     * Dont Rollback high impact package if only high impact package is available. high impact
    ...
    /**
     * If only high impact rollback is present and the recoverability detection flag is disabled
     * then return user impact 0 to indicate no actions available from RollbackPackageHealthObserver
     */
    @Test
    public void healthCheckFailed_impactLevelHighRecoverabilityDetectionFlagDisabled_UserImpact0() {
        VersionedPackage appAFrom = new VersionedPackage(APP_A, VERSION_CODE_2);
        VersionedPackage appATo = new VersionedPackage(APP_A, VERSION_CODE);
        PackageRollbackInfo packageRollbackInfo = new PackageRollbackInfo(appAFrom, appATo,
                null, null, false, false,
    ...
    /**
     * Don't roll back high impact package if recoverability detection flag is disabled.
     */
    @Test
    public void execute_impactLevelHighFlagRecoverabilityDetectionDisabled_rollbackHigh() {
        int rollbackId2 = 2;
        VersionedPackage appBFrom = new VersionedPackage(APP_B, VERSION_CODE_2);
        VersionedPackage appBTo = new VersionedPackage(APP_B, VERSION_CODE);
        PackageRollbackInfo packageRollbackInfoB = new PackageRollbackInfo(appBFrom, appBTo,
     ...
     */
    @Test
    public void onBootLoop_impactLevelLow_onePackage() {
        mSetFlagsRule.enableFlags(Flags.FLAG_RECOVERABILITY_DETECTION);
        VersionedPackage appAFrom = new VersionedPackage(APP_A, VERSION_CODE_2);
        VersionedPackage appATo = new VersionedPackage(APP_A, VERSION_CODE);
        PackageRollbackInfo packageRollbackInfo = new PackageRollbackInfo(appAFrom, appATo,
