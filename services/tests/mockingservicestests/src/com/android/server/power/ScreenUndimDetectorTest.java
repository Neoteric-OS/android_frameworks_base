...
import static com.android.server.power.ScreenUndimDetector.KEY_PREVENT_SCREEN_TIMEOUT_ENABLED;
...
public class ScreenUndimDetectorTest {
    ...
    public void setup() {
        ...
        DeviceConfig.setProperty(NAMESPACE_ATTENTION_MANAGER_SERVICE,
                KEY_PREVENT_SCREEN_TIMEOUT_ENABLED, Boolean.TRUE.toString(), false /*makeDefault*/);
        DeviceConfig.setProperty(NAMESPACE_ATTENTION_MANAGER_SERVICE,
                KEY_UNDIMS_REQUIRED,
    ...
    public void recordScreenPolicy_disabledByFlag_noop() {
        setup();
        DeviceConfig.setProperty(NAMESPACE_ATTENTION_MANAGER_SERVICE,
                KEY_PREVENT_SCREEN_TIMEOUT_ENABLED, Boolean.FALSE.toString(), false /*makeDefault*/);
