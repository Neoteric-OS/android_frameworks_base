...
public class RebootEscrowManagerTests {
    ...
    @Test
    public void loadRebootEscrowDataIfAvailable_ServerBased_RuntimeExceptionFailure()
            throws Exception {
        setServerBasedRebootEscrowProvider();
        ...
        // Throw a runtime exception. We expect unwrap to fail gracefully.
        when(mServiceConnection.unwrap(any(), anyLong())).thenThrow(new IllegalStateException());
