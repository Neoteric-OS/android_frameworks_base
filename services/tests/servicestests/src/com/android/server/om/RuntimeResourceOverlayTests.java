...
public class RuntimeResourceOverlayTests extends AndroidTestCase {
    ...
    public void setUp() throws Exception {
        ...
        Utils.orderOverlays(mContext, APP_OVERLAY_1, APP_OVERLAY_2, UserHandle.myUserId());
        Utils.orderOverlays(mContext, APP_OVERLAY_2, APP_OVERLAY_3, UserHandle.myUserId());
        Utils.orderOverlays(mContext, APP_OVERLAY_3, APP_OVERLAY_4, UserHandle.myUserId());
        Utils.orderOverlays(mContext, SYSTEM_OVERLAY_1, SYSTEM_OVERLAY_2, UserHandle.myUserId());
    ...
    private static class Utils {
        ...
        public static void orderOverlays(Context ctx, String lessImportantPackageName,
            ...
            filter.addDataScheme("package");
            filter.addDataSchemeSpecificPart(moreImportantPackageName, PatternMatcher.PATTERN_LITERAL);
            ctx.registerReceiver(observer, filter);
