...
public class PackageTrackerTest {
    private static final java.lang.String UPDATE_APP_PACKAGE_NAME = "updateAppPackageName";
    private static final java.lang.String DATA_APP_PACKAGE_NAME = "dataAppPackageName";
    ...
    public void trackingDisabled_triggerUpdateIfNeededNotAllowed() {
        ...
        try {
            // This call should also not be allowed and will throw an exception if tracking is disabled.
    ...
    // Commented because of isAppPrivileged() bug.
//    @Test
...
//    }
    ...
    @Test
    public void trackingEnabled_packageUpdate_badUpdateAppManifestEntry()
            throws Exception {
        // Set up device configuration.
        configureTrackingEnabled();
        configureReliabilityConfigSettingsOk();
        ...
        configureUpdateAppPackageVersion(UPDATE_APP_PACKAGE_NAME, packageVersions.mUpdateAppVersion);
    ...
    public void trackingEnabled_reliabilityTrigger_failureCountIsReset() throws Exception {
        ...
        // Fail (retries - 1) times, succeed on the last allowed attempt.
    ...
    private static class FakeIntentHelper implements IntentHelper {
        ...
        public void assertInitialized(String expectedUpdateAppPackageName, String expectedDataAppPackageName) {
