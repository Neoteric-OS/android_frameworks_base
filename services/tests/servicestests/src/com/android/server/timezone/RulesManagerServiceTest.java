...
public class RulesManagerServiceTest {
    ...
    @Test(expected = SecurityException.class)
    public void checkComplete_noCallerPermission() throws Exception {
        configureCallerDoesNotHavePermission();
    ...
    public void requestInstall_asyncSuccess() throws Exception {
        ...
        callback.assertResultReceived(RulesManager.SUCCESS);
    }
    ...
    public void requestInstall_asyncInstallFail() throws Exception {
        ...
        // Check the callback was received.
        callback.assertResultReceived(RulesManager.ERROR_INSTALL_VALIDATION_ERROR);
    }
    ...
    public void requestInstall_asyncParcelFileDescriptorReadFail() throws Exception {
        ...
        // Check the callback was received.
        callback.assertResultReceived(RulesManager.ERROR_UNKNOWN_FAILURE);
    }
    ...
    @Test
    public void checkComplete_operationInProgressOk() throws Exception {
        configureCallerHasPermission();
    ...
    @Test
    public void checkComplete_badToken() throws Exception {
        configureCallerHasPermission();
    ...
    @Test
    public void checkComplete_nullTokenBytes() throws Exception {
        configureCallerHasPermission();
