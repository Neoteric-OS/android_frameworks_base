...
public class OverrideValidatorImplTest {
    ...
    public void getOverrideAllowedState_debugBuildAnyChangeDebugApp_allowOverride()
            throws Exception {
        OverrideValidatorImpl overrideValidator = new OverrideValidatorImpl(
                debuggableBuild(),
                mContext,
        ...
        assertThat(stateTargetSdkLessChange.state).isEqualTo(ALLOWED);
        assertThat(stateTargetSdkEqualChange.state).isEqualTo(ALLOWED);
        assertThat(stateTargetSdkAfterChange.state).isEqualTo(ALLOWED);
        assertThat(stateEnabledChange.state).isEqualTo(ALLOWED);
        assertThat(stateDisabledChange.state).isEqualTo(ALLOWED);
    }
    ...
    public void getOverrideAllowedState_betaBuildEnabledChangeDebugApp_rejectOverride()
        ...
        assertThat(allowedState.state).isEqualTo(DISABLED_NON_TARGET_SDK);
    }
    ...
    public void getOverrideAllowedState_betaBuildAnyChangeReleaseApp_rejectOverride()
        ...
        assertThat(stateTargetSdkLessChange.state).isEqualTo(DISABLED_NOT_DEBUGGABLE);
        assertThat(stateTargetSdkEqualChange.state).isEqualTo(DISABLED_NOT_DEBUGGABLE);
        assertThat(stateTargetSdkAfterChange.state).isEqualTo(DISABLED_NOT_DEBUGGABLE);
        assertThat(stateEnabledChange.state).isEqualTo(DISABLED_NOT_DEBUGGABLE);
        assertThat(stateDisabledChange.state).isEqualTo(DISABLED_NOT_DEBUGGABLE);
    }
    ...
    public void getOverrideAllowedState_finalBuildTargetSdkChangeDebugAppOptin_allowOverride()
        ...
        assertThat(allowedState.state).isEqualTo(ALLOWED);
    }
    ...
    public void getOverrideAllowedState_finalBuildTargetSdkChangeDebugAppOptout_rejectOverride()
        ...
        assertThat(stateTargetSdkLessChange.state).isEqualTo(DISABLED_TARGET_SDK_TOO_HIGH);
        assertThat(stateTargetSdkEqualChange.state).isEqualTo(DISABLED_TARGET_SDK_TOO_HIGH);
    }
