...
class InputManagerServiceTests {
    ...
    @Test
    fun addUniqueIdAssociationByDescriptor_verifyAssociationAdded_amongus() {
        // Overall goal is to have 2 displays and verify that events from the InputDevice are sent
        // specifically to the associated display, not the other.
        ...
        // Another option: look up input reader
    }
}
