...
public class AudioServiceTest {
    ...
    public void setProductStrategiesZoneIdForUserId() {
        int userId = 11;
    ...
    @Test
    @EnableFlags(android.media.audiopolicy.Flags.FLAG_MULTI_ZONE_AUDIO)
    public void setProductStrategiesZoneIdForUserId_withAudioSystemFailure() {
        int userId = 11;
        int zoneId = DEFAULT_ZONE_ID + 1;
        ...
        Assert.assertEquals("User should not be mapped for zone " + zoneId,
                UserHandle.USER_CURRENT, mAudioService.getUserIdForZoneId(zoneId));
    }

    @Test
    @EnableFlags(android.media.audiopolicy.Flags.FLAG_MULTI_ZONE_AUDIO)
    public void getUserIdForZoneId_withoutMapping() {
        int zoneId = DEFAULT_ZONE_ID + 1;
    ...
    @Test
    @EnableFlags(android.media.audiopolicy.Flags.FLAG_MULTI_ZONE_AUDIO)
    public void getUserIdForZoneId_afterUserToZoneReset() {
        int userId = 11;
        int zoneId = DEFAULT_ZONE_ID + 1;
    ...
    @Test
    @EnableFlags(android.media.audiopolicy.Flags.FLAG_MULTI_ZONE_AUDIO)
    public void resetProductStrategiesZoneIdForUserId() {
        int userId = 11;
        int zoneId = DEFAULT_ZONE_ID + 1;
        mAudioService.setProductStrategiesZoneIdForUserId(userId, zoneId);
    ...
    @Test
    @EnableFlags(android.media.audiopolicy.Flags.FLAG_MULTI_ZONE_AUDIO)
    public void resetProductStrategiesZoneIdForUserId_forUnsetUser() {
        int userId = 11;
