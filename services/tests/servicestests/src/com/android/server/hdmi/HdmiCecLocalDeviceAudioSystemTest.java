...
public class HdmiCecLocalDeviceAudioSystemTest {
    ...
    public void handleRequestShortAudioDescriptor_noAudioDeviceInfo() throws Exception {
        ...
        byte[] expectedSadArray = new byte[] {0x53, 0x62, 0x01};

        HdmiCecMessage expectedMessage =
                HdmiCecMessageBuilder.buildReportShortAudioDescriptor(
                        ADDR_AUDIO_SYSTEM, ADDR_TV, expectedSadArray);

        mHdmiCecLocalDeviceAudioSystem.checkSupportAndSetSystemAudioMode(true);

        // Make sure the config file is not found.
        Field configPath =
                HdmiCecLocalDeviceAudioSystem.class.getDeclaredField(
