...
public class RecoverySystemServiceTest {
    ...
    public void rebootWithLskf_armEscrowDataFatalError_Failure() throws Exception {
        ...
        assertFalse(mRecoverySystemService.rebootWithLskf(FAKE_OTA_PACKAGE_NAME, "ab-update",
                true));
        ...
        verify(mMetricsReporter).reportRebootEscrowRebootMetrics(eq(8 /* provider mismatch */),
