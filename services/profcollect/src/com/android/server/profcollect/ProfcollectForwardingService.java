        ...
        new Thread(() -> {
            try {
                ...
                if (uploadReport) {
                    Intent uploadIntent =
                            new Intent(
                                "com.google.android.apps.betterbug.intent.action.UPLOAD_PROFILE")
                    ...
                    if (context.getPackageManager().queryBroadcastReceivers(uploadIntent, 0)
                            != null) {
