...
public final class ProfcollectForwardingService extends SystemService {
    ...
    private static int sUsageSetting;
    private static boolean sUploadEnabled;
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (INTENT_UPLOAD_PROFILES.equals(intent.getAction())) {
                ...
                packAndUploadReport(sSelfService);
            }
        }
    };
    ...
    public ProfcollectForwardingService(Context context) {
        ...
        try {
            ...
            // disabled.
            sUsageSetting = Settings.Global.getInt(context.getContentResolver(), "multi_cb");
    ...
    private static void packAndUploadReport(ProfcollectForwardingService pfs) {
        String reportName;
        try {
            reportName = pfs.mIProfcollect.report(pfs.sUsageSetting) + ".zip";
        } catch (RemoteException e) {
            Log.e(LOG_TAG, "Failed to create report: " + e.getMessage());
            return;
        }
        if (!pfs.sUploadEnabled) {
