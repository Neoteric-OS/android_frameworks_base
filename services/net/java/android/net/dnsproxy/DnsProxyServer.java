 ...
 *
 * <p>The server uses a single thread for handling TCP/UDP events and DNS responses which are
...
public class DnsProxyServer {
    ...
    private byte[] addPacketLength(@NonNull byte[] buf) throws IOException {
