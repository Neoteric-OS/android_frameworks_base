 ...
 * @hide
 */
public class NetworkStackClientBase {
    private static final String TAG = NetworkStackClientBase.class.getSimpleName();
    ...
    protected interface NetworkStackCallback {
        void onNetworkStackConnected(INetworkStackConnector connector);
    }

    public NetworkStackClientBase(@NonNull Dependencies dependencies, SharedLog log) {
    ...
    protected static Dependencies makeDependencies() {
    ...
    protected void requestConnector(@NonNull NetworkStackCallback request) {
