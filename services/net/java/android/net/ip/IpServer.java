...
public class IpServer extends StateMachine {
    ...
    public static class Callback {
         ...
         *
         * @param who this instance of IpServer (TODO: obviate this)
         * @param state one of Callback.STATE_*
    ...
    public IpServer(
        ...
        mServingMode = Callback.STATE_AVAILABLE;
    ...
    class InitialState extends State {
        @Override
        public void enter() {
            sendInterfaceState(Callback.STATE_AVAILABLE);
        }
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case CMD_TETHER_REQUESTED:
                    mLastError = ConnectivityManager.TETHER_ERROR_NO_ERROR;
                    switch (message.arg1) {
                        case Callback.STATE_LOCAL_ONLY:
                            transitionTo(mLocalHotspotState);
                            break;
                        case Callback.STATE_TETHERED:
    ...
    class LocalHotspotState extends BaseServingState {
        ...
        public void enter() {
            ...
            sendInterfaceState(Callback.STATE_LOCAL_ONLY);
        }
    ...
    class TetheredState extends BaseServingState {
        ...
        public void enter() {
            ...
            sendInterfaceState(Callback.STATE_TETHERED);
        }
    ...
    class UnavailableState extends State {
        ...
        public void enter() {
            mLastError = ConnectivityManager.TETHER_ERROR_NO_ERROR;
            sendInterfaceState(Callback.STATE_UNAVAILABLE);
        }
    }
