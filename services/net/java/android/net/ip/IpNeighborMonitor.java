...
public class IpNeighborMonitor extends PacketReader {
    ...
    public static class NeighborEventConsumer {
    ...
    public IpNeighborMonitor(Handler h, SharedLog log, NeighborEventConsumer cb) {
        ...
        mConsumer = (cb != null) ? cb : new NeighborEventConsumer();
    }
    ...
    private void evaluateRtNetlinkNeighborMessage(
        ...
        if (!mConsumer.watchingInterfaceIndex(ifindex)) return;

        final InetAddress destination = neighMsg.getDestination();
        if (!mConsumer.watchingInetAddress(destination)) return;
        ...
        mConsumer.handleNeighborEvent(event);
    }
}
