...
public class SharedLog {
    ...
    public void error(Exception e) {
        recordAndEmit(Category.ERROR, e.toString());
    }

    public void error(String msg) {
        recordAndEmit(Category.ERROR, msg);
    }

    public void event(String msg) {
        record(Category.EVENT, msg);
    }
    ...
    public void logAndEmit(String msg) {
        recordAndEmit(Category.NONE, msg);
    }
    ...
    private void record(Category category, String msg) {
