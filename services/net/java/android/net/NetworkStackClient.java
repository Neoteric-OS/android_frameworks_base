...
public class NetworkStackClient {
    ...
    public void start(Context context) {
        ...
        Intent intent = getNetworkStackIntent(pm,
                INetworkStackConnector.class.getName() + IN_PROCESS_SUFFIX);

        // Otherwise use the updatable module version
        if (intent == null) {
            intent = getNetworkStackIntent(pm, INetworkStackConnector.class.getName());
    ...
    @Nullable
    private Intent getNetworkStackIntent(@NonNull PackageManager pm, @NonNull String action) {
        ...
        if (uid != Process.NETWORK_STACK_UID && uid != Process.SYSTEM_UID) {
