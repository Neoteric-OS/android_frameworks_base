...
public class InetDiagMessage extends NetlinkMessage {
    ...
    private static int lookupUidByFamily(int protocol, InetSocketAddress local,
        ...
        ByteBuffer response = NetlinkSocket.recvMessage(fd, DEFAULT_RECV_BUFSIZE, 500);
    ...
    private static int lookupUid(int protocol, InetSocketAddress local,
        ...
        for (int family : FAMILY) {
            /**
             * Swap local and remote for UDP lookups due to kernel bug which will not be fixed. See
             * aosp/755889 and https://www.mail-archive.com/netdev@vger.kernel.org/msg248638.html
             */
