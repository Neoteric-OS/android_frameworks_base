...
public class ConntrackMessage extends NetlinkMessage {
    ...
    public static ConntrackMessage parse(StructNlMsgHdr header, ByteBuffer byteBuffer) {
        final ConntrackMessage neighMsg = new ConntrackMessage(header);
    ...
    public static byte[] newIPv4UpdateRequest(
            int proto, Inet4Address src, int sport, Inet4Address dst, int dport) {
        ...
        nlmsghdr.nlmsg_type = IPCTNL_MSG_CT_NEW;
    ...
    public static byte[] newNewNeighborMessage(
        ...
        final ConntrackMessage msg = new ConntrackMessage(nlmsghdr);
