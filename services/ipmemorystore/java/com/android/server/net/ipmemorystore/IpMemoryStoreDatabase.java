...
public class IpMemoryStoreDatabase {
    ...
    static final String SELECT_L2KEY = NetworkAttributesContract.COLUMNNAME_L2KEY + " = ?";
    ...
    static NetworkAttributes retrieveNetworkAttributes(@NonNull final SQLiteDatabase db,
        ...
        final long expiry = cursor.getLong(
                    cursor.getColumnIndexOrThrow(NetworkAttributesContract.COLUMNNAME_EXPIRYDATE));
        ...
        final int assignedV4AddressInt = cursor.getInt(cursor.getColumnIndexOrThrow(
                NetworkAttributesContract.COLUMNNAME_ASSIGNEDV4ADDRESS));
        final String groupHint = cursor.getString(
                cursor.getColumnIndexOrThrow(NetworkAttributesContract.COLUMNNAME_GROUPHINT));
        final byte[] dnsAddressesBlob = cursor.getBlob(
                cursor.getColumnIndexOrThrow(NetworkAttributesContract.COLUMNNAME_DNSADDRESSES));
        final int mtu = cursor.getInt(
                cursor.getColumnIndexOrThrow(NetworkAttributesContract.COLUMNNAME_MTU));
