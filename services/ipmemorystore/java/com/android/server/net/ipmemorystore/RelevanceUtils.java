...
public class RelevanceUtils {
     ...
     *
     * Specifically, it gives the following two results :
     ...
     *
     * @param oldExpiryDuration the old expiry date in milliseconds from now.
     * @return the expiry date representing a bumped up relevance value.
     */
