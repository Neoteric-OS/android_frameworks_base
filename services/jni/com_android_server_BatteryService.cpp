...
static void setEnergyField(JNIEnv* env, jobject obj, const char* path_now,
        const char* path_full, jfieldID fieldID)
{
    const int SIZE = 128;
    char buf[SIZE];
    int enow=0, efull=0;
...
static void android_server_BatteryService_update(JNIEnv* env, jobject obj)
{
    ...
    if (gPaths.batteryCapacityPath) {
        ...
        setEnergyField(env, obj, gPaths.batteryEnergyNowPath, gPaths.batteryEnergyFullPath,
