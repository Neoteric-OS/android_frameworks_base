...
import com.android.server.connectivity.PacProxyManagerService;
...
public final class SystemServer {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
        ...
        PacProxyManagerService pacPrxoyManagerService = null;
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            t.traceBegin("StartPacProxyManagerService");
            try {
                pacPrxoyManagerService = PacProxyManagerService.create(context);
                ServiceManager.addService(Context.PAC_PROXY_SERVICE, pacPrxoyManagerService);
            } catch (Throwable e) {
                reportWtf("starting PacProxyManagerService", e);
            }
            t.traceEnd();
