...
public class HdmiCecMessageValidator {
     ...
     * adhere to message description of Digital Timer defined in CEC 1.4 Specification : Message
     * Descriptions for Timer Programming Feature (CEC Table 12)
     */
     ...
     * within the range description of Record Status Info defined in CEC 1.4 Specification : Operand
     * Descriptions (Section 17)
     */
