...
final class HdmiControlShellCommand extends ShellCommand {
    ...
    public static final String TAG = "HdmiShellCommand";
    ...
    public int onCommand(String cmd) {
        ...
        try {
            ...
            getErrPrintWriter().println("Caught error: " + e.getMessage());
            Slog.e(TAG, "Error handling hdmi_control shell command", e);
            return 1;
        }
    }
