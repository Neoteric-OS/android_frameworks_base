...
public class HdmiCecLocalDevicePlayback extends HdmiCecLocalDeviceSource {
    ...
    HdmiCecLocalDevicePlayback(HdmiControlService service) {
        ...
        mAutoLanguageChange =
            mService.readBooleanSetting(Global.HDMI_CONTROL_AUTO_LANGUAGE_CHANGE_ENABLED, SET_MENU_LANGUAGE);
        mService.writeBooleanSetting(Global.HDMI_CONTROL_AUTO_LANGUAGE_CHANGE_ENABLED, mAutoLanguageChange);
    ...
    protected boolean handleSetMenuLanguage(HdmiCecMessage message) {
        ...
        try {
            ...
            HdmiLogger.debug("handleSetMenuLanguage new:" + iso3Language + " cur:" + curIso3Language);
