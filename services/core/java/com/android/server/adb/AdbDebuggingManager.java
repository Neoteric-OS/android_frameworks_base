...
public class AdbDebuggingManager {
    // TODO: Change this tag before submitting
    ...
    class AdbKeyStore {
        ...
        public void reloadKeyMap() {
            Slog.d(TAG, "Reloading key map");
            readTempKeysFile();
            Slog.d(TAG, "Reloaded key map");
        }
        ...
        private void readAdbKeysIntoMap(TypedXmlPullParser parser)
