...
public class LightsService extends SystemService {
    ...
    private LightImpl[] mLightsByType = new LightImpl[LightsManager.LIGHT_ID_COUNT];
    ...
    private void populateAvailableLights(Context context) {
        if (mVintfLights != null) {
            ...
            populateAvailableLightsFromHidl();
        }
    ...
    private void populateAvailableLightsFromAidl() {
        try {
    ...
    private void populateAvailableLightsFromHidl() {
