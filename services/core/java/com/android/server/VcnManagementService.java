...
public class VcnManagementService extends IVcnManagementService.Stub {
    ...
    public static class Dependencies {
        ...
        public Set<Integer> getRestrictedTransports(
            ...
            final int[] restrictedTransportsArray =
                    carrierConfig.getIntArray(VCN_RESTRICTED_TRANSPORTS_KEY);
            if (restrictedTransportsArray == null) {
                return defaultTransports;
            }
    ...
    public VcnUnderlyingNetworkPolicy getUnderlyingNetworkPolicy(
        ...
        return Binder.withCleanCallingIdentity(() -> {
            ...
            final VcnUnderlyingNetworkPolicy policy = new VcnUnderlyingNetworkPolicy(
                    mTrackingNetworkCallback
                            .requiresRestartForforImmutableCapabilityChanges(result),
                    result);
    ...
    private class TrackingNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        private Set<Integer> getTransportTypesWithoutTest(NetworkCapabilities caps) {
        ...
        private boolean hasSameTransportsAndCapabilities(
            ...
            if (!Objects.equals(
                    getTransportTypesWithoutTest(caps), getTransportTypesWithoutTest(capsOther))) {
                return false;
            }
        ...
        private boolean requiresRestartForforImmutableCapabilityChanges(NetworkCapabilities caps) {
