...
public class VcnManagementService extends IVcnManagementService.Stub {
    ...
    public interface VcnCallback {
        ...
        void onGatewayConnectionError(@NonNull int[] gatewayNetworkCapabilities, @GatewayConnectionError int errorType, @Nullable String message);
    }
        ...
        public void onGatewayConnectionError(
            ...
            synchronized (mLock) {
                ...
                for (VcnStatusCallbackInfo cbInfo : mRegisteredStatusCallbacks.values()) {
                    ...
                    Binder.withCleanCallingIdentity(() -> cbInfo.mCallback.onGatewayConnectionError(gatewayNetworkCapabilities, errorType, message));
                }
            }
        }
    }
