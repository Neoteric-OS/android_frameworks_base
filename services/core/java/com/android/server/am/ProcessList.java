...
public final class ProcessList {
    ...
    private boolean shouldEnableMemoryTagging(ProcessRecord app) {
        ...
        // Only enable MTE for system apps at this time.
        if ((app.info.flags & ApplicationInfo.FLAG_SYSTEM) == 0) {
            return false;
        }

        // And ensure that compat feature for MTE is enabled.
    ...
    private boolean shouldEnableTaggedPointers(ProcessRecord app) {
        ...
        // Only enable pointer tagging for system apps at this time.
        if ((app.info.flags & ApplicationInfo.FLAG_SYSTEM) == 0) {
            return false;
        }
