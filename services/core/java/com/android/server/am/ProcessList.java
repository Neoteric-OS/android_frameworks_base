...
public final class ProcessList {
    ...
    public record OomAdjProc(int pid, int uid, int amt) {}

    /**
     * Set the out-of-memory badness adjustment for a list of processes.
     *
     * @param procs Process list to adjust their respective oom score.
     *
     * {@hide}
     */
    public static void batchSetOomAdj(ArrayList<OomAdjProc> procs) {
        ...
        for (OomAdjProc proc: procs) {
            if (proc.pid <= 0 || proc.amt == UNKNOWN_ADJ) continue;
