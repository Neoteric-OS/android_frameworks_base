    ...
    public void systemServicesReady() {
        ...
        try {
            if (!Flags.trackMultipleNetworkActivities()) {
                // If trackMultipleNetwork is enabled, ConnectivityService calls BatteryStats API to
                // update RadioPowerState change. So BatteryStatsService registers the callback
                // only when this flag is disabled.
