...
public class NotificationComparator
    ...
    private int mNotificationInterruptionMode;
    ...
    public NotificationComparator(Context context) {
        ...
        mNotificationInterruptionMode = Settings.Secure.getInt(mContext.getContentResolver(),
    ...
    public int compare(NotificationRecord left, NotificationRecord right) {
        ...
        if (mNotificationInterruptionMode == 1) {
