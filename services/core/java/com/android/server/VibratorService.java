        ...
        public boolean playWaveform() {
            ...
            try {
                synchronized (this) {
                    ...
                    long onDuration = 0;
                    long onStartTime = 0;
                    long currentStepStartTime = SystemClock.uptimeMillis();
                    while (!mForceStop) {
                        if (index < len) {
                            ...
                            if (amplitude != 0) {
                                long actualOnDuration = SystemClock.uptimeMillis() - onStartTime;
                                if (onDuration <= actualOnDuration) {
                            ...
                            currentStepStartTime += duration;
                            delayLocked(currentStepStartTime);
                        } else if (repeat < 0) {
                            break;
                        } else {
                            index = repeat;
