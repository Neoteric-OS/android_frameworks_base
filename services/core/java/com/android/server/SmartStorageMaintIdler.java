...
public class SmartStorageMaintIdler extends JobService {
    ...
    private static ComponentName sSmartStorageMaintService =
            new ComponentName("android", SmartStorageMaintIdler.class.getName());

    private static int SMART_MAINT_JOB_ID = 2808;
    ...
    private Runnable mFinishCallback = new Runnable() {
        ...
        public void run() {
            ...
            scheduleSmartIdlePass(SmartStorageMaintIdler.this, 1);
        }
    };
    ...
    public boolean onStartJob(JobParameters params) {
        ...
        if (ms != null) {
            ...
            ms.setSmartIdleMaint(mFinishCallback);
        }
        return ms != null;
    }
