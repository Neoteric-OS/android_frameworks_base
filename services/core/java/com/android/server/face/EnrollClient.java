...
public abstract class EnrollClient extends ClientMonitor {
    ...
    public boolean onEnrollResult(int remaining, long vendorMsg) {
        ...
        return sendEnrollResult(remaining, vendorMsg);
    }

    /*
     * @return true if we're done.
     */
    private boolean sendEnrollResult(int remaining, long vendorMsg) {
        ...
        try {
            receiver.onEnrollResult(getHalDeviceId(), remaining, vendorMsg);
            return remaining == 0;
    ...
    public int start() {
        ...
        try {
            final int result = daemon.enroll(mCryptoToken, getTargetUserId(), timeout);
            if (result != 0) {
