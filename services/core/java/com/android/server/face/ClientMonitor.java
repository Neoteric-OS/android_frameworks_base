...
public abstract class ClientMonitor implements IBinder.DeathRecipient {
     ...
     * @param restricted whether or not client has the {@link Manifest#MANAGE_FACE_AUTHENTICATION}
     * permission
    ...
    public abstract boolean onEnrollResult(int remaining, long vendorMsg);
    public abstract boolean onAuthenticated(boolean authenticated);
    ...
    public boolean onAcquired(int acquiredInfo, int vendorCode) {
        ...
        try {
            ...
            if (acquiredInfo == FaceAuthenticationManager.FACE_ACQUIRED_GOOD) {
                notifyUserActivity();
            }
        }
    }
