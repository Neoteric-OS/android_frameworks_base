...
class TestNetworkService extends ITestNetworkManager.Stub {
    ...
    private AtomicInteger mTestTunIndex = new AtomicInteger();
    ...
    public TestNetworkInterface createTunInterface(@NonNull LinkAddress[] linkAddrs) {
        ...
        String iface = TEST_TUN_PREFIX + mTestTunIndex.getAndIncrement();
    ...
    @NonNull
    private final ConcurrentHashMap<Integer, TestNetworkAgent> mTestNetworkTracker =
    ...
    public class TestNetworkAgent extends NetworkAgent implements IBinder.DeathRecipient {
        ...
        @NonNull private Object mBinderLock = new Object();
        ...
        private TestNetworkAgent(
            ...
            // No need to synchronize here; it is impossible to have a race condition in this
            // constructor
        ...
        private void teardown() {
            ...
            // resources, even for binder death or unwanted calls. If teardown is called
            // more than once, this remove call will have no effect the second time
