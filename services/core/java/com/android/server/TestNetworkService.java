...
class TestNetworkService extends ITestNetworkManager.Stub {
    ...
    // Native method stubs
    private static native int jniCreateTun(boolean isTun, @NonNull String iface);
     ...
     * interface.
     */
    public TestNetworkInterface createInterface(boolean isTun, LinkAddress[] linkAddrs) {
                ...
                () -> {
                    try {
                        ParcelFileDescriptor tunIntf =
                                ParcelFileDescriptor.adoptFd(jniCreateTun(isTun, iface));
    ...
    /**
     * Create a TAP interface with the given interface name and link addresses
     *
