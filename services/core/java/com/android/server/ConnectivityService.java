                ...
                case NetworkMonitor.EVENT_NETWORK_TESTED: {
                    ...
                    if (nai != null) {
                        ...
                        if (valid != nai.lastValidated) {
                            if (wasDefault) {
                                metricsLogger().defaultNetworkMonitor().logDefaultNetworkValidity(
    ...
    private void handleAsyncChannelDisconnected(Message msg) {
        ...
        if (nai != null) {
            ...
            if (wasDefault) {
                ...
                metricsLogger().defaultNetworkMonitor().logDefaultNetworkEvent(now, null, nai);
            }
...
//        }
    ...
    private void rematchNetworkAndRequests(NetworkAgentInfo newNetwork,
        ...
        if (isNewDefault) {
            ...
            metricsLogger().defaultNetworkMonitor().logDefaultNetworkEvent(
