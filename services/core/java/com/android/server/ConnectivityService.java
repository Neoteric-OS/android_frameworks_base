...
//        mNetTrackers[info.getType()].captivePortalCheckCompleted(isCaptivePortal);
    ...
    //    is in place.  This is important so legacy PAC resolver changes aren't missed.  The
    //    legacy PAC resolver pretends to be a simple HTTP proxy but actually uses the PAC to
    //    resolve; this results in ProxyInfo's with PAC URL, host and port all set.
