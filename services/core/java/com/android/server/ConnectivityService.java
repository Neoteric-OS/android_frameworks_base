    ...
    private void showNetworkNotification(NetworkAgentInfo nai, NotificationType type) {
        ...
        switch (type) {
            case CONNECTED:
                ...
                mHandler.removeMessages(EVENT_DISMISS_NOTIFICATION);
                mHandler.sendMessageDelayed(mHandler.obtainMessage(EVENT_DISMISS_NOTIFICATION,
                        nai.network.netId, 0), DISMISS_NOTIFICATION_DELAY_MS);
                return;
            case NO_INTERNET:
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case EVENT_DISMISS_NOTIFICATION:
                    mNotifier.clearNotification(msg.arg1, NotificationType.CONNECTED);
                    break;
            }
        }
    }
