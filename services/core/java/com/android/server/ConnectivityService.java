...
//        }
     ...
     */
    private boolean shouldApplyInterfaceFiltering(NetworkAgentInfo nai, NetworkCapabilities nc,
            LinkProperties lp) {
    ...
    private void updateUids(NetworkAgentInfo nai, NetworkCapabilities prevNc,
        ...
        try {
            final boolean needsToRemoveOldFiltering = shouldApplyInterfaceFiltering(nai, prevNc,
                    nai.linkProperties);
            final boolean needsToAddNewFiltering = shouldApplyInterfaceFiltering(nai, newNc,
                    nai.linkProperties);
