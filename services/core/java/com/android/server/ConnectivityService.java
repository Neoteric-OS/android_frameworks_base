...
public class ConnectivityService extends IConnectivityManager.Stub
        ...
        if (mNetworkFactoryInfos.containsKey(msg.replyTo)) {
            if (msg.arg1 == AsyncChannel.STATUS_SUCCESSFUL) {
                ...
                for (NetworkRequestInfo nri : mNetworkRequests.values()) {
                    ...
                    NetworkAgentInfo nai = getNetworkAgentInfo(nri.request.requestId);
    ...
    private void handleAsyncChannelDisconnected(Message msg) {
        ...
        if (nai != null) {
            ...
            for (int i = 0; i < nai.numNetworkRequests(); i++) {
                ...
                NetworkAgentInfo currentNetwork = getNetworkAgentInfo(request.requestId);
                if (currentNetwork != null && currentNetwork.network.netId == nai.network.netId) {
                    removeNetworkAgentInfo(request.requestId);
    ...
    private void handleRegisterNetworkRequest(NetworkRequestInfo nri) {
        ...
        rematchAllNetworksAndRequests(null, 0);
        if (nri.request.isRequest() && getNetworkAgentInfo(nri.request.requestId) == null) {
    ...
    private boolean unneeded(NetworkAgentInfo nai, UnneededFor reason) {
        ...
        for (NetworkRequestInfo nri : mNetworkRequests.values()) {
            ...
            if (nri.request.isRequest() && nai.satisfies(nri.request) &&
                    ...
                    getNetworkAgentInfo(nri.request.requestId).getCurrentScore() <
    ...
    private void handleTimedOutNetworkRequest(final NetworkRequestInfo nri) {
        ...
        if (getNetworkAgentInfo(nri.request.requestId) != null) {
            return;
        }
    ...
    private void handleRemoveNetworkRequest(final NetworkRequestInfo nri) {
        ...
        if (nri.request.isRequest()) {
            ...
            if (nai != null) {
                ...
                removeNetworkAgentInfo(nri.request.requestId);
    ...
    private NetworkAgentInfo getNetworkAgentInfo(int requestId) {
        synchronized (mNetworkForRequestId) {
            return mNetworkForRequestId.get(requestId);
        }
    }

    private void removeNetworkAgentInfo(int requestId) {
        synchronized (mNetworkForRequestId) {
            mNetworkForRequestId.remove(requestId);
        }
    }

    private void putNetworkAgentInfo(int requestId, NetworkAgentInfo nai) {
        synchronized (mNetworkForRequestId) {
    ...
    private NetworkAgentInfo getDefaultNetwork() {
        return getNetworkAgentInfo(mDefaultRequest.requestId);
    }
...
//        }
    ...
    private void rematchNetworkAndRequests(NetworkAgentInfo newNetwork,
        ...
        for (NetworkRequestInfo nri : mNetworkRequests.values()) {
            ...
            final NetworkAgentInfo currentNetwork = getNetworkAgentInfo(nri.request.requestId);
            ...
            if (satisfies) {
                ...
                if (currentNetwork == null || currentNetwork.getCurrentScore() < score) {
                    ...
                    putNetworkAgentInfo(nri.request.requestId, newNetwork);
