...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private NetworkStateSnapshot getFilteredNetworkState(int networkType, int uid) {
    ...
    private NetworkStateSnapshot getUnfilteredActiveNetworkState(int uid) {
     ...
     */
    private void filterNetworkStateForUid(
    ...
    public NetworkInfo getActiveNetworkInfo() {
        ...
        final NetworkStateSnapshot state = getUnfilteredActiveNetworkState(uid);
        filterNetworkStateForUid(state, uid, false);
    ...
    public NetworkInfo getActiveNetworkInfoUnfiltered() {
        enforceAccessPermission();
        final int uid = mDeps.getCallingUid();
        NetworkStateSnapshot state = getUnfilteredActiveNetworkState(uid);
        return state.networkInfo;
    }
    ...
    public NetworkInfo getNetworkInfo(int networkType) {
        ...
        final NetworkStateSnapshot state = getFilteredNetworkState(networkType, uid);
        return state.networkInfo;
    }
    ...
    public Network getNetworkForType(int networkType) {
        enforceAccessPermission();
        final int uid = mDeps.getCallingUid();
        NetworkStateSnapshot state = getFilteredNetworkState(networkType, uid);
