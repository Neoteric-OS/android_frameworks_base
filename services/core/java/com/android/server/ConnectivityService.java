...
//        }
    ...
    private CaptivePortalData mergeCaptivePortalData(CaptivePortalData naData,
        ...
        // Prioritize the user portal URL from the network agent. Passpoint may provide a URL
        // to a T&C portal that the user must accept in order to get access. This URL is retrieved
        // by Passpoint specific protocol exchange.
        ...
        // Prioritize the venue information URL from the network agent. Passpoint may provide a
        // trusted venue URL which cannot be spoofed, because the implementation requests for the
        // venue URL via ANQP only after the connection was established.
        ...
        // in use in RFC8908. Passpoint uses a friendly name to identify a network, rather than
        // the network SSID.
