...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    protected ConnectivityService(Context context, INetworkManagementService netManager,
        ...
        NetworkRequestInfo defaultNRI =
                new NetworkRequestInfo(null, mDefaultRequest, NetworkCallback.FLAG_NONE,
                        new Binder(), null);
    ...
    private void handleAlwaysOnNetworkRequest(NetworkRequest networkRequest, boolean enable) {
        ...
        if (enable) {
            handleRegisterNetworkRequest(new NetworkRequestInfo(
                    null, networkRequest, NetworkCallback.FLAG_NONE, new Binder(), null));
        } else {
    ...
    public NetworkCapabilities[] getDefaultNetworkCapabilitiesForUser(
        ...
        final NetworkCapabilities ncSanitized =
                createWithLocationInfoSanitizedIfNecessaryWhenParceled(
                        nc, false /* includeLocationSensitiveInfoInTransportInfo */,
    ...
    public NetworkCapabilities getNetworkCapabilitiesWithLocationInfoInTransportInfo(
            Network network, String callingPackageName, @Nullable String callingAttributionTag) {
        mAppOpsManager.checkPackage(mDeps.getCallingUid(), callingPackageName);
        enforceAccessPermission();
        return createWithLocationInfoSanitizedIfNecessaryWhenParceled(
                getNetworkCapabilitiesInternal(network),
    ...
    NetworkCapabilities createWithLocationInfoSanitizedIfNecessaryWhenParceled(
        ...
        return createWithLocationInfoSanitizedIfNecessaryWhenParceled(nc,
                (callbackFlags & NetworkCallback.FLAG_INCLUDE_LOCATION_INFO_IN_TRANSPORT_INFO) != 0,
    ...
    @Nullable
    NetworkCapabilities createWithLocationInfoSanitizedIfNecessaryWhenParceled(
            @Nullable NetworkCapabilities nc, boolean includeLocationSensitiveInfoInTransportInfo,
            int callerUid, @NonNull String callerPkgName, @Nullable String callingAttributionTag) {
        if (nc == null) {
            return null;
        }
