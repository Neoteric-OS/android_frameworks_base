...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    protected ConnectivityService(Context context, INetworkManagementService netManager,
        ...
        if (DBG) log("ConnectivityService starting up, VPN is nowhere to be seen");
        ...
        switch (reqType) {
            ...
            case TRACK_SYSTEM_DEFAULT:
                ...
                networkCapabilities = new NetworkCapabilities(
                        mFallbackRequest.mRequests.get(0).networkCapabilities);
                break;
...
//        }
    ...
    private @VpnManager.VpnType int getVpnType(NetworkAgentInfo vpn) {
    ...
    public int getConnectionOwnerUid(ConnectionInfo connectionInfo) {
        ...
        if (uid == INVALID_UID) return INVALID_UID;  // Not found.
