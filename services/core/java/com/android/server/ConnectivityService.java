        ...
        private boolean maybeHandleNetworkMonitorMessage(Message msg) {
            switch (msg.what) {
                ...
                case EVENT_NETWORK_TESTED: {
                    ...
                    // If user accepts partial connectivity network, NetworkMonitor will skip HTTPS
                    // probing. It will make partial connectivity network becomes valid. But user
                    // still need to know this network is limited. So, it's needed to refer to
                    // acceptPartialConnectivity to add NET_CAPABILITY_PARTIAL_CONNECTIVITY into
                    // NetworkCapabilities of this network. So that user can see
                    // "Limited connection" in Settings.
            ...
            try {
                if (networkAgent.networkMisc.acceptPartialConnectivity) {
                    networkAgent.networkMonitor().setAcceptPartialConnectivity(
                            networkAgent.networkMisc.acceptPartialConnectivity);
                }
