...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    protected class NetworkRequestInfo implements IBinder.DeathRecipient {
        ...
        final int mPid;
        final int mUid;
        final @NetworkCallback.NetworkCallbackFlag int mCallbackFlags;
        @Nullable
        ...
        NetworkRequestInfo(@NonNull final NetworkRequest r, @Nullable final Messenger m,
                ...
                @NetworkCallback.NetworkCallbackFlag int callbackFlags,
                @Nullable String callingAttributionTag) {
            ...
            case ConnectivityManager.CALLBACK_AVAILABLE: {
                ...
                putParcelable(
                        ...
                        createWithLocationInfoSanitizedIfNecessaryWhenParceled(
                                nc,
                                (nri.mCallbackFlags
                                        & NetworkCallback.FLAG_INCLUDE_LOCATION_INFO) != 0,
                                nri.mUid, nrForCallback.getRequestorPackageName(),
