...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    // Must be called on the ConnectivityService thread.
    ...
    private VpnInfo createVpnInfo(NetworkAgentInfo nai) {
        ...
        for (Network network : underlyingNetworks) {
            NetworkAgentInfo underlyingNai = getNetworkAgentInfoForNetId(network.netId);
    ...
    protected void applyUnderlyingNetworkCapabilities(Network[] underlyingNetworks,
            NetworkCapabilities caps,  boolean agentMetered) {
        int[] transportTypes = new int[] { NetworkCapabilities.TRANSPORT_VPN };
        int downKbps = NetworkCapabilities.LINK_BANDWIDTH_UNSPECIFIED;
        int upKbps = NetworkCapabilities.LINK_BANDWIDTH_UNSPECIFIED;
        boolean metered = agentMetered; // metered if any underlying is metered, or agentMetered
    ...
    private void mixInUnderlyingCapabilities(NetworkAgentInfo nai, NetworkCapabilities nc) {
        ...
        applyUnderlyingNetworkCapabilities(underlyingNetworks, nc, nai.agentMetered);
    }
