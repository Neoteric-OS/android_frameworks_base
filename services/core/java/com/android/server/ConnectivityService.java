...
public class ConnectivityService extends IConnectivityManager.Stub
     ...
     * Both of the arguments are bitmasks, and the value of bits come from INetworkMonitor.aidl.
            ...
            switch (msg.what) {
                ...
                case EVENT_PROBE_STATUS_CHANGED: {
                    ...
                    if (probePrivateDnsCompleted) {
                        ...
                        // If network becomes valid, the hasShownBroken should be reset for that
                        // network to prevent the notification won't be fired when the private DNS
                        // is broken again.
                        nai.networkMisc.hasShownBroken = (privateDnsBroken && !nai.lastValidated);
                    }
                    break;
                }
