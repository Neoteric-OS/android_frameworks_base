...
//        }
     ...
     * maintained here that the NetworkAgent is not aware of (e.g., validated status and captive
     * portal status). Does not touch the FOREGROUND capability, since that never changes as a
     * direct result of a NetworkAgent capability update. Returns a new NetworkCapabilities object.
     */
