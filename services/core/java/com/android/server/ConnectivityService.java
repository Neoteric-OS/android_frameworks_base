...
public class ConnectivityService extends IConnectivityManager.Stub
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case EVENT_CLEAR_NET_TRANSITION_WAKELOCK: {
                    handleWakeLockRelease(msg.what, msg.arg1);
                    break;
                }
    ...
    private void handleWakeLockRelease(int eventId, int wantSerialNumber) {
        ...
        String msg = String.format("RELEASE %d by %s: %b", wantSerialNumber, eventName(eventId), release);
        if (!isHeld) {
            msg += " (was already unlocked)";
        }
        if (!release) {
            msg += String.format( " (serial number was: %d)", serialNumber);
        }
