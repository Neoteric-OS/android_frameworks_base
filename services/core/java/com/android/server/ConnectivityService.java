...
//        }
    ...
    private void updateCapabilities(
        ...
        // Once a NetworkAgent is connected, complain if some capabilities are removed.
        if (nai.everConnected &&
                !nai.networkCapabilities.satisfiedByNetworkCapabilities(networkCapabilities)) {
            // TODO: consider not complaing when a network agent degrade its capabilities if this
