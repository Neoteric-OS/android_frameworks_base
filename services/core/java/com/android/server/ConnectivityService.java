...
//        }
    ...
    private static class NetworkReassignment {
        static class AffectedNetworkPlusState {
            @NonNull final NetworkAgentInfo mNetwork;
            final boolean mOldBackground;
            AffectedNetworkPlusState(@NonNull final NetworkAgentInfo network,
        ...
        @NonNull private final Set<AffectedNetworkPlusState> mAffectedNetworks = new ArraySet<>();
        @NonNull private final Map<NetworkRequestInfo, RequestReassignment> mReassignments =
                new ArrayMap<>();

        @NonNull Iterable<AffectedNetworkPlusState> getAffectedNetworks() {
        ...
        void addAffectedNetwork(@NonNull final AffectedNetworkPlusState network) {
    ...
    private void rematchNetworkAndRequests(@NonNull final NetworkReassignment changes,
        ...
        changes.addAffectedNetwork(new NetworkReassignment.AffectedNetworkPlusState(newNetwork,
    ...
    private NetworkReassignment computeNetworkReassignment() {
        ...
        for (final NetworkAgentInfo nai : mNetworkAgentInfos.values()) {
            ...
            nais.add(nai);
            changes.addAffectedNetwork(new NetworkReassignment.AffectedNetworkPlusState(nai,
    ...
    private void applyNetworkReassignment(@NonNull final NetworkReassignment changes,
        ...
        for (final NetworkReassignment.AffectedNetworkPlusState event :
                changes.getAffectedNetworks()) {
    ...
    @NonNull
    private static String netToSimpleString(@NonNull final NetworkAgentInfo nai) {
        return "[" + nai.network.netId + " "
