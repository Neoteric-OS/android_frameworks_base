...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private void disconnectAndDestroyNetwork(NetworkAgentInfo nai) {
        ...
        for (int i = 0; i < nai.numNetworkRequests(); i++) {
            ...
            NetworkAgentInfo currentNetwork = getNetworkForRequest(nri);
    ...
    // The network currently satisfying the default request, if any.
    @Nullable
...
//        }
    ...
    private void rematchNetworkAndRequests(NetworkAgentInfo newNetwork,
        ...
        final ArrayList<NetworkAgentInfo> affectedNetworks = new ArrayList<>();
        ...
        for (final Map.Entry<NetworkRequestInfo, NetworkAgentInfo> entry :
            ...
            if (newSatisfier == previousSatisfier) {
                ...
                if (previousSatisfier != null) {
                    ...
                    affectedNetworks.add(previousSatisfier);
                } else {
                ...
                if (isDefaultRequest(nri)) {
                    ...
                    if (previousSatisfier != null) {
                        mLingerMonitor.noteLingerDefaultNetwork(previousSatisfier, newNetwork);
                    }
                }
            } else {
