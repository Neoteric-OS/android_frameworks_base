...
public class ConnectivityService extends IConnectivityManager.Stub
     ...
     */
    private void removeSatisfiedNetworkRequestFromNetwork(final NetworkRequestInfo nri) {
...
//        }
    ...
    private NetworkReassignment computeNetworkReassignment(
            final Collection<NetworkRequestInfo> networkRequests) {
        ensureRunningOnConnectivityServiceThread();
     ...
     * being disconnected.
     */
    private void rematchNetworksAndRequests(final Collection<NetworkRequestInfo> networkRequests) {
