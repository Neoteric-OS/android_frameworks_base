...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private void handleAlwaysOnNetworkRequest(
            NetworkRequest networkRequest, String settingName, int defaultValue) {
        final boolean enable = (Settings.Global.getInt(
                mContext.getContentResolver(), settingName, defaultValue) == 1);
    ...
    private void handleConfigureAlwaysOnNetworks() {
        handleAlwaysOnNetworkRequest(
                mDefaultMobileDataRequest,Settings.Global.MOBILE_DATA_ALWAYS_ON, 1);
        handleAlwaysOnNetworkRequest(mDefaultWifiRequest, Settings.Global.WIFI_ALWAYS_ON, 0);
    }
