...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    public static class PerUidCounter {
         ...
         */
        public void transact(@NonNull final Context context,
                final int uid, final int numOfNewRequests, @NonNull final Runnable r) {
            // TODO put a check here controlling access/usage.
            synchronized (mUidToNetworkRequestCount) {
...
//        }
    ...
    private void handleSetProfileNetworkPreference(
        ...
        mSystemNetworkRequestCounter.transact(
                mContext, mDeps.getCallingUid(), mProfileNetworkPreferences.preferences.size(),
                () -> {
    ...
    private void handleSetOemNetworkPreference(
        ...
        mSystemNetworkRequestCounter.transact(
                mContext, mDeps.getCallingUid(), uniquePreferenceCount,
                () -> {
                    final ArraySet<NetworkRequestInfo> nris =
    ...
    private void addPerAppDefaultNetworkRequests(@NonNull final Set<NetworkRequestInfo> nris) {
        ...
        mSystemNetworkRequestCounter.transact(
                mContext, mDeps.getCallingUid(), perAppCallbackRequestsToUpdate.size(),
                () -> {
