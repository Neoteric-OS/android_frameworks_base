...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private boolean isNetworkWithCapabilitiesBlocked(@Nullable final NetworkCapabilities nc,
        ...
        try {
            // If |nc| is null, then we got here to serve a an API call for a legacy type and
    ...
    private NetworkInfo getFilteredNetworkInfo(NetworkAgentInfo nai, int uid,
        ...
        return filterNetworkInfo(nai.networkInfo, nai.networkCapabilities, uid, ignoreBlocked);
    }
