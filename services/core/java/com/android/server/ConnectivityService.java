...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private void disconnectAndDestroyNetwork(NetworkAgentInfo nai) {
        ...
        for (final Map.Entry<NetworkRequestInfo, NetworkAgentInfo> defaultNetwork :
                mDefaultNetworkAgents.entrySet()) {
            if (defaultNetwork.getValue() != nai) {
                continue;
            }
            defaultNetwork.setValue(null);
            if (getDeviceDefaultNri() == defaultNetwork.getKey()) {
    ...
    @VisibleForTesting
    @NonNull
    final HashMap<NetworkRequestInfo, NetworkAgentInfo> mDefaultNetworkAgents =
            new HashMap<>();
    ...
    @VisibleForTesting
    NetworkRequestInfo getDeviceDefaultNri() {
