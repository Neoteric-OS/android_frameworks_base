...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private NetworkAgentInfo getNetworkAgentInfoForType(int networkType) {
        ...
        if (defaultNai != null && defaultNai.networkInfo.getType() == networkType) {
            ...
            // teaching LegacyTypeTracker about per-uid default networking, simply overwrite
            // it here if the default network happens to be of the same type as the network
            // that was going to be returned.
            nai = defaultNai;
        } else {
