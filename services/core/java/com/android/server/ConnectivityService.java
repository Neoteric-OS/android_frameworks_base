...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private class NetworkStateTrackerHandler extends Handler {
        ...
        private boolean maybeHandleNetworkAgentInfoMessage(Message msg) {
            switch (msg.what) {
                ...
                case NetworkAgentInfo.EVENT_AGENT_CONNECTED: {
                    handleNetworkAgentConnect(msg);
                    break;
                }
    ...
    private void handleNetworkAgentConnect(Message msg) {
    ...
    private int[] getSignalStrengthThresholds(NetworkAgentInfo nai) {
        ...
        final int[] ret = new int[thresholds.size()];
        int i = 0;
    ...
    private final HashSet<NetworkAgentInfo> mNetworkAgentInfos = new HashSet<>();
