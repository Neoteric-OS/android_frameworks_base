...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private void ensureValidNetworkSpecifier(NetworkSpecifier nc) {
        MatchAllNetworkSpecifier.checkNotMatchAllNetworkSpecifier(nc);
        if (nc != null) {
            nc.assertValidFromUid(Binder.getCallingUid());
        }
    }
    ...
    public NetworkRequest requestNetwork(NetworkCapabilities networkCapabilities,
        ...
        ensureValidNetworkSpecifier(networkCapabilities.getNetworkSpecifier());
