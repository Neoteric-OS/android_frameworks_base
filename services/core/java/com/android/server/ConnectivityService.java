...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private boolean isNetworkBlocked(@Nullable NetworkAgentInfo nai, int uid,
        ...
        try {
            // XXX legacy code used to pass in "new NetworkCapabilities", which are metered.
     ...
     */
    private NetworkInfo filterNetworkInfo(NetworkAgentInfo nai, NetworkInfo networkInfo, int uid,
            boolean ignoreBlocked) {
    ...
    public NetworkInfo getActiveNetworkInfoUnfiltered() {
        ...
        return (nai != null) ? nai.networkInfo : null;
    }
    ...
    private NetworkInfo getFilteredNetworkInfo(int networkType, int uid) {
        ...
        return filterNetworkInfo(nai, info, uid, false);
    }
    ...
    public Network getNetworkForType(int networkType) {
        ...
        final int uid = mDeps.getCallingUid();
        if (nai == null || isNetworkBlocked(nai, uid, false)) {
            return null;
        }
        return nai.network;
    }
