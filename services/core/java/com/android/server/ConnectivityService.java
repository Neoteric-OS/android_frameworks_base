...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private void updateLinkProperties(NetworkAgentInfo networkAgent, LinkProperties newLp,
        ...
        final boolean needsToAddNewFiltering = shouldApplyInterfaceFiltering(
                networkAgent, newLp);
        Log.d("PermissionMonitor", "updateLinkProperties: old=" + needsToRemoveOldFiltering
                + " new=" + needsToAddNewFiltering);
        if (needsToRemoveOldFiltering || needsToAddNewFiltering) {
            ...
            Log.d("PermissionMonitor", "updateLinkProperties: if=" + oldIf + " if=" + newIf);
...
//        }
    ...
    private void updateUids(NetworkAgentInfo nai, NetworkCapabilities prevNc,
        ...
        try {
            ...
            Log.d("PermissionMonitor", "updateUids" + shouldFilter + " " + ifname + newRanges + " " + prevRanges);
