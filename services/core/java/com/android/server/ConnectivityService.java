...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private NetworkAgentInfo getLegacyLockdownNai() {
        ...
        return (getVpnType(nai) == VpnManager.TYPE_VPN_LEGACY) ? nai : null;
    };
    ...
    private boolean isLegacyLockdownConnected() {
        ...
        if (legacyLockdownNai.declaredUnderlyingNetworks == null
                ||  legacyLockdownNai.declaredUnderlyingNetworks.length != 1) {
            Log.wtf(TAG, "Legacy lockdown VPN must have exactly 1 underlying network");
            return false;
        }
        ...
        if (defaultNetwork == null) return false;
        return defaultNetwork.network.equals(legacyLockdownNai.declaredUnderlyingNetworks[0]);
    }
