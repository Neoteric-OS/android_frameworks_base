...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    private void handleAsyncChannelDisconnected(Message msg) {
        ...
        if (nai != null) {
            ...
            if (nai.isSatisfyingRequest(mDefaultRequest.requestId)) {
                ...
                acquireNetworkTransitionWakelock(nai.name());
            }
            mLegacyTypeTracker.remove(nai, wasDefault);
    ...
    private void acquireNetworkTransitionWakelock(String forWhom) {
        synchronized (this) {
    ...
    private void requestReleaseNetworkTransitionWakelock() {
        synchronized (this) {
            if (!mNetTransitionWakeLock.isHeld()) {
    ...
    // Called when either message of acquireNetworkTransitionWakelock or
    // requestReleaseNetworkTransitionWakelock is processed.
...
//        }
    ...
    private void rematchNetworkAndRequests(NetworkAgentInfo newNetwork,
        ...
        if (isNewDefault) {
            ...
            requestReleaseNetworkTransitionWakelock();
        }
