...
public class UnderlyingNetworkController {
    ...
    public void updateSubscriptionSnapshot(@NonNull TelephonySubscriptionSnapshot newSnapshot) {
        ...
        // config to calculate their cached priority classes. By design  no need to trigger network
        // reevaluation for route selection when the snapshot or carrier config change
