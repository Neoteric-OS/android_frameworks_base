...
public class UnderlyingNetworkRecord {
    ...
    /** Returns if two records represent the same Network with same states */
    ...
    void dump(
        ...
        pw.println("Priority index: " + priorityClass);
    ...
    public String toString() {
        return "priorityClass " + priorityClass + " isSelected " + isSelected;
    }
