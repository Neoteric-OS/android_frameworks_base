...
class UnderlyingNetworkEvaluator {
    ...
    UnderlyingNetworkEvaluator(
        ...
        LOCAL_LOG.log("[INFO] " + getTagLogPrefix(network) + "Initializing");
    ...
    void setLastSnapshotAndCarrierConfig(
        ...
        // TODO: Add a flag and update priority class if flag is enabled
    }
    ...
    private static String getTagLogPrefix(Network network) {
