...
class NetworkPriorityClassifier {
     ...
     *
     * <p>If none of the network candidates are validated or match any template, VCN can fall back
     * to choose any Internet network as the underlying network.
     */
    @VisibleForTesting(visibility = Visibility.PRIVATE)
    ...
    /** Value for networks that have not calculated their priority classes */
    @VisibleForTesting(visibility = Visibility.PRIVATE)
    static final int PRIORITY_UNKNOWN = -2;
