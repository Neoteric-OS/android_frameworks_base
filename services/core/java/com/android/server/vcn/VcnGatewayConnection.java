...
public class VcnGatewayConnection extends StateMachine implements UnderlyingNetworkTrackerCallback {
    ...
    private static class EventUnderlyingNetworkChangedInfo implements EventInfo {
        ...
        EventUnderlyingNetworkChangedInfo(@NonNull UnderlyingNetworkRecord newUnderlying) {
    ...
    public void onSelectedUnderlyingNetworkChanged(@Nullable UnderlyingNetworkRecord underlying) {
        ...
        // getHandler() can return null if the state machine has already quit. Since this is called
    ...
    private abstract class BaseState extends State {
        ...
        protected void handleDisconnectRequested(String msg) {
            ...
            if (msg.equals(DISCONNECT_REASON_UNDERLYING_NETWORK_LOST)) {
                mUnderlying = null;
            }
        }
        ...
        protected void processStateMsg(Message msg) {
            switch (msg.what) {
                ...
                case EVENT_DISCONNECT_REQUESTED:
                    ...
                    break;
                case EVENT_TEARDOWN_TIMEOUT_EXPIRED:
                    // Grace period ended. Forcibly kill session.
                    mIkeSession.kill();
