...
public class VcnGatewayConnection extends StateMachine implements UnderlyingNetworkTrackerCallback {
     ...
     * @param obj @Nullable The String reason why a disconnect was requested
     */
    ...
    private abstract class BaseState extends State {
        ...
        protected void logUnhandledMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case EVENT_SETUP_COMPLETE: // Fallthrough
    ...
    class RetryTimeoutState extends ActiveBaseState {
        ...
        protected void processStateMsg(Message msg) {
            switch (msg.what) {
                case EVENT_UNDERLYING_NETWORK_CHANGED: // Fallthrough
                    final UnderlyingNetworkRecord newUnderlying = (UnderlyingNetworkRecord) msg.obj;
        ...
        private long nextRetryTimeoutMs() {
            final int retryDelayIndex = mRetryCount - 1;
