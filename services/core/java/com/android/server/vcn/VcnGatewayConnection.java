...
public class VcnGatewayConnection extends StateMachine {
    ...
    @VisibleForTesting(visibility = Visibility.PRIVATE)
    static final int SAFEMODE_TIMEOUT_SECONDS = 60;
    ...
    VcnGatewayConnection(
        ...
        mWakeLock = mDeps.newWakeLock(mVcnContext, PowerManager.PARTIAL_WAKE_LOCK, TAG);
    ...
    void setSafemodeAlarm() {
        mSafemodeTimeoutAlarm =
                mDeps.newWakeupMessage(
                        ...
                        () -> sendMessage(EVENT_SAFEMODE_TIMEOUT_EXCEEDED, TOKEN_ALL));
    ...
    private void cancelSafemodeAlarm() {
        ...
        getHandler().removeMessages(EVENT_SAFEMODE_TIMEOUT_EXCEEDED);
    }
    ...
    private abstract class BaseState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            // Release the Message-processing WakeLock if the Handler is empty. getHandler() can't
            // be null here since it's still actively processing a message.
    ...
    private class DisconnectingState extends ActiveBaseState {
        ...
        protected void exitState() throws Exception {
            ...
            getHandler().removeMessages(EVENT_TEARDOWN_TIMEOUT_EXPIRED);
        }
    }
