...
public class TelephonySubscriptionTracker extends BroadcastReceiver {
    ...
    public void handleSubscriptionsChanged() {
        ...
        if (allSubs == null || allSubs.isEmpty()) {
            return; // No way to verify subscriptions
        }
    ...
    public static class TelephonySubscriptionSnapshot {
         ...
         */
        @NonNull
        public List<Integer> getAllSubIdsInGroup(ParcelUuid subGrp) {
            final List<Integer> subIds = new ArrayList<>();
