        ...
        TreeSet<UnderlyingNetworkRecord> sorted =
                new TreeSet<>(
                        UnderlyingNetworkRecord.getComparator(
                                mLastSnapshot, mCurrentRecord, mCarrierConfig));
        ...
        private static Comparator<UnderlyingNetworkRecord> getComparator(
            ...
            return (left, right) -> {
                return Integer.compare(
                        left.calculatePriorityClass(snapshot, currentlySelected, carrierConfig),
                        right.calculatePriorityClass(snapshot, currentlySelected, carrierConfig));
            };
        }
