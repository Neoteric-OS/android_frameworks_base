...
/**
 * Tracks a set of Networks underpinning a VCN tunnel.
 *
 * <p>A single UnderlyingNetworkTracker is built to serve a SINGLE VCN tunnel, and MUST be torn down
 * with the VCN tunnel in order to ensure underlying networks are allowed to be reaped.
 *
 * @hide
 */
