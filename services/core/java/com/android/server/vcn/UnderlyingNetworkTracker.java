...
public class UnderlyingNetworkTracker {
    ...
    private void registerOrUpdateNetworkRequests() {
        ...
        if (!mIsQuitting) {
            ...
            mConnectivityManager.requestBackgroundNetwork(
                    getBaseNetworkRequest().build(), mHandler, mRouteSelectionCallback);
    ...
    private NetworkRequest getWifiNetworkRequest() {
        return getBaseNetworkRequest().addTransportType(NetworkCapabilities.TRANSPORT_WIFI).build();
    }

    private NetworkRequest getCellNetworkRequestForSubId(int subId) {
        return getBaseNetworkRequest()
     ...
     */
    private NetworkRequest.Builder getBaseNetworkRequest() {
