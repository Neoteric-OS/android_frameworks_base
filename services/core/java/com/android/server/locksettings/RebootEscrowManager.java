...
class RebootEscrowManager {
    ...
    private static final int DEFAULT_LOAD_ESCROW_DATA_RETRY_INTERVAL_SECONDS = 60;
    ...
    void loadRebootEscrowDataIfAvailable(Handler retryHandler) {
        ...
        mInjector.postDelayed(
                retryHandler, () -> mRebootEscrowTimedOut = true, DEFAULT_WAKE_LOCK_TIMEOUT_MILLIS);
        mInjector.post(
                retryHandler,
