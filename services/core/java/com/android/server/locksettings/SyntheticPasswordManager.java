...
class SyntheticPasswordManager {
    ...
    private WeaverSlotData weaverEnroll(IGateWeaver weaver, int slot, byte[] key) {
        ...
        try {
            ...
            Slog.e(TAG, "Gateweaver create arc call failed with RemoteException, slot: " + slot, e);
            return null;
        } catch (ServiceSpecificException e) {
            Slog.e(
                    TAG,
                    "Gateweaver create arc call failed with SecurityException, slot: " + slot,
                    e);
            return null;
        }
    }
    ...
    // Create new gateweaver specific arcs for a given credential
