...
class PackageManagerShellCommand extends ShellCommand {
    ...
    private static final Set<String> UNSUPPORTED_HIGH_LEVEL_INSTALL_OPTS = Set.of(
            "--multi-package"
    );
    private static final Set<String> UNSUPPORTED_LOW_LEVEL_INSTALL_OPTS = Collections.emptySet();
    ...
    private int runStreamingInstall() throws RemoteException {
        final InstallParams params = makeInstallParams(UNSUPPORTED_HIGH_LEVEL_INSTALL_OPTS);
    ...
    private int runInstall() throws RemoteException {
        return doRunInstall(makeInstallParams(UNSUPPORTED_HIGH_LEVEL_INSTALL_OPTS));
    }
    ...
    private int runInstallCreate() throws RemoteException {
        final PrintWriter pw = getOutPrintWriter();
        final InstallParams installParams = makeInstallParams(UNSUPPORTED_LOW_LEVEL_INSTALL_OPTS);
