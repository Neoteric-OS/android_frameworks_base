...
final class InstallPackageHelper {
    ...
    public void restoreAndPostInstall(InstallRequest request) {
        ...
        // app and restore must take place, therefore, we need to look into the removedUsers array to
        // make sure that the app is not considered removed for the current user.
