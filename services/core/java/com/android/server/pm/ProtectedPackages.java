...
public class ProtectedPackages {
    ...
    public ProtectedPackages(Context context) {
        ...
        final String networkStackPackage = mContext.getResources().getString(
                R.string.config_networkStackPackage);
        if (!TextUtils.isEmpty(networkStackPackage)) {
            mDeviceProtectedPackages.add(networkStackPackage);
        }
    }
