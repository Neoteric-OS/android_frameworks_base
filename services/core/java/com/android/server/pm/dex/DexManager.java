...
public class DexManager {
    ...
    // This will be reported in place of a class loader context when an unknown class loader was
    // used to load a dex file. Keep in sync with DexLoadReporter#UNSUPPORTED_CLASS_LOADER.
    private static final String UNSUPPORTED_CLASS_LOADER = "=UnsupportedClassLoader=";
    ...
    /*package*/ void notifyDexLoadInternal(ApplicationInfo loadingAppInfo,
        ...
        for (Map.Entry<String, String> mapping : classLoaderContextMap.entrySet()) {
            ...
            if (searchResult.mOutcome != DEX_SEARCH_NOT_FOUND) {
                ...
                if (VMRuntime.isValidClassLoaderContext(classLoaderContext)) {
