    ...
    /*package*/ void notifyDexLoadInternal(ApplicationInfo loadingAppInfo,
        ...
        for (Map.Entry<String, String> mapping : classLoaderContextMap.entrySet()) {
            ...
            if (searchResult.mOutcome != DEX_SEARCH_NOT_FOUND) {
                ...
                // simple to always override the context for system server. This way, the context
                // will always be up to date and we will prevent  merging which could lead to the
                // the context being marked as variable and thus making dexopt impossible.
