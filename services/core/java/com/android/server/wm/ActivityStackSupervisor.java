...
public class ActivityStackSupervisor implements RecentTasks.Callbacks {
    ...
    private static final int IDLE_TIMEOUT = 10 * 1000 * Build.TIMEOUT_MULTIPLIER;

    /** How long we can hold the sleep wake lock before giving up. */
    private static final int SLEEP_TIMEOUT = 5 * 1000 * Build.TIMEOUT_MULTIPLIER;

    // How long we can hold the launch wake lock before giving up.
    private static final int LAUNCH_TIMEOUT = 10 * 1000 * Build.TIMEOUT_MULTIPLIER;
