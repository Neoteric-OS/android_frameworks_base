...
public class BackgroundActivityStartController {
    ...
    private static final String TAG = TAG_WITH_CLASS_NAME ? "BackgroundActivityStarter" : TAG_ATM;
    ...
    BackgroundActivityStartController(
            final ActivityTaskManagerService service,
            final RootWindowContainer rootWindowContainer,
            final ActivityTaskSupervisor supervisor) {
        mService = service;
