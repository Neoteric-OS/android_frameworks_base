            ...
            if (TextUtils.isEmpty(targetLastImiId)
                ...
                if (enabled != null) {
                    ...
                    final Locale locale = mCurrentSubtype == null
                            ...
                            : mCurrentSubtype.getLocaleClass();
                    for (int i = 0; i < N; ++i) {
        ...
        for (InputMethodInfo imi: imis) {
            ...
            if (mCurrentSubtype != null) {
                subtype = InputMethodUtils.findLastResortApplicableSubtypeLocked(
                        mRes, enabledSubtypes, mode, mCurrentSubtype.getLocaleClass(), false);
            }
            ...
            if (subtype == null && mCurrentSubtype != null) {
                subtype = InputMethodUtils.findLastResortApplicableSubtypeLocked(
                        mRes, subtypesForSearch, mode, mCurrentSubtype.getLocaleClass(), false);
            }
