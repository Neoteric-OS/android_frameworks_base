...
public class NsdService extends INsdManager.Stub {
    ...
    private void notifyEnabled(boolean isEnabled) {
        mNsdStateMachine.sendMessage(enabledMessage(isEnabled));
    }

    private static int enabledMessage(boolean isEnabled) {
        return isEnabled ? NsdManager.ENABLE : NsdManager.DISABLE;
    }
