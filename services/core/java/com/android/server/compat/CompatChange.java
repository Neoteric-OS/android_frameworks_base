...
public final class CompatChange extends CompatibilityChangeInfo {
    ...
    private boolean mFromApex;

    public CompatChange(long changeId, boolean fromApex) {
        this(changeId, null, -1, -1, false, false, null, false, fromApex);
    }
    ...
    boolean isEnabled(ApplicationInfo app, AndroidBuildClassifier buildClassifier) {
        ...
        if (getEnableSinceTargetSdk() != -1) {
            ...
            if (compareSdk != app.targetSdkVersion && !getFromApex()) {
