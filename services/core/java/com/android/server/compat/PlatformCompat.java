...
public final class PlatformCompat {
    ...
    private static final PlatformCompat sInstance = new PlatformCompat();
     ...
     */
    public static PlatformCompat get() {
        return sInstance;
    }
    ...
    public long[] getDisabledChanges(ApplicationInfo app) {
        ...
        // Note: we don't need to explicitly sort the array, as tjhe behaviour of LongSparseArray
    ...
    /**
     * Overrides the enabled state for a given change and app. This method us intended to be used
