...
public class PlatformCompat extends IPlatformCompat.Stub {
    ...
    private final IOverrideValidator mOverrideValidator;
    private final IAndroidBuildClassifier mAndroidBuildClassifier;
    ...
    public PlatformCompat(Context context) {
        ...
        mAndroidBuildClassifier = new AndroidBuildClassifierImpl();
        mOverrideValidator = new OverrideValidatorImpl(mAndroidBuildClassifier,
                context.getPackageManager(), mCompatConfig);
    }

    @VisibleForTesting
    PlatformCompat(Context context, CompatConfig compatConfig,
                   IAndroidBuildClassifier androidBuildClassifier,
                   IOverrideValidator overrideValidator) {
        mContext = context;
        mChangeReporter = new ChangeReporter(
                StatsLog.APP_COMPATIBILITY_CHANGE_REPORTED__SOURCE__SYSTEM_SERVER);
        mCompatConfig = compatConfig;
        mAndroidBuildClassifier = androidBuildClassifier;
        mOverrideValidator = overrideValidator;
    }
    ...
    public void setOverrides(CompatibilityChangeConfig overrides, String packageName) {
        mCompatConfig.addOverrides(overrides, packageName, mOverrideValidator);
    ...
    public void clearOverrides(String packageName) {
        mCompatConfig.removePackageOverrides(packageName, mOverrideValidator);
        killPackage(packageName);
    }
    ...
    public boolean clearOverride(long changeId, String packageName) {
        boolean existed = mCompatConfig.removeOverride(changeId, packageName, mOverrideValidator);
        killPackage(packageName);
        return existed;
    }
    ...
    @Override
    public IAndroidBuildClassifier getAndroidBuildClassifier() {
        return mAndroidBuildClassifier;
    }
