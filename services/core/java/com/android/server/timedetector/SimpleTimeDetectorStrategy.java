...
public final class SimpleTimeDetectorStrategy implements TimeDetectorStrategy {
    ...
    @NonNull
    private final LocalLog mTimeChangesLog = new LocalLog(30, false /* uesLocalTimestamps */);
    ...
    @GuardedBy("this")
    private boolean validateAndStorePhoneSuggestion(
            @NonNull PhoneTimeSuggestion timeSuggestion) {
    ...
    @VisibleForTesting
    @Nullable
    public synchronized PhoneTimeSuggestion findBestSuggestionForTests() {
