...
// TODO EventLog calls where useful
// TODO Check logging best practices
...
public final class RulesManagerService extends IRulesManager.Stub {
    ...
    private class InstallRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                sendFinishedStatus(mCallback, RulesManager.ERROR_UNKNOWN_FAILURE);
            } finally {
        ...
        private int mapInstallerResultToApiCode(int installerResult) {
            switch (installerResult) {
                ...
                case TimeZoneDistroInstaller.INSTALL_FAIL_BAD_DISTRO_STRUCTURE:
                    return RulesManager.ERROR_INSTALL_BAD_DISTRO_STRUCTURE;
                case TimeZoneDistroInstaller.INSTALL_FAIL_RULES_TOO_OLD:
                    return RulesManager.ERROR_INSTALL_RULES_TOO_OLD;
                case TimeZoneDistroInstaller.INSTALL_FAIL_BAD_DISTRO_FORMAT_VERSION:
                    return RulesManager.ERROR_INSTALL_BAD_DISTRO_FORMAT_VERSION;
                case TimeZoneDistroInstaller.INSTALL_FAIL_VALIDATION_ERROR:
                    return RulesManager.ERROR_INSTALL_VALIDATION_ERROR;
                default:
                    return RulesManager.ERROR_UNKNOWN_FAILURE;
            }
        }
    }
    ...
    private class UninstallRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                int resultCode = success ? RulesManager.SUCCESS
                        : RulesManager.ERROR_UNKNOWN_FAILURE;
                sendFinishedStatus(mCallback, resultCode);
            } catch (Exception e) {
    ...
    @Override
    public void checkComplete(byte[] checkTokenBytes, boolean success) {
        mPermissionHelper.enforceCallerHasPermission(REQUIRED_UPDATER_PERMISSION);

        // TODO Make async? Do off thread?
