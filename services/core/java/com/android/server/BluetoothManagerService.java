        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_HANDLE_ENABLE_DELAYED:
                    Slog.d(TAG, "MESSAGE_HANDLE_ENABLE_DELAYED");
                    // The Bluetooth is turning off in progress, wait for STATE_OFF
                ...
                case MESSAGE_HANDLE_DISABLE_DELAYED:
                    ...
                    if (!disabling) {
                        // The Bluetooth is turning on in progress, wait for STATE_ON
                        ...
                        // The Bluetooth is turning off in progress, wait for exiting STATE_ON
                        if (mWaitForDisableRetry >= MAX_WAIT_FOR_ENABLE_DISABLE_RETRIES
                                || mState != BluetoothAdapter.STATE_ON) {
