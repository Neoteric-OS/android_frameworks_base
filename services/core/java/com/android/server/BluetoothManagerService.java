        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_ENABLE:
                    ...
                    try {
                        ...
                        if (!mEnable && (mBluetooth != null)
                            ...
                            Slog.d(TAG, "postpone enable BT in unstable state");
                ...
                case MESSAGE_DISABLE:
                    ...
                    try {
                        mBluetoothLock.readLock().lock();
                        if (mEnable && (mBluetooth != null) && (mBluetooth.getState()
                ...
                case MESSAGE_DISABLE_TIMEOUT:
                    Slog.d(TAG, "[BTFM] handleMessage(), DISABLE_TIMEOUT");
                    mHandler.removeMessages(MESSAGE_DISABLE);
                    break;

                case MESSAGE_ENABLE_TIMEOUT:
                    Slog.d(TAG, "[BTFM] handleMessage(), ENABLE_TIMEOUT");
