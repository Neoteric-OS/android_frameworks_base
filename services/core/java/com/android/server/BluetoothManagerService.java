...
class BluetoothManagerService extends IBluetoothManager.Stub {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (BluetoothAdapter.ACTION_BD_ADDR_CHANGED.equals(action)) {
                String newAddress = intent.getStringExtra(BluetoothAdapter.EXTRA_BD_ADDR);
                if (newAddress != null) {
    ...
    BluetoothManagerService(Context context) {
        ...
        IntentFilter filter2 = new IntentFilter(BluetoothAdapter.ACTION_BD_ADDR_CHANGED);
