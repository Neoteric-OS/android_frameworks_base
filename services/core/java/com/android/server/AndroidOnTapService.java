 ...
 * It provides permission check before passing requests to gsid
 */
public class AndroidOnTapService extends IAndroidOnTapService.Stub implements DeathRecipient {
