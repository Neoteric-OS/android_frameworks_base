...
public class IpSecService extends IIpSecService.Stub {
    ...
    public class RefcountedResource<T extends IResource> implements IBinder.DeathRecipient {
         ...
         *     and the other system service manages the lifecycle of the resource for us.
         * 3. an actual binder, to ensure we can cleanup after users that forget to close their
         *     resources.
         */
