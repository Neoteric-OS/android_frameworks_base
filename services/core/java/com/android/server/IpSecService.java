...
public class IpSecService extends IIpSecService.Stub {
    ...
    static final class UserRecord {
        /* Type names */
        public static final String TYPENAME_SPI = SpiRecord.class.getSimpleName();
        public static final String TYPENAME_TRANSFORM = TransformRecord.class.getSimpleName();
        public static final String TYPENAME_ENCAP_SOCKET = EncapSocketRecord.class.getSimpleName();
         ...
         * that it is possible that a user calling releaseResource() will not return their quota if
     ...
     *
     * <p>This class allows for relating kernel resources with the UID on whose behalf the resources
     * were allocated.
     */
    ...
    /**
     * Tracks a pair of SAs in the kernel, and manages cleanup paths. Once a TransformRecord is
     * created, the two SPI records that originally tracked the SAs will reliquish the
     * responsibility of freeing the underlying SAs to this class.
     */
