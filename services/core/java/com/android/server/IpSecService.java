...
public class IpSecService extends IIpSecService.Stub {
    ...
    public static class ResourceTracker {
        ...
        public String toString() {
            return new StringBuilder().append("{mCurrent=").append(mCurrent)
                            .append(", mMax=").append(mMax).append("}").toString();
        }
    }

    private static final class UserQuotaTracker {
        public static final int MAX_NUM_SOCKETS = 2;
        ...
        public static class UserRecord {
            ...
            @Override
            public String toString() {
                return new StringBuilder().append("{socket=").append(socket)
    ...
    private abstract class ManagedResource implements IBinder.DeathRecipient {
        ...
        @Override
        public String toString() {
            return new StringBuilder().append("{mResourceId=")
                            .append(mResourceId)
                            .append(", pid=").append(pid)
                            .append(", uid=").append(uid)
                            .append(", mReferenceCount=")
                            .append(mReferenceCount.get()).append("}").toString();
        }
    };
    ...
    private final class TransformRecord extends ManagedResource {
        ...
        public String toString() {
            ...
            strBuilder.append("{super=")
                    ...
                    .append(", mConfig=").append(mConfig).append("}");
    ...
    private final class SpiRecord extends ManagedResource {
        ...
        public String toString() {
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.append("{super=").append(super.toString())
                    .append(", mSpi=").append(mSpi)
                    .append(", mDirection=").append(mDirection)
                    .append(", mLocalAddress=").append(mLocalAddress)
                    .append(", mRemoteAddress=").append(mRemoteAddress)
                    .append(", mOwnedByTransform=").append(mOwnedByTransform).append("}");
            return strBuilder.toString();
        }
    }
