...
public class AudioService extends IAudioService.Stub
    ...
    */
     ...
     * It prevents to unnecessary {@see AudioSystem#setStreamVolume} done for each stream and aliased
    ...
    protected void adjustStreamVolume(int streamType, int direction, int flags,
        ...
        if (adjustVolume
            ...
            if (streamTypeAlias == AudioSystem.STREAM_MUSIC
                ...
                mDeviceBroker.postSetAvrcpAbsoluteVolumeIndex((newIndex + 5) / 10);
            }
    ...
    private class VolumeGroupState {
        ...
        private void setVolumeIndex(int index, int device, int flags) {
            ...
            final boolean changed = mute(index == mIndexMin);
            if (!changed) {
            ...
            synchronized (VolumeStreamState.class) {
                ...
                switch (direction) {
                    ...
                    case AudioManager.ADJUST_LOWER:
                        ...
                        if (isMuted() && previousIndex != mIndexMin) {
                            mute(false);
                        } else {
                ...
                for (int i = 0; i < mIndexMap.size(); i++) {
                    ...
                    if (device != AudioSystem.DEVICE_OUT_DEFAULT) {
                        ...
                        if (!synced) {
                            ...
                            setVolumeIndexInt(isMuted() ? mIndexMin : index, device, 0 /*flags*/);
                        }
                    }
                }
    ...
    private class VolumeStreamState {
        ...
        public void doMute() {
            synchronized (VolumeStreamState.class) {
                // If associated to volume group, update group cache
                Log.v(TAG, "updateVolumeGroupIndex FROM MUTE for stream " + mStreamType);
