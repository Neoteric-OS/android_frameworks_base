    ...
    */
    ...
    public void onSystemReady() {
        ...
        if (isMicMuted != InputManager.SWITCH_STATE_UNKNOWN) {
            setMicMuteFromSwitch(im.isMicMuted() != InputManager.SWITCH_STATE_OFF,
    ...
    private void setMicMuteFromSwitch(boolean on, int userId) {
    ...
    public void setMicrophoneMuteFromSwitch(boolean on) {
        setMicMuteFromSwitch(on, Binder.getCallingUid());
    }
