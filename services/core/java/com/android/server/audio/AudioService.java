...
public class AudioService extends IAudioService.Stub
   ...
   /** Maximum volume index values for audio streams */
                ...
                if (mBluetoothHeadset != null) {
                    if (mBluetoothHeadsetDevice == null) {
                        ...
                        if (activeDevice != null) {
                            // This might trigger resetBluetoothSco() which will call
                            // setBluetoothScoOnInt(false, "resetBluetoothSco")
                            // Thus it won't end up in an infinite recursion, but future refactor
                            // effort should be aware of this
    ...
    private boolean handleBtScoActiveDeviceChange(BluetoothDevice btDevice, boolean isActive) {
        ...
        result = result && handleDeviceConnection(isActive, inDevice, address, btDeviceName);
        return result;
    }
