...
public class AudioDeviceBroker {
    ...
    /*package*/ void setHearingAidTimeout(String address, int delayMs) {
        sendLMsg(MSG_IL_BTHEARINGAID_TIMEOUT, SENDMSG_QUEUE, address, delayMs);
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_IIL_BTLEAUDIO_TIMEOUT:
                    ...
                    break;
                case MSG_IL_BTHEARINGAID_TIMEOUT:
    ...
    private static final int MSG_IL_BTHEARINGAID_TIMEOUT = 60;
