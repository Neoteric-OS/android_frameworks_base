...
public class NetIdManager {
    ...
    public static final int MAX_NET_ID = 65535 - 0x0400; // Top 1024 IDs reserved by IpSecService
    ...
    /**
     * Get the first netId that is greater than or equal to the provided nextNetId and is available.
     */
