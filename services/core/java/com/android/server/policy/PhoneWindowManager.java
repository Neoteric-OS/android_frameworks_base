...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private static final String ATTR_KEY_INTERCEPT_DELAY_MILLIS = "keyInterceptDelayMillis";
    private static final String ATTR_KEY_COMBINE_DELAY_MILLIS = "keyCombineDelayMillis";
    private static final String ATTR_MINIMUM_PRESS_TIME_MILLIS = "minimumComboPressTimeMillis";
