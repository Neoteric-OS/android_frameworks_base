...
final class LocaleUtils {
    ...
    private static byte calculateMatchingSubScore(@NonNull final ULocale supported,
        ...
        // Since addLikelySubtags can change subtags for reassigned tags, e.g. the country code
        // of CS, an locale with identical script and country before addLikelySubtags is in favour,
