...
public class NetworkAgentInfo implements Comparable<NetworkAgentInfo> {
     ...
     * not a speculative network (i.e. kept pending validation when validation would have it outscore
     * another foreground network). That implies it is kept up by some background request (otherwise
     * it would be torn down), maybe the mobile always-on request.
     */
