    ...
    class TetherMasterSM extends StateMachine {
        ...
        class TetherMasterUtilState extends State {
            ...
            protected void chooseUpstreamType(boolean tryCell) {
                ...
                final int upstreamType = findPreferredUpstreamType(mConfig);
            ...
            protected int findPreferredUpstreamType(TetheringConfiguration cfg) {
                return mUpstreamNetworkMonitor.selectPreferredUpstreamType(
                        cfg.preferredUpstreamIfaceTypes);
            }
