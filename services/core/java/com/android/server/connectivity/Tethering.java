...
public class Tethering extends BaseNetworkObserver {
    ...
    public Tethering(Context context, INetworkManagementService nmService,
        ...
        UserManagerInternal userManagerIntern = LocalServices.getService(UserManagerInternal.class);

        // this check is useful only for some unit tests; example: ConnectivityServiceTest
        if (userManagerIntern != null) {
            userManagerIntern.addUserRestrictionsListener(new TetheringUserRestrictionListener(this));
        }
