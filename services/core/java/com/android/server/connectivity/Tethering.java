...
public class Tethering extends BaseNetworkObserver implements IControlsTethering {
    ...
    public Tethering(Context context, INetworkManagementService nmService,
        ...
        mUpstreamNetworkMonitor = new UpstreamNetworkMonitor(
                context, mTetherMasterSM, TetherMasterSM.EVENT_UPSTREAM_CALLBACK);
    ...
    /**
     * Creates a proxy {@link ResultReceiver} which enables tethering if the provisioning result is
    ...
    class TetherMasterSM extends StateMachine {
        ...
        class TetherMasterUtilState extends State {
            ...
            protected boolean turnOnUpstreamMobileConnection(int apnType) {
                ...
                final boolean dunRequired = (apnType == ConnectivityManager.TYPE_MOBILE_DUN);
                mUpstreamNetworkMonitor.requestMobileUpstream(dunRequired);
                return true;
            }

            protected void turnOffUpstreamMobileConnection() {
                mUpstreamNetworkMonitor.releaseMobileUpstream();
