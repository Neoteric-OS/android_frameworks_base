...
public class Tethering extends BaseNetworkObserver implements IControlsTethering {
    ...
    public void interfaceStatusChanged(String iface, boolean up) {
        ...
        if (interfaceType == ConnectivityManager.TETHERING_INVALID) return;
        ...
        if (up) {
            ...
            switch (interfaceType) {
                case ConnectivityManager.TETHERING_BLUETOOTH:
                    post(() -> {
                        synchronized (mPublicSync) {
                            stopTrackingTetherableInterface(iface);
                        }
                    });
                    break;
    ...
    private void stopTrackingTetherableInterface(String iface) {
        final TetherState tetherState = mTetherStates.get(iface);
