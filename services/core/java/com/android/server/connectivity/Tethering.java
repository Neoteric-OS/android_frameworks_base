...
public class Tethering extends BaseNetworkObserver {
    ...
    public Tethering(Context context, INetworkManagementService nmService,
        ...
        mEntitleMgr = mDeps.getEntitlementManager(mContext, mTetherMasterSM, mLog,
                TetherMasterSM.EVENT_MOBILE_UPSTREAM_PERMITTED_CHANGE, systemProperties);
    ...
    public void startTethering(int type, ResultReceiver receiver, boolean showProvisioningUi) {
        boolean up = mDeps.isCellularDefaultInternet();
        mEntitleMgr.setCellularDefaultInternetUp(up);
        mEntitleMgr.startProvisioningIfNeeded(type, showProvisioningUi);
        enableTetheringInternal(type, true, receiver);
    }

    public void stopTethering(int type) {
        enableTetheringInternal(type, false, null);
        mEntitleMgr.stopProvisioningIfNeeded(type);
    }
    ...
    class TetherMasterSM extends StateMachine {
        ...
        static final int EVENT_MOBILE_UPSTREAM_PERMITTED_CHANGE = BASE_MASTER + 8;
        ...
        class TetherModeAliveState extends State {
            ...
            public void enter() {
                ...
                mUpstreamNetworkMonitor.start(mDeps.getDefaultNetworkRequest(), mEntitleMgr);
