...
public class Tethering extends BaseNetworkObserver {
    ...
    public Tethering(Context context, INetworkManagementService nmService,
        ...
        mMasterHandler = mTetherMasterSM.getHandler();
        mOffloadController = new OffloadController(mMasterHandler,
                mDeps.getOffloadHardwareInterface(mMasterHandler, mLog),
        ...
        mCarrierConfigChange = new VersionedBroadcastListener(
                "CarrierConfigChangeListener", mContext, mMasterHandler, filter,
                (Intent ignored) -> {
        ...
        mDefaultSubscriptionChange = new VersionedBroadcastListener(
                "DefaultSubscriptionChangeListener", mContext, mMasterHandler, filter,
                (Intent ignored) -> {
        ...
        startStateMachineUpdaters(mMasterHandler);
    }
    ...
    class TetherMasterSM extends StateMachine {
        ...
        protected void chooseUpstreamType(boolean tryCell) {
            ...
            if (mTetherUpstream != newUpstream) {
                ...
                reportUpstreamChangedLocked(mTetherUpstream);
            }
        }
        ...
        class TetherModeAliveState extends State {
            ...
            public void exit() {
                ...
                if (mTetherUpstream != null) {
                    ...
                    reportUpstreamChangedLocked(null);
                }
            }
    ...
    private void reportUpstreamChangedLocked(Network network) {
