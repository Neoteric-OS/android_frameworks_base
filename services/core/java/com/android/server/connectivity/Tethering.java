...
public class Tethering extends BaseNetworkObserver {
    ...
    public Tethering(Context context, INetworkManagementService nmService,
        ...
        mEntitlementMgr = mDeps.getEntitlementManager(mContext, mTetherMasterSM, mLog,
                TetherMasterSM.EVENT_MOBILE_UPSTREAM_PERMISSION_CHANGED, systemProperties);
    ...
    public void startTethering(int type, ResultReceiver receiver, boolean showProvisioningUi) {
        ...
        mEntitlementMgr.setCellularIsDefaultInternetUpstream(up);
    ...
    class TetherMasterSM extends StateMachine {
        ...
        static final int EVENT_MOBILE_UPSTREAM_PERMISSION_CHANGED = BASE_MASTER + 8;
        ...
        class TetherModeAliveState extends State {
            ...
            public void enter() {
                ...
                mUpstreamNetworkMonitor.start(mDeps.getDefaultNetworkRequest(), mEntitlementMgr);
            ...
            public boolean processMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case EVENT_MOBILE_UPSTREAM_PERMISSION_CHANGED:
