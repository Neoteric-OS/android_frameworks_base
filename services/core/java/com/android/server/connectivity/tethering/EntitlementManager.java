 ...
 *
 * This class does not require locking when accessed from same handler thread.
 * Access from other threads is not advised.
 * @hide
 */
public class EntitlementManager {
    ...
    // While round-trip parceling is not great, there is currently has no other way of
    // generating a vanilla instance of ResultReceiver because all its fields are private.
