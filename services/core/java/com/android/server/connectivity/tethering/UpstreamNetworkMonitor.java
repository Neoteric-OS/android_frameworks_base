...
public class UpstreamNetworkMonitor {
    ...
    public UpstreamNetworkMonitor(Context ctx, SharedLog log, StateMachine tgt, int what) {
        mContext = ctx;
    ...
    public UpstreamNetworkMonitor(
            SharedLog log, StateMachine tgt, int what, ConnectivityManager cm) {
        this(null, log, tgt, what);
        mCM = cm;
    }
