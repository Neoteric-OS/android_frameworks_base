...
public class UpstreamNetworkMonitor {
    ...
    private static final IpPrefix[] MINIMUM_LOCAL_PREFIXES_SET = {
            prefix("127.0.0.0/8"), prefix("127.0.0.1/32"),
            prefix("::1/128"), prefix("fe80::/64"),
    };
    ...
    public Set<IpPrefix> getOffloadExemptPrefixes() {
        return new HashSet<>(mOffloadExemptPrefixes);
    }
    ...
    private void recomputeOffloadExemptPrefixes() {
        ...
        if (!mOffloadExemptPrefixes.equals(exemptPrefixes)) {
            ...
            notifyTarget(NOTIFY_EXEMPT_PREFIXES, exemptPrefixes);
        }
    }
    ...
    private static Set<IpPrefix> allOffloadExemptPrefixes(Iterable<NetworkState> networkStates) {
