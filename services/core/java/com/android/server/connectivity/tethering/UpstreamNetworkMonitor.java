...
public class UpstreamNetworkMonitor {
    ...
    private boolean mDefaultCelluar;
    ...
    /**
     * Tracking the system default network, this method should be called when system ready.
     *
     * @param defaultNetworkRequest Should be the same as ConnectivityService default request
     * @param entitle EntitlementManager want to know if default network is cellular or not.
     */
    ...
    private class UpstreamNetworkCallback extends NetworkCallback {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities newNc) {
            if (mCallbackType == CALLBACK_DEFAULT_INTERNET) {
                ...
                if (mDefaultCelluar != isCellular(newNc)) {
                    mDefaultCelluar = !mDefaultCelluar;
                    mEntitlementMgr.setCellularIsDefaultInternetUpstream(mDefaultCelluar);
                }
                return;
            }
