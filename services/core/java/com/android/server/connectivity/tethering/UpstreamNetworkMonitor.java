...
public class UpstreamNetworkMonitor {
    ...
    // The current default upstream is mobile or not.
    ...
    public NetworkState selectPreferredUpstreamType(Iterable<Integer> preferredTypes) {
        ...
        switch (typeStatePair.type) {
            ...
            case TYPE_MOBILE_HIPRI:
                // Tethering select mobile upstream when default upstream is not mobile.
                ...
                break;
            case TYPE_NONE:
                // If mobile data is not permitted as upstream connection,
                // mobile network request should be released.
                if (isCellularUpstreamPermitted()) break;
            default:
    ...
    private class UpstreamNetworkCallback extends NetworkCallback {
        ...
        public void onCapabilitiesChanged(Network network, NetworkCapabilities newNc) {
            if (mCallbackType == CALLBACK_DEFAULT_INTERNET) {
                ...
                if (mIsDefaultCellularUpstream != isCellular(newNc)) {
                    mIsDefaultCellularUpstream = !mIsDefaultCellularUpstream;
                    mEntitlementMgr.notifyUpstream(mIsDefaultCellularUpstream);
                }
                return;
            }
