...
public class TetheringConfiguration {
    ...
    private static Collection<Integer> getUpstreamIfaceTypes(Resources res, boolean dunRequired) {
        ...
        if (dunRequired) {
            ...
            // This preserves backwards compatibility and prevent DUN, default mobile
            // types appear together problem that previous releases had in the common
            // case where checkDunRequired returned DUN_UNSPECIFIED.
