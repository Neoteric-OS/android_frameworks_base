...
public class ProxyTracker {
    ...
    // When the system is operating under a VPN, the default proxy should be mVPNProxy, and
    // otherwise mDefaultProxy. This member is true if mDefaultProxy is in use, false if mVPNProxy
    // is in use.
    @GuardedBy("mProxyLock")
