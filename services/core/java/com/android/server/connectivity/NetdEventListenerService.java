...
public class NetdEventListenerService extends INetdEventListener.Stub {
    ...
    @Override
    public synchronized void onWakeupEvent(String prefix, int uid, int gid, int ethertype,
            int ipProtocol, byte[] dstHw, String srcIp, String dstIp, int srcPort, int dstPort,
            long timestampNs) {
