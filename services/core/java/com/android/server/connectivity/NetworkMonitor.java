...
public class NetworkMonitor extends StateMachine {
    ...
    private int mFallbackUrlIndex = -1;
    ...
    private URL[] makeCaptivePortalFallbackUrls(Context context) {
        ...
        String joinedUrls = firstUrl + "," + getSetting(context,
        ...
        if (urls.isEmpty()) {
            Log.e(TAG, String.format("could not create any url from %s", firstUrl, joinedUrls));
        }
