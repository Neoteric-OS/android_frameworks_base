...
public class NetworkMonitor extends StateMachine {
        ...
        public boolean processMessage(Message message) {
            switch (message.what) {
                ...
                case CMD_PRIVATE_DNS_SETTINGS_CHANGED: {
                    ...
                    //         no DNS-over-TLS server, et cetera).
    ...
    private class EvaluatingPrivateDnsState extends State {
        ...
        public void enter() {
            ...
            sendMessageAtFrontOfQueue(CMD_EVALUATE_PRIVATE_DNS);
        }
        ...
        @Override
        public void exit() {
            // If we're transitioning back to, say, EvaluatingState, clear any
            // enqueued Private DNS reevaluations. Reevaluation will start again
            // when EvaluatingPrivateDnsState is reentered.
