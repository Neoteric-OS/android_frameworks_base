...
import static android.net.CaptivePortal.HTTP_PROBE_FAILED_CODE;
import static android.net.CaptivePortal.HTTP_PROBE_SUCCESS_CODE;
...
public class NetworkMonitor extends StateMachine {
    ...
    public static final class CaptivePortalProbeResult {
        ...
        boolean isSuccessful() {
            return mHttpResponseCode == HTTP_PROBE_SUCCESS_CODE;
        }

        boolean isPortal() {
            return CaptivePortal.isCaptivePortalProbeResult(mHttpResponseCode);
        }
    ...
    protected CaptivePortalProbeResult sendHttpProbe(URL url, int probeType) {
        ...
        int httpResponseCode = HTTP_PROBE_FAILED_CODE;
        ...
        try {
            ...
            if (httpResponseCode == HTTP_PROBE_FAILED_CODE) {
