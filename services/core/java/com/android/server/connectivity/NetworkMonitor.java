...
public class NetworkMonitor extends StateMachine {
    ...
    private final State mProbeFailReevaluationState = new ProbeFailReevaluationState();
    ...
    protected NetworkMonitor(Context context, Handler handler, NetworkAgentInfo networkAgentInfo,
        ...
        addState(mMaybeNotifyState, mDefaultState);
            addState(mEvaluatingState, mMaybeNotifyState);
                ...
                addState(mProbeFailReevaluationState, mEvaluatingState);
            ...
            switch (message.what) {
                case CMD_PROBE_COMPLETE:
                    ...
                    if (probeResult.isSuccessful()) {
                        ...
                        notifyNetworkTestResultInvalid(probeResult.redirectUrl);
                        transitionTo(mProbeFailReevaluationState);
                    }
                    return HANDLED;
                case EVENT_DNS_NOTIFICATION:
    ...
    // Being in the ProbeFailReevaluationState indicates that evaluating probes failed and state is
    // transited from ProbingState. In ProbingState, most events are deferred. It means it will need
    // to remember to explicitly return HANDLED or NOT_HANDLED in the ProbingState for every new
    // message. Thus, have this state to handle coming or deferred events while waiting for
    // reevaluation and have ProbingState defer most events by default.
    private class ProbeFailReevaluationState extends State {
        @Override
        public void enter() {
