...
import static android.net.ConnectivitySettingsManager.RESTRICTED_ALLOWED_APPS;
...
public class PermissionMonitor {
    ...
    // to uids whose package name is listed in RESTRICTED_ALLOWED_APPS setting.
    @GuardedBy("this")
    private final Set<String> mRestrictedAllowedApps = new ArraySet<>();
    ...
    public static class Dependencies {
        ...
        /**
         * Get restricted allowed apps via ConnectivitySettingsManager.
         */
        public Set<String> getRestrictedAllowedApps(@NonNull Context context) {
            return ConnectivitySettingsManager.getRestrictedAllowedApps(context);
        }
    ...
    public synchronized void startMonitoring() {
        ...
        // Register RESTRICTED_ALLOWED_APPS setting observer
        mDeps.registerContentObserver(
                userAllContext,
                Settings.Secure.getUriFor(RESTRICTED_ALLOWED_APPS),
        ...
        // Read RESTRICTED_ALLOWED_APPS setting and update mRestrictedAllowedApps.
        updateRestrictedAllowedApps(mDeps.getRestrictedAllowedApps(mContext));
    ...
    @VisibleForTesting
    void updateRestrictedAllowedApps(final Set<String> apps) {
        mRestrictedAllowedApps.clear();
        mRestrictedAllowedApps.addAll(apps);
    }
    ...
    @VisibleForTesting
    boolean isRestrictedAllowedApp(@NonNull final PackageInfo app) {
        // Check whether package name is in restricted allowed app list. If so, this app can have
        // netd system permission.
        return mRestrictedAllowedApps.contains(app.packageName);
    }
    ...
    boolean hasRestrictedNetworkPermission(@NonNull final PackageInfo app) {
        ...
        return isCarryoverPackage(app.applicationInfo) || isRestrictedAllowedApp(app)
    ...
    private synchronized void onSettingChanged() {
        // Step1. Update restricted allowed apps and compute the set of packages to update.
        final Set<String> packagesToUpdate = new ArraySet<>(mRestrictedAllowedApps);
        updateRestrictedAllowedApps(mDeps.getRestrictedAllowedApps(mContext));
        packagesToUpdate.addAll(mRestrictedAllowedApps);
