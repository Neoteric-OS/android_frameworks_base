...
public class PermissionMonitor {
    ...
    // Keys are App packageNames, Values are app uids;
    ...
    private class PackageListObserver implements PackageManagerInternal.PackageListObserver {
        ...
        public synchronized void onPackageAdded(String packageName) {
            ...
            try {
                app = mPackageManager.getPackageInfo(packageName,
                        GET_PERMISSIONS);
            } catch (NameNotFoundException e) {
                // App not found.
                Slog.wtf(TAG, "NameNotFoundException " + packageName);
                return;
            }
            ...
            processPackagePermissions(uid, Arrays.asList(app.requestedPermissions));
        ...
        public synchronized void onPackageRemoved(String packageName) {
            ...
            int uid = mPackageNameUidMap.get(packageName);
            SparseIntArray netdPermissionsAppIds = new SparseIntArray();
            netdPermissionsAppIds.put(uid, INetd.NO_PERMISSIONS);
            sendPackagesPermissionsToNetd(netdPermissionsAppIds);
    ...
    public synchronized void startMonitoring() {
        ...
        sendPackagesPermissionsToNetd(netdPermsUids);
    ...
    /**
     * Called by PackageListObserver when a package is installed. Send the requested INTERNET
     * and/or UPDATE_DEVICE_STATS permissions to netd.
     *
     * @param uid the app uid of the package installed
     * @param requestedPermissions the permissions the app requested.
     *
     * @hide
     */
    private void processPackagePermissions(int uid,
     ...
     * @hide
     */
    public static void sendPackagesPermissionsToNetd(SparseIntArray netdPermissionsAppIds) {
