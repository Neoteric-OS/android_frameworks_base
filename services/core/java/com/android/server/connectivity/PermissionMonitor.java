...
public class PermissionMonitor {
    ...
    @VisibleForTesting
    boolean isVendorApp(PackageInfo app) {
        return app.applicationInfo != null ? app.applicationInfo.isVendor() : false;
    }
    ...
    private boolean hasRestrictedNetworkPermission(PackageInfo app) {
        ...
        // request the appropriate permission for their use case after android P.
        if (app.applicationInfo != null
                && app.applicationInfo.targetSdkVersion <= Build.VERSION_CODES.P
                && isVendorApp(app)) {
            return true;
        }
