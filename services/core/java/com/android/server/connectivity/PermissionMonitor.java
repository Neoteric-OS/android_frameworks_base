...
public class PermissionMonitor {
     ...
     *
     * @param appName The name of the new package.
     * @param appUid The uid of the new package.
     *
     * @hide
     */
     ...
     *
     * @param appUid containing the integer uid previously assigned to the package.
     *
     * @hide
     */
