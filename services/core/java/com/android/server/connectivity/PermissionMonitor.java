...
public class PermissionMonitor {
    ...
    private boolean hasRestrictedNetworkPermission(PackageInfo app) {
        ...
        if (app.applicationInfo != null) {
            // Backward compatibility for b/114245686. Give permission for SYSTEM_UID only.
            if (app.applicationInfo.uid == SYSTEM_UID
                    && getDeviceFirstSdkInt() < Build.VERSION_CODES.Q) {
                return true;
            }

            if (app.applicationInfo.targetSdkVersion < Build.VERSION_CODES.Q
