...
public class NetworkNotificationManager {
    ...
    public void showNotification(int id, NotificationType notifyType, NetworkAgentInfo nai,
        ...
        if (nai != null) {
            ...
            if (nai.networkAgentPortalData != null
                    && !TextUtils.isEmpty(nai.networkAgentPortalData.getVenueFriendlyName())) {
                name = nai.networkAgentPortalData.getVenueFriendlyName();
            } else {
