...
public class DnsManager {
    ...
    public void setDnsConfigurationForNetwork(
        ...
        Slog.d(TAG, String.format("setDnsConfigurationForNetwork(%d, %s, %s, %s, %s, %s)",
                netId, stringify(serverStrs), stringify(domainStrs), stringify(params),
                useTls, tlsHostname));
        try {
    ...
    private static String stringify(int[] elements) {
        final StringJoiner sj = makeArrayStringJoiner();
        if (elements != null) for (int e : elements) sj.add(Integer.toString(e));
        return sj.toString();
    }

    private static <T> String stringify(T... elements) {
        final StringJoiner sj = makeArrayStringJoiner();
        if (elements != null) for (T e : elements) sj.add(e.toString());
        return sj.toString();
    }

    private static StringJoiner makeArrayStringJoiner() {
