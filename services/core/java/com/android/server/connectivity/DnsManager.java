 ...
 * Mechanics:
 *     [1] NetworkMonitor is notified and initiates a reevaluation with
 *         Private DNS bypass enabled.
 *     [2] Once completed, NetworkMonitor checks if strict mode is in operation
 *         and if so enqueues another reevaluation, this time without the
 *         bypassing of Private DNS.
 *
 * @hide
 */
