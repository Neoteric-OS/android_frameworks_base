...
public class DataConnectionStats extends BroadcastReceiver {
    ...
    private final void updateSimState(Intent intent) {
        ...
        if (Intent.INTENT_VALUE_SIM_STATE_ABSENT.equals(stateExtra)) {
            mSimState = TelephonyManager.SIM_STATE_ABSENT;
        } else if (Intent.INTENT_VALUE_SIM_STATE_READY.equals(stateExtra)) {
            mSimState = TelephonyManager.SIM_STATE_READY;
        } else if (Intent.INTENT_VALUE_SIM_STATE_LOCKED.equals(stateExtra)) {
            final String lockedReason =
                    intent.getStringExtra(Intent.EXTRA_SIM_LOCKED_REASON);
            if (Intent.INTENT_VALUE_SIM_LOCKED_ON_PIN.equals(lockedReason)) {
                mSimState = TelephonyManager.SIM_STATE_PIN_REQUIRED;
            } else if (Intent.INTENT_VALUE_SIM_LOCKED_ON_PUK.equals(lockedReason)) {
