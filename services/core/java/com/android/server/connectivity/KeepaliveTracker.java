...
public class KeepaliveTracker {
    ...
    class KeepaliveInfo implements IBinder.DeathRecipient {
        ...
        // Max allowed unprivileged keepalive slots. Caller's permission will be enforced if number
        // of existing keepalives reach this limit.
        ...
        private int checkPermission() {
            ...
            for (KeepaliveInfo ki : networkKeepalives.values()) {
                ...
                if (unprivilegedCount >= MAX_UNPRIVILEGED_SLOTS) {
                    return mPrivileged ? SUCCESS : ERROR_HARDWARE_UNSUPPORTED;
                }
            }
            return SUCCESS;
        }
