...
public class KeepaliveTracker {
    ...
    class KeepaliveInfo implements IBinder.DeathRecipient {
        ...
        void stop(int reason) {
            ...
            // might happen when network is about to disconnect but the caller listens for a
            // low-layer callback and stop the keepalive that races with the stop generated
            // in network disconnection code path.
