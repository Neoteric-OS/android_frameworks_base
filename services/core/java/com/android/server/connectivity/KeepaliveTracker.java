...
public class KeepaliveTracker {
    ...
    class KeepaliveInfo implements IBinder.DeathRecipient {
        ...
        // Stores the resoure Id returned by IpSecService.
        private int mEncapResourceId = INVALID_RESOURCE_ID;
        ...
        KeepaliveInfo(@NonNull ISocketKeepaliveCallback callback,
            ...
            mEncapResourceId = INVALID_RESOURCE_ID;
        ...
        public String toString() {
            return "KeepaliveInfo ["
                    ...
                    + " encapRId=" + mEncapResourceId + " encapSocketRId=" + mEncapSocketResourceId
        ...
        private int checkAndLockNattKeepaliveResource() {
            ...
            // Check if the ipsec encapsulated socket resource id is not registered.
            final HashMap<Integer, KeepaliveInfo> networkKeepalives = mKeepalives.get(mNai);
            if (networkKeepalives == null) {
                return ERROR_INVALID_NETWORK;
            }
            for (KeepaliveInfo ki : networkKeepalives.values()) {
                if (ki.mEncapSocketResourceId == mEncapSocketResourceId
                        && ki.mEncapResourceId != INVALID_RESOURCE_ID) {
        ...
        void stop(int reason) {
            ...
            if (mEncapResourceId != INVALID_RESOURCE_ID) {
                try {
                    mIpSec.releaseNattKeepalive(mEncapResourceId, mUid);
                } catch (RemoteException e) {
    ...
    **/
    public void startNattKeepalive(@Nullable NetworkAgentInfo nai,
        ...
        startNattKeepalive(nai, fd, intervalSeconds, cb, srcAddrString, srcPort,
                dstAddrString, dstPort, encapSocketResourceId);
    }
