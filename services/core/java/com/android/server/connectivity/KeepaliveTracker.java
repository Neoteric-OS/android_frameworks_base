...
public class KeepaliveTracker {
    ...
    public void handleEventPacketKeepalive(@Nullable NetworkAgentInfo nai,
   ...
   /**
     ...
     * {@link android.net.SocketKeepalive}.
     *
     * @param nai The {@link NetworkAgentInfo} which contains the network the socket is on.
     * @param fd The file descriptor that needs to be kept alive.
     * @param resourceId The resource index bound to the {@link UdpEncapsulationSocket} which
     *                   created by {@link com.android.server.IpSecService}. Unused if the caller
     *                   is a system app.
     * @param intervalSeconds The target interval in seconds between keepalive packet transmissions.
     * @param messenger The messenger to send messages to the corresponding
     *                  {@link android.net.SocketKeepalive}.
     * @param binder IBinder instance to allow cleanup if the app dies.
     * @param srcAddrString The source address of the {@link UdpEncapsulationSocket}.
     * @param dstAddrString The destination address of the {@link UdpEncapsulationSocket}.
     * @param dstPort The NAT-T destination port for IPsec.
     **/
    public void startNattKeepalive(@Nullable NetworkAgentInfo nai,
     ...
     *
     * @param fd The file descriptor that needs to be verified.
     * @param resourceId The resource index bound to the {@link UdpEncapsulationSocket} which
     *                   created by {@link com.android.server.IpSecService}. Unused if the caller
     *                   is a system app.
     **/
