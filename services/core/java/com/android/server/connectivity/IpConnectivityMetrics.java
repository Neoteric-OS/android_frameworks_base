...
final public class IpConnectivityMetrics extends SystemService {
    ...
    @VisibleForTesting
    final DefaultNetworkMonitor mDefaultNetworkMonitor = new DefaultNetworkMonitor();
    ...
    /*
     * Return a copy of metrics events storred in buffer for metrics uploading.
     */
    ...
    public final class Impl extends IIpConnectivityMetrics.Stub {
        // Dump and flushe the metrics event buffer in base64 encodedserialized proto output.
        static final String CMD_FLUSH   = "flush";
        // Dump the rolling buffer of metrics event in human readable proto text format.
        static final String  CMD_PROTO   = "proto";
        // Command used by dumpsys.cpp for collecting bug report dumps. This dumps the rolling
        // buffer of metrics events and pretty print them in a human readable ad-hoc format. It also
        // prints recent network dns/connect statistics and recent default network events.
        static final String CMD_LIST    = "-a"; // dumpsys.cpp dumps services with "-a" as arguments
    ...
    private class LoggerImpl implements Logger {
        public DefaultNetworkMonitor defaultNetworkMonitor() {
