...
final public class IpConnectivityMetrics extends SystemService {
    ...
    // Buffer of connectivity event used for metrics reporting. This buffer does
    // not rotate automatically and instead saturates when it becomes full. It
    // is flushed at metrics reporting.
    @GuardedBy("mLock")
