...
public class VpnIkev2Utils {
    ...
    static class Ikev2VpnNetworkCallback extends NetworkCallback {
        ...
        public void onCapabilitiesChanged(@NonNull Network network,
            ...
            Log.d(mTag, "Receiving network capabilities changed on network: " + network);
            mCallback.onDefaultNetworkCapabilitiesChanged(network, networkCapabilities);
        }

        @Override
        public void onLinkPropertiesChanged(@NonNull Network network,
                @NonNull LinkProperties linkProperties) {
            Log.d(mTag, "Receiving link properties changed on network: " + network);
