...
public class Nat464Xlat extends BaseNetworkObserver {
    ...
    private enum State {
        ...
        STARTED,    // start() called. Base iface and stacked iface names are known.
     ...
     * A true result corresponds to internal states STARTED and RUNNING.
     */
     ...
     * Sets internal state.
     */
    private void enterStartedState(String baseIface) {
    ...
    public void stop() {
        ...
        // When clatd stops and its interface is deleted, handleInterfaceRemoved() will triger
