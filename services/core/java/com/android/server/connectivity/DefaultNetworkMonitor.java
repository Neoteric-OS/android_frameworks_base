...
public class DefaultNetworkMonitor {
    ...
    public DefaultNetworkMonitor() {
        prepareNewDefaultNetwork(SystemClock.elapsedRealtime(), null);
    }
    ...
    private void prepareNewDefaultNetwork(long timeMs, NetworkAgentInfo newNai) {
