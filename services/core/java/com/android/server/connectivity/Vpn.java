...
public class Vpn {
    ...
    public synchronized boolean setAlwaysOnPackage(
        ...
        if (setAlwaysOnPackageInternal(packageName, lockdown, lockdownAllowlist)) {
            ...
            if (packageName != null && !VpnConfig.LEGACY_VPN.equals(packageName)) {
                // TODO: underlyingNetwork, NetworkCapabilities and LinkProperties should be set
                //  once the related code is completed.
                sendEventToVpnManagerApp(VpnManager.CATEGORY_EVENT_ALWAYS_ON_STATE_CHANGED,
                        -1 /* errorClass */, -1 /* errorCode*/, packageName, mSessionKey,
    ...
    private @VpnProfileState.State int getStateFromLegacyState(int legacyState) {
        switch (legacyState) {
            ...
            default:
                Log.w(TAG, "Unhandled state " + legacyState
