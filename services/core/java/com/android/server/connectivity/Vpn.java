        ...
        public void onDefaultNetworkChanged(@NonNull Network network) {
            ...
            mExecutor.execute(() -> {
                try {
                    ...
                    final IkeSessionParams ikeSessionParams = (ikeTunConnParams != null)
                            ? ikeTunConnParams.getIkeSessionParams()
                            : VpnIkev2Utils.buildIkeSessionParams(mContext, mProfile, network);
                    final ChildSessionParams childSessionParams = (ikeTunConnParams != null)
                            ? ikeTunConnParams.getTunnelModeChildSessionParams()
