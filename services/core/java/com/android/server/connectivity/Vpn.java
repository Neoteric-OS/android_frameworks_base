...
public class Vpn {
    ...
    class IkeV2VpnRunner extends VpnRunner implements IkeV2VpnRunnerCallback {
        ...
        // will come up
        private static final long NETWORK_LOST_TIMEOUT = 5L;
        ...
        public void onChildOpened(int token, @NonNull ChildSessionConfiguration childConfig) {
            ...
            try {
                ...
                synchronized (Vpn.this) {
                    ...
                    // The actual network this IPsec Transform pair has been set up with is
        ...
        public void onChildMigrated(
            ...
            try {
                // The actual network this IPsec Transform pair has migrated to is
        ...
        private void startNewIkeSession(@Nullable Network network) {
            ...
            try {
                ...
                // IKE session is not able to switch network before onChildOpened. Thus
        ...
        public void onDefaultNetworkLost(@NonNull Network network) {
            ...
            Log.d(TAG, "Schedule onNetworkLostTimeout for network " + network);
            mExecutor.schedule(
                    () -> {
                        onNetworkLostTimeout(network);
                    },
                    NETWORK_LOST_TIMEOUT,
                    TimeUnit.SECONDS);
        }

        private void onNetworkLostTimeout(Network network) {
            if (!isActiveNetwork(network)) {
                Log.d(TAG, "onNetworkLostTimeout called for obsolete network " + network);
                return;
            }
