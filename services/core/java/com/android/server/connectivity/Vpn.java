...
public class Vpn {
    ...
    public static class Dependencies {
        ...
        /**
         * Call native method to create the VPN interface.
         */
        ...
        /**
         * Call native method to set the VPN addresses.
         */
    ...
    public boolean startAlwaysOnVpn() {
        ...
        try {
            ...
            if (profile != null) {
                ...
                if (!VpnConfig.LEGACY_VPN.equals(alwaysOnPackage)) {
    ...
    public synchronized ParcelFileDescriptor establish(VpnConfig config) {
        ...
        boolean isSeamlessHandover = false;
    ...
    public synchronized void startVpnProfile(@NonNull String packageName) {
        ...
        try {
            ...
            mAppOpsManager.startOp(
                    AppOpsManager.OPSTR_ESTABLISH_VPN_MANAGER, mOwnerUID, mPackage, null, null);
