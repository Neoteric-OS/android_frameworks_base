...
public class Vpn {
            ...
            if (mConnection != null) {
                ...
                if (!VpnConfig.LEGACY_VPN.equals(mPackage)) {
                    ...
                    sendEventToVpnManagerApp(mPackage, VpnManager.CATEGORY_ERROR_USER_DEACTIVATED,
                            mSessionKey,
                            (mNetworkCapabilities.getUnderlyingNetworks() == null) ? null
                                    : mNetworkCapabilities.getUnderlyingNetworks().get(0),
    ...
    public synchronized String startVpnProfile(@NonNull String packageName) {
        ...
        try {
            ...
            // Session key should be generated before starting Ikev2VpnRunner, otherwise, there is
            // no session key can be sent when there is any error.
