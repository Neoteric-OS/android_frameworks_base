...
public class Vpn {
     ...
     *
     * <p>The largest certificates are about 12kB (x2), and the largest private key is about 64kB.
     * These parameters take up almost all the space in the profile, with the rest expected to take
     * less than 1kB.
     */
    private static final int MAX_VPN_PROFILE_SIZE = 1 << 20; // 128kB
    ...
    public synchronized boolean provisionVpnProfile(
        ...
        if (profile.encode().length > MAX_VPN_PROFILE_SIZE) {
