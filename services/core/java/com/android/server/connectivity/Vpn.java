...
public class Vpn {
    ...
    private void prepareInternal(String newPackage) {
        ...
        try {
            ...
            if (mConnection != null) {
                ...
                //  ConnectivityServiceTest.
                Intent intent = null;
                if (SdkLevel.isAtLeastT() && !VpnConfig.LEGACY_VPN.equals(mPackage)) {
                ...
                mVpnRunner.exit();
                if (intent != null && !VpnConfig.LEGACY_VPN.equals(mPackage)) {
                    notifyVpnManagerVpnStopped(mPackage, mOwnerUID, intent);
                }
            }
    ...
    class IkeV2VpnRunner extends VpnRunner implements IkeV2VpnRunnerCallback {
         ...
         * opened or when the VPN pass network validation.
         */
        ...
        IkeV2VpnRunner(
            ...
            mConnectivityDiagnosticsManager.registerConnectivityDiagnosticsCallback(
                    request, mExecutor, mDiagnosticsCallback);
        }
