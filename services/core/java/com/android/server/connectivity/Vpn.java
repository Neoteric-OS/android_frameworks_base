...
public class Vpn {
    ...
    static class Dependencies {
        ...
        // This method can throw IOException on its own from Socket#getOutputStream or
        // Socket#write, and it can throw any exception thrown by the interrupt checker.
        // To clarify this, it declares both though IOException is a subclass of Exception.
        public void sendArgumentsToDaemon(
                final String daemon, final LocalSocket socket, final String[] arguments,
                final ThrowingConsumer<Boolean> interruptChecker) throws IOException, Exception {
            ...
            while (true) {
                ...
                interruptChecker.acceptOrThrow(true /* sleepLonger */);
            }
            ...
            for (String argument : arguments) {
                ...
                out.write(bytes);
                interruptChecker.acceptOrThrow(false /* sleepLonger */);
            }
            out.write(0xFF);
            out.write(0xFF);
        ...
        public void checkpoint() {
            // Nothing to do here, this is used by the test to check state.
        }
    ...
    private class LegacyVpnRunner extends VpnRunner {
        ...
        private void bringup() {
            ...
            try {
                ...
                // Trick to let the test check the state and cancel starting the VPN at this point.
                mDeps.checkpoint();
