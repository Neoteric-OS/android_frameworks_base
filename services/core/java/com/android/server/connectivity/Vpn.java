    ...
    private class LegacyVpnRunner extends VpnRunner {
        ...
        private final ConnectivityManager.NetworkCallback
                mNetworkCallback = new ConnectivityManager.NetworkCallback() {
                    ...
                    // capability, so this will be called any time when an internet-providing
                    // network is lost. Then notify the interface down event to disconnect from vpn.
                    @Override
        ...
        LegacyVpnRunner(VpnConfig config, String[] racoon, String[] mtpd, VpnProfile profile) {
            ...
            if (!TextUtils.isEmpty(mOuterInterface)) {
                for (final Network network : mCm.getAllNetworks()) {
