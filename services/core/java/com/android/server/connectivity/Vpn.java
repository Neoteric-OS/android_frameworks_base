...
public class Vpn {
    ...
    public void startLegacyVpnPrivileged(VpnProfile profile, KeyStore keyStore,
        ...
        switch (profile.type) {
            case VpnProfile.TYPE_IKEV2_IPSEC_RSA:
                ...
                // Ikev2VpnProfile.
                profile.ipsecSecret = Ikev2VpnProfile.KEYSTORE_ALIAS_PREFIX + privateKey;
    ...
    interface VpnRunner extends Runnable {
         ...
         *
         * <p>All outer Vpn instance state is cleaned up in teardownVpn()
         */
        void exitVpnRunner();
    }
    ...
    class IkeV2VpnRunner implements VpnRunner, IkeV2VpnRunnerCallback {
         ...
         */
        @VisibleForTesting @NonNull final ExecutorService mExecutor =
