...
public class Vpn {
    ...
    class IkeV2VpnRunner extends VpnRunner implements IkeV2VpnRunnerCallback {
         ...
         *
         * <p>This token is monotonically increasing and will never be reset. It also MUST be
         * accessed on the executor thread and updated when a new IKE session is created.
         */
