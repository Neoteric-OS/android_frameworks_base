...
public class Vpn {
    ...
    VpnProfile getVpnProfilePrivileged(@NonNull String packageName, @NonNull KeyStore keyStore) {
        if (Binder.getCallingUid() != Process.SYSTEM_UID) {
            // Warn only, otherwise Platform VPN methods become untestable due to the creation of
            // a Vpn instance in the test process.
