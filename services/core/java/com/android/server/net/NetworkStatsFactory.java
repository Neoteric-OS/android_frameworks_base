...
public class NetworkStatsFactory {
    ...
    private final Object mDetailStatsLock = new Object();

    // A persistent Snapshot since device start for eBPF stats
    @GuardedBy("mDetailStatsLock")
    ...
    private void requestSwapActiveStatsMap() throws RemoteException {
