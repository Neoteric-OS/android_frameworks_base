    ...
    private final class FaceServiceWrapper extends IFaceService.Stub {
        ...
        private void addCustomProviders() {
            if (CustomFaceProvider.useCustomFaceUnlockService()) {
                mServiceProviders.add(new CustomFaceProvider(getContext(),
                        new FaceSensorPropertiesInternal(CustomFaceProvider.DEVICE_ID,
                        SensorProperties.STRENGTH_WEAK, 1, new ArrayList(), 1,
                        false, false, false), mLockoutResetDispatcher));
            }
        }
