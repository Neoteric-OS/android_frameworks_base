...
package com.android.server.omapi.security.ara;
...
import com.android.server.omapi.security.gpac.BerTlv;
import com.android.server.omapi.security.gpac.ParserException;
import com.android.server.omapi.security.gpac.REF_AR_DO;
import com.android.server.omapi.security.gpac.Response_ALL_AR_DO;
import com.android.server.omapi.security.gpac.Response_DO_Factory;
    ...
    public AraController(AccessRuleCache cache, Terminal terminal) {
        ...
        if (mTerminal.getName().startsWith(SecureElementService.ESE_TERMINAL)) {
            mAids = mContext.getResources().getStringArray(
                    com.android.internal.R.array.config_ara_aid_candidate_list_ese);
        }
    }
