...
public abstract class BatteryStatsInternal {
    ...
    /**
     * Informs battery stats of a packet wakeup event.
     *
     * @param network The network over which the packet arrived.
     * @param elapsedMillis The time of the packet wakeup in elapsed timebase.
     * @param uid The uid that received the packet.
     */
    public abstract void notePacketWakeup(Network network, long elapsedMillis, int uid);
