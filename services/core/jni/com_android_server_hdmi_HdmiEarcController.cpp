...
#include <aidl/android/hardware/tv/earc/IHdmiEarc.h>
#include <aidl/android/hardware/tv/earc/BnHdmiEarcCallback.h>
...
using aidl::android::hardware::tv::earc::EarcCapability;
using aidl::android::hardware::tv::earc::EarcControl;
using aidl::android::hardware::tv::earc::EarcEvent;
using aidl::android::hardware::tv::earc::EarcEventType;
using aidl::android::hardware::tv::earc::EarcStatus;
using aidl::android::hardware::tv::earc::IHdmiEarc;
using aidl::android::hardware::tv::earc::BnHdmiEarcCallback;
...
private:
    ...
    std::shared_ptr<HdmiEarcCallback> mHdmiEarcCallback;
    sp<Looper> mLooper;
};
...
public:
    ...
    void handleMessage(const Message& message) {
        ...
        case ::aidl::android::hardware::tv::earc::EarcEventType::STATUS_CHG:
            propagateEarcStatusChanged(mEarcEvent);
            break;
        case ::aidl::android::hardware::tv::earc::EarcEventType::LATENCY_CHG:
            propagateEarcAudioLatencyChanged(mEarcEvent);
            break;
        case ::aidl::android::hardware::tv::earc::EarcEventType::CAPABILITY_CHG:
...
HdmiEarcController::HdmiEarcController(auto hdmiEarc,
        ...
        : mHdmiEarc(hdmiEarc),
          ...
          mLooper(looper) {
    mHdmiEarcCallback = std::make_shared<HdmiEarcCallback>(this);
