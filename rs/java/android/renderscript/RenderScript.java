...
//    native void rsnScriptForEach(long con, long id, int slot, long ain,
//                                 long aout, byte[] params, int[] limits);

//    synchronized void nScriptForEach(long id, int slot, long ain, long aout,
//                                     byte[] params, int[] limits) {
//        validate();
//        rsnScriptForEach(mContext, id, slot, ain, aout, params, limits);
//    }
