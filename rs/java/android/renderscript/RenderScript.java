...
public class RenderScript {
    ...
    native void rsnClosureEval(long con, long closureID);
    synchronized void nClosureEval(long closureID) {
      validate();
      rsnClosureEval(mContext, closureID);
    }
    ...
    // Does this have to be synchronzied?
