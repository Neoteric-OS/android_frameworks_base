...
public class Allocation extends BaseObj {
   ...
   /**
     ...
     * @return Allocation[]
     */
    public static Allocation[] createAllocatins(RenderScript rs, Type t, int usage, int numAlloc) {
        try {
            ...
            Allocation bqOwner = createTyped(rs, t, usage);
            bqOwner.setupBufferQueue(numAlloc);
            mAllocationArray[0] = bqOwner;
            for (int i=1; i<numAlloc; i++) {
                mAllocationArray[i] = createFromAllcation(rs, bqOwner);
            }
