...
// A few helpers copied from core_jni_helpers. We could have split core_jni_helpers from
// libandroid_runtime, but this should be okay for a separate JNI library.
