...
static jint
android_media_AudioSystem_setVolumeIndexForGroup(JNIEnv *env,
                                                 jobject thiz,
                                                 jint groupId,
                                                 jint uid,
                                                 jint index,
...
static jint
android_media_AudioSystem_getVolumeIndexForGroup(JNIEnv *env,
                                                 jobject thiz,
                                                 jint groupId,
                                                 jint device)
{
    int index;
    if (AudioSystem::getVolumeIndexForGroup(static_cast<volume_group_t>(groupId),
                                            index,
                                            static_cast<audio_devices_t>(device))
            != NO_ERROR) {
        index = -1;
...
static jint android_media_AudioSystem_getDirectProfilesForAttributes(JNIEnv *env,
...
static const JNINativeMethod gMethods[] = {
        ...
        MAKE_JNI_NATIVE_METHOD("getVolumeIndexForGroup",
                               "(II)I",
