...
static jint
android_media_AudioSystem_setA2dpSourceCodecConfigChanged(JNIEnv *env, jobject thiz, jstring device_address, jstring device_name)
{
    const char *c_address = env->GetStringUTFChars(device_address, NULL);
    const char *c_name = env->GetStringUTFChars(device_name, NULL);
    int status = check_AudioSystem_Command(AudioSystem::setA2dpSourceCodecConfigChanged(c_address, c_name));
    env->ReleaseStringUTFChars(device_address, c_address);
    env->ReleaseStringUTFChars(device_name, c_name);
    return (jint) status;
}
...
static const JNINativeMethod gMethods[] = {
    ...
    {"setA2dpSourceCodecConfigChanged", "(Ljava/lang/String;Ljava/lang/String;)I", (void *)android_media_AudioSystem_setA2dpSourceCodecConfigChanged},
