...
// Declares android::report_sysprop_change() and android::add_sysprop_change_callback(),
// which the bridge binds directly and the trampoline below installs; the
// cxx-generated code includes this header, so the declaration must be visible.
