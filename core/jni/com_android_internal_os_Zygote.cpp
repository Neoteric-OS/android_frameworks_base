...
{
  std::string terminator_process_name;
  if (info != NULL) {
    terminator_process_name = GetProcessName(info->si_pid);
    ALOGE("System server was killed by %s(pid %d), code %d.\n", terminator_process_name.c_str(),
