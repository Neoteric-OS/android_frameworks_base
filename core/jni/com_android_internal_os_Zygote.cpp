...
static pid_t ForkCommon(JNIEnv* env, jstring java_se_name,
                        bool is_system_server, jintArray fdsToIgnore) {
  SetSignalHandlers();
...
static jint com_android_internal_os_Zygote_nativeForkAndSpecialize(
    ...
    pid_t pid = ForkCommon(env, se_name, false, fdsToIgnore);
    if (pid == 0) {
      SpecializeCommon(env, uid, gid, gids, runtime_flags, rlimits,
                       capabilities, capabilities,
                       mount_external, se_info, se_name, false, fdsToClose,
...
static jint com_android_internal_os_Zygote_nativeForkSystemServer(
  ...
  pid_t pid = ForkCommon(env, NULL, true, NULL);
  if (pid == 0) {
      SpecializeCommon(env, uid, gid, gids, runtime_flags, rlimits,
