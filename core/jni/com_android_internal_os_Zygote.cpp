...
static void RuntimeAbort() {
  // TODO: This used to call through to Runtime::Abort() (art/) which adds
  // some useful logging. In order to use that method, we need to add a java
  // binding and call through to it.
  abort();
}
