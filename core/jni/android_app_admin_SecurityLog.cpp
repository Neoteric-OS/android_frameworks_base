...
static void android_app_admin_SecurityLog_readEvents(JNIEnv* env, jobject /* clazz */,
    ...
    SLog::readEvents(env, ANDROID_LOG_RDONLY | ANDROID_LOG_NONBLOCK, nullptr, 0, out);
}
...
static void android_app_admin_SecurityLog_readEventsSince(JNIEnv* env, jobject /* clazz */,
    ...
    SLog::readEvents(env, ANDROID_LOG_RDONLY | ANDROID_LOG_NONBLOCK, nullptr, timestamp, out);
}
...
static void android_app_admin_SecurityLog_readPreviousEvents(JNIEnv* env, jobject /* clazz */,
    ...
    SLog::readEvents(env, ANDROID_LOG_RDONLY | ANDROID_LOG_NONBLOCK | ANDROID_LOG_PSTORE, nullptr,
            0, out);
}
...
static void android_app_admin_SecurityLog_readEventsOnWrapping(JNIEnv* env, jobject /* clazz */,
    ...
    SLog::readEvents(env, ANDROID_LOG_RDONLY | ANDROID_LOG_NONBLOCK | ANDROID_LOG_WRAP, nullptr,
            timestamp, out);
}
