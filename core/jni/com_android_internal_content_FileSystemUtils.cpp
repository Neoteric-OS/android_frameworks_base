...
bool punchHoles(const char *filePath, const uint64_t offset,
    ...
    IF_ALOGD() {
        ...
        ALOGD("Size before punching holes st_blocks: %" PRIu64 ", st_blksize: %" PRIu64
              ", st_size: %" PRIu64 "",
              beforePunch.st_blocks, static_cast<uint64_t>(beforePunch.st_blksize),
    ...
    IF_ALOGD() {
        ...
        ALOGD("Size after punching holes st_blocks: %" PRIu64 ", st_blksize: %" PRIu64
              ", st_size: %" PRIu64 "",
              afterPunch.st_blocks, static_cast<uint64_t>(afterPunch.st_blksize),
...
bool punchHolesInZip(const char *filePath, uint64_t offset, uint16_t extraFieldLen) {
    ...
    IF_ALOGD() {
        ALOGD("Extra field length: %hu,  Size before punching holes st_blocks: %" PRIu64
              ...
              extraFieldLen, beforePunch.st_blocks, static_cast<uint64_t>(beforePunch.st_blksize),
              static_cast<uint64_t>(beforePunch.st_size));
    }
