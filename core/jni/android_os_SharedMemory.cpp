...
static jobject SharedMemory_nCreate(JNIEnv* env, jobject, jstring jname, jint size) {
...
static jint SharedMemory_nGetSize(JNIEnv* env, jobject, jobject fileDescriptor) {
...
static jint SharedMemory_nSetProt(JNIEnv* env, jobject, jobject fileDescriptor, jint prot) {
    int fd = jniGetFDFromFileDescriptor(env, fileDescriptor);
    int err = 0;
