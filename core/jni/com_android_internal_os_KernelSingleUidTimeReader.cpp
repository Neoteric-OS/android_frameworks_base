...
static jboolean canReadBpfTimes(JNIEnv *, jclass) {
    return android::bpf::getUidCpuFreqTimes(0).has_value();
}
...
static const JNINativeMethod g_single_methods[] = {
    {"getUidCpuFreqTimeMs", "(I)[J", (void *)getUidCpuFreqTimeMs},
    {"canReadBpfTimes", "()Z", (void *)canReadBpfTimes}
};

int register_com_android_internal_os_KernelSingleUidTimeReader(JNIEnv *env) {
    return RegisterMethodsOrDie(env, "com/android/internal/os/KernelSingleUidTimeReader",
