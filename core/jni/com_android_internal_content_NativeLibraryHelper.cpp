...
static inline install_status_t extractNativeFileFromApk(const std::string nativeLibPath, const char *fileName,
                                                        uint32_t when, uint32_t uncompLen, uint32_t crc,
                                                        ZipFileRO* zipFile, ZipEntryRO zipEntry)
{
...
copyFileIfChanged(JNIEnv *env, void* arg, ZipFileRO* zipFile, ZipEntryRO zipEntry, const char* fileName)
{
    ...
    return extractNativeFileFromApk(nativeLibPath.c_str(), fileName, when, uncompLen, crc, zipFile,
                                    zipEntry);
}
