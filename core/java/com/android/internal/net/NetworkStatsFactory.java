...
public class NetworkStatsFactory {
    ...
    /**
     * Read network statistics that were compiled by the kernel on a per-socket basis.
     *
     * Equivalent to calling {@link #readNetworkStatsDetail(int, String[], int, NetworkStats)} with
     * no filtering.
     */
     ...
     * Read network statistics that were compiled by the kernel on a per-socket basis.
     *
     * <p>As data is counted separately for each interface, some statistics may be double-counted;
     * this is the case for clat traffic in particular
     * (see {@link NetworkStats#apply464xlatAdjustments(Map)}.
     * @param limitUid UID to return statistics for.
     * @param limitIfaces Interfaces to return statistics for; null for all.
     * @param limitTag Tag to return statistics for.
     * @param lastStats Object to recycle and fill with the new values.
     */
