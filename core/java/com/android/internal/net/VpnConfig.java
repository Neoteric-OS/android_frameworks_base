...
public class VpnConfig implements Parcelable {
    ...
    public boolean requiresPlatformValidation = false;
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(requiresPlatformValidation ? 1 : 0);
    ...
    public static final Parcelable.Creator<VpnConfig> CREATOR =
        ...
        public VpnConfig createFromParcel(Parcel in) {
            ...
            config.requiresPlatformValidation = in.readInt() != 0;
    ...
    public String toString() {
        return new StringBuilder()
                ...
                .append(", requiresPlatformValdiation").append(requiresPlatformValidation)
