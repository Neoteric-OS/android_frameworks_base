...
public class ArrayUtils {
     ...
     * that needs to be entirely wiped from memory when no longer needed. The owner of the array is
     * still responsible for the zeroization; {@link #zeroize(byte[])} should be used to do so.
     *
