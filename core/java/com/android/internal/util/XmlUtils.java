...
public class XmlUtils {
    ...
    /**
     * Read a ConcurrentHashMap from an InputStream containing XML.  The stream can
     * previously have been written by writeMapXml().
     *
     * @param in The InputStream from which to read.
     *
     * @return ConcurrentHashMap The resulting map.
     *
     * @see #readListXml
     * @see #readValueXml
     * @see #readThisMapXml
    ...
    /**
     * Read a ConcurrentHashMap object from an XmlPullParser.  The XML data could
     ...
     *             of the map's tag.
     *
     * @return ConcurrentHashMap The newly generated map.
     *
     * @see #readMapXml
     */
    public static final ConcurrentHashMap<String, ?> readThisMapXml(XmlPullParser parser, String endTag,
    ...
    /**
     * Like {@link #readThisMapXml}, but returns an ArrayMap instead of ConcurrentHashMap.
     * @hide
     */
     ...
     *             of the list's tag.
     *
     * @return ConcurrentHashMap The newly generated list.
     *
     * @see #readListXml
     */
