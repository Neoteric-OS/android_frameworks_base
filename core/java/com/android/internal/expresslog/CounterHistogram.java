...
public final class CounterHistogram {
    ...
    public static final class FixedRangeOptions implements BinOptions {
        ...
        public FixedRangeOptions(int binCount, float minValue, float exclusiveMaxValue) {
            if (binCount < 1) {
        ...
        public int getBinForSample(float sample) {
            ...
            return (int) ((sample - mMinValue) / mBinSize);
        }
    }
    ...
    public void logSample(float sample) {
        ...
        FrameworkStatsLog.write(FrameworkStatsLog.EXPRESS_HISTOGRAM_SAMPLE_REPORTED,
