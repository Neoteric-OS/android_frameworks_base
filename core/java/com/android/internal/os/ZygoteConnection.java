        ...
        try (ZygoteCommandBuffer argBuffer = ZygoteCommandBuffer.getInstance(mSocket)) {
            ...
            if (parsedArgs.mInvokeWith != null || parsedArgs.mStartChildZygote) {
                ...
                pid = Zygote.forkAndSpecialize(parsedArgs.mUid, parsedArgs.mGid, parsedArgs.mGids,
                        ...
                        parsedArgs.mStartChildZygote, parsedArgs.mInstructionSet,
                        parsedArgs.mAppDataDir, parsedArgs.mIsTopApp, parsedArgs.mPkgDataInfoList,
                ...
                ZygoteHooks.preFork();
                Object result = Zygote.forkChild(argBuffer, null, peer, fdsToClose,
                                                /*isPriorityFork=*/ true);
