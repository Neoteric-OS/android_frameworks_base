...
public abstract class KernelCpuUidBpfMapReader {
    ...
    private SparseArray<long[]> mData = new SparseArray<>();
    ...
    public final native boolean startTrackingBpfTimes();
    ...
    private boolean dataValid() {
        return mData.size() > 0 && (SystemClock.elapsedRealtime() - mLastReadTime < FRESHNESS);
    }
