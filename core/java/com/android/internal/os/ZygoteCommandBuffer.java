...
class ZygoteCommandBuffer implements AutoCloseable {
     ...
     */
    int forkRepeatedly(FileDescriptor zygoteSocket, int expectedUid, int minUid,
     ...
     */
    private static native int nativeForkRepeatedly(long /* NativeCommandBuffer* */ nbuffer,
