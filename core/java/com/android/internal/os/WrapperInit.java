...
public class WrapperInit {
    ...
    public static void execApplication(String invokeWith, String niceName,
        ...
        // We assume that if the wrapper command is used, backtraces are desirable:
        //  * The wrap.sh script can only used by debuggable apps, which would enable this flag
        //    without the script anyway (the fork-zygote path). So this makes the two consist.
        //  * The wrap.* can only be used on userdebug builds, and is likely to used to enable
        //    extra debugging (e.g. debug-malloc), in which case backtraces are likely useful.
