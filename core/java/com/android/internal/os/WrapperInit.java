...
public class WrapperInit {
    ...
    private static void preserveCapabilities() {
        try {
            ...
            // Only log here. Try to run the wrapped application even when capget/capset fail.
            // This is best effort and will give the app strictly lower capabilities, so is not
            // a security issue.
