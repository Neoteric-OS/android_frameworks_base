...
public final class Zygote {
    ...
    */
     ...
     * @return A Runnable in each child process, Boolean in the parent. The boolean value is
     * true if the current buffer contains a command that must be executed.
     * A return of false in the parent indicates that something went wrong with refilling
