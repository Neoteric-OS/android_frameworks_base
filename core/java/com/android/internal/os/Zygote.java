...
public final class Zygote {
    ...
    */
     ...
     * @param peer  Credentials for the requesting peer, if an argBuffer is supplied
    ...
    static Object forkChild(@Nullable ZygoteCommandBuffer argBuffer,
                            ...
                            @Nullable Credentials peerCredentials,
        ...
        if (pid == 0) {
            ...
            return childMain(argBuffer, usapPoolSocket, peerCredentials, writeFD);
        } else if (pid == -1) {
            // Fork failed.
            return null;
        } else {
     ...
     *                   of the ZygoteServer.
     * @param peerCrentials Credentials of peer requesting the fork. Used if argBuffer is non-null.
    ...
    private static Runnable childMain(@Nullable ZygoteCommandBuffer argBuffer,
        ...
        if (argBuffer == null) {
            ...
            // peerCredentials were passed in.
        }
        if (args == null) {
