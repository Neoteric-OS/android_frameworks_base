...
interface IAdbManager {
    ...
    /**
     * Query for the list of paired devices. The list of paired devices will be sent via
     * intent action {@link android.debug.AdbManager#WIRELESS_DEBUG_PAIRED_DEVICES_ACTION}.
     */
