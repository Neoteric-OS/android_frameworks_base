...
public abstract class PlatformSelectionActionMenuClient {
  ...
  /**
   * Checks whether a cached selection menu can be reused. Chromium's implementation to cache
   ...
   */
  public boolean canReuseCachedSelectionMenu(@NonNull Context context) {
    return true;
  }
   ...
   *     If true is returned for a menu item here, MenuItem click will be handled by {@link
   *     PlatformSelectionActionMenuClient#handleMenuItemClick(Context, MenuItem, ViewGroup)}.
   */
  public boolean canHandleCustomMenuItem(@NonNull MenuItem item) {
    return false;
  }
   ...
   */
  public void prepareForMenuHandling(@NonNull Context context, @NonNull View containerView) {}
