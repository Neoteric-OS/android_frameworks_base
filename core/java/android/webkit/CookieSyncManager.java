 ...
 *
 * The sync timeout is 5 minutes, so you will want to force syncs
 * manually anyway, for instance, after a page load event. Note that
 * even sync() happens asynchronously, so don't do it just as your
