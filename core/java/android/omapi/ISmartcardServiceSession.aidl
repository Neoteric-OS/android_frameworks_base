...
import android.omapi.ISmartcardServiceChannel;
import android.omapi.ISmartcardServiceReader;
import android.omapi.ISmartcardServiceCallback;
import android.omapi.SmartcardError;
