...
/**
 * Instances of this class represent an ISO/IEC 7816-4 channel opened to a Secure
...
public class Channel {
    ...
    public static final String TAG = "SmartcardService - Channel";
    ...
    public void close() {
        if (mService == null || !mService.isConnected()) {
            Log.e(TAG, "close(): throw IllegalStateException");
