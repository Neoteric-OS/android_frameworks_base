...
public class UpdateEngine {
    ...
    public static final class AllocateSpaceResult {
         ...
         * </ul>
         */
        public int errorCode = ErrorCodeConstants.SUCCESS;

        /**
         * Estimated space requested on userdata partition to apply the payload.
         * In some rare cases, fragmentation may cause this number to be
         * underestimated. In any case, user should free up more space than this
         * number before applying the payload to keep the device functioning.
         *
         * This value is non-zero when {@link #errorCode} is
         * {@link ErrorCodeConstants#NOT_ENOUGH_SPACE}, and zero otherwise.
         *
         */
        public long spaceRequired = 0;
    }
    ...
    public AllocateSpaceResult allocateSpace(
        ...
        try {
            result.spaceRequired = mUpdateEngine.allocateSpaceForPayload(
                    payloadMetadataFilename,
                    headerKeyValuePairs);
            result.errorCode = result.spaceRequired == 0
