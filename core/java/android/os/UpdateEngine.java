...
public class UpdateEngine {
     ...
     * <p>1. Sets the boot slot to the source/current slot. So the device
     *       doesn't accidentally take the update when it reboots. This is
     *       useful when users don't want to take the update immediately;
     *       or the updater determines some condition hasn't met, e.g.
     *       insufficient space for boot.
