...
public class UpdateEngine {
     ...
     *
     * <p>The {@code offset} and {@code size} parameters specify the location
     * of the payload within the file represented by the file descriptor.
     * This is useful if the downloadable package at the file descriptor
     * contains more than just the update_engine payload (such as extra metadata).
     * This is true for Google's OTA system, where the file descriptor points to
     * a zip file in which the payload is stored uncompressed within the zip file
