...
public class UpdateEngine {
     ...
     * @return {@code true} if space has been allocated successfully.
     * {@code false} if any error (insufficient space, I/O error, etc.).
     */
    public boolean allocateSpace(@NonNull String payloadMetadataFilename,
            @NonNull String[] headerKeyValuePairs) {
        try {
