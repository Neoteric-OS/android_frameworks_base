...
public class GraphicsEnvironment {
    ...
    /**
     * If ANGLE is not the native driver, determine whether ANGLE should be used, and if so, pass
     * down the necessary details to the C++ GraphicsEnv class via GraphicsEnv::setAngleInfo().
     * <p>
     * If ANGLE is the native driver or the various flags indicate it should be used, attempt to
    ...
    private boolean setupAngle(Context context, Bundle bundle, PackageManager packageManager,
        ...
        // The ANGLE choice only makes sense if ANGLE is not the native driver.
        ...
        // 1. native driver is not ANGLE, but ANGLE is requested.
        // 2. native driver is ANGLE.
