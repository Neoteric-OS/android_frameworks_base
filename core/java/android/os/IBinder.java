...
public interface IBinder {
     ...
     * @hide
     */
    void addFrozenStateChangeCallback(@NonNull IFrozenStateChangeCallback callback)
            throws RemoteException {
     ...
     * @hide
     */
    boolean removeFrozenStateChangeCallback(@NonNull IFrozenStateChangeCallback callback) {
        throw new UnsupportedOperationException();
    }
}
