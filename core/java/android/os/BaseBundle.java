...
public class BaseBundle {
    ...
    private void initializeFromParcelLocked(@NonNull Parcel parcelledData, boolean recycleParcel,
        ...
        try {
            recycleParcel &= readMapFromParcelLocked(parcelledData, map, count, mClassLoader,
                    parcelledByNative);
    ...
    /**
     * Reads map from {@code parcel} and returns whether the parcel can be recycled or not.
     *
     * @hide
     */
    ...
    public boolean kindofEquals(BaseBundle other) {
        ...
        if (isParcelled() != other.isParcelled()) {
            ...
            // getMap() triggers full deserialization
   ...
   public int getInt(String key, int defaultValue) {
    ...
    /** @hide */
    protected void writeMapToParcel(Parcel parcel, ArrayMap<String, Object> map) {
