...
/**
 * A VibrationAmplitude describes the strength of a component of a haptic
 * effect {@link VibrationEffect}.  VibrationAmplitude descibes the
 * applied amplitude to various motors which a haptic device may contain.
 */
public class VibrationAmplitude implements Parcelable {
    ...
    /** @hide to prevent subclassing */
    private VibrationAmplitude(int strong, int weak) {
        this.strong = strong;
        this.weak = weak;
    }

    /** @hide to prevent subclassing */
    private VibrationAmplitude() {
    ...
    public String toString() {
        return "VibrationAmplitude{strong="
                + strong
                + ",weak="
                + weak
                + "}";
