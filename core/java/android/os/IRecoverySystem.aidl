...
interface IRecoverySystem {
    ...
    boolean requestLskf(in String callerId, in String updateToken, in IntentSender sender);
    boolean clearLskf(in String callerId);
    boolean rebootWithLskf(in String callerId, in String updateToken, in String reason);
}
