...
import android.os.TypedSystemProperty.BooleanSystemProperty;
...
public final class PlatformProperties {
    ...
    private static class IntegerProperty extends IntegerSystemProperty {
        protected IntegerProperty(String name, Owner owner, boolean isWriteOnce,
            ...
            super(name, owner, isWriteOnce, defaultValue, accessor);
        }
    }

    private static class BooleanProperty extends BooleanSystemProperty {
    ...
    private static class EnumProperty<T extends Enum<T>>
        ...
        protected EnumProperty(String name, Owner owner, boolean isWriteOnce,
                Class<T> type, Optional<T> defaultValue, Accessor accessor) {
            super(name, owner, isWriteOnce, type, defaultValue, accessor);
        }
    }
}
