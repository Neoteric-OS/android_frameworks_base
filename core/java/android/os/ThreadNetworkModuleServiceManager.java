...
/**
 * Provides a way to register and obtain the system service binder objects managed by
 * the ThreadNetwork mainline module.
 *
 * Only the ThreadNetwork mainline module will be able to access an instance of this class.
 *
 * @hide
 */
@SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
public class ThreadNetworkModuleServiceManager {
    /** @hide */
    public ThreadNetworkModuleServiceManager() {}
