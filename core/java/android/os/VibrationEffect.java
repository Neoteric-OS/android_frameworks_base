...
public abstract class VibrationEffect implements Parcelable {
     ...
     * @param timings The timing values of the timing / amplitude pairs. Timing values of 0
     *                will cause the pair to be ignored.
     * @param amplitudes The {@link android.os.VibrationAmplitude} objects of the timing / amplitude
     *                   pairs.  Provides for amplitude control of individual vibration motors.
     *                   Amplitude component values must be between 0 and 255, or equal to
     *                   {@link #DEFAULT_AMPLITUDE}. An amplitude component value of 0 implies the
     *                   corresponding motor is off. Elements can be null, implying both motors
     *                   are off.
     * @param repeat The index into the timings array at which to repeat, or -1 if you you don't
     *               want to repeat.
     *
    ...
    public static class OneShot extends VibrationEffect implements Parcelable {
        ...
        public void validate() {
            // OneShot effect can not have an amplitude of 0
    ...
    public static class Waveform extends VibrationEffect implements Parcelable {
        ...
        public void validate() {
            ...
            for (VibrationAmplitude amplitude : mAmplitudes) {
                if (amplitude != null) {
                    // off periods of the motor will have an amplitude of zero
