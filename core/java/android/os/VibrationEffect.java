...
public abstract class VibrationEffect implements Parcelable {
    ...
    public static class Waveform extends VibrationEffect implements Parcelable {
        ...
        public void validate() {
            ...
            if (Stream.of(mElements).anyMatch(e -> e.duration < 0)) {
                throw new IllegalArgumentException("timings must be positive or zero"
                        + " (elements=" + Arrays.toString(mElements) + ")");
            }
        ...
        public int hashCode() {
            int result = 17;
            result += 37 * 37 * Arrays.hashCode(mElements);
            result += 37 * mRepeat;
            return result;
        }
