...
public final class Parcel {
    ...
    private static final int EX_APPLICATION_SPECIFIC = -8;
    ...
    public final void writeException(Exception e) {
        ...
        } else if (e instanceof ApplicationSpecificException) {
            code = EX_APPLICATION_SPECIFIC;
        }
        writeInt(code);
        ...
        if (e instanceof ApplicationSpecificException) {
            writeInt(((ApplicationSpecificException)e).mErrorCode);
        }
    }
    ...
    public final void readException(int code, String msg) {
        switch (code) {
            ...
            case EX_APPLICATION_SPECIFIC:
                throw new ApplicationSpecificException(readInt(), msg);
        }
