...
public final class Parcel {
     ...
     */
    public <T> void readList(@NonNull List<T> outVal,
    ...
    @Nullable
    private <T> T readValue(@Nullable ClassLoader loader,
    ...
    @SuppressWarnings("unchecked")
    @Nullable
    private <T> T readValue(int type, @Nullable ClassLoader loader,
            @Nullable Class<T> clazz) {
        final Object object;
        switch (type) {
            case VAL_NULL:
        ...
        return (clazz == null) ? (T) object : clazz.cast(object);
    }
    ...
    @Nullable
    private <T> T readParcelableInternal(@Nullable ClassLoader loader,
            @Nullable Class<T> clazz) {
    ...
    private <T> void readListInternal(@NonNull List<T> outVal, int n,
            @Nullable ClassLoader loader, @Nullable Class<T> clazz) {
        while (n > 0) {
