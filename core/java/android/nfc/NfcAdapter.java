...
public final class NfcAdapter {
    ...
    */
    ...
    /**
     * Set a package name and the allow status to the preference list of the UserId.
     *
     * <p> Stores a package name to a preference list for checking packages name before dispatching
     * Tag intents. {@link #ACTION_NDEF_DISCOVERED}, {@link #ACTION_TECH_DISCOVERED} or
     * {@link #ACTION_TAG_DISCOVERED} will not be dispatched to an Activity if its package name is
     * mapped to false in the preference list.
     * <p> By default, packages would be added to the preference list with {@code true}(allow) when
     * a Tag intent dispatched to the package's activity for the first time, user can choose to
     * set {@code false} to the annoying packages from the preference list later.
     *
     ...
     *
     * <P>It returns a map of the UserId which indicates the mapping from package name to
     * boolean(allow status).
     * {@link #ACTION_NDEF_DISCOVERED}, {@link #ACTION_TECH_DISCOVERED} or
     * {@link #ACTION_TAG_DISCOVERED} will not be dispatched to an Activity if its package name is
     * mapped to false in the preference list.
     *
     ...
     *
     * @return {@code true} if the device supports Tag application preference, false otherwise
     * @throws UnsupportedOperationException if FEATURE_NFC is unavailable
     *
     * @hide
     */
