...
public final class NfcAdapter {
    ...
    */
     ...
     * When a package has been launched by a tag detection for the first time, putting the package
     * name to the map and default mapped to {@code true}. The package will receive Tag intents as
     * usual.
