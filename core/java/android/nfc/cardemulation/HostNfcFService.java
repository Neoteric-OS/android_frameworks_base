...
public abstract class HostNfcFService extends Service {
     ...
     * Reason for {@link #onDeactivated(int)}.
     *
     * <p>Indicates deactivation was due to a different System Code
     * being selected (which implicitly deselects the System Code
     * currently active on the logical channel).
     *
     * <p>Note that this next System Code may still be resolved to this
     * service, in which case {@link #processNfcFPacket(byte[], Bundle)}
     ...
     * another System Code was selected that resolved to
   ...
   /**
     ...
     * @return a byte-array containing the response response, or null if no
     *         response packet can be sent.
     */
     ...
     * <li>A different System Code has been selected and was resolved to a different
     *     service component
