...
public final class DateIntervalFormat {
    ...
    public static String formatDateRange(ULocale icuLocale, android.icu.util.TimeZone icuTimeZone,
      ...
      // its start
        //   (which can be thought of as 24:00 the same day), we fudge the end date so we don't
      //   show the
        //    dates --- unless the start is anything displayed as 00:00, in which case we include
      //    both
