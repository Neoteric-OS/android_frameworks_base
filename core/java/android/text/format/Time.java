...
public class Time {
    ...
    private static class TimeCalculator {
        ...
        private ZoneInfoData zoneInfoData;

        public TimeCalculator(String timezoneId) {
            this.zoneInfoData = lookupZoneInfoDelegate(timezoneId);
        ...
        public long toMillis(boolean ignoreDst) {
            ...
            int r = wallTime.mktime(zoneInfoData);
            if (r == -1) {
                return -1;
            }
            return r * 1000L;
        ...
        public void setTimeInMillis(long millis) {
            ...
            wallTime.localtime(intSeconds, zoneInfoData);
        }
        ...
        public String format(String format) {
            ...
            return formatter.format(format, wallTime, zoneInfoData);
        }

        private void updateZoneInfoFromTimeZone() {
            if (!zoneInfoData.getID().equals(timezone)) {
                this.zoneInfoData = lookupZoneInfoDelegate(timezone);
            }
        }


        private static ZoneInfoData lookupZoneInfoDelegate(String timezoneId) {
            ZoneInfoData zoneInfoData = ZoneInfoDb.getInstance().makeZoneInfoDelegate(timezoneId);
            if (zoneInfoData == null) {
                zoneInfoData = ZoneInfoDb.getInstance().makeZoneInfoDelegate("GMT");
            }
            if (zoneInfoData == null) {
        ...
        public void switchTimeZone(String timezone) {
            int seconds = wallTime.mktime(zoneInfoData);
            this.timezone = timezone;
            updateZoneInfoFromTimeZone();
            wallTime.localtime(seconds, zoneInfoData);
        }
