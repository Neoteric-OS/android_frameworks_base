...
public class Time {
     ...
     * use <tt>true</tt> or <tt>false</tt> for "ignoreDst" and when -1 might be
     * returned.
     *
     * @return the UTC milliseconds since the epoch, or -1
     */
     ...
     *
     * <p>
     * This method can return -1 when the date / time fields have been set to
     * a local time that conflicts with available timezone information. For
     * example, when daylight savings transitions cause an hour to be skipped:
     * times within that hour will return -1 if isDst = -1.
     *
