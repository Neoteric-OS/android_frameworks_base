...
public final class UwbManager {
    ...
    public interface AdapterStateCallback {
        ...
        @IntDef(value = {
                ...
                STATE_CHANGED_REASON_CALLBACK_REGISTERED,
        ...
        /**
         * Indicates that the state change callback was invoked due to callback registration and
         * not a state change
         */
        int STATE_CHANGED_REASON_CALLBACK_REGISTERED = 3;
         ...
         * {@link AdapterStateCallback} using {@link UwbManager#registerAdapterStateCallback}.
         *
     ...
     * {@link AdapterStateCallback#onStateChanged} is immediately invoked to indicate the current
     * state of the underlying UWB adapter.
     *
     ...
     * {@link #registerAdapterStateCallback} must be used.
     *
