 ...
 *
 * One should interpret the value as:
 *   {@link #meters()} +/- {@link #errorMeters()} at {@link #confidenceLevel()}
 *
 * @hide
 */
public class DistanceMeasurement {
    ...
    /**
     * Error in distance measurement in meters
     * <p>Must be positive
     *
    ...
    /**
     * Distance measurement confidence level expressed as a value between 0 to 1.0.
     *
