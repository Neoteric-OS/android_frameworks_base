...
public final class RangingMeasurement {
     ...
     *
     * @return a {@link DistanceMeasurement} or null if {@link #status()} !=
     *         {@link #RANGING_STATUS_SUCCESS}
     */
    public DistanceMeasurement distance() {
        throw new UnsupportedOperationException();
    }
     ...
     *
     * @return an {@link AngleOfArrivalMeasurement} or null if {@link #status()} !=
     *         {@link #RANGING_STATUS_SUCCESS}
     */
    public AngleOfArrivalMeasurement angleOfArrival() {
        throw new UnsupportedOperationException();
    }
}
