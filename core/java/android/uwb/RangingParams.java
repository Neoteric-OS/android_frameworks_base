...
public class RangingParams {
    ...
    /**
     * Get the role of this device in the UWB ranging sessions
     *
    ...
    /**
     * Return type of PHY packet when STS is used as defined by 802.15.4z
     *
    ...
    /**
     * Parameters for the specific a UWB specification gotten from one of the support
     * libraries.
     *
