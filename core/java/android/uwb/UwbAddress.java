...
public class UwbAddress {
     ...
     * created. If the provided array is {@link #EXTENDED_ADDRESS_BYTE_LENGTH}, then an extended
     * address is created.
     *
     ...
     *       SHORT_ADDRESS_LENGTH or EXTENDED_ADDRESS_LENGTH
     */
    @NonNull
     ...
     *
     * @return the byte representation of associated with the {@link UwbAddress}
     */
    @NonNull
    public byte[] toBytes() {
        throw new UnsupportedOperationException();
