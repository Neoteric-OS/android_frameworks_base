...
public class AngleOfArrivalMeasurement {
     ...
     * <p>Azimuth angle measurement of remote device in radian from -pi to +pi
     ...
     * must be supported when AoA is supported
     *
     ...
     * <p>Altitude angle measurement of remote device in randian from -pi to +pi
