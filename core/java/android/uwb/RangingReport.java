...
public final class RangingReport {
    ...
    public static final class Builder {
        ...
        public RangingReport build() {
            // Verify that all events are in monotonically increasing
            RangingMeasurement prevMeasurement = null;
            for (RangingMeasurement measurement : mMeasurements) {
                if (prevMeasurement != null
                        && (prevMeasurement.getElapsedRealtimeNanos()
                                > measurement.getElapsedRealtimeNanos())) {
                    throw new IllegalStateException(
                            "RangingMeasurement timestamps must be monotonically increasing");
                }
