...
interface IUwbAdapter {
   ...
   *
   * IUwbAdapterCallbacks#onRangingStarted must be called after successfully
   * starting the session.
   *
   * IUwbAdapterCallbacks#onRangingStartFailed must be called after
   * failing to start the session.
   *
