...
public class NtpTrustedTime {
    ...
    @GuardedBy("this") private NtpResult mNtpResult;
     ...
     *
     * @deprecated Use {@link #getCachedNtpResult()}
     */
    @Deprecated
    @UnsupportedAppUsage
    ...
    public synchronized long getCachedNtpTime() {
        ...
        return mNtpResult == null ? 0 : mNtpResult.getTimeMillis();
    }
    ...
    public synchronized long getCachedNtpTimeReference() {
        return mNtpResult == null ? 0 : mNtpResult.getElapsedRealtimeMillis();
    }
     ...
     */
    @Nullable
    public synchronized NtpResult getCachedNtpResult() {
        return mNtpResult;
    }
