...
public final class EuiccProfileInfo implements Parcelable {
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({ProfileClass.TESTING, ProfileClass.PROVISIONING, ProfileClass.OPERATIONAL})
    ...
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({ProfileState.DISABLED, ProfileState.ENABLED})
    ...
    public final OperatorId operatorId;

    /** The policy rules of the subscription. */
    @PolicyRule public final int policyRules;

    /**
     * The builder to build a new {@link EuiccProfileInfo} instance. Values are only check for some
     * mutable entities defined in the GSMA spec SGP.22. Readonly values from eUICC are not checked.
     */
    public static final class Builder {
        ...
        public Builder(EuiccProfileInfo baseProfile) {
            ...
            operatorId = baseProfile.operatorId;
            policyRules = baseProfile.policyRules;
        }

        /**
         * Builds the profile instance. This builder should not be used anymore after this method is
        ...
        /** Sets the operator Id of the subscription. */
        public Builder setOperatorId(OperatorId value) {
            operatorId = value;
            return this;
        }
    ...
    private EuiccProfileInfo(Parcel in) {
        ...
        state = in.readInt();
        operatorId = OperatorId.CREATOR.createFromParcel(in);
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(state);
        operatorId.writeToParcel(dest, flags);
