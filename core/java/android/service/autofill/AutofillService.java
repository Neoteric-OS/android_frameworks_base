 ...
 * target package and should be used with caution. The platform supports creating an allowlist which
 * packages can be targeted in compatibility mode to ensure this mode is used only when needed and
 * as long as needed.
 *
