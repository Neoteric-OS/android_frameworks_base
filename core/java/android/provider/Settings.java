...
public final class Settings {
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
        ...
        /**
         * Only dns received for latest ms interval should be evaluated for data stall judgement.
         * @hide
         */
        public static final String RECENT_DNS_INTERVAL = "recent_dns_interval";

        /**
         * Which data stall detection signal to use. Possible values are
         * NetworkMonitor.DATA_STALL_EVALUATION_*
         * @hide
         */
