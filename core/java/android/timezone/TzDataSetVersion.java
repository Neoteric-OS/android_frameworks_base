...
public final class TzDataSetVersion {
    ...
    public static int currentFormatMajorVersion() {
        return com.android.icu.timezone.TzDataSetVersion.currentFormatMajorVersion();
    }
    ...
    public static int currentFormatMinorVersion() {
        return com.android.icu.timezone.TzDataSetVersion.currentFormatMinorVersion();
    }
    ...
    public static boolean isCompatibleWithThisDevice(TzDataSetVersion tzDataSetVersion) {
        return com.android.icu.timezone.TzDataSetVersion.isCompatibleWithThisDevice(
    ...
    public static TzDataSetVersion read() throws IOException, TzDataSetException {
        try {
            return new TzDataSetVersion(
                    com.android.icu.timezone.TzDataSetVersion.readTimeZoneModuleVersion());
        } catch (com.android.icu.timezone.TzDataSetVersion.TzDataSetException e) {
    ...
    @NonNull
    private final com.android.icu.timezone.TzDataSetVersion mDelegate;

    private TzDataSetVersion(@NonNull com.android.icu.timezone.TzDataSetVersion delegate) {
