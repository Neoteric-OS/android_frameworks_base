 ...
 * scope are optional. If not specified, no flags are set, and the scope will be automatically
 * determined based on the IP address. If they are specified, they are not checked for validity.
 *
 * @hide
 */
public class LinkAddress implements Parcelable {
    ...
    /**
     * Constructs a new {@code LinkAddress} from an {@code InetAddress} and a prefix length, with
     * the default flags and global scope.
     * @param address The IP address.
     * @param prefixLength The prefix length.
     */
     ...
     * "2001:db8::1/64", with the default flags and automatically determined scope.
    ...
    /**
     * Determines the scope of a unicast address per RFC 4291 section 2.5 and RFC 6724 section 3.2.
     */
    public static int scopeForUnicastAddress(InetAddress addr) {
