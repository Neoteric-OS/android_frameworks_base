...
public class MeteredMultipathPreferenceTracker {
    private static final String TAG = MeteredMultipathPreferenceUpdater.class.getSimpleName();
    ...
    public MeteredMultipathPreferenceUpdater(Context context, Handler handler) {
        mContext = context;
        mHandler = handler;
