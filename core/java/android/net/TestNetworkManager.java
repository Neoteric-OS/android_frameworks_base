...
public class TestNetworkManager {
    ...
    private void setupTestNetwork(
        ...
        try {
            mService.setupTestNetwork(iface, lp, isMetered, binder, administratorUids);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setupTestNetwork(
        ...
        setupTestNetwork(lp.getInterfaceName(), lp, isMetered, binder, new int[0]);
    }
    ...
    public void setupTestNetwork(@NonNull String iface, @NonNull IBinder binder) {
        setupTestNetwork(iface, null, true, binder, new int[0]);
    }
     ...
     * @param iface the name of the interface to be used for the Network LinkProperties.
     * @param binder A binder object guarding the lifecycle of this test network.
     * @param administratorUids The administrator UIDs to be used for the the test-only network
     * @hide
     */
    public void setupTestNetworkWithAdministrator(
            @NonNull String iface, @NonNull IBinder binder, @NonNull int[] administratorUids) {
        setupTestNetwork(iface, null, true, binder, administratorUids);
    }
