...
public class NetworkUtils {
     ...
     */
    public static void addArpEntry(Inet4Address ipv4Addr, MacAddress ethAddr, char netPort,
            String ifname, FileDescriptor fd) throws IOException {
        addArpEntry(ethAddr.toByteArray(), ipv4Addr.getAddress(), netPort, ifname, fd);
    }

    private static native void addArpEntry(byte[] ethAddr, byte[] netAddr, char netPort,
            String ifname, FileDescriptor fd) throws IOException;
