...
public class NetworkUtils {
     ...
     */
    public static void addArpEntry(Inet4Address netAddr, MacAddress ethAddr, char netPort,
            String ifname, FileDescriptor fd) throws IOException {
        addArpEntry(ethAddr.toByteArray(), netAddr.getAddress(), netPort, ifname, fd);
    }
