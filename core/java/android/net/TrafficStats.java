...
public class TrafficStats {
    ...
    /**
     * Return number of packets transmitted on the specified interface since device
     * boot. Statistics are measured at the network layer, so both TCP and UDP usage
     * are included.
     *
    ...
    /**
     * Return number of packets received on the specified interface since device
     * boot. Statistics are measured at the network layer, so both TCP and UDP
     * usage are included.
     *
     * @param iface The name of the interface.
