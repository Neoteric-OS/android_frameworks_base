...
public class NetworkStack {
    ...
    public static void checkNetworkStackPermissionOr(final @NonNull Context context,
        ...
        String[] others = otherPermissions.clone();
        ArrayList<String> permissions = new ArrayList<String>(Arrays.asList(others));
        permissions.add(NETWORK_STACK);
        permissions.add(PERMISSION_MAINLINE_NETWORK_STACK);
        enforceAnyPermissionOf(context, (String[]) permissions.toArray(others));
    }
