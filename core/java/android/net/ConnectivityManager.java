...
public class ConnectivityManager {
    ...
    public static class NetworkCallback {
         ...
         * @param blocked The flag indicate if the network is blocked
         * @hide
         */
        public void onAvailable(Network network, NetworkCapabilities networkCapabilities,
            ...
            onUpdateBlockedStatus(network, blocked);
        }
         ...
         * {@link #onUpdateBlockedStatus(Network, boolean)}.
         *
         * @param network The {@link Network} of the satisfying network.
         */
        public void onAvailable(Network network) {}
        ...
        /**
         * Called when the network the framework connected to for this request changes blocked
         * status.
         * @param network The {@link Network} whose blocked status have changed.
         * @param blocked The blocked status of this {@link Network}.
         */
        public void onUpdateBlockedStatus(Network network, boolean blocked) {}
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case CALLBACK_AVAILABLE: {
                    ...
                    callback.onAvailable(network, cap, lp, message.arg1 != 0 ? true : false);
                    break;
                }
                ...
                case CALLBACK_BLK_CHANGED: {
                    ...
                    callback.onUpdateBlockedStatus(network, blocked);
                }
            }
        }
