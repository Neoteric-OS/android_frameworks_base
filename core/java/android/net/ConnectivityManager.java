...
public class ConnectivityManager {
    ...
    public static class NetworkCallback {
         ...
         */
        private void onAvailable(Network network, NetworkCapabilities networkCapabilities,
         ...
         * Called when the framework connects and has declared a new network ready for use.
         * This callback may be called more than once if the {@link Network} that is
         * satisfying the request changes. This will alwayl immediately be followed with a
         * call to {@link #onCapabilitiesChanged(Network, NetworkCapabilities)} then with a
