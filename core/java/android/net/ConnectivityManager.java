...
public class ConnectivityManager {
     ...
     * @see #doesCarrierAllowTethering(int, TetherProvisioningCheckedListener, Handler)
     * @hide
     */
    @SystemApi
    ...
    public interface TetherProvisioningCheckedListener {
        /**
         * Called when the carrier provisioning check for tethering finshes. If
         * {@link #doesCarrierAllowTethering} is called multiple times before the callback is
         * triggered, the callback will be called once for each call to
         * {@link #doesCarrierAllowTethering}.
         *
