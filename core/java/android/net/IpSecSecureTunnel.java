...
public final class IpSecSecureTunnel implements AutoCloseable {
    ...
    public static class Builder {
         ...
         * IpSecSecureTunnel
         *
         * <p>In cases where the source and destination address are the same, the tunnel will be
         * built using a single SPI and Transform (Since two Transforms cannot share the same
         * SPI/destination pair)
         */
