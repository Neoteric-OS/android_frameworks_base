 ...
 * when an MTU is found while attempting to send an ICMP6 packet.
 *
 * @see <a
 *     href="https://www.iana.org/assignments/icmpv6-parameters/icmpv6-parameters.xhtml#icmpv6-parameters-codes-3">ICMPv6
 *     Packet Too Big</a>
 */
public class Icmpv6PacketTooBigException extends Icmpv6Exception {
    ...
    public Icmpv6PacketTooBigException(
        ...
        super(OsConstants.ICMP6_PACKET_TOO_BIG, 0, msg);
