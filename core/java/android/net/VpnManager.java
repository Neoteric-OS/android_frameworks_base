...
public class VpnManager {
     ...
     *
     * This action will have a category of either {@link #CATEGORY_ERROR_IKE},
     * {@link #CATEGORY_ERROR_NETWORK}, or {@link #CATEGORY_DEACTIVATED_BY_USER},
     ...
     * </ul>
     * When this event is an error, either {@link #CATEGORY_ERROR_IKE} or
     * {@link #CATEGORY_ERROR_NETWORK}, the following extras will be populated :
     * <ul>
     *   <li>{@link #EXTRA_ERROR_CLASS}, an {@code int} for the class or error, either
     ...
     */
    @SdkConstant(SdkConstant.SdkConstantType.INTENT_CATEGORY)
    public static final String CATEGORY_DEACTIVATED_BY_USER =
            "android.net.category.DEACTIVATED_BY_USER";
    ...
    /**
     * An {@link #EXTRA_ERROR_CODE} for {@link #CATEGORY_ERROR_NETWORK} indicating that
