...
public class VpnManager {
     ...
     */
    public static final String ACTION_VPN_MANAGER_ERROR =
            "android.net.action.VPN_MANAGER_ERROR";
     ...
     */
    public static final String CATEGORY_ERROR_NETWORK =
            "android.net.category.ERROR_NETWORK";
    ...
    public static final String EXTRA_UNDERLYING_NETWORK =
            "android.net.extra.UNDERLYING_NETWORK";

    /**
     * The network capabilities of the underlying network.
     */
    ...
    /**
     * Extra for the error code. The value should be 0 for ERROR_CATEGORY_USER_DEACTIVATED, one of
     * ERROR_CODE_NETWORK_* for ERROR_CATEGORY_NETWORK or one of values defined in
     * IkeProtocolException#ErrorType.
     */
    ...
    /**
     * An error code to indicate that there is an UnknownHostException.
     */
     ...
     */
    public static final int ERROR_CODE_NETWORK_REFUSED = 2;

    /**
     * An error code to indicate that there is a SocketException.
     */
