...
public final class NetworkScore implements Parcelable {
    ...
    // NOTE : temporarily this is managed by ConnectivityService, because of legacy. The legacy
    // design has this bit global to the system and tacked on WiFi which means it will affect
    ...
    // affect other carriers but will at least leave non-mobile networks alone.
