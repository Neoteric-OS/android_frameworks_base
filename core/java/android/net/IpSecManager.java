...
public final class IpSecManager {
    ...
    public static final class IpSecTunnelInterface implements AutoCloseable {
        ...
        /**
         * Update the underlying network of this IpSecTunnelInterface.
         *
         * <p>To migrate IPSec tunnel mode traffic , the caller should:
         *
         * <ol>
         *   <li>1. Update the IpSecTunnelInterface’s underlying network
         *   <li>2. Apply migrated inbound and outbound IpSecTransforms to this IpSecTunnelInterface
         * </ol>
         *
        ...
        public void setUnderlyingNetwork(@NonNull Network underlyingNetwork) throws IOException {
            try {
                mService.setNetworkOfTunnelInterface(
