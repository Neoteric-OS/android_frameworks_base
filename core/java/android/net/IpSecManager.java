...
public class IpSecManager {
    ...
    public static final int STATUS_NO_EXISTING_FLOW = 1;
     ...
     * @hide
     */
    public void addIpSecTransform(ParcelFileDescriptor boundSocket, InetAddress remote,
            int remotePort, int direction, int spi, IpSecAlgorithm encryption,
            IpSecAlgorithm authentication, Network network)
     ...
     * @hide
     */
    public ConnectivityManager.PacketKeepalive addIpSecTransform(
        ParcelFileDescriptor boundSocket, InetAddress remote, int remotePort,
        int direction, int spi, IpSecAlgorithm encryption, IpSecAlgorithm authentication,
        Network network, ConnectivityManager.PacketKeepaliveCallback callback,
        int intervalSeconds)
        throws SocketNotBoundException, TransformCollisionException,
            InsufficientPermissionException {
      return null;
