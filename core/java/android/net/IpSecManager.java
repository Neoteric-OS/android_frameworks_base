...
public class IpSecManager {
     ...
     * @hide
     */
    public void addIpSecTransform(IpSecTransform tranform)
     ...
     *
     * @param transform a transport mode IpSecTransform object
     * @param callback the {@link ConnectivityManager#PacketPeepaliveCallback} that will receive
     * status information regarding the transmission of NATT Keepalive packets.
     * @param intervalSeconds the maximum number of seconds between requested NATT Keepalive
     * packet transmisions.
     * @return a {@link ConnectivityManager#Packetkeepalive} object that will invoke the provided
     * callbacks.
     * @hide
     */
    public ConnectivityManager.PacketKeepalive addIpSecTransform(
        ConnectivityManager.PacketKeepaliveCallback callback, int intervalSeconds)
        throws SocketNotBoundException, TransformCollisionException,
            InsufficientPermissionException {
      return null;
    }
