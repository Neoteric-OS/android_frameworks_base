...
/** @hide */
public class IpSecConfig implements Parcelable {
    private static final String TAG = IpSecConfig.class.getSimpleName();

    static int FEATURE_TRANSPORT_MODE = 1 << 0;
    static int FEATURE_TUNNEL_MODE    = 1 << 1;
    static int FEATURE_SELECTOR       = 1 << 2;
    static int FEATURE_NETWORK        = 1 << 3;
    static int FEATURE_ENCRYPTION     = 1 << 4;
    static int FEATURE_AUTHENTICATION = 1 << 5;
    static int FEATURE_UDP_ENCAP      = 1 << 6;
    static int FEATURE_SELECTOR_PROTO = 1 << 7;
