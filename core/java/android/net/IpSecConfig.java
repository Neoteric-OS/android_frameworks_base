...
public final class IpSecConfig implements Parcelable {
    ...
    public IpSecAlgorithm getCombined(int direction) {
        return flow[direction].combined;
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeParcelable(flow[IpSecTransform.DIRECTION_IN].combined, flags);
        ...
        out.writeParcelable(flow[IpSecTransform.DIRECTION_OUT].combined, flags);
    ...
    private IpSecConfig(Parcel in) {
        ...
        flow[IpSecTransform.DIRECTION_IN].authentication =
                (IpSecAlgorithm) in.readParcelable(IpSecAlgorithm.class.getClassLoader());
        flow[IpSecTransform.DIRECTION_IN].combined =
                (IpSecAlgorithm) in.readParcelable(IpSecAlgorithm.class.getClassLoader());
        ...
        flow[IpSecTransform.DIRECTION_OUT].authentication =
                (IpSecAlgorithm) in.readParcelable(IpSecAlgorithm.class.getClassLoader());
        flow[IpSecTransform.DIRECTION_OUT].combined =
                (IpSecAlgorithm) in.readParcelable(IpSecAlgorithm.class.getClassLoader());
