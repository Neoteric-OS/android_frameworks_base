...
public final class IpSecConfig implements Parcelable {
    ...
    private void checkAlgorithms(int direction) {
        if (mFlow[direction].mAuthenticatedEncryption != null
                && (mFlow[direction].mAuthentication != null
                        || mFlow[direction].mEncryption != null)) {
