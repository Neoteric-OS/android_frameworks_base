...
public class NetworkStats implements Parcelable {
     ...
     */
    public void migrateTun(
            int tunUid,
            @NonNull String tunIface,
    ...
    private void tunAdjustmentInit(
            ...
            @NonNull String tunIface,
            @NonNull String[] underlyingIfaces,
            @NonNull Entry tunIfaceTotal,
            @NonNull Entry[] perInterfaceTotal,
            @NonNull Entry underlyingIfacesTotal) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            } else if (Objects.equals(tunIface, recycle.iface)) {
