...
public final class NetworkStats implements Parcelable {
    ...
    /**
     * Basic element of network statistics. Contains the number of packet and number of bytes
     * transferred on both directions in a certain set of conditions. See
    ...
    public static class Entry {
         ...
         * @param rxBytes Number of bytes received for this {@link Entry}. Statistics are measured
         *                at the network layer or above, so IP headers are included.
         * @param rxPackets Number of packets received for this {@link Entry}. Statistics are
         *                  measured at the network layer or above, so IP headers are included.
         * @param txBytes Number of bytes transmitted for this {@link Entry}. Statistics are
         *                measured at the network layer or above, so IP headers are included.
         * @param txPackets Number of bytes transmitted for this {@link Entry}. Statistics are
         *                  measured at the network layer or above, so IP headers are included.
