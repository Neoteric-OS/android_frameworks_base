...
interface IConnectivityManager
{
    ...
    void startNattKeepaliveWithFd(in Network network, in ParcelFileDescriptor fd, int resourceId,
            int intervalSeconds, in ISocketKeepaliveCallback cb, String srcAddr,
            String dstAddr);

    void startTcpKeepalive(in Network network, in ParcelFileDescriptor fd, int intervalSeconds,
