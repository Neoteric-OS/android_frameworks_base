...
public class NetworkTemplate implements Parcelable {
    ...
    /**
     * Template to combine all {@link ConnectivityManager#TYPE_WIFI} and
     * {@link ConnectivityManager#TYPE_MOBILE} networks with the given IMSI.
     */
    public static NetworkTemplate buildTemplateCarrierAll(@NonNull String subscriberId) {
