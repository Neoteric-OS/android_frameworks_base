...
public final class NetworkTemplate implements Parcelable {
    ...
    public NetworkTemplate(@TemplateMatchRule int matchRule, @Nullable String subscriberId,
            @Nullable String[] matchSubscriberIds, @Nullable String networkId, int metered,
            int roaming, int defaultNetwork, int subType, int oemManaged,
            @SubscriberIdMatchRule int subscriberIdMatchRule) {
    ...
    /**
     * Get Network Id of the template.
     *
     * @hide
     */
    @Nullable
    ...
    /**
     * Get Meteredness of the template.
     *
     * @hide
     */
    @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
