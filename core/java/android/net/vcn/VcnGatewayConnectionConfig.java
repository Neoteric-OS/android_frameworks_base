...
public final class VcnGatewayConnectionConfig {
    ...
    public static final class Builder {
         ...
         * connectivity by allow underlying cellular networks to be used as default. At the same
         * time, VCN will continue to try to connect until it succeeds.
         *
         ...
         * networks.
         *
         * @params enabled whether safe mode should be enabled. Defaults to {@code true}
         */
        @FlaggedApi(FLAG_SAFE_MODE_CONFIG)
        @NonNull
