...
public final class VcnGatewayConnectionConfig {
    ...
    @NonNull private final BitSet mExposedCapabilities;
    ...
    public VcnGatewayConnectionConfig(
            @NonNull BitSet exposedCapabilities,
    ...
    public VcnGatewayConnectionConfig(@NonNull PersistableBundle in) {
        ...
        mExposedCapabilities =
                BitSet.valueOf(PersistableBundleUtils.toByteArray(exposedCapsBundle));
    ...
    private void validate() {
        Preconditions.checkArgument(
                mExposedCapabilities != null && mExposedCapabilities.cardinality() > 0,
    ...
    private List<Integer> getAllExposedCapabilities() {
        ...
        for (int cap = mExposedCapabilities.nextSetBit(0);
                cap != -1;
                cap = mExposedCapabilities.nextSetBit(cap + 1)) {
            exposedCapsList.add(cap);
        }
        return exposedCapsList;
    }
    ...
    public boolean hasExposedCapability(@NetCapability int capability) {
        ...
        return mExposedCapabilities.get(capability);
    }
    ...
    public boolean requiresUnderlyingCapability(@NetCapability int capability) {
        ...
        return mUnderlyingCapabilities.get(capability);
    }
    ...
    /**
     * Retrieves the maximum MTU allowed for this GatewayConnection.
     *
     * @hide
     */
    ...
    /**
     * Retrieves the meteredness of the GatewayConnection.
     *
     * @hide
     */
    ...
    /**
     * Retrieves the roaming state of the GatewayConnection.
     *
     * @hide
     */
    ...
    public PersistableBundle toPersistableBundle() {
        ...
        final PersistableBundle exposedCapsBundle =
                PersistableBundleUtils.fromByteArray(mExposedCapabilities.toByteArray());
        final PersistableBundle underlyingCapsBundle =
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return getAllExposedCapabilities().equals(rhs.getAllExposedCapabilities())
    ...
    public static class Builder {
        @NonNull private final BitSet mExposedCapabilities = new BitSet();
        ...
        /**
         * Add a capability that this VCN GatewayConnection will support.
         *
         * <p>Only Telephony service capabilities and {@link
         * NetworkCapabilities.NET_CAPABILITY_INTERNET} allowed as a GatewayConnection-supported
         * capabilities:
         *
         * <ul>
         ...
         * </ul>
         *
         * @param exposedCapability the app-facing capability to be exposed by this VCN
         *     GatewayConnection (i.e., the capabilities that this VCN GatewayConnection will
         *     support).
        ...
        public Builder addExposedCapability(@NetCapability int exposedCapability) {
            ...
            mExposedCapabilities.set(exposedCapability);
            return this;
        }

        /**
         * Remove a capability that this VCN GatewayConnection will support.
         *
         * <p>Only Telephony service capabilities and {@link
         * NetworkCapabilities.NET_CAPABILITY_INTERNET} allowed as a GatewayConnection-supported
         * capabilities:
         ...
         * </ul>
         *
         * @param exposedCapability the app-facing capability to not be exposed by this VCN
         *     GatewayConnection (i.e., the capabilities that this VCN GatewayConnection will
         *     support)
         * @return this {@link Builder} instance, for chaining
         */
        public Builder removeExposedCapability(@NetCapability int exposedCapability) {
            ...
            mExposedCapabilities.clear(exposedCapability);
            return this;
        }

        /**
         * Require a capability for Networks underlying this VCN GatewayConnection.
         *
         * <p>Only Telephony service capabilities and {@link
         ...
         *     underlying network for this VCN GatewayConnection.
         * @return this {@link Builder} instance, for chaining
         */
        ...
        /**
         * Remove a requirement of a capability for Networks underlying this VCN GatewayConnection.
         *
         * <p>Calling this method will allow Networks that do NOT have this capability to be
         * selected as an underlying network for this VCN GatewayConnection. However, underlying
         ...
         *     to be an underlying network for this VCN GatewayConnection.
         * @return this {@link Builder} instance, for chaining
         */
         ...
         *
         * <p>Each GatewayConnection will retry according to the retry intervals configured, but if
         * safe mode is enabled, all GatewayConnection(s) will be disabled.
         *
        ...
        /**
         * Sets the maximum MTU allowed for this VCN GatewayConnection.
         *
         * <p>The system may reduce the MTU below the maximum specified based on signals such as the
         * MTU of the underlying networks (and adjusted for GatewayConnection overhead).
         *
         * @param maxMtu the maximum MTU allowed for this GatewayConnection. Must be greater than
        ...
        /**
         * Sets whether this VCN GatewayConnection should be considered metered.
         *
         * @param isMetered whether or not this GatewayConnection should have the {@link
        ...
        /**
         * Sets whether this VCN GatewayConnection should be considered roaming.
         *
         * @param isRoaming whether or not this GatewayConnection should have the {@link
