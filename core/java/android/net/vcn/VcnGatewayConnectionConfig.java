...
public final class VcnGatewayConnectionConfig {
    ...
    private void validate() {
        ...
        validateNetworkPriorityRuleList(mUnderlyingNetworkTemplates);
    ...
    public static final class Builder {
        ...
        /**
         * Set the list of rules to match underlying networks against, in priority order.
         *
        ...
        public Builder setVcnUnderlyingNetworkTemplates(
                @NonNull List<VcnUnderlyingNetworkTemplate> underlyingNetworkTemplates) {
            validateNetworkPriorityRuleList(underlyingNetworkTemplates);
