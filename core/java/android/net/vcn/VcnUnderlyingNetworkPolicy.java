...
/**
 * VcnUnderlyingNetworkPolicy represents the Network policy for a VCN underlying Network.
 *
 * <p>VcnManagementService provides VcnUnderlyingNetworkPolicy instances to registered
 * VcnUnderlyingNetworkPolicyListener when their policy changes, or when requested through
 * VcnManager.
 *
 * @hide
 */
public class VcnUnderlyingNetworkPolicy implements Parcelable {
    ...
    /** Returns whether this policy indicates that the underlying Network should be torn down. */
    public boolean isTeardownRequested() {
        return mIsTearDownRequested;
    }

    /** Returns the merged NetworkCapabilities indicated by this Network policy. */
    @NonNull
