 ...
 *
 * <p>Please see subclass android.net.ipsec.ike.vcn.VcnControlPlaneIkeConfig in IPsec module.
 */
public abstract class VcnControlPlaneConfig {
    ...
    private static final String CONFIG_TYPE_KEY = "configType";
    ...
    public PersistableBundle toPersistableBundle() {
        ...
        result.putInt(CONFIG_TYPE_KEY, getConfigType());
        return result;
    }
