 ...
 *
 * <p>Each {@link VcnTunnelConfig} instance added represents a tunnel that will be brought up on
 * demand based on app-requested {@link Network}s.
 *
 * @hide
 */
public final class VcnConfig implements Parcelable {
    ...
    @NonNull private final List<VcnTunnelConfig> mTunnelConfigs;

    private VcnConfig(
            @NonNull long[] retryIntervalsMs, @NonNull List<VcnTunnelConfig> tunnelConfigs) {
    ...
    public VcnConfig(@NonNull PersistableBundle in) {
        ...
        mTunnelConfigs = PersistableBundleUtils.toList(tunnelConfigsBundle, VcnTunnelConfig::new);
     ...
     */
    @NonNull
    public List<VcnTunnelConfig> getTunnelConfigs() {
    ...
    public PersistableBundle toPersistableBundle() {
        ...
        final PersistableBundle tunnelConfigsBundle =
                PersistableBundleUtils.fromList(
                        mTunnelConfigs, VcnTunnelConfig::toPersistableBundle);
    ...
    public static class Builder {
        @NonNull private final List<VcnTunnelConfig> mTunnelConfigs = new ArrayList<>();
         ...
         *
         * <p>Each tunnel as defined by {@link VcnTunnelConfig} will retry separately, but if safe
         * mode is enabled, all tunnels will be disabled.
         *
        ...
        /**
         * Adds a {@link VcnTunnelConfig} with the configuration for an individual tunnel.
         *
         * @param tunnelConfig the configuration for an individual tunnel.
         * @return this {@link Builder} instance, for chaining.
         */
        @NonNull
        public Builder addTunnelConfig(@NonNull VcnTunnelConfig tunnelConfig) {
