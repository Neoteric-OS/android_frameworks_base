...
public final class VcnCellUnderlyingNetworkTemplate extends VcnUnderlyingNetworkTemplate {
     ...
     *
     * @see Builder#setRequiredCapabilities(Set)
     * @hide
     */
    @NonNull
    public Set<Integer> getRequiredCapabilities() {
    ...
    public static final class Builder {
        ...
        public Builder() {
            mRequiredCapabilities.addAll(REQUIRED_CAPABILITIES_DEFAULT);
        }
         ...
         *
         * @param capabilities a set of capabilities an underlying network MUST have to be able to
         *     match this template. Defaults to {@code [{@link
         *     NetworkCapabilities#NET_CAPABILITY_INTERNET}]}. The full list of allowed capabilities
         *     are:
         *     <ul>
         ...
         *
         * @return this {@link Builder} instance, for chaining
         * @throws IllegalArgumentException if the provided set is empty or contains unsupported
         *     capabilities
         * @hide
         */
        @NonNull
        public Builder setRequiredCapabilities(@NonNull Set<Integer> capabilities) {
