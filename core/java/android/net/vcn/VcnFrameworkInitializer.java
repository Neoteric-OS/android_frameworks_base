...
/**
 * Called by {@link SystemServiceRegistry}'s static initializer and registers all VcnManager to
 * {@link Context}, so that {@link Context#getSystemService} can return.
 *
