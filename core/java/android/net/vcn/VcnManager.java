...
public class VcnManager {
    ...
    @IntDef({
        ...
        GATEWAY_CONNECTION_ERROR_GATEWAY_CONNECTION_DIED,
     ...
     *
     * <p>This may be caused by external events such as network failures or server-requested
     * teardowns.
     *
     * @hide
     */
    ...
    public void registerVcnStatusCallback(
        ...
        if (callback.mCbBinder != null) {
            throw new IllegalStateException("callback is already registered wtih VcnManager");
        }
