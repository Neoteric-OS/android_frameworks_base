...
public class VcnManager {
     ...
     *
     * @param network the Network for which the VCN Network policy result is being generated, or
     ...
     * callback is not privileged for it.
     */
     ...
     *
     * <p>A VCN is inactive if a profile is present for the subscription group, but it is not
     * privileged.
     */
