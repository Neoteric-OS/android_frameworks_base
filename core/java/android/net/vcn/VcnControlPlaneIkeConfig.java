 ...
 *
 * <p>This is a subclass of {@link VcnControlPlaneConfig}.
 *
 * <p>@see {@link VcnControlPlaneConfig}
 *
 * @hide
 */
public final class VcnControlPlaneIkeConfig extends VcnControlPlaneConfig {
    ...
    public VcnControlPlaneIkeConfig(@NonNull PersistableBundle in) {
        ...
        mIkeParams = IkeSessionParams.fromPersistableBundle(ikeParamsBundle);
        mChildParams =
                (TunnelModeChildSessionParams)
                        ChildSessionParams.fromPersistableBundle(childParamsBundle);
        validate();
    }
    ...
    public PersistableBundle toPersistableBundle() {
        ...
        result.putPersistableBundle(IKE_PARAMS_KEY, mIkeParams.toPersistableBundle());
        result.putPersistableBundle(CHILD_PARAMS_KEY, mChildParams.toPersistableBundle());
        return result;
    }
