...
public final class VcnTransportInfo implements TransportInfo, Parcelable {
    ...
    /** This class can be used to construct a {@link VcnTransportInfo}. @hide */
    @FlaggedApi(FLAG_MAINLINE_VCN_MODULE_API)
    @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
    public static final class Builder {
        private int mMinUdpPort4500NatTimeoutSeconds = MIN_UDP_PORT_4500_NAT_TIMEOUT_UNSET;

        /** Construct Builder @hide */
        @FlaggedApi(FLAG_MAINLINE_VCN_MODULE_API)
        @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
        public Builder() {}

        /**
         * Sets the minimum duration that the VCN Gateway guarantees to preserve a NAT mapping.
         *
         ...
         *     guarantees to preserve a NAT mapping. To ensure uninterrupted connectivity, the
         *     device must send keepalive packets within this interval. Failure to do so may result
         *     in the mapping being cleared and connection termination.
        ...
        /** Build a VcnTransportInfo instance @hide */
        @FlaggedApi(FLAG_MAINLINE_VCN_MODULE_API)
        @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
        @NonNull
