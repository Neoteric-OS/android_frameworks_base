...
public class LinkProperties implements Parcelable {
     ...
     * @return true if {@code address} was added, false if it was null or existed and was updated.
     */
    ...
    /**
     * Removes a link address. More precisely, removes the link address, if any, with the same IP
     * address and prefix as @{code toRemove}; other attributes of the address, such as the flags,
