...
public final class LinkProperties implements Parcelable {
    ...
    /**
     * Constructs a new {@code LinkProperties} without any parameter.
     */
    ...
    @SystemApi
    @TestApi
    public boolean addLinkAddress(@Nullable LinkAddress address) {
        if (address == null) {
            return false;
        }
    ...
    @SystemApi
    @TestApi
    public boolean removeLinkAddress(@Nullable LinkAddress toRemove) {
        if (toRemove == null) {
            return false;
        }
    ...
    @TestApi
    @SystemApi
    public boolean addDnsServer(@Nullable InetAddress dnsServer) {
    ...
    @TestApi
    @SystemApi
    public boolean removeDnsServer(@Nullable InetAddress dnsServer) {
        if (dnsServer != null) {
     ...
     * @hide
     */
    public boolean addValidatedPrivateDnsServer(@Nullable InetAddress dnsServer) {
     ...
     * @hide
     */
    public boolean removeValidatedPrivateDnsServer(@Nullable InetAddress dnsServer) {
        if (dnsServer != null) {
     ...
     * @hide
     */
    public boolean addPcscfServer(@Nullable InetAddress pcscfServer) {
     ...
     * @hide
     */
    public boolean removePcscfServer(@Nullable InetAddress pcscfServer) {
        if (pcscfServer != null) {
    ...
    @TestApi
    @SystemApi
    public boolean removeRoute(@Nullable RouteInfo route) {
        return route != null &&
     ...
     */
    @UnsupportedAppUsage
    public boolean addStackedLink(@Nullable LinkProperties link) {
     ...
     * @hide
     */
    public boolean removeStackedLink(@Nullable String iface) {
        if (iface != null) {
    ...
    @TestApi
    @SystemApi
    public boolean isReachable(@Nullable InetAddress ip) {
     ...
     */
    @UnsupportedAppUsage
    public boolean isIdenticalInterfaceName(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     */
    @UnsupportedAppUsage
    public boolean isIdenticalAddresses(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     */
    @UnsupportedAppUsage
    public boolean isIdenticalDnses(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     * @hide
     */
    public boolean isIdenticalPrivateDns(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     * @hide
     */
    public boolean isIdenticalValidatedPrivateDnses(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     * @hide
     */
    public boolean isIdenticalPcscfs(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     */
    @UnsupportedAppUsage
    public boolean isIdenticalRoutes(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     */
    @UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 115609023)
    public boolean isIdenticalHttpProxy(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     */
    @UnsupportedAppUsage
    public boolean isIdenticalStackedLinks(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     * @hide
     */
    public boolean isIdenticalMtu(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     * @hide
     */
    public boolean isIdenticalTcpBufferSizes(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
     ...
     * @hide
     */
    public boolean isIdenticalNat64Prefix(@Nullable LinkProperties target) {
        if (target == null) {
            return false;
        }
