...
public final class Ikev2VpnProfile extends PlatformVpnProfile {
    ...
    public static Ikev2VpnProfile fromVpnProfile(@NonNull VpnProfile profile)
        ...
        builder.setAutomaticNattKeepaliveTimer(profile.automaticNattKeepaliveTimerEnabled);
        builder.setAutomaticIpVersionSelection(profile.automaticIpVersionSelectionEnabled);
