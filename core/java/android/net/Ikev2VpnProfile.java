...
public final class Ikev2VpnProfile extends PlatformVpnProfile {
    ...
    @VisibleForTesting
    private static final List<String> IPSEC_ALGORITHMS = Collections.unmodifiableList(Arrays.asList(
    ...
    public static final class Builder {
        ...
        @NonNull private List<String> mAllowedAlgorithms = IPSEC_ALGORITHMS;
