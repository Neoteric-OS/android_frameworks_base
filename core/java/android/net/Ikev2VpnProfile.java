...
public final class Ikev2VpnProfile extends PlatformVpnProfile {
    ...
    private static void addAlgorithmToIfSupported(List<String> algorithms, String ipSecAlgoName) {
    ...
    static {
        ...
        addAlgorithmToIfSupported(algorithms, CRYPT_AES_CBC);
        addAlgorithmToIfSupported(algorithms, CRYPT_AES_CTR);
        addAlgorithmToIfSupported(algorithms, AUTH_HMAC_SHA256);
        addAlgorithmToIfSupported(algorithms, AUTH_HMAC_SHA384);
        addAlgorithmToIfSupported(algorithms, AUTH_HMAC_SHA512);
        addAlgorithmToIfSupported(algorithms, AUTH_AES_XCBC);
        addAlgorithmToIfSupported(algorithms, AUTH_AES_CMAC);
        addAlgorithmToIfSupported(algorithms, AUTH_CRYPT_AES_GCM);
        addAlgorithmToIfSupported(algorithms, AUTH_CRYPT_CHACHA20_POLY1305);
