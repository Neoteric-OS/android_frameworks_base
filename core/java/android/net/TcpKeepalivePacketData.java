...
public class TcpKeepalivePacketData extends KeepalivePacketData implements Parcelable {
    private static final String TAG = "TcpKeepalivePacketData";
     ...
     /** TCP sequence number. */
    private final int mTcpSeq;

    /** TCP ACK number. */
    private final int mTcpAck;

    /** TCP RCV window. */
    private final int mTcpWnd;

    /** TCP RCV window scale. */
    private final int mTcpWndScale;
    ...
    private TcpKeepalivePacketData(TcpSocketInfo tcpDetails, byte[] data)
        ...
        mTcpSeq = tcpDetails.seq;
        mTcpAck = tcpDetails.ack;
        // In the packet, the window is shifted right by the window scale.
        mTcpWnd = tcpDetails.rcvWnd;
        mTcpWndScale = tcpDetails.rcvWndScale;
    }
    ...
    public boolean equals(@Nullable final Object o) {
        ...
        return this.srcAddress.equals(other.srcAddress)
                ...
                && this.mTcpAck == other.mTcpAck
                && this.mTcpSeq == other.mTcpSeq
                && this.mTcpWnd == other.mTcpWnd
                && this.mTcpWndScale == other.mTcpWndScale;
    }

    @Override
    public int hashCode() {
        return Objects.hash(srcAddress, dstAddress, srcPort, dstPort, mTcpAck, mTcpSeq, mTcpWnd,
                mTcpWndScale);
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeInt(mTcpSeq);
        out.writeInt(mTcpAck);
        out.writeInt(mTcpWnd);
        out.writeInt(mTcpWndScale);
    }
