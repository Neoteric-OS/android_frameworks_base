...
public class ConnectivityDiagnosticsManager {
    ...
    public static final class ConnectivityReport implements Parcelable {
         ...
         * connectivity nor is it deemed to be a captive portal.
         */
        public static final int NETWORK_VALIDATION_RESULT_INVALID = 0;

        /**
         * The overall status of the network is that it is valid, either because it provides
         * full Internet access (all probes succeeded) or is deemed to be a captive portal.
         */
        ...
        public static final int NETWORK_PROBE_RESULT_DNS_SUCCESS = 0x04;

        /** HTTP connected successfully. */
        // TODO: link to INetworkMonitor.NETWORK_VALIDATION_PROBE_HTTP
        public static final int NETWORK_PROBE_RESULT_HTTP_SUCCESS = 0x08;

        /** HTTPS connected successfully. */
        // TODO: link to INetworkMonitor.NETWORK_VALIDATION_PROBE_HTTPS;
        public static final int NETWORK_PROBE_RESULT_HTTPS_SUCCESS = 0x10;

        /** Captive portal fallback address probe succeeded. */
        // TODO: link to INetworkMonitor.NETWORK_VALIDATION_FALLBACK
        public static final int NETWORK_PROBE_RESULT_FALLBACK_SUCCESS = 0x20;

        /** Private DNS (DNS over TLS) resolved successfully. */
        // TODO: link to INetworkMonitor.NETWORK_VALIDATION_PROBE_PRIVDNS
        public static final int NETWORK_PROBE_RESULT_PRIVATE_DNS_SUCCESS = 0x40;

        /** @hide */
        @IntDef(
                prefix = {"NETWORK_PROBE_RESULT_"},
                value = {
                        NETWORK_PROBE_RESULT_DNS_SUCCESS,
                        NETWORK_PROBE_RESULT_HTTP_SUCCESS,
                        NETWORK_PROBE_RESULT_HTTPS_SUCCESS,
                        NETWORK_PROBE_RESULT_FALLBACK_SUCCESS,
                        NETWORK_PROBE_RESULT_PRIVATE_DNS_SUCCESS
                })
        @Retention(RetentionPolicy.SOURCE)
        public @interface NetworkProbeResult {}

        /**
         * A bitmask of network validation probes that succeeded.
         *
         * <p>A result missing from this list does not necessarily mean that a test failed; it is
         * possible that the probe was never performed.
         *
         * <p>The possible bits values reported by this key are:
         * {@link #NETWORK_PROBE_RESULT_DNS_SUCCESS},
         * {@link #NETWORK_PROBE_RESULT_HTTP_SUCCESS},
         * {@link #NETWORK_PROBE_RESULT_HTTPS_SUCCESS},
         * {@link #NETWORK_PROBE_RESULT_FALLBACK_SUCCESS},
         * {@link #NETWORK_PROBE_RESULT_PRIVATE_DNS_SUCCESS}.
         */
        @NetworkProbeResult
        public static final String KEY_NETWORK_PROBE_RESULT_BITMASK =
                "networkProbeResultBitmask";

        /** @hide */
        @StringDef(prefix = {"KEY_"}, value = {
                KEY_NETWORK_VALIDATION_RESULT, KEY_NETWORK_PROBE_RESULT_BITMASK})
        @Retention(RetentionPolicy.SOURCE)
    ...
    public static final class DataStallReport implements Parcelable {
         ...
         * Returns a PersistableBundle with additional info for this report.
         *
         * <p>Get a bundle with detail about the suspected data stall including information
