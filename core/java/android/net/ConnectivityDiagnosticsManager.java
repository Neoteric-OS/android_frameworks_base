...
public class ConnectivityDiagnosticsManager {
    ...
    public static final class ConnectivityReport implements Parcelable {
         ...
         *
         * <p>@deprecated because NETWORK_VALIDATION_RESULT is being updated to be a bitmask.
         * Skipped will not be reported from the system and conflicts with VALID | PARTIALLY_VALID.
         */
        @Deprecated
