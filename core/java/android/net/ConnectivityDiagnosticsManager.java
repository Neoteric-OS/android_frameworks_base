...
public class ConnectivityDiagnosticsManager {
    ...
    public static class RouteDiagnosticsOptions {
         ...
         * simplify this check, the minimum allowed MTU must accommodate both IPv4 and IPv6.
         */
        public static final int MTU_BYTES = 48;
        ...
        public static class Builder {
             ...
             *     RouteDiagnosticsOptions#MTU_BYTES}
             */
            @NonNull
            public Builder setPacketSizeBytes(int packetSizeBytes) {
                if (packetSizeBytes < MTU_BYTES) {
                    throw new IllegalArgumentException(
                            "Packet size (in bytes) must be at least " + MTU_BYTES + " Bytes");
                }
