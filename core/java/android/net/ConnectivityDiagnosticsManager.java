...
public class ConnectivityDiagnosticsManager {
    ...
    public static class ConnectivityReport {
        ...
        /** PersistableBundle that may contain addtional info about the report */
         ...
         *     reportTimestamp
         * @param additionalInfo A PersistableBundle that may contain addtional info about the
         *     report
         */
    ...
    public static class DataStallReport {
         ...
         * @param stallDetails A PersistableBundle that may contain addtional info about the report
         */
