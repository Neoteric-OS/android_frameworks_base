...
public class ConnectivityDiagnosticsManager {
    ...
    public abstract static class RouteDiagnosticsCallback {
        ...
        public static class ProbeResponse {
            ...
            /** The RTT (round trip time) for this ProbeResponse. */
            ...
            /** @hide */
            public static ProbeResponse getTimeoutProbeResponse(int ttl) {
                return new ProbeResponse(null, ttl, TIMEOUT_RTT);
            }
        }
         ...
         *
         * <p>The network specified may not be active when this method is invoked.
         *
         ...
         * @param probeResponses The ProbeResponse
         */
    ...
    public static class RouteDiagnosticsParams {
         ...
         *
         * <p>Unless overridden, the defaults are:
         *
         * <ul>
         *   <li>Max TTL: 30
         *   <li>Probes per Hop: 3
        ...
        public static class Builder {
             ...
             *
             * <p>The minimum allowed packet size is dependent on whether an IPv4 or IPv6 address is
             * specified.
             *
            ...
            public Builder setProbeTimeoutMillis(int probeTimeoutMillis) {
                ...
                this.mProbeTimeoutMillis = probeTimeoutMillis;
                return this;
            }
            ...
            public Builder setDiagnosticsTimeoutMillis(int diagnosticsTimeoutMillis) {
                ...
                this.mDiagnosticsTimeoutMillis = diagnosticsTimeoutMillis;
                return this;
            }
     ...
     * @param diagnosticsExecutor The Executor on which the route diagnostics will be computed. The
     *     diagnostics will be computed concurrently on this Executor based on the number of threads
     *     allocated to it.
     ...
     *     must be 28 Bytes. For IPv6, packet size must be 48 Bytes
     */
