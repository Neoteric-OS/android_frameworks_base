...
public class Network implements Parcelable {
    ...
    private void maybeInitHttpClient() {
        synchronized (mLock) {
            if (mUrlConnectionFactory == null) {
                ...
                HttpURLConnectionFactory httpClient = new HttpURLConnectionFactory();
                ...
                mUrlConnectionFactory = httpClient;
            }
        }
    }
    ...
    public URLConnection openConnection(URL url, java.net.Proxy proxy) throws IOException {
        ...
        mUrlConnectionFactory.setSocketFactory(getSocketFactory());
        return mUrlConnectionFactory.openConnection(url, proxy);
    }
