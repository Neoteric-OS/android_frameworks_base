...
public final class OemNetworkPreferences implements Parcelable {
    ...
    private final @NonNull SparseArray<List<String>> mNetworkMappings;
    ...
    public static final class Builder {
         ...
         * @param packages full package names (e.g.: "com.google.apps.contacts") for apps to use the
         *                 given preference
