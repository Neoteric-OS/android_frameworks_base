...
public final class OemNetworkPreferences implements Parcelable {
    ...
    private OemNetworkPreferences(@NonNull SparseArray<List<String>> networkMappings) {
        ...
        this.mNetworkMappings = networkMappings.clone();
    }
    ...
    public static final class Builder {
        private SparseArray<List<String>> mNetworkMappings;
    ...
    /* package-private */ OemNetworkPreferences(@NonNull android.os.Parcel in) {
        SparseArray<List<String>> networkMappings = (SparseArray) in.readSparseArray(
                List.class.getClassLoader());

        this.mNetworkMappings = networkMappings;
        com.android.internal.util.AnnotationValidations.validate(
                NonNull.class, null, mNetworkMappings);
    }
    ...
    public static final Parcelable.Creator<OemNetworkPreferences> CREATOR =
        ...
        public OemNetworkPreferences createFromParcel(@NonNull android.os.Parcel in) {
            return new OemNetworkPreferences(in);
        }
    };
}
