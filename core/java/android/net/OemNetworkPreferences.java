...
public final class OemNetworkPreferences implements Parcelable {
    /**
     * Use default behavior requesting networks. Equivilent to not setting any preference at all.
     */
     ...
     */
    public static final int OEM_NETWORK_PREFERENCE_OEM_PAID_ONLY = 2;

    /**
     * Prefer networks in order: NET_CAPABILITY_NOT_METERED, NET_CAPABILITY_OEM_PRIVATE, default.
     */
    public static final int OEM_NETWORK_PREFERENCE_OEM_PRIVATE = 3;
    ...
    /** @hide */
    public final @NonNull SparseArray<List<String>> mNetworkMappings;
     ...
     * to package name mappings. Package name need to be (e.g.: "com.google.apps.contacts"). This
    ...
    public static final class Builder {
         ...
         * @param packages the packages to use the given preference
        ...
        public Builder addNetworkPreference(@OemNetworkPreference final int preference,
            ...
            mNetworkMappings.put(preference, packages);
            return this;
        }
    ...
    //
    // To regenerate run:
    // $ codegen $ANDROID_BUILD_TOP/frameworks/base/core/java/android/net/OemNetworkPreferences.java
    //
    ...
    @IntDef(prefix = "OEM_NETWORK_PREFERENCE_", value = {
        ...
        OEM_NETWORK_PREFERENCE_OEM_PRIVATE,
    ...
    public static String oemNetworkPreferenceToString(@OemNetworkPreference int value) {
        switch (value) {
            ...
            case OEM_NETWORK_PREFERENCE_OEM_PRIVATE:
                    return "OEM_NETWORK_PREFERENCE_OEM_PRIVATE";
    ...
    /* package-private */ OemNetworkPreferences(@NonNull android.os.Parcel in) {
        ...
        SparseArray<List<String>> networkMappings = (SparseArray) in.readSparseArray(List.class.getClassLoader());
    ...
    @DataClass.Generated.Member
    public static final @NonNull Parcelable.Creator<OemNetworkPreferences> CREATOR
    ...
    @DataClass.Generated(
            ...
            sourceFile = "frameworks/base/core/java/android/net/OemNetworkPreferences.java",
            inputSignatures = "public static final  int OEM_NETWORK_PREFERENCE_DEFAULT\npublic static final  int OEM_NETWORK_PREFERENCE_OEM_PAID\npublic static final  int OEM_NETWORK_PREFERENCE_OEM_PAID_ONLY\npublic static final  int OEM_NETWORK_PREFERENCE_OEM_PRIVATE\npublic static final  int OEM_NETWORK_PREFERENCE_OEM_PRIVATE_ONLY\npublic final @android.annotation.NonNull android.util.SparseArray<java.util.List<java.lang.String>> mNetworkMappings\npublic @android.annotation.NonNull android.util.SparseArray<java.util.List<java.lang.String>> getNetworkPreferences()\nclass OemNetworkPreferences extends java.lang.Object implements [android.os.Parcelable]\n@com.android.internal.util.DataClass")
    @Deprecated
