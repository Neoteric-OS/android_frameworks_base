...
public class DisabledVpnManager extends VpnManager {
    ...
    /**
     * An intent is always returned to a system activity that grants the permission to provision VPN
     * profiles. If the device doesn't support VPN the dialog will fail.
     */
    @Nullable
                        ...
                        Resources.getSystem()
                                .getString(
                                        com.android.internal.R.string
                                                .config_platformVpnConfirmDialogComponent));
