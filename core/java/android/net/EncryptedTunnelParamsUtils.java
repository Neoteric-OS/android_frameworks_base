...
public final class EncryptedTunnelParamsUtils {
    ...
    /** Serializes an EncryptedTunnelParams to a PersistableBundle. */
    @NonNull
    ...
    /** Constructs an EncryptedTunnelParams by deserializing a PersistableBundle. */
    @NonNull
    ...
    private static final class IkeTunnelParamsUtils {
        ...
        @NonNull
        public static PersistableBundle serializeIkeParams(@NonNull IkeTunnelParams ikeParams) {
            final PersistableBundle result = new PersistableBundle();
