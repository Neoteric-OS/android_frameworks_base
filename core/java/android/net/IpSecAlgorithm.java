...
public final class IpSecAlgorithm implements Parcelable {
     ...
     * before using it. @see {@link getSupportedAlgorithms}
     *
     * @hide
     */
    ...
    private static final Set<String> ENABLED_OPTIONAL_ALGOS = loadOptionalAlgos();
    ...
    private static Set<String> loadOptionalAlgos() {
        String[] resourceAlgos = Resources.getSystem().getStringArray(
