...
public class PacProxyManager {
    ...
    /**
     * Add a callback to start monitoring the event which reports from PacProxyManagerService.
     */
    @RequiresPermission(anyOf = {
            android.Manifest.permission.OBSERVE_PAC_PROXY,
            NetworkStack.PERMISSION_MAINLINE_NETWORK_STACK})
    public void registerPacProxyInstalledCallback(@NonNull Executor executor,
            @NonNull PacProxyInstalledCallback callback) throws RuntimeException {
        try {
