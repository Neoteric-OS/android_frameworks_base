...
public final class NetworkCapabilities implements Parcelable {
    ...
    public String toString() {
        ...
        String unwantedCapabilities = (types.length > 0 ? " Unwanted: " : "");
        ...
        return "[" + transports + capabilities + unwantedCapabilities + upBand + dnBand + specifier
                + signalStrength + uids + establishingAppUid + "]";
    }
