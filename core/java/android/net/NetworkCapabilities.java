...
public final class NetworkCapabilities implements Parcelable {
    ...
    /**
     * Indicates that this network may provide partial ability. This capability is set when the
     * network only pass the http validation but fail to https validation.
     * @hide
     */
    @SystemApi
     ...
     * @hide
     */
    private static final long SYSTEM_MANAGED_CAPABILITIES =
            (1 << NET_CAPABILITY_VALIDATED)
            | (1 << NET_CAPABILITY_CAPTIVE_PORTAL)
            | (1 << NET_CAPABILITY_FOREGROUND)
            | (1 << NET_CAPABILITY_PARTIAL_CONNECTIVITY);
     ...
     * @hide
     */
    public boolean hasSystemManagedCapability() {
        return ((mNetworkCapabilities & SYSTEM_MANAGED_CAPABILITIES) != 0);
    }
