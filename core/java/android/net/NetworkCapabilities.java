...
public final class NetworkCapabilities implements Parcelable {
     ...
     * MUST be reset to Process.INVALID_UID.
     *
     ...
     *
     * <p>For user privacy reasons, this field will only be populated if the caller is part of the
     * system (as determined by {@link Process.isApplicationUid()}).
     *
     * @hide
     */
    @SystemApi
     ...
     *
     * @return {@code true} if the app is a part of the system.
     */
