...
public final class NetworkCapabilities implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (mNetworkSpecifier != null && !NetworkSpecifier.isWhitelistedNetworkSpecifier(
                mNetworkSpecifier)) {
            throw new IllegalStateException("Invalid network specifier");
        }
        ...
        new Creator<NetworkCapabilities>() {
            ...
            public NetworkCapabilities createFromParcel(Parcel in) {
                ...
                try {
                    ...
                    Log.e(TAG, "BadParcelableException: e=" + e);
                    netCap.mNetworkSpecifier = null;
                }
