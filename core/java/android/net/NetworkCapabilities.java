...
public final class NetworkCapabilities implements Parcelable {
     ...
     * <p>
     * Please note that a single app can be associated with multiple UIDs because each app will
     * have a different UID when it's run as a different user.
     * <p>
    ...
    /**
     * Returns whether this network applies to the passed ranged.
    ...
    /**
     * Combine the currently UIDs this network applies to with the UIDs the passed
