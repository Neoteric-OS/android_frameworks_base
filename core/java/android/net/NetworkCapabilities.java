...
public final class NetworkCapabilities implements Parcelable {
    ...
    public static void appendStringRepresentationOfBitMaskToStringBuilder(@NonNull StringBuilder sb,
            long bitMask, @NonNull NameOf nameFetcher, @Nullable String separator) {
        int bitPos = 0;
     ...
     * @hide
     */
    public static @NonNull String capabilityNamesOf(@NetCapability int[] capabilities) {
        StringJoiner joiner = new StringJoiner("|");
     ...
     */
    @UnsupportedAppUsage
    public static @NonNull String transportNamesOf(@Transport int[] types) {
        StringJoiner joiner = new StringJoiner("|");
        if (types != null) {
            for (int t : types) {
