...
public class DataStallEventLogger{
    ...
    public DataStallEventLogger() {
        // Initialize CellularData and WifiData though they are optional proto data by definition.
        // However, it's not optional in practice. It depends on the statsd design.
    ...
    public void write() {
        ...
        // Reset the dns event whenever data is sent to statsd.
        resetDnsResult();
    }
