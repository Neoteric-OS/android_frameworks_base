...
/**
 * A class accumulating network metrics received from Netd for dns queries and
 * connect() calls.
 *
...
public class NetworkMetrics {
    ...
    public void addDnsResult(int eventType, int returnCode, int latencyMs) {
        ...
        pendingSummary.dnsLatencies.count(latencyMs / 1000.0);
    ...
    public void addConnectResult(int error, int latencyMs, String ipAddr) {
        ...
        if (ConnectStats.isNonBlocking(error)) {
            pendingSummary.connectLatencies.count(latencyMs / 1000.0);
        }
    }
    ...
    public static class Summary {
        ...
        public final int netId;
        public final long transports;
        // DNS latencies measured in seconds.
        ...
        // Blocking connect latencies measured in seconds.
        ...
        public String toString() {
            ...
            j.add(String.format("dns avg=%.2fs max=%.2fs err=%.1f%% tot=%d",
                    dnsLatencies.average(), dnsLatencies.max,
                    100 * dnsErrorRate.average(), dnsErrorRate.count));
            j.add(String.format("connect avg=%.2fs max=%.2fs err=%.1f%% tot=%d",
