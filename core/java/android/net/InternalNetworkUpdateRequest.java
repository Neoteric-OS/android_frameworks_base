...
public final class InternalNetworkUpdateRequest implements Parcelable {
    ...
    private InternalNetworkUpdateRequest(@NonNull final Parcel source) {
        ...
        mIpConfig = source.readParcelable(
                StaticIpConfiguration.class.getClassLoader(), StaticIpConfiguration.class);
        mNetworkCapabilities =
                source.readParcelable(
                        NetworkCapabilities.class.getClassLoader(), NetworkCapabilities.class);
    }
