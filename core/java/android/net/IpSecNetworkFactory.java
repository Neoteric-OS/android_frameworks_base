 ...
 *
 * <p>This class reports a static network score of 75.
 *
 * @hide
 */
public class IpSecNetworkFactory extends NetworkFactory {
    ...
    private static class NetworkInterfaceState {
        ...
        void stop() {
            ...
            // object with a state of DISCONNECTED or SUSPENDED. So we can't simply clear our
            // NetworkInfo here; that sets the state to IDLE, and ConnectivityService will still
