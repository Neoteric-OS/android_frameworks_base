...
public class NetworkIdentity implements Comparable<NetworkIdentity> {
     ...
     * @hide
     */
    public static String getOemManagedNames(int oemManaged) {
        if (oemManaged < 0) {
            return "Unknown";
        } else if (oemManaged == OEM_NONE) {
            return "OEM_NONE";
        }
        final StringBuilder sb = new StringBuilder("[");
        appendOemManagedStringToStringBuilder(sb, oemManaged);
        sb.append("]");
        return sb.toString();
    }
    ...
    private static void appendOemManagedStringToStringBuilder(@NonNull StringBuilder sb,
            int oemManaged) {
        int bitPos = 1;
        ...
        while (oemManaged != 0) {
            if ((oemManaged & 1) != 0) {
                ...
                sb.append(nameOfOemManaged(bitPos));
            }
            oemManaged >>= 1;
            bitPos <<= 1;
        }
