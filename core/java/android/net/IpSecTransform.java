...
/**
 * This class represents an IPsec transform, which comprises a pair of security associations.
 *
 ...
 * transport mode security associations and apply them to individual sockets. Only system services
 * can create tunnel mode transforms and apply them to {@link Network Networks}. Applications
 * looking to create a VPN should use {@link VpnService}.
 *
 * <p>It is an error to allow an {@code IpSecTransform} object to be garbage collected without
 * first calling {@link #close()}.
 *
...
public final class IpSecTransform implements AutoCloseable {
    ...
    /**
     * IPsec traffic will not be encapsulated within UDP.
     *
     * @hide */
     ...
     * IpSecManager#removeTransportModeTransform}. On the other hand, removing an {@code
     * IpSecTransform} from a socket will not deactivate it (because one transform may be applied to
     * multiple sockets.)
     *
     ...
     *
     * {@link IpSecTransform IpSecTransforms} are built with a simple builder pattern. After all
     * parameters are set, the object is built by calling {@link #buildTransportModeTransform}.
     */
    public static class Builder {
         ...
         * creation of an {@link IpSecTransform} will fail when calling the build method.
         *
         * @param direction either {@link #DIRECTION_IN} or {@link #DIRECTION_OUT}
         * @param algo the encryption algorithm to be applied
         */
         ...
         * direction, creation of an {@link IpSecTransform} will fail when calling the build method.
         *
         * @param direction either {@link #DIRECTION_IN} or {@link #DIRECTION_OUT}
         * @param algo  the authentication algorithm to be applied
         */
        ...
        /**
         * Set the inbound or outbound SPI.
         *
         ...
         *
         * <p>If the SPI is omitted for one direction, traffic in that direction will not be
         * encrypted or authenticated.
         *
         * @param direction either {@link #DIRECTION_IN} or {@link #DIRECTION_OUT}
         * @param spi a unique SPI to identify transformed traffic
         */
         ...
         *
         * @param localSocket a socket for sending and receiving encapsulating traffic
         ...
         * @throws IOException indicating other exciting errors
         */
         ...
         *
         * @param localAddress the {@code InetAddress} that provides the local endpoint for this
         *     IPsec tunnel. This is almost certainly an address belonging to the {@link Network}
         *     that will originate the traffic, which is set as the {@link #setUnderlyingNetwork}.
         * @param remoteAddress the {@code InetAddress} representing the remote endpoint of this
         *     IPsec tunnel.
         * @throws IllegalArgumentException indicating that a particular combination of transform
         *     properties is invalid.
         * @hide
