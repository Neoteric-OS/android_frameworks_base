...
public final class IpSecTransform implements AutoCloseable {
    ...
    public static class Builder {
        ...
        /**
         * Add a combined mode algorithm to the transform for the given direction.
         *
         * <p>If a combined mode algorithm is set for a given direction without also
         * providing an SPI for that direction, creation of an IpSecTransform will
         * fail upon calling a build() method.
         *
         * @param direction either {@link #DIRECTION_IN or #DIRECTION_OUT}
         * @param algo {@link IpSecAlgorithm} specifying the combined mode algorithm to be applied.
         */
        public IpSecTransform.Builder setCombined(
                @TransformDirection int direction, IpSecAlgorithm algo) {
            mConfig.flow[direction].combined = algo;
            return this;
        }
