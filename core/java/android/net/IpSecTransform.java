...
public final class IpSecTransform implements AutoCloseable {
    ...
    public static class Builder {
        ...
        public IpSecTransform.Builder setEncryption(
            ...
            if (mConfig.flow[direction].authenticatedEncryption != null) {
         ...
         *
         * <p>If an authenticated encryption algorithm is set for a given direction without 
         * also providing an SPI for that direction, creation of an IpSecTransform will
         ...
         * 
         * @param direction either {@link #DIRECTION_IN or #DIRECTION_OUT}
         * @param algo {@link IpSecAlgorithm} specifying the authenticated encryption algorithm to be applied.
         */
        public IpSecTransform.Builder setAuthenticatedEncryption(
                @TransformDirection int direction, IpSecAlgorithm algo) {
            if (mConfig.flow[direction].authentication != null || mConfig.flow[direction].encryption != null) {
            ...
            mConfig.flow[direction].authenticatedEncryption = algo;
            return this;
        }
