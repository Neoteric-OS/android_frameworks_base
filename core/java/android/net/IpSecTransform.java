...
public final class IpSecTransform {
     ...
     * @hide
     */
    @SystemApi public static final int ENCAP_ESPINUDP_NONIKE = 2;
    ...
    public static class Builder {
         ...
         *
         * @param encapType {@link #ENCAP_ESPINUDP} indicating how IPsec traffic will be
         *     encapsulated in UDP.
         * @param localPort a UDP port number that will be reserved for sending and receiving
         *     encapsulating traffic. This port must already be opened for use via the {@link
         *     IpSecManager#openUdpEncapsulationSocket(int)} method. If not, then the IpSecTransform
