...
public final class IpSecTransform implements AutoCloseable {
    ...
    private IpSecTransform activate()
            throws IOException, IpSecManager.ResourceUnavailableException,
                    IpSecManager.TransformCollisionException {
        int transformId;
        synchronized (this) {
            //try {
    ...
    public static class Builder {
         ...
         * IpSecManager#reserveOutboundSpi(InetAddress, int)}. Otherwise, Transforms will fail to
         * activate.
         *
         ...
         * @param spi a unique 32-bit integer to identify transformed traffic
         */
        public IpSecTransform.Builder setSpi(@TransformDirection int direction, IpSecManager.SecurityParameterIndex spi) {
         ...
         *
         * @param localSocket a {@link IpSecManager.UdpEncapsulationSocket} for sending and receiving encapsulating traffic.
         ...
         * user this operation will fail and throw ResourceUnavailableException. Because Transform
         * objects have substantial impact on the system, unused Transform objects must be cleaned
         * up by calling {@link IpSecTransform#close()} when they are no longer needed.
         *
        ...
        public IpSecTransform buildTransportModeTransform(InetAddress remoteAddress)
                throws IpSecManager.ResourceUnavailableException,
                        IpSecManager.TransformCollisionException, IOException {
         ...
         *     that will originate the traffic, which is set as the {@link #viaNetwork}.
         * @param remoteAddress the {@link InetAddress} that, when matched on traffic to/from this
         *     socket will cause the transform to be applied.
         * @throws IllegalArgumentException indicating that a particular combination of transform
         *     properties is invalid.
