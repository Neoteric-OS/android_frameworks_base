 ...
 * {@hide}
 *
 * Android's original SNTP client implementation. This class and the classes only it relies upon
 * will be removed once the new implementation, {@link NewSntpClient} is stable and working.
 *
 * Sample usage:
 * <pre>OldSntpClient client = new OldSntpClient();
 * if (client.requestTime("time.foo.com", 123, 5000, network)) {
 *     long now = client.getNtpTime() + SystemClock.elapsedRealtime() - client.getNtpTimeReference();
 * }
 * </pre>
 */
public class OldSntpClient implements SntpClientDelegate {
    private static final String TAG = "OldSntpClient";
    ...
    public static final int STANDARD_NTP_PORT = SntpClient.STANDARD_NTP_PORT;
    ...
    @UnsupportedAppUsage
    public OldSntpClient() {
        this(Instant::now, defaultRandom());
    }

    @VisibleForTesting
    public OldSntpClient(Supplier<Instant> systemTimeSupplier, Random random) {
