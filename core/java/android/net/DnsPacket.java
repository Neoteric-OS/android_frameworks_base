...
public abstract class DnsPacket {
    ...
    public class DnsRecord {
         ...
         * This is meant to chain with other methods reading a DNS response in sequence.
         */
        DnsRecord(int sectionType, @NonNull ByteBuffer buf)
        ...
        private String parseName(@NonNull ByteBuffer buf, int depth) throws
            ...
            if (depth > MAXLABELCOUNT) {
                throw new ParseException("Parse name fails, too many labels");
            }
    ...
    protected final List<DnsRecord>[] mSections;
    ...
    protected DnsPacket(@NonNull byte[] data) throws ParseException {
        ...
        for (int i = 0; i < NUM_SECTIONS; ++i) {
            ...
            for (int j = 0; j < count; ++j) {
                try {
                    mSections[i].add(new DnsRecord(i, buffer));
                } catch (BufferUnderflowException e) {
