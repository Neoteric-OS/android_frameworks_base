...
public abstract class DnsPacket {
    ...
    public static class DnsHeader {
        ...
        /**
         * Create a new DnsHeader from specified parameters, useful when synthesizing dns response
         * from query packet.
         */
        @VisibleForTesting
        ...
        public boolean equals(Object o) {
            ...
            final DnsHeader dnsHeader = (DnsHeader) o;
    ...
    public static class DnsRecord {
            ...
            if (rType != QDSECTION) {
                switch (nsType) {
                    ...
                    case TYPE_AAAA:
                        ...
                        break;
                    case TYPE_CNAME:
                        mRdata = domainNameToLabels(rDataStr);
                        break;
                    default:
        ...
        /**
         * Simple implementation converts domain name to labels according to RFC 1035.
         *
         ...
         * label.
         */
        private @NonNull byte[] domainNameToLabels(@NonNull String name) throws
                IOException, ParseException {
            if (!Patterns.DOMAIN_NAME.matcher(name).matches()) {
                throw new ParseException("Fail to parse input: " + name);
            }
    ...
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        final DnsPacket dnsPacket = (DnsPacket) o;
