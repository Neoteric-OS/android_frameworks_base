...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.TELEPHONY_RCS_SERVICE, RcsMessageStorage.class,
                new CachedServiceFetcher<RcsMessageStorage>() {
                    @Override
                    public RcsMessageStorage createService(ContextImpl ctx) {
                        return new RcsMessageStorage();
                    }
                });
