...
public class DevicePolicyManager {
    ...
    /**
     * Called by device owner to add an APN override.
     * The {@link android.telephony.ApnSetting#id} field of the supplied object will be ignored.
     * May replace existing APN if conflicted.
     *
     * @param admin which {@link DeviceAdminReceiver} this request is associated with
     * @param apnSetting the APN to insert
     * @return The id of inserted override APN. Or {@code 0} when
     *         {@link android.telephony.ApnSetting#id} is provided or
     ...
     * {@link android.telephony.ApnSetting#id} should be provided.
     *
     * @param admin which {@link DeviceAdminReceiver} this request is associated with
     * @param apnSetting the override APN to update
     * @return The id of the updated override APN. Or {@code 0} when
     *         {@link android.telephony.ApnSetting#id} is not provided
     *         or failed to update in the database.
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    public int updateOverrideApn(@NonNull ComponentName admin, @NonNull ApnSetting apnSetting) {
        throwIfParentInstance("addOverrideApn");
        if (mService != null) {
            try {
                return mService.addOverrideApn(admin, apnSetting);
    ...
    /**
     * Called by device owner to remove an existing override APN.
     *
     * @param admin which {@link DeviceAdminReceiver} this request is associated with
     * @param apnId the id of the override APN to remove
     * @return {@code true} if successfully removed this override APN, {@code false} otherwise.
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    ...
    /**
     * Called by device owner to get all override APN records inserted by device owner.
     *
     * @param admin which {@link DeviceAdminReceiver} this request is associated with
     * @return A list of override APN inserted by device owner.
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    @Nullable
    ...
    /**
     * Called by device owner to set if override APN should be used. When enabled is {@code true},
     * only override APNs will be used, APNs from any other sources won't be used.
     *
     * @param admin which {@link DeviceAdminReceiver} this request is associated with
     * @param enabled {@true} if override APN should be used, {@false} otherwise
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    @Nullable
    public void setOverrideApnEnabled(@NonNull ComponentName admin, boolean enabled) {
        throwIfParentInstance("setOverrideApnEnabled");
        if (mService != null) {
            try {
                mService.setOverrideApnEnabled(admin, enabled);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
