...
interface IDevicePolicyManager {
    ...
    void setPreferentialNetworkServicePreference(
            in PreferentialNetworkServicePreference preferentialNetworkServicePreference);
    PreferentialNetworkServicePreference getPreferentialNetworkServicePreference(int userHandle);
