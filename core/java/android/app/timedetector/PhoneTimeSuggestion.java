...
/**
 * A time signal from a telephony source. The value can be {@code null} to indicate a previous time
 * suggestion is being withdrawn. When not {@code null}, the value consists of the number of
