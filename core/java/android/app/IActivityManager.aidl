...
interface IActivityManager {
    ...
    @EnforcePermission("GET_JAVA_METHOD_EXECUTABLE_OFFSET")
    JavaMethodExecutableOffset getJavaMethodExecutableOffset(in TargetProcess targetProcess, in MethodDescriptor methodDescriptor);
