...
public class AppFunctionManagerHelper {
    ...
    public static void isAppFunctionEnabled(
        ...
        getAppFunctionExecutionInfo(
                ...
                new OutcomeReceiver<AppFunctionExecutionInfo, Exception>() {
                    @Override
                    public void onResult(AppFunctionExecutionInfo result) {
                        callback.onResult(result.isEnabled());
                    }
    ...
    public static void getAppFunctionExecutionInfo(
            @NonNull String functionIdentifier,
            @NonNull String targetPackage,
            @NonNull AppSearchManager appSearchManager,
            @NonNull Executor executor,
            @NonNull OutcomeReceiver<AppFunctionExecutionInfo, Exception> callback) {
                        ...
                        results.getNextPage(
                                ...
                                listAppSearchResult -> {
                                    if (listAppSearchResult.isSuccess()) {
                                        callback.onResult(
                                                getAppFunctionExecutionInfoFromSearchResults(
     ...
     */
    private static AppFunctionExecutionInfo getAppFunctionExecutionInfoFromSearchResults(
        ...
        if (joinedStaticRuntimeResults.isEmpty()) {
            ...
            if (enabled != APP_FUNCTION_STATE_DEFAULT) {
                String serviceName =
                        joinedStaticRuntimeResults
                                .getFirst()
                                .getGenericDocument()
                                .getPropertyString(
                                        AppFunctionStaticMetadataHelper.PROPERTY_SERVICE_NAME);
                return new AppFunctionExecutionInfo(
                        enabled == APP_FUNCTION_STATE_ENABLED, serviceName);
            }
