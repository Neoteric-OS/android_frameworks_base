...
oneway interface IBackupAgent {
    ...
    */
    ...
    /**
     * Tells the agent that the following file paths should be excluded from the full
     * backup.
     *
     * @param paths List of paths that should be excluded.
     */
    void addExcludedFilePaths(in List<String> paths);
}
