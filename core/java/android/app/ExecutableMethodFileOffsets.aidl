 ...
 * memory. A value of ("", -1, -1) for `containerPath, `containerOffset`,
 * and `methodOffset`, respectively, means that the method was found, but
 * the offset info was unavailable because it is JIT compiled.
 * {@hide}
 */
