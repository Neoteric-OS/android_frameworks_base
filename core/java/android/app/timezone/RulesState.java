...
public final class RulesState implements Parcelable {
     ...
     * distro IANA rules version supplied. i.e. true when the version supplied would be "worse"
     * than that on the device and should not be installed. Returns false if the version supplied
