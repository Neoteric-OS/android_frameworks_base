 ...
 *     </li>
 *     <li>
 *         distroFormatVersionSupported - the distro format version supported by this device.
 *         Always present.
 *     </li>
 *     <li>
 ...
 *     </li>
 *     <li>
 *         stagedOperationType - one of {@link #STAGED_OPERATION_UNKNOWN},
 *         {@link #STAGED_OPERATION_NONE}, {@link #STAGED_OPERATION_UNINSTALL} and
 *         {@link #STAGED_OPERATION_INSTALL} indicating whether there is a currently staged time
 *         zone distro operation. {@link #STAGED_OPERATION_UNKNOWN} is used when
 *         {@link #isOperationInProgress()} is {@code true}. Staged operations currently require a
 *         reboot to become active.
 *     </li>
 *     <li>
 *         stagedDistroRulesVersion - [present if distroStagedState == STAGED_STATE_INSTALL], the
 *         rules version of the distro currently staged for installation.
 *     </li>
 *     <li>
 *         distroStatus - {@link #DISTRO_STATUS_INSTALLED} if there is a time zone
 *         distro installed and active, {@link #DISTRO_STATUS_NONE} if there is no active
 *         installed distro. {@link #DISTRO_STATUS_UNKNOWN} is used when
 *         {@link #isOperationInProgress()} is {@code true}.
 *     </li>
 *     <li>
 *         installedDistroRulesVersion - [present if distroStatus ==
 *         {@link #DISTRO_STATUS_INSTALLED}], the rules version of the installed and active distro.
 *     </li>
 * </ul>
 *
 * @hide
...
public final class RulesState implements Parcelable {
    ...
    public RulesState(String systemRulesVersion, DistroFormatVersion distroFormatVersionSupported,
        ...
        this.mDistroStatus = validateDistroStatue(distroStatus);
    ...
    /**
     * Returns true if the rules version supplied is better than the one currently installed. If
     * there is no installed distro this method throws IllegalStateException.
     */
    public boolean isInstalledDistroWorseThan(DistroRulesVersion distroRulesVersion) {
        ...
        return mInstalledDistroRulesVersion.isWorseThan(distroRulesVersion);
    }
    ...
    private static int validateDistroStatue(int distroStatus) {
