...
interface IRulesManager {
     ...
     *
     * @param timeZoneDistro the file descriptor for the distro
     ...
     */
    int requestInstall(in ParcelFileDescriptor timeZoneDistro, in byte[] checkToken,
            ICallback callback);
     ...
     * and there was nothing to do. The token passed should be the one presented when the check was
     * triggered.
     *
