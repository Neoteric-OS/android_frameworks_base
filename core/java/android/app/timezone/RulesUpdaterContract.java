...
public final class RulesUpdaterContract {
     ...
     * @hide
     */
    // TODO Rename to match permission
    @SystemApi
    public final static String ACTION_DO_CHECK_BROADCAST =
            "android.intent.action.timezone.DO_RULES_UPDATE_CHECK";

    /**
     * The extra containing the {@code byte[]} that should be passed to
     * {@link RulesManager#checkComplete(byte[], boolean)} when the
     * {@link #ACTION_DO_CHECK_BROADCAST} intent has been processed.
     * @hide
     */
    @SystemApi
