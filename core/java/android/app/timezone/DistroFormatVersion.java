 ...
 * <ul>
 *     <li>
 *         majorVersion - the major distro format version. Major versions differences are not
 *         compatible - e.g. 2 is not compatible with 1 or 3.
 *     </li>
 *     <li>
 *         minorVersion - the minor distro format version. Minor versions should be backwards
 *         compatible iff the major versions match exactly, i.e. version 2.2 will be compatible
 *         with 2.1 devices but not 2.3 devices.
 *     </li>
 * </ul>
 *
 * @hide
...
public final class DistroFormatVersion implements Parcelable {
    ...
    public static final Creator<DistroFormatVersion> CREATOR
            = new Creator<DistroFormatVersion>() {
