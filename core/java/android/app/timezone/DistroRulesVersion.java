 ...
 * <ul>
 *     <li>
 *         rulesVersion - the IANA rules version. e.g. "2017a"
 *     </li>
 *     <li>
 *         revision - the revision for the rules. Allows there to be several revisions for a given
 *         IANA rules release. Numerically higher is better.
 *     </li>
 * </ul>
 *
 * @hide
...
public final class DistroRulesVersion implements Parcelable {
    ...
    public static final Creator<DistroRulesVersion> CREATOR
            = new Creator<DistroRulesVersion>() {
    ...
    public boolean isWorseThan(DistroRulesVersion distroRulesVersion) {
