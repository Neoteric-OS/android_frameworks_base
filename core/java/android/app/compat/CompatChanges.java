...
public final class CompatChanges {
    private static final String TAG = "CompatChanges";
     ...
     * server). If the binder call fails, CompatChangesException will be thrown.
     *
     * @param changeId    The ID of the compatibility change in question.
     * @param packageName The package name of the app in question.
     * @param userId      The ID of the user that the operation is done for.
     * @return {@code true} if the change is enabled for the current app.
     * @throws CompatChangesException if communication to service failed.
     */
    public static boolean isChangeEnabled(long changeId, @NonNull String packageName, int userId)
            throws CompatChangesException {
        ...
        try {
            ...
            throw new CompatChangesException(e.getMessage());
        }
    }
     ...
     * @throws CompatChangesException if communication to service failed.
     */
    public static boolean isChangeEnabled(long changeId, int uid) throws CompatChangesException {
        IPlatformCompat platformCompat = IPlatformCompat.Stub.asInterface(
                ServiceManager.getService(Context.PLATFORM_COMPAT_SERVICE));
        try {
