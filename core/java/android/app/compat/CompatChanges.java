...
public class CompatChanges {
     ...
     */
    public boolean isChangeEnabled(long changeId, @NonNull String packageName, int userId)
     ...
     * @throws CompatChangesException if communication to service failed.
     */
    public boolean isChangeEnabled(long changeId, int uid) throws CompatChangesException {
        IPlatformCompat platformCompat = IPlatformCompat.Stub.asInterface(
                ServiceManager.getService(Context.PLATFORM_COMPAT_SERVICE));
        try {
