...
//      }
    ...
    public Map<Long, Boolean> setCompatChanges(
        ...
        ApplicationInfo ai = getTargetContext().getApplicationInfo();
        IPlatformCompat platformCompat = IPlatformCompat.Stub
                .asInterface(ServiceManager.getService(Context.PLATFORM_COMPAT_SERVICE));
        Map<Long, Boolean> previousConfig;
        try {
            previousConfig = platformCompat.setOverrides(
                    new CompatConfigOverrides(enabled, disabled, ai.packageName));
        } catch (RemoteException e) {
    ...
    public void clearCompatChanges(Map<Long, Boolean> oldState) {
        ...
        try {
            Map<Long, Boolean> newState = platformCompat.clearOverrides(ai);
