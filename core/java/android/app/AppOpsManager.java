...
public class AppOpsManager {
    ...
    private static final int[] RUNTIME_PERMISSION_OPS = {
            ...
            // Placeholder for OP_READ_HEART_RATE
            OP_NONE,
            // Placeholder for OP_READ_SKIN_TEMPERATURE
            OP_NONE,
    };
    ...
    static final AppOpInfo[] sAppOpInfos = new AppOpInfo[]{
        ...
        // Placeholder in AOSP for READ_HEART_RATE
        new AppOpInfo.Builder(OP_NONE, "placeholder:read_heart_rate", "Placeholder1")
                .setDefaultMode(AppOpsManager.MODE_IGNORED).build(),
        // Placeholder in AOSP for READ_SKIN_TEMPERATURE
        new AppOpInfo.Builder(OP_NONE, "placeholder:read_skin_temperature", "Placeholder2")
                .setDefaultMode(AppOpsManager.MODE_IGNORED).build(),
