...
public class ApplicationPackageManager extends PackageManager {
    ...
    private static final Set<String> featuresP23 = Set.of(
        "com.google.android.feature.PIXEL_2023_EXPERIENCE",
        "com.google.android.feature.PIXEL_2023_MIDYEAR_EXPERIENCE"
    );

    private static final Set<String> featuresP22 = Set.of(
        "com.google.android.feature.PIXEL_2022_EXPERIENCE",
        "com.google.android.feature.PIXEL_2022_MIDYEAR_EXPERIENCE"
    );

    private static final Set<String> featuresP21 = Set.of(
    ...
    private static final Set<String> featuresAndroid = Set.of(
    ...
    public boolean hasSystemFeature(String name, int version) {
        ...
        if (packageName != null &&
            ...
            if (featuresP23.contains(name)) return false;
            if (featuresP21.contains(name)) return false;
            if (featuresNexus.contains(name)) return true;
            if (featuresAndroid.contains(name)) return true;
        }
        if (featuresAndroid.contains(name)) return true;
        if (featuresP22.contains(name)) return false;
