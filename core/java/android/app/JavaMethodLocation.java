...
public final class JavaMethodLocation implements Parcelable {
    ...
    @FlaggedApi(android.security.Flags.FLAG_CONTENT_URI_PERMISSION_APIS)
    public JavaMethodLocation(@NonNull VMDebug.JavaMethodLocation location) {
        this.odexPath = location.odexPath;
        this.odexOffset = location.odexOffset;
        this.methodOffset = location.methodOffset;
    }
