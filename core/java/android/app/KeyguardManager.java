...
public class KeyguardManager {
     ...
     * <p>
     * Note that in the case of multiple full users, each user can have their own lock screen
     ...
     * <p>
     * Note that in the case of a profile, when the device goes to the lock screen, up to two layers
     * of authentication may be required to regain access to the profile's apps: one to unlock the
