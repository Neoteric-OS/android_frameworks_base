...
public class ActivityManager {
    ...
    public static class RunningAppProcessInfo implements Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            info.processName = android.text.TextUtils.emptyIfNull(processName);
            info.pid = pid;
            info.uid = uid;
            info.pkgList = pkgList == null ? new String[0] : pkgList;
            info.pkgDeps = pkgDeps == null ? new String[0] : pkgDeps;
