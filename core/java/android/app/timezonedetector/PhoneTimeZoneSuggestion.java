...
public final class PhoneTimeZoneSuggestion implements Parcelable {
     ...
     * the same {@code slotId}.
     */
    @NonNull
    public static PhoneTimeZoneSuggestion createEmptySuggestion(
            int slotId, @NonNull String debugInfo) {
        return new Builder(slotId).addDebugInfo(debugInfo).build();
    }
    ...
    private static PhoneTimeZoneSuggestion createFromParcel(Parcel in) {
        ...
        PhoneTimeZoneSuggestion suggestion = new Builder(slotId)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mSlotId, mZoneId, mMatchType, mQuality);
    }
