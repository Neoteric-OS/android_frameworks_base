...
public class CryptoObject {
     ...
     * two or more parties can agree on a cryptographic key in such a way that both
     * influence the outcome. This class provides the functionality of a
     * key agreement (or key exchange) protocol.
     *
