...
public class FaceAuthenticationManager {
    ...
    /**
     * User's face moved too much during image acquisition.
     * The user should be informed to be more still.
     */
    ...
    private IFaceServiceReceiver mServiceReceiver = new IFaceServiceReceiver.Stub() {
        ...
        public void onEnrollResult(long deviceId, int remaining, long vendorMsg) {
            mHandler.obtainMessage(MSG_ENROLL_RESULT,
                    new EnrollResultMsg(new Face(deviceId), remaining, vendorMsg)).sendToTarget();
        }
        ...
        @Override // binder call
        public void onRemoved(long deviceId) {
            mHandler.obtainMessage(MSG_REMOVED, new Face(deviceId)).sendToTarget();
        }
    };
     ...
     * @hide
     */
    public FaceAuthenticationManager(Context context, IFaceService service) {
        mContext = context;
        mService = service;
        if (mService == null) {
    ...
    private String getAcquiredString(int acquireInfo, int vendorCode) {
        switch (acquireInfo) {
            ...
            case FACE_ACQUIRED_TOO_MUCH_MOTION:
                return mContext.getString(R.string.face_acquired_too_much_motion);
    ...
    public static class AuthenticationResult {
         ...
         *
         * @return crypto object provided to {@link FaceAuthenticationManager#authenticate
         * (CryptoObject,
         * CancellationSignal, int, AuthenticationCallback, Handler)}.
         */
    ...
    /**
     * Callback structure provided to {@link FaceAuthenticationManager#enroll(long,
    ...
    /**
     * Callback structure provided to {@link #remove}. Users of {@link FaceAuthenticationManager}
     * may
