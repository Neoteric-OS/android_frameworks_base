...
public class Resources {
    ...
    static private final int FONT_SCALE_CONFIG = ActivityInfo.activityInfoConfigToNative(
            ActivityInfo.CONFIG_FONT_SCALE);
    static private final int DENSITY_CONFIG = ActivityInfo.activityInfoConfigToNative(
    ...
    private boolean verifyPreloadConfig(int changingConfigurations, int allowVarying,
        ...
        // by the caller.
        if (((changingConfigurations&~(FONT_SCALE_CONFIG | DENSITY_CONFIG | SPEC_PUBLIC)) &
                ~allowVarying) != 0) {
            String resName;
            try {
