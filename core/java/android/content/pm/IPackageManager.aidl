...
interface IPackageManager {
   ...
   /**
     ...
     *     the class loader context that was used to load them. If an unknown class loader was
     *     present at load time, then the special value "=UnsupportedClassLoader=" will be
     *     substitued for the class loader context
