...
public abstract class PackageManager {
  ...
  public static final String FEATURE_CONTEXTUAL_SEARCH_HELPER =
    ...
    */
    ...
    /**
     * As the generated feature index lookup is useful for classes that may not be compiled in the
     * same annotation processing unit as PackageManager, we redeclare it here for visibility.
     *
     * @return An index in [0, SDK_FEATURE_COUNT) for features defined in PackageManager, else -1.
     * {@hide}
     */
    @VisibleForTesting
