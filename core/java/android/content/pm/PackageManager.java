...
public abstract class PackageManager {
     ...
     * <ul>
     * <li>100: Hardware support for ECDH (see {@link javax.crypto.KeyAgrement}) and support
     ...
     * devices launching with Android 12 and may be set on devices launching with an earlier version.
     * If the feature version is set, it will at least have the value 40. If it's not set the device
     * may have StrongBox but it may not support all features listed above.
     */
    @SdkConstant(SdkConstantType.FEATURE)
