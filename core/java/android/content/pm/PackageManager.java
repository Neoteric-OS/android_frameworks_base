...
public abstract class PackageManager {
    ...
    */
     ...
     * Permissions can also be allowlisted by the installer or on upgrade.
     */
     ...
     * Permissions can also be allowlisted by the system or on upgrade.
     */
     ...
     * Permissions can also be allowlisted by the installer or the system.
     */
     ...
     * @param whitelistFlag The flag to determine which allowlist to query. Only one flag
     * can be passed.s
     ...
     * on record.
     *
     * <p>You need to specify the whitelists for which to set the allowlisted permissions
