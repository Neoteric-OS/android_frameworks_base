...
public final class WapPushManagerConnector {
    ...
    public static final String SERVICE_INTERFACE =
            "android.telephony.action.WapPushManager";
    ...
    public boolean bindToWapPushManagerService() {
        ...
        return mContext.bindService(intent, mWapPushManagerConnection, Context.BIND_AUTO_CREATE);
    }
    ...
    public void unbindWapPushManagerService() {
        ...
        mContext.unbindService(mWapPushManagerConnection);
