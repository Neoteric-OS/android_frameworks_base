...
/**
 * {@link CertificateSource} based on a hash indexed directory of CA certificates.
 * @hide
 */
abstract class DirectoryCertificateSource implements CertificateSource {
    protected final File mCaDir;
    ...
    protected abstract boolean isCaRemoved(String caFile);
    ...
    public Set<X509Certificate> getCertificates() {
        ...
        synchronized (mLock) {
            ...
            if (mCaDir.isDirectory()) {
                for (String caFile : mCaDir.list()) {
                    if (isCaRemoved(caFile)) {
                        continue;
                    }
