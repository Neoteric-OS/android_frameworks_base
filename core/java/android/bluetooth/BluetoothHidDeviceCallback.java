...
public abstract class BluetoothHidDeviceCallback {
    ...
    /**
     * Callback called when Virtual Cable is removed. This can be either due to {@link
     * BluetoothHidDevice#unplug(BluetoothDevice)} or request from remote side. After this callback
     * is received connection will be disconnected automatically.
     */
