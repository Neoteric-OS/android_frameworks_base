...
public abstract class BleBroadcastAudioScanAssistCallback {
     ...
     * containing available broadcast source channels that are being broadcasted from the selected
     * broadcast source
     *
     */
    ...
    /**
     * Callback when BLE broadcast audio source is been successfully added to the remote
     * Scan delegator.
     ...
     * to the Scan delegator. Actual updated source Information values of resulting Broadcast
     * Source Information will be notified using
     * {@link BleBroadcastAudioScanAssistManager#ACTION_BROADCAST_RECEIVER_STATE} intent
     *
     ...
     * @param status true on successful addition of source Information, false otherwise.
     *
     */
    ...
    /**
     * Callback when BLE broadcast audio source Information is been updated to the remote
     * Scan delegator.
     * result of {@link BleBroadcastAudioScanAssistManager#updateBroadcastSource} will be
     * delivered through this callback
     *
     * This callback is an acknowledgement confirming the source information update request
     * is successfully written on the Scan delegator. Actual updated source Information values
     * of resulting Broadcast Source Information will be notified using
     * {@link BleBroadcastAudioScanAssistManager#ACTION_BROADCAST_RECEIVER_STATE} intent
     *
     ...
     * @param status true on successful updating of source Information, false otherwise.
     *
     */
    ...
    /**
     * Callback when BLE broadcast audio source Information is updated with broadcast PIN
     * code to the remote Scan delegator.
     * result of {@link BleBroadcastAudioScanAssistManager#setBroadcastCode} will be
     * delivered through this callback.
     *
     * This callback is an acknowledgement confirming the Broadcast PIN update request is
     * successfully written to the Scan delegator. Actual updated source Information values
     * of resulting Broadcast Source Information will be notified using
     * {@link BleBroadcastAudioScanAssistManager#ACTION_BROADCAST_RECEIVER_STATE} intent.
     * Encryption status from the
     * {@link BleBroadcastAudioScanAssistManager#ACTION_BROADCAST_RECEIVER_STATE}
     * will confirm the successful Broadcast PIN code and resulting decryption of the
     * Broadcast data at the receiver side.
     *
     * @param device remote scan delegator for which Source is been updated.
    ...
    /**
     * Callback when BLE broadcast audio source Information is removed from the remote Scan
     * delegator.
     * result of {@link BleBroadcastAudioScanAssistManager#removeBroadcastSource} will be
     * delivered through this callback
     *
     * This callback is an acknowledgement confirming the Broadcast source infor removal request
     * is successfully written to the Scan delegator. Actual removal of source Information values
     * of resulting Broadcast Source Information will be notified using
     * {@link BleBroadcastAudioScanAssistManager#ACTION_BROADCAST_RECEIVER_STATE} intent.
     * Deletion of source Information will result is setting all the source information attributes
     * to ZERO other than source Id
     *
