...
interface IBluetoothGatt {
    ...
    void createSync(in ScanResult scanResult, in int skip, in int timeout, in IPeriodicAdvertisingCallback callback);
    void cancelCreateSync(in IPeriodicAdvertisingCallback callback);
    void terminateSync(int syncHandle);
