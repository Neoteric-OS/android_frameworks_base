...
public final class BleBroadcastAudioScanAssistManager {
    ...
    private void printSelectedIndices(List<BleBroadcastSourceChannel> selectedBISIndices) {
        ...
        for (int i=0; i<selectedBISIndices.size(); i++) {
            log(TAG, selectedBISIndices.get(i).getDescription() + ": " + selectedBISIndices.get(i).getStatus());
        }
    }
    /**
     ...
     *
     * Successful addition Broadcast source will be indicated through Broadcast receiver state information
     ...
     *  from Available Broadcast indices.
     *  Avaiable broadcast indices are notified application using {@link BleBroadcastAudioScanAssistCallback#onBleBroadcastSourceSelected}
     ...
     *
     *  However Successful updating of Broadcast source information will be indicated through Broadcast receiver state information
     *  update intent through {@link #ACTION_BROADCAST_RECEIVER_STATE} intent
     *
     * If this operation need to be performed over all the members of coordinated set members, isGroupOp
    ...
    /**
      ...
      *
      *
      * However, Successful updating of Broadcast PIN code will be indicated through Broadcast receiver state information
      * update intent through {@link #ACTION_BROADCAST_RECEIVER_STATE} intent.
      *
      *  @param sourceId sourceId of the Broadcast Source information which need to be updated
