...
public final class BluetoothPan implements BluetoothProfile {
     ...
     * It can be one of {@link #TETHERING_STATUS_START} or {@link #TETHERING_STATUS_STOP}.
     */
    public static final String EXTRA_TETHERING_STATUS =
            "android.bluetooth.pan.extra.TETHERING_STATUS";

    /** @hide **/
    @IntDef({TETHERING_STATUS_NONE, TETHERING_STATUS_START, TETHERING_STATUS_STOP})
    @Retention(RetentionPolicy.SOURCE)
    public @interface TetheringStatus{}
    public static final int TETHERING_STATUS_NONE = 0;
    /**
     * Switch tethering status to start
     */
    public static final int TETHERING_STATUS_START = 1;

    /**
     * Switch tethering status to stop
     */
    public static final int TETHERING_STATUS_STOP = 2;
