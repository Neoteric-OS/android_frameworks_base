...
public final class BluetoothMcsMediaControlRequest implements Parcelable {
    ...
    BluetoothMcsMediaControlRequest(@NonNull Parcel in) {
        ...
        switch (mOpcode) {
            case Opcodes.PLAY:
            case Opcodes.PAUSE:
            case Opcodes.FAST_REWIND:
            case Opcodes.FAST_FORWARD:
            case Opcodes.STOP:
            case Opcodes.PREVIOUS_SEGMENT:
            case Opcodes.NEXT_SEGMENT:
            case Opcodes.FIRST_SEGMENT:
            case Opcodes.LAST_SEGMENT:
            case Opcodes.PREVIOUS_TRACK:
            case Opcodes.NEXT_TRACK:
            case Opcodes.FIRST_TRACK:
            case Opcodes.LAST_TRACK:
            case Opcodes.PREVIOUS_GROUP:
            case Opcodes.NEXT_GROUP:
            case Opcodes.FIRST_GROUP:
            case Opcodes.LAST_GROUP:
                mIntArg = null;
                break;
            case Opcodes.MOVE_RELATIVE:
            case Opcodes.GOTO_SEGMENT:
            case Opcodes.GOTO_TRACK:
            case Opcodes.GOTO_GROUP:
                mIntArg = in.readInt();
                break;
        }
    }
