...
public final class BluetoothLeBroadcastAssistant implements BluetoothProfile {
     ...
     * @hide
     */
    public int connect(@NonNull BluetoothDevice sink) {
        log("connect: " + sink);
     ...
     * @hide
     */
    public int disconnect(@NonNull BluetoothDevice sink) {
        log("disconnect: " + sink);
     ...
     * @hide
     */
    public int stopSearchforBroadcastSources(@NonNull BluetoothDevice sink) {
