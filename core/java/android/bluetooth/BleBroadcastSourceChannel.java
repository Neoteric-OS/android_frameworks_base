 ...
 * are mapped to the BIS indices that given Broadcast source is broadcasting with.
 *
...
public final class BleBroadcastSourceChannel implements Parcelable {
    ...
    public boolean getStatus () {
     ...
     /**
     * Gets the address type of the Broadcast source advertisement for the BleBroadcastSourceChannel
     * Object
     *
     * @return byte addressType, this can be one of {@link #BROADCAST_ASSIST_ADDRESS_TYPE_PUBLIC}
     * OR {@link #BROADCAST_ASSIST_ADDRESS_TYPE_PUBLIC}
     * @hide
     *
     * @deprecated
     */
    ...
    public static final @android.annotation.NonNull
            Parcelable.Creator<BleBroadcastSourceChannel> CREATOR =
