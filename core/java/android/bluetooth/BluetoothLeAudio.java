...
public final class BluetoothLeAudio implements BluetoothProfile, AutoCloseable {
    ...
    public static final String ACTION_CONNECTION_STATE_CHANGED =
            "android.bluetooth.le_audio.profile.action.CONNECTION_STATE_CHANGED";
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_LEAUDIO_ACTIVE_DEVICE_CHANGED =
            "android.bluetooth.le_audio.profile.action.ACTIVE_DEVICE_CHANGED";
     ...
     */
    @RequiresPermission(Manifest.permission.BLUETOOTH_PRIVILEGED)
    public boolean setPriority(@NonNull BluetoothDevice device, int priority) {
