...
public final class BluetoothLeAudioCodecConfig {
    ...
    /** @hide */
    @IntDef(prefix = "FRAME_DURATION_", value = {
        FRAME_DURATION_NONE,
        FRAME_DURATION_7500,
    ...
    private BluetoothLeAudioCodecConfig(@SourceCodecType int codecType,
            ...
            @ChannelMode int channelMode, @FrameDuration int frameDuration,
            int octetsPerFrame) {
    ...
    public static final class Builder {
        ...
        public @NonNull BluetoothLeAudioCodecConfig build() {
            return new BluetoothLeAudioCodecConfig(mCodecType, mCodecPriority,
                                                   mSampleRate, mBitsPerSample,
                                                   mChannelMode, mFrameDuration,
                                                   mOctetsPerFrame);
        }
    }
}
