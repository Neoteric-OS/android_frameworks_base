 ...
 *
 * @deprecated Health Device Profile (HDP) and MCAP protocol is largely replaced by BLE. New apps
 * should use Bluetooth Low Energy based solutions such as {@link BluetoothGatt},
 * {@link BluetoothAdapter#listenUsingL2capCoc(int)}, or
 * {@link BluetoothDevice#createL2capCocSocket(int, int)}
 */
@Deprecated
public final class BluetoothHealth implements BluetoothProfile {
     ...
     *
     * @deprecated Health Device Profile (HDP) and MCAP protocol is largely replaced by BLE. New
