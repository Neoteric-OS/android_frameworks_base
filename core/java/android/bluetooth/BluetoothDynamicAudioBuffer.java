...
public final class BluetoothDynamicAudioBuffer implements Parcelable {
    /** @hide */
    @IntDef(prefix = "DYNAMIC_AUDIO_BUFFER_TYPE_", value = {
            DYNAMIC_AUDIO_BUFFER_TYPE_NONE,
            DYNAMIC_AUDIO_BUFFER_TYPE_A2DP_OFFLOAD,
            DYNAMIC_AUDIO_BUFFER_TYPE_A2DP_SOFTWARE_ENCODING
    })
    @Retention(RetentionPolicy.SOURCE)
    public @interface DynamicBufferType {}
    ...
    /** @hide */
    @IntDef(prefix = "BUFFER_TYPE_", value = {
            BUFFER_TYPE_DEFAULT_VALUE,
            BUFFER_TYPE_MAXIMUM_VALUE,
            BUFFER_TYPE_MINIMUM_VALUE,
            BUFFER_TYPE_MAX
    })
    @Retention(RetentionPolicy.SOURCE)
