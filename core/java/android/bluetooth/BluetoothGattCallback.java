...
public abstract class BluetoothGattCallback {
    ...
    /**
     * Callback reporting the result of a characteristic read operation. Refer to the param value
     * for the value that was read from the server as the value in the characteristic may have
     * changed since this read request.
     *
     * @param gatt           GATT client invoked
     *                       {@link BluetoothGatt#readCharacteristic(BluetoothGattCharacteristic)}
     * @param characteristic Characteristic that was read from the associated remote device.
     ...
     *                       the
     *                       operation succeeds.
     * @deprecated Use {@link BluetoothGattCallback#onCharacteristicWrite(BluetoothGatt,
     * BluetoothGattCharacteristic, byte[], int)} as it is memory safe by providing the
     * characteristic value that was written
     */
    @Deprecated
     ...
     *
     * <p>If this callback is invoked while a reliable write transaction is
     * in progress, the writtenValue represents the value reported by the remote device.
     * Note: an application should compare the writtenValue to the desired value to be written as
     * the local characteristic value may have changed since the write operation.
     ...
     *                       byte[], int)}
     * @param characteristic Characteristic that was written to the associated remote device.
     * @param writtenValue   the value that was written to the remote device characteristic
     * @param status         The result of the write operation {@link BluetoothGatt#GATT_SUCCESS} if
     *                       the
     *                       operation succeeds.
     */
    public void onCharacteristicWrite(@NonNull BluetoothGatt gatt, @NonNull
            BluetoothGattCharacteristic characteristic, @NonNull byte[] writtenValue, int status) {
    }
     ...
     * @param characteristic Characteristic that has been updated as a result of a remote
     *                       notification event.
     * @param value          the characteristic value at the time of notification
     */
    ...
    /**
     * Callback reporting the result of a descriptor read operation. Note that the value
     * within the descriptor object may have changed since reading the remote descriptor.
     * Check the parameter value for the value at the time of the read operation.
     *
     * @param gatt       GATT client invoked {@link BluetoothGatt#readDescriptor}
     * @param descriptor Descriptor that was read from the associated remote device.
     * @param status     {@link BluetoothGatt#GATT_SUCCESS} if the read operation was completed
     ...
     *                   operation succeeds.
     * @deprecated Use {@link BluetoothGattCallback#onDescriptorWrite(BluetoothGatt,
     * BluetoothGattDescriptor, int, byte[])} as it is memory safe by providing the descriptor value
     * that was written.
     */
    @Deprecated
     ...
     * @param status     The result of the write operation {@link BluetoothGatt#GATT_SUCCESS} if the
     *                   operation succeeds.
     * @param value      the descriptor value that was being written
     */
