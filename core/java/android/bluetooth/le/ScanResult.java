...
public final class ScanResult implements Parcelable {
    ...
    /**
     * The data returned is incomplete, more ScanResults will follow.
     */
    public static final int DATA_INCOMPLETE_MORE_TO_COME = 1;
    ...
    /**
     * No packets were received on secondary advertising channel
     */
     ...
     * @param scanRecord Scan record including both advertising data and scan
     * response data.
    ...
    public ScanResult(BluetoothDevice device, ScanRecord scanRecord, int rssi,
                      long timestampNanos, int eventType, int primaryPhy,
     ...
     */
    public boolean isLegacy() { return (mEventType & 0x10) != 0; }

    /**
     * Returns strue if this object represents connectable scan result;
     */
    public boolean isConnectable() { return (mEventType & 0x01) != 0; }

    /**
     * Returns the data status. Can be one of {@link ScanResult#DATA_COMPLETE},
     * {@link ScanResult#DATA_INCOMPLETE_MORE_TO_COME} or {@link
     * ScanResult#DATA_INCOMPLETE_TRUNCATED}
     */
    public int getDataStatus() { return (mEventType >> 5) & 0x03; }

    /**
     * Returns the primary physical channel on which this advertisment was
    ...
    /**
     * Returns the secondary physical channel on which this advertisment was
