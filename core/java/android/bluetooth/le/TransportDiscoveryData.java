...
public final class TransportDiscoveryData implements Parcelable {
     ...
     *
     * Uses the transport discovery datas bytes and parses them into an usable class.
     *
     * @param transportDiscoveryData the raw discovery datas
     */
     ...
     *
     * @return byte array representation of this Transport Discovery Data
     */
    @Nullable
