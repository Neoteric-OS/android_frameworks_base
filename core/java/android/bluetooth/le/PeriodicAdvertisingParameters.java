 ...
 * advertising
 * preferences for eachBluetooth LE advertising set. Use {@link
 * AdvertisingSetParameters.Builder}
 * to create an instance of this class.
 */
public final class PeriodicAdvertisingParameters implements Parcelable {

  private static final int INTERVAL_MAX = 818;
  ...
  private PeriodicAdvertisingParameters(boolean enable, boolean includeTxPower,
                                        int interval) {
    this.enable = enable;
  ...
  /**
   * Returns the periodic advertising interval, in 0.1s units.
   */
  ...
  public static final class Builder {
    ...
    /**
     * Set advertising interval for periodic advertising, in units of 0.1s.
     * Valid values are from 1 (0.1s) to 818 (81.8s)
     * @throws IllegalArgumentException If the interval is invalid.
     */
    public Builder setInterval(int interval) {
      if (interval < INTERVAL_MIN || interval > INTERVAL_MAX) {
        throw new IllegalArgumentException("Invalid interval (must be " +
    ...
    public PeriodicAdvertisingParameters build() {
      return new PeriodicAdvertisingParameters(enable, includeTxPower,
                                               interval);
    }
  }
}
