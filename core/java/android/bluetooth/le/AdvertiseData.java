...
public final class AdvertiseData implements Parcelable {
    ...
    @Nullable
    private final List<TransportDiscoveryData> mTransportDiscoveryDatas;
    ...
    private AdvertiseData(List<ParcelUuid> serviceUuids,
            ...
            List<TransportDiscoveryData> transportDiscoveryDatas,
        ...
        mTransportDiscoveryDatas = transportDiscoveryDatas;
     ...
     */
    @NonNull
    public List<TransportDiscoveryData> getTransportDiscoveryDatas() {
        if (mTransportDiscoveryDatas == null) {
            return Collections.emptyList();
        }
        return mTransportDiscoveryDatas;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mServiceUuids, mServiceSolicitationUuids, mTransportDiscoveryDatas,
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Objects.equals(mServiceUuids, other.mServiceUuids)
                ...
                && Objects.equals(mTransportDiscoveryDatas, other.mTransportDiscoveryDatas)
    ...
    public String toString() {
        return "AdvertiseData [mServiceUuids=" + mServiceUuids + ", mServiceSolicitationUuids="
                + mServiceSolicitationUuids + ", mTransportDiscoveryDatas="
                + mTransportDiscoveryDatas + ", mManufacturerSpecificData="
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeTypedList(mTransportDiscoveryDatas);
    ...
    public static final @android.annotation.NonNull Parcelable.Creator<AdvertiseData> CREATOR =
            new Creator<AdvertiseData>() {
                ...
                public AdvertiseData createFromParcel(Parcel in) {
                    ...
                    for (TransportDiscoveryData tdd : transportDiscoveryDatas) {
    ...
    public static final class Builder {
        ...
        @Nullable
        private List<TransportDiscoveryData> mTransportDiscoveryDatas =
        ...
        public Builder addTransportDiscoveryData(
            ...
            mTransportDiscoveryDatas.add(transportDiscoveryData);
            return this;
        }
        ...
        public AdvertiseData build() {
            return new AdvertiseData(mServiceUuids, mServiceSolicitationUuids,
                    mTransportDiscoveryDatas, mManufacturerSpecificData, mServiceData,
