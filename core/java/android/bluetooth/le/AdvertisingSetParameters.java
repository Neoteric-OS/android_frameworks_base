...
public final class AdvertisingSetParameters implements Parcelable {
    ...
    private AdvertisingSetParameters(Parcel in) {
        mConnectable = in.readInt() != 0 ? true : false;
        mScannable = in.readInt() != 0 ? true : false;
        mIsLegacy = in.readInt() != 0 ? true : false;
        mIsAnonymous = in.readInt() != 0 ? true : false;
        mIncludeTxPower = in.readInt() != 0 ? true : false;
