...
public abstract class AdvertisingSetCallback {
     ...
     * contains the set that was started and is advertising. If error occured, advertisingSet is
     ...
     * result of the operation. If status is ADVERTISE_SUCCESS, then advertising
     * set is advertising.
     *
     * @param advertisingSet The advertising set.
     * @param status Status of the operation.
    ...
    /**
     * Callback triggered in response to {@link AdvertisingSet#setAdvertisingData}
     * indicating
     ...
     * AdvertisingSet#setAdvertisingParameters}
    ...
    /**
     * Callback triggered in response to {@link
     * AdvertisingSet#setPeriodicAdvertisingData}
     * indicating result of the operation.
     *
     * @param advertisingSet The advertising set.
     * @param status Status of the operation.
    ...
    /**
     * Callback triggered in response to {@link
     * AdvertisingSet#periodicAdvertisingEnable}
     * indicating result of the operation.
     *
     * @param advertisingSet The advertising set.
     * @param status Status of the operation.
     */
    public void onPeriodicAdvertisingEnable(AdvertisingSet advertisingSet,
                                            int status) {}
}