...
public final class BluetoothLeAdvertiser {
    ...
    private final Map<AdvertisingSetCallback, IAdvertisingSetCallback> advertisingSetCallbackWrappers = new HashMap<>();
    ...
    */
    public void
    startAdvertisingSet(AdvertisingSetParameters parameters,
                      AdvertiseData advertiseData, AdvertiseData scanResponse,
                      PeriodicAdvertisingParameters periodicParameters,
                      AdvertiseData periodicData,
                      AdvertisingSetCallback callback) {
        startAdvertisingSet(parameters, advertiseData, scanResponse, periodicParameters, periodicData,
    ...
    */
    ...
    startAdvertisingSet(AdvertisingSetParameters parameters,
        ...
        try {
            gatt.startAdvertisingSet(parameters, advertiseData, scanResponse, periodicParameters, periodicData, wrapped);
        } catch (RemoteException e) {
    ...
    IAdvertisingSetCallback wrap(AdvertisingSetCallback callback, Handler handler) {
        return new IAdvertisingSetCallback.Stub() {
            ...
            public void onPeriodicAdvertisingEnable(int advertiserId, int status) {
    ...
    public void stopAdvertisingSet(AdvertisingSetCallback callback) {
        ...
        if (wrapped == null) {
            throw new IllegalArgumentException("callback does not represent valid registered callback."); 
        }
