...
public final class AdvertisingSet {
     ...
     *
     * @param enable                       whether the advertising should be enabled (true), or
     *                                     disabled (false)
     ...
     *                      advertisement is connectable, three bytes will be added for flags. If
     *                      the
     ...
     *                     exceed {@link BluetoothAdapter#getLeMaximumAdvertisingDataLength}. If
     *                     the
     *                     update takes place when the advertising set is enabled, the data can be
     *                     maximum 251 bytes long.
     */
     ...
     *                     {@link BluetoothAdapter#getLeMaximumAdvertisingDataLength}. If the
     *                     update takes place when the periodic advertising is enabled for this
     *                     set,
