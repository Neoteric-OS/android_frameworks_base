...
public final class ScanFilter implements Parcelable {
    ...
    public static final class Builder {
         ...
         * @throws IllegalArgumentException If the {@code deviceAddress} is invalid or is a
         * RANDOM_RESOLVABLE address.
         */
         ...
         * @param deviceAddress The device Bluetooth address for the filter. It needs to be in the
         * format of "01:02:03:AB:CD:EF". The device address can be validated using {@link
         * BluetoothAdapter#checkBluetoothAddress}.  Must not be a RANDOM RESOLVABLE address.
         ...
         * @throws IllegalArgumentException If the {@code addressType} is invalid length or is
         * RANDOM_RESOLVABLE.
         ...
         * @param deviceAddress The device Bluetooth address for the filter. It needs to be in the
         * format of "01:02:03:AB:CD:EF". The device address can be validated using {@link
         * BluetoothAdapter#checkBluetoothAddress}.  This Address MUST BE A RANDOM RESOLVABLE 
         * ADDRESS!
         * @param addressType indication of the type of address
         * e.g. {@link BluetoothDevice#ADDRESS_TYPE_PUBLIC}
         * or {@link BluetoothDevice#ADDRESS_TYPE_RANDOM}
        ...
        private Builder setDeviceAddressInternal(@NonNull String deviceAddress,
            ...
            // IRK can only be used for a PUBLIC or RANDOM (STATIC) Adress.
        ...
        public Builder setServiceData(ParcelUuid serviceDataUuid,
            ...
            if (mServiceDataMask != null) {
                ...
                // Since the mServiceDataMask is a bit mask for mServiceData, the lengths of the
                // two byte array need to be the same.
