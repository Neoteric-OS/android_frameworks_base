...
public final class ScanFilter implements Parcelable {
    ...
    public static final class Builder {
         ...
         *                                  {@code serviceDataMask} is {@code null} while {@code
         *                                  serviceData} is not or
         *                                  {@code serviceDataMask} and {@code serviceData} has
         *                                  different length.
         */
         ...
         *                                  {@code manufacturerData} is null while {@code
         *                                  manufacturerDataMask} is not,
         *                                  or {@code manufacturerData} and {@code
         *                                  manufacturerDataMask} have different
         *                                  length.
         */
        public Builder setManufacturerData(int manufacturerId, byte[] manufacturerData,
