...
public final class BluetoothAdapter {
    ...
    /**
     * Get the active device for the BluetoothProfile specified
     *
     * @param profile is the profile from which we want the active device.
     *                 Possible values are:
     *                 {@link BluetoothProfile#HEADSET},
     *                 {@link BluetoothProfile#A2DP},
     *                 {@link BluetoothProfile#HEARING_AID}
     * @return A list of active bluetooth device
     * @throws IllegalArgumentException If profile is not one of {@link ActiveDeviceProfileUse}
     * @hide
     */
    @SystemApi
    @RequiresPermission(Manifest.permission.BLUETOOTH_PRIVILEGED)
    public @NonNull List<BluetoothDevice> getActiveDevices(@ActiveDeviceProfileUse int profile) {
        ...
        try {
            ...
            if (mService != null) {
                ...
                return mService.getActiveDevices(profile);
            }
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
        } finally {
