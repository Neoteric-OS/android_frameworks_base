...
public class BluetoothMcsService {
    ...
    public final static class ServiceFeature {
        ...
        // This is set according to the Media Control Service Specification, Rev. 09r10, Section 3, Table 3.
    ...
    public final static class ObjectIds {
        ...
        public static final int CURRENT_TRACK_SEGMENT_OBJ_ID = (int) ServiceFeature.CURRENT_TRACK_SEGMENT_OBJ_ID;
     ...
     *
     * <p> The following values is set according to the Media Control Service, Revision: 09r06
     * specification
     * @hide
     */
    public static final long TRACK_POSITION_UNAVAILABLE = 0x00000009FFFFFFF6L;  // 0xFFFFFFFF * 10

    /**
     * Track duration unavailable definition
     *
     * <p> The following value is set according to the Media Control Service, Revision: 09r06
     * specification
     * @hide
     */
    public static final long TRACK_DURATION_UNAVAILABLE = 0x00000009FFFFFFF6L;  // 0xFFFFFFFF * 10
    ...
    /**
     * Playing possible orders definition
     * @hide
     */
    ...
    /**
     * Supported playing possible orders definition
     * @hide
     */
