...
public final class BleBroadcastSourceInfo implements Parcelable {
   ...
   /**
     ...
     *  @param advSid advertising Sid of the Broadcast source device for which receiver synchronized with.
    ...
    public BleBroadcastSourceInfo (BluetoothDevice audioSource,
       ...
       if (selectedBISIndicesList != null) {
           for (Map.Entry<Integer, List<BleBroadcastSourceChannel>> entry : selectedBISIndicesList.entrySet()) {
     ...
     * @hide
     */
    /*package*/ void setBroadcastChannelsSyncStatus(List<BleBroadcastSourceChannel> selectedBISIndices) {
        if (selectedBISIndices == null) {
            //set No preference
            BASS_Debug(TAG, "selectedBISIndicesList is null");
            return;
    ...
    public List<BleBroadcastSourceChannel> getBroadcastChannelsSyncStatus () {
        ...
        BASS_Debug(TAG, "returning Bisindicies:" + bcastIndices);
        return bcastIndices;
    }
