 ...
 * Device Profile.
 *
 *<p>BluetoothInputHost is a proxy object for controlling the Bluetooth
 * Service via IPC. Use {@link BluetoothAdapter#getProfileProxy} to get
 * the BluetoothInputHost proxy object.
 *
 *<p>Each method is protected with its appropriate permission.
 *@hide
 */
public final class BluetoothInputHost implements BluetoothProfile {
    private static final String TAG = "BluetoothInputHost";
    ...
    public static final String ACTION_VIRTUAL_UNPLUG_STATUS =
        "android.bluetooth.inputhost.profile.action.VIRTUAL_UNPLUG_STATUS";
     ...
     * @hide
     */
    public static final String EXTRA_STATUS = "android.bluetooth.BluetoothInputHost.extra.STATUS";

    /**
     * @hide
     */
    public static final String EXTRA_DATA = "android.bluetooth.BluetoothInputHost.extra.DATA";

    /**
     * @hide
     */
    public static final String EXTRA_VIRTUAL_UNPLUG_STATUS = "android.bluetooth.BluetoothInputHost.extra.VIRTUAL_UNPLUG_STATUS";
    ...
    /**
     * Create a BluetoothInputHost proxy object for interacting with the local
     * Bluetooth Service which handles the InputHost profile
     *
     */
    /*package*/ BluetoothInputHost(Context context, ServiceListener l) {
        mContext = context;
        mServiceListener = l;
    ...
    private final ServiceConnection mConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if (mServiceListener != null) {
                mServiceListener.onServiceConnected(BluetoothProfile.INPUT_HOST, BluetoothInputHost.this);
            }
        }
    ...
    public boolean sendData(BluetoothDevice device, byte[] data) {
        if (mService != null && isEnabled() && isValidDevice(device)) {
            try {
                return mService.sendData(device, data);
            } catch (RemoteException e) {
                Log.e(TAG, "Stack:" + Log.getStackTraceString(new Throwable()));
                return false;
            }
