...
public final class BluetoothHidDeviceAppQosSettings implements Parcelable {
     ...
     * Settings is optional. Recommended to use BluetoothHidDeviceAppQosSettings.Builder. Please
     * refer to Bluetooth HID Specfication v1.1.1 Section 5.2 and Appendix D for parameters.
     *
     ...
     * @param latency L2CAP mLatency, default = MAX
