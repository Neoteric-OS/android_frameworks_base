...
public final class ViewRootImpl implements ViewParent,
    ...
    private void performTraversals() {
        ...
        if ((host.mPrivateFlags & View.PFLAG_REQUEST_TRANSPARENT_REGIONS) != 0 && (didLayout
                || mMatrixTransformChanged)) {
    ...
    /**
     * Called when a view's matrix transform (e.g. rotation, scale, translation) has changed.
     * Sets a flag so that the transparent region is recomputed on the next traversal even when
     * layout is not requested (e.g. during animations). See
     * {@link View#notifyMatrixTransformChanged}.
     */
    public void matrixTransformChanged() {
