...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_CRITICAL_COMMUNICATION_CONTROL = 286;
    /** Key code constant: SOS button. */
    public static final int KEYCODE_CRITICAL_COMMUNICATION_SOS = 287;

    private static final int LAST_KEYCODE = KEYCODE_CRITICAL_COMMUNICATION_SOS;
