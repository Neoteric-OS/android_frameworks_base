...
public final class Display {
     ...
     *         size of the current app window is returned. In multi-window mode, the returned value
     *         can be smaller than the size of the device screen.
     ...
     *         returned value can vary depending on API level:
     *         <ul>
