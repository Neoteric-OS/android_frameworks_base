...
import static com.android.time.client.base.testing.Bytes.bytes;
import static com.android.time.client.sntp.impl.NtpDateTimeUtils.MAX_32BIT_SECONDS_VALUE;
import static com.android.time.client.sntp.impl.NtpMessage.LI_VN_MODE_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.ORIGINATE_TIME_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.POLL_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.PRECISION_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.RECEIVE_TIME_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.REFERENCE_IDENTIFIER_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.REFERENCE_TIME_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.ROOT_DELAY_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.ROOT_DISPERSION_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.STRATUM_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.TRANSMIT_TIME_OFFSET;
import static com.android.time.client.sntp.impl.NtpMessage.read32Unsigned;
import static com.android.time.client.sntp.impl.NtpMessage.readTimestamp64;
import static com.android.time.client.sntp.impl.NtpMessage.write32SignedFixedPointDuration;
import static com.android.time.client.sntp.impl.NtpMessage.write32Unsigned;
import static com.android.time.client.sntp.impl.NtpMessage.write32UnsignedFixedPointDuration;
