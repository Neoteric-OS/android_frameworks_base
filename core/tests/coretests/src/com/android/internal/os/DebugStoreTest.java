...
public class DebugStoreTest {
    ...
    public void testRecordServiceCreate() {
        ...
        assertThat(paramsFor("SvcCreate"))
                .containsExactly(
                        "name", "androidService",
                        "pkg", "com.android")
                .inOrder();
    ...
    public void testRecordGoAsync() {
        DebugStore.recordGoAsync("androidReceiver", 3840 /* 0xf00 */);

        assertThat(paramsFor("GoAsync"))
                .containsExactly(
                        "tname",
    ...
    public void testRecordLongLooperMessage() {
        ...
        assertThat(paramsFor("LooperMsg"))
                .containsExactly(
                        "code", "100",
                        "trgt", "androidHandler",
                        "elapsed", "500")
    ...
    public void testRecordBroadcastReceive() {
        ...
        long eventId = DebugStore.recordBroadcastReceive(intent);
        assertThat(paramsFor("BcRcv"))
                .containsExactly(
    ...
    public void testRecordHandleBindApplication() {
        ...
        assertThat(paramsFor("BindApp")).isEmpty();
    ...
    public void testRecordScheduleReceiver() {
        ...
        assertThat(paramsFor("SchRcvReg"))
                .containsExactly(
                        "tname",
                        Thread.currentThread().getName(),
                        "tid",
    ...
    @Test
    public void testRecordBroadcastReceiveComp_withNullIntent() {
        when(mDebugStoreNativeMock.beginEvent(anyString(), anyList())).thenReturn(8L);

        long eventId = DebugStore.recordBroadcastReceiveComp(null);
        assertThat(paramsFor("BcRcvComp"))
                .containsExactly(
                        "tname", Thread.currentThread().getName(),
                        "tid", String.valueOf(Thread.currentThread().getId()),
                        "act", "null",
    ...
    @Test
    public void testRecordGoAsync_withNullReceiverClassName() {
        DebugStore.recordGoAsync(null, 3840 /* 0xf00 */);
    ...
    public void testRecordFinish_withNullReceiverClassName() {
        DebugStore.recordFinish(null, 3840 /* 0xf00 */);
    ...
    private List<String> paramsFor(String eventName) {
