...
public class SafeZipPathCallbackTest {
    ...
    @Test
    @EnableCompatChanges({SafeZipPathCallback.VALIDATE_ZIP_PATH_FOR_PATH_TRAVERSAL})
    public void testZipPathTraversalBlockedInZipFileGatingPositive() throws Exception {
    ...
    @Test
    @EnableCompatChanges({SafeZipPathCallback.VALIDATE_ZIP_PATH_FOR_PATH_TRAVERSAL})
    public void testZipPathTraversalBlockedInZipInputStreamGatingPositive() throws Exception {
        final String[] dangerousEntryNames = {
                "../foo.bar",
                "foo/../bar.baz",
                "foo/../../bar.baz",
    ...
    @Test
    @EnableCompatChanges({SafeZipPathCallback.VALIDATE_ZIP_PATH_FOR_PATH_TRAVERSAL})
    public void testNormalZipPathAllowedInZipFileGatingPositive() throws Exception {
    ...
    @Test
    @DisableCompatChanges({SafeZipPathCallback.VALIDATE_ZIP_PATH_FOR_PATH_TRAVERSAL})
    public void testNormalZipPathAllowedInZipInputStreamGatingPositive() throws Exception {
        final String[] normalEntryNames = {
                "foo",
                "foo.bar",
        };
    ...
    @Test
    @DisableCompatChanges({SafeZipPathCallback.VALIDATE_ZIP_PATH_FOR_PATH_TRAVERSAL})
    public void testAnyZipPathAllowedInZipFileGatingNegative() throws Exception {
    ...
    @Test
    @DisableCompatChanges({SafeZipPathCallback.VALIDATE_ZIP_PATH_FOR_PATH_TRAVERSAL})
    public void testAnyZipPathAllowedInZipInputStreamGatingNegative() throws Exception {
        final String[] entryNames = {
                "../foo.bar",
                "foo/../bar.baz",
                "foo/../../bar.baz",
