...
public class TestReapply extends TestCase {
    ...
    static class C6 implements InjectionTarget, Singleton, A, D {
    ...
    static class C7 implements InjectionTarget, Singleton, B {
    ...
    static class C8 implements InjectionTarget, Singleton, C, D {
    ...
    static class C9 implements InjectionTarget, Singleton, C {
    ...
    static class C10 implements InjectionTarget, Singleton, D {
    ...
    static class C11 implements InjectionTarget, Singleton, C {
    ...
    static class C13 implements InjectionTarget, Singleton, E {
    }

    static class C14 implements Singleton, F {
    }

    static class C15 implements InjectionTarget, Singleton, A, D {
    ...
    static class C16 implements InjectionTarget, Singleton, B {
    ...
    static class C19 implements InjectionTarget, Singleton, C {
    }
