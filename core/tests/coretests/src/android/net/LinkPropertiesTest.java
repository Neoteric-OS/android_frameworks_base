...
public class LinkPropertiesTest extends TestCase {
    ...
    public void testLinkPropertiesEnsureDirectlyConnectedRoutes() {
        ...
        RouteInfo defaultRoute2 = new RouteInfo((IpPrefix) null,
                NetworkUtils.numericToInetAddress("2001:db8::1"), rmnet1.getInterfaceName());
        RouteInfo directRoute2 = new RouteInfo(new IpPrefix("2001:db8::0/64"), null,
                rmnet1.getInterfaceName());
        ...
        assertEqualRoutes(Arrays.asList(defaultRoute2, directRoute2), rmnet2.getAllRoutes());
    }
    ...
    private <T> void testCompareResult(List<T> oldItems, List<T> newItems, List<T> expectAdded,
        ...
        assertEquals(new ArraySet<T>(expectAdded), new ArraySet<T>(result.added));
        assertEquals(new ArraySet<T>(expectRemoved), (new ArraySet<T>(result.removed)));
    }
}
