...
public class PhoneTimeSuggestionTest {
    ...
    public void testEquals() {
        PhoneTimeSuggestion.Builder builder1 = new PhoneTimeSuggestion.Builder(SLOT_ID);
        {
            PhoneTimeSuggestion one = builder1.build();
            assertEquals(one, one);
        }

        PhoneTimeSuggestion.Builder builder2 = new PhoneTimeSuggestion.Builder(SLOT_ID);
        {
            PhoneTimeSuggestion one = builder1.build();
        ...
        PhoneTimeSuggestion.Builder builder3 = new PhoneTimeSuggestion.Builder(SLOT_ID + 1);
    ...
    public void testParcelable() {
        PhoneTimeSuggestion.Builder builder = new PhoneTimeSuggestion.Builder(SLOT_ID);
