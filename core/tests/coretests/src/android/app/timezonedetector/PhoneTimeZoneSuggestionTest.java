...
public class PhoneTimeZoneSuggestionTest {
    private static final int SLOT_ID = 99999;

    @Test
    public void testEquals() {
        PhoneTimeZoneSuggestion.Builder builder1 = new PhoneTimeZoneSuggestion.Builder(SLOT_ID);
        {
            PhoneTimeZoneSuggestion one = builder1.build();
            assertEquals(one, one);
        }

        PhoneTimeZoneSuggestion.Builder builder2 = new PhoneTimeZoneSuggestion.Builder(SLOT_ID);
        {
            PhoneTimeZoneSuggestion one = builder1.build();
        ...
        PhoneTimeZoneSuggestion.Builder builder3 =
                new PhoneTimeZoneSuggestion.Builder(SLOT_ID + 1);
        {
            PhoneTimeZoneSuggestion one = builder1.build();
    ...
    public void testBuilderValidates_emptyZone_badMatchType() {
        PhoneTimeZoneSuggestion.Builder builder = new PhoneTimeZoneSuggestion.Builder(SLOT_ID);
