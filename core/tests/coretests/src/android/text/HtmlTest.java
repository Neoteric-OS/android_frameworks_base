...
public class HtmlTest extends TestCase {
    ...
    public void testParagraphs() throws Exception {
        ...
        assertEquals(Html.toHtml(s), "<p dir=\"ltr\">Hello world</p>\n");

        s = new SpannableString("Hello world\nor something");
        assertEquals(Html.toHtml(s), "<p dir=\"ltr\">Hello world<br>\nor something</p>\n");
    ...
    public void testEntities() throws Exception {
        ...
        assertEquals(Html.toHtml(s), "<p dir=\"ltr\">Hello &#981; world</p>\n");
