...
import static android.os.AndroidOnTapManager.KEY_SYSTEM_SIZE;
import static android.os.AndroidOnTapManager.KEY_SYSTEM_URL;
import static android.os.AndroidOnTapManager.KEY_USERDATA_SIZE;
...
public class VerificationActivity extends Activity {
    ...
    private void startInstallationService() {
        ...
        // start service
        Intent intent = new Intent(this, AndroidOnTapInstallationService.class);
        intent.setAction(AndroidOnTapManager.ACTION_START_INSTALL);
