...
public class NsdService extends INsdManager.Stub {
    ...
    private class NsdStateMachine extends StateMachine {
        ...
        private void maybeStartDaemon() {
            ...
            mMdnsServiceManager.startDaemon();
        ...
        private void maybeStopDaemon() {
            ...
            mMdnsServiceManager.stopDaemon();
        ...
        class EnabledState extends State {
            ...
            private boolean handleMdnsServiceEvent(int code, int id, Object obj) {
                if (DBG) {
                    Log.d(TAG, "handleMdnsServiceEvent: code:" + code
                            + ", id=" + id);
                }
                NsdServiceInfo servInfo;
                ClientInfo clientInfo = mIdToClientInfoMap.get(id);
                if (clientInfo == null) {
                    Log.e(TAG, String.format("id %d for %s has no client mapping", id, code));
                    return false;
                }
                ...
                switch (code) {
                    ...
                    case IMdnsEventListener.SERVICE_GET_ADDR_SUCCESS: {
                        ...
                        final Network network = netId == 0L ? null : new Network(netId);
    ...
    private boolean registerService(int regId, NsdServiceInfo service) {
        ...
        return mMdnsServiceManager.registerService(
                regId, name, type, port, textRecord, IFACE_IDX_ANY);
    }

    private boolean unregisterService(int regId) {
        return mMdnsServiceManager.stopOperation(regId);
    }
    ...
    private boolean discoverServices(int discoveryId, NsdServiceInfo serviceInfo) {
        ...
        return mMdnsServiceManager.discover(discoveryId, type, discoverInterface);
    }

    private boolean stopServiceDiscovery(int discoveryId) {
        return mMdnsServiceManager.stopOperation(discoveryId);
    }
    ...
    private boolean resolveService(int resolveId, NsdServiceInfo service) {
        ...
        return mMdnsServiceManager.resolve(resolveId, name, type, "local.", resolveInterface);
    }
    ...
    private boolean stopResolveService(int resolveId) {
        return mMdnsServiceManager.stopOperation(resolveId);
    }

    private boolean getAddrInfo(int resolveId, String hostname, int interfaceIdx) {
        return mMdnsServiceManager.getServiceAddress(resolveId, hostname, interfaceIdx);
    }
