...
public class NsdService extends INsdManager.Stub {
            ...
            private boolean handleMdnsServiceEvent(int responseCode, int id, Object obj) {
                ...
                switch (responseCode) {
                    case MdnsResponseCode.SERVICE_FOUND: {
                        ...
                        final String name = event.serviceName;
                        final String type = event.registrationType;
                    ...
                    case MdnsResponseCode.SERVICE_RESOLVED: {
                        ...
                        int index = 0;
                        final String fullName = event.serviceFullName;
                        ...
                        clientInfo.mResolvedService.setTxtRecords(event.txtRecord);
    ...
    private boolean registerService(int regId, NsdServiceInfo service) {
        ...
        return mMdnsServiceManager.registerService(regId, name, type, port, textRecord, null);
    }
    ...
    private boolean discoverServices(int discoveryId, String serviceType) {
        return mMdnsServiceManager.discover(discoveryId, serviceType, null /* iface */);
    }
    ...
    private boolean resolveService(int resolveId, NsdServiceInfo service) {
        String name = service.getServiceName();
        String type = service.getServiceType();
        return mMdnsServiceManager.resolve(resolveId, name, type, "local.",
                null /* iface */);
    }
    ...
    private boolean getAddrInfo(int resolveId, String hostname) {
        return mMdnsServiceManager.getServiceAddressInfo(resolveId, hostname, 0 /* ifaceIdx */);
    }
