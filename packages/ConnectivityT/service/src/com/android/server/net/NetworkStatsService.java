...
public class NetworkStatsService extends INetworkStatsService.Stub {
    ...
    public void systemReady() {
        ...
        final TetheringManager tetheringManager =
                (TetheringManager) mContext.getSystemService(Context.TETHERING_SERVICE);
     ...
     */
    final private TetheringManager.TetheringEventCallback mTetherListener =
    ...
    private class NetworkStatsManagerInternalImpl extends NetworkStatsManagerInternal {
        ...
        public long getNetworkTotalBytes(NetworkTemplate template, long start, long end) {
            Trace.beginSection("getNetworkTotalBytes");
            try {
        ...
        public NetworkStats getNetworkUidBytes(NetworkTemplate template, long start, long end) {
            Trace.beginSection("getNetworkUidBytes");
            try {
