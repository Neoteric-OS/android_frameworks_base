...
public class NetworkStatsService extends INetworkStatsService.Stub {
    ...
    public void systemReady() {
        ...
        mContentResolver.registerContentObserver(ConnectivitySettingsManager
                .getUriForNetstatsCombineSubtypeEnabled(),
        ...
        mHandler.post(() -> mContentObserver.onChange(false, ConnectivitySettingsManager
                .getUriForNetstatsCombineSubtypeEnabled()));
    ...
    private static class DefaultNetworkStatsSettings implements NetworkStatsSettings {
        ...
        public long getPollInterval() {
            return ConnectivitySettingsManager.getPollInterval(mContext);
        }
        @Override
        ...
        public Config getDevConfig() {
            return new Config(ConnectivitySettingsManager.getDevBucketDuration(mContext),
                    ConnectivitySettingsManager.getDevRotateAge(mContext),
                    ConnectivitySettingsManager.getDevDeleteAge(mContext));
        }
        @Override
        ...
        public Config getUidConfig() {
            return new Config(ConnectivitySettingsManager.getUidBucketDuration(mContext),
                    ConnectivitySettingsManager.getUidRotateAge(mContext),
                    ConnectivitySettingsManager.getUidDeleteAge(mContext));
        }
        @Override
        public Config getUidTagConfig() {
            return new Config(ConnectivitySettingsManager.getUidTagBucketDuration(mContext),
                    ConnectivitySettingsManager.getUidTagRotateAge(mContext),
                    ConnectivitySettingsManager.getUidTagDeleteAge(mContext));
        }
        @Override
