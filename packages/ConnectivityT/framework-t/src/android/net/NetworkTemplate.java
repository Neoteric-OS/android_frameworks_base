...
public class NetworkTemplate implements Parcelable {
    ...
    public static final class Builder {
        ...
        private static boolean isValidMatchRule(boolean includesWildcard) {
            // TODO: Verify the entry can be found in a sparse name string array. Wildcard match
            //  rules will not pass the check if includesWildcard is set to false.
            return true;
        }
        ...
        private void enforceRequestableParameters() {
            ...
            // FIXME: Any way to check the inputs are in the @IntDef?
            isValidMatchRule(true /*includeWildcard*/);
        }

        /**
         * Override the match rule to a wildcard match rule for backward compatibility.
         */
        private void maybeMarkWildcard() {
