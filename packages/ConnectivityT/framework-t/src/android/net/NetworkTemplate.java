...
public final class NetworkTemplate implements Parcelable {
    ...
    public Set<String> getSubscriberIds() {
        return new LinkedHashSet<>(Arrays.asList(mMatchSubscriberIds));
    }
    ...
    public static final class Builder {
        private final int mMatchRule;
        // Use LinkedHashSet to provide a deterministic order when fetching the first one.
        @NonNull
        private final LinkedHashSet<String> mMatchSubscriberIds = new LinkedHashSet<>();
        @Nullable
