...
public class NetworkTemplate implements Parcelable {
    ...
    public static final class Builder {
         ...
         */
        @NonNull
        public Builder setOemManaged(@SubscriberIdMatchRule int oemManaged) {
            mOemManaged = oemManaged;
            return this;
        }
         ...
         */
        private static void assertRequestableMatchRule(@TemplateMatchRule final int matchRule) {
            if (!isKnownMatchRule(matchRule) || matchRule == MATCH_MOBILE_WILDCARD
                    || matchRule == MATCH_WIFI_WILDCARD || matchRule == MATCH_PROXY) {
        ...
        private void enforceRequestableParameters() {
            ...
            assertRequestableMatchRule(mMatchRule);
