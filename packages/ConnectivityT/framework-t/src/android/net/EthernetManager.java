...
public class EthernetManager {
     ...
     *
     * When the link is successfully turned down, the listener will be called with the resulting
     * network. If any error or unexpected condition happens while the system tries to turn the
     * interface down, the listener will be called with an appropriate exception.
