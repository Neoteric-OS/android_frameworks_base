...
public class MdnsServiceManager {
    ...
    public boolean registerService(int id, @NonNull String name, @NonNull String type, int port,
            @NonNull byte[] txtRecord, @Nullable String iface) {
        try {
            mMdns.registerService(id, name, type, port, txtRecord, iface);
        } catch (RemoteException | ServiceSpecificException e) {
     ...
     */
    public boolean discover(int id, @NonNull String type, @Nullable String iface) {
        try {
            mMdns.discover(id, type, iface);
        } catch (RemoteException | ServiceSpecificException e) {
    ...
    public boolean resolve(int id, @NonNull String name, @NonNull String type,
            @NonNull String domain, @NonNull String iface) {
        try {
            mMdns.resolve(id, name, type, domain, iface);
        } catch (RemoteException | ServiceSpecificException e) {
     ...
     */
    public boolean getServiceAddressInfo(int id, @NonNull String hostName, int ifaceIdx) {
        try {
            mMdns.getServiceAddressInfo(id, hostName, ifaceIdx);
        } catch (RemoteException | ServiceSpecificException e) {
