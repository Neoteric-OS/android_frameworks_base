...
/**
 * See {@link EthernetManager#updateConfiguration} for more information.
 *
 * @hide
 */
@SystemApi
public final class EthernetNetworkUpdateRequest implements Parcelable {
    ...
    public IpConfiguration getIpConfiguration() {
        // returning mIpConfig without an extra copy should be safe, as the Builder has already
        // created a copy.
        return mIpConfig;
    }
    ...
    public NetworkCapabilities getNetworkCapabilities() {
        // returning mNetworkCapabilities without an extra copy should be safe, as the Builder has
        // already created a copy.
