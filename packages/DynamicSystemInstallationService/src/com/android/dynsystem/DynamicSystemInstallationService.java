        ...
        switch (status) {
            ...
            case STATUS_NOT_STARTED:
                if (cause != CAUSE_NOT_SPECIFIED && cause != CAUSE_INSTALL_CANCELLED) {
                    if (detail instanceof InstallationAsyncTask.RevocationListException) {
                        builder.setContentText(
                                getString(R.string.notification_install_failed_revocation_list));
                    } else if (detail instanceof InstallationAsyncTask.KeyRevokedException) {
                        builder.setContentText(
                                getString(R.string.notification_install_failed_key_revoked));
                    } else if (detail instanceof InstallationAsyncTask.PublicKeyException) {
                        builder.setContentText(
                                getString(R.string.notification_install_failed_public_key));
                    } else {
