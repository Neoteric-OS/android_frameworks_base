        ...
        switch (status) {
            ...
            case STATUS_NOT_STARTED:
                if (cause != CAUSE_NOT_SPECIFIED && cause != CAUSE_INSTALL_CANCELLED) {
                    if (detail instanceof InstallationAsyncTask.RevocationListFetchException
                            || detail instanceof InstallationAsyncTask.KeyRevokedException
                            || detail instanceof InstallationAsyncTask.PublicKeyException) {
