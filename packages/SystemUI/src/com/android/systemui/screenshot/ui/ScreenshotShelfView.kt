...
class ScreenshotShelfView(context: Context, attrs: AttributeSet? = null) :
    ...
    fun getTouchRegion(gestureInsets: Insets): Region {
        ...
        val operand: Region.Op =
            if (navBarInteractionMode == NAV_BAR_MODE_GESTURAL) {
