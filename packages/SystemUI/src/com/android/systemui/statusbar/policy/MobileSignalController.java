...
public class MobileSignalController extends SignalController<
    ...
    public void notifyListeners() {
        ...
        int typeIcon = showDataIcon
                ...
                : 0;
        boolean isWide = false; //isWide always sets false because icon moves if sets true.
        mCallbackHandler.setMobileDataIndicators(statusIcon, qsIcon, typeIcon, qsTypeIcon,
                activityIn, activityOut, dataContentDescription, description, isWide,
    ...
    static class MobileIconGroup extends SignalController.IconGroup {
        ...
        public MobileIconGroup(String name, int[][] sbIcons, int[][] qsIcons, int[] contentDesc,
                ...
                int discContentDesc, int dataContentDesc, int dataType, boolean isWide, int qsDataType) {
