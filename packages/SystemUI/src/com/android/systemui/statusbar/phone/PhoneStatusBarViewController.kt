...
class PhoneStatusBarViewController private constructor(
    ...
    fun setBrightnessControlNoLandscape(disableInLandscape: Boolean) {
        mView.brightnessControlNoLandscape = disableInLandscape
    }
    ...
    fun onTouch(event: MotionEvent) {
        if (mView.brightnessControlEnabled &&
                !(mView.brightnessControlNoLandscape && mView.isLandscape())) {
