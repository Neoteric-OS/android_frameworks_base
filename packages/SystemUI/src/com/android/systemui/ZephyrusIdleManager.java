/*
 * Copyright (C) 2021 Project-Zephyrus
 *
...
public class ZephyrusIdleManager {
    static String TAG = "ZephyrusIdleManager";
    ...
    private static void IdleManLog(String msg) {
        if (SystemProperties.getBoolean("zephyrus.debug", false))
            Log.d(TAG, msg);
    }
}
