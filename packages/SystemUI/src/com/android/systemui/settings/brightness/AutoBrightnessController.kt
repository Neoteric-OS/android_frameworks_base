...
import android.os.CustomVibrationAttributes.VIBRATION_ATTRIBUTES_QS_TILE
...
class AutoBrightnessController internal constructor(
    ...
    private val settingsObserver = object : ContentObserver(bgHandler) {
        override fun onChange(selfChange: Boolean, uri: Uri?) {
            ...
            if (key == Settings.System.SCREEN_BRIGHTNESS_MODE) {
                updateIcon()
            } else if (key == Settings.System.QS_SHOW_AUTO_BRIGHTNESS_BUTTON) {
    ...
    fun registerCallbacks() {
        ...
        autoBrightnessIcon.setOnClickListener {
            vibratorHelper.vibrate(EFFECT_CLICK, VIBRATION_ATTRIBUTES_QS_TILE)
            bgHandler.post {
