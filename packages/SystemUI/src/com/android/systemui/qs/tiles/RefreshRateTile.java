...
import com.android.internal.util.nameless.display.DisplayRefreshRateHelper;
...
public class RefreshRateTile extends QSTileImpl<State> {
    ...
    public RefreshRateTile(
        ...
        mSupportedList = DisplayRefreshRateHelper.getSupportedRefreshRateList(mContext);
        mObserver = new SettingsObserver(mainHandler, systemSettings);

        mMinRefreshRate = DisplayRefreshRateHelper.getMinimumRefreshRate(mContext);
        mPeakRefreshRate = DisplayRefreshRateHelper.getPeakRefreshRate(mContext);
    ...
    protected void handleClick(@Nullable View view) {
        ...
        DisplayRefreshRateHelper.setRefreshRate(mContext, mMinRefreshRate, mPeakRefreshRate);
    ...
    private boolean isRefreshRateValid() {
        return DisplayRefreshRateHelper.isRefreshRateValid(mContext, mMinRefreshRate) &&
                DisplayRefreshRateHelper.isRefreshRateValid(mContext, mPeakRefreshRate) &&
