...
internal abstract class SecureLongQSTile<TState : QSTile.State> protected constructor(
    ...
    protected fun checkLongKeyguard(view: View?, keyguardShowing: Boolean): Boolean {
        return if (keyguardShowing) {
            mActivityStarter.postQSRunnableDismissingKeyguard {
                handleLongClick(view, false)
            }
            true
        } else {
            false
