...
public class QSPanel extends LinearLayout {
    ...
    protected void setBrightnessViewMargin() {
        ...
        if (mSliderAtTop) {
            lp.topMargin = mContext.getResources().getDimensionPixelSize(R.dimen.qs_brightness_margin_top);
            lp.bottomMargin = mContext.getResources().getDimensionPixelSize(R.dimen.qs_brightness_margin_bottom);
        } else {
