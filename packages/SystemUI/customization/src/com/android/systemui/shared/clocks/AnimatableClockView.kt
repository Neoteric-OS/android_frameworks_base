...
class AnimatableClockView @JvmOverloads constructor(
    ...
    private fun getClockFormat(): Int = Settings.Secure.getIntForUser(context.contentResolver, 
    Settings.Secure.CLOCK_USE_CUSTOM_FORMAT, 0,  UserHandle.USER_CURRENT)
    
    private fun isClockSingleLine(): Boolean = Settings.Secure.getIntForUser(context.contentResolver, 
    Settings.Secure.CLOCK_USE_CUSTOM_FORMAT, 0,  UserHandle.USER_CURRENT) == 1
