...
public class CaptivePortalLaunchActivity extends Activity {
    ...
    private static final int NETWORK_REQUEST_TIMEOUT_IN_MS = 5 * 1000;
    ...
    private void showConnectingProgressDialog() {
        ...
        mProgressDialog.setTitle(getString(R.string.progress_dialogue_network_connection));
                ...
                new CaptivePortal(new ICaptivePortal.Stub() {
                    ...
                    public void appResponse(int response) {
                        ...
                        if (response == APP_RETURN_DISMISSED) {
                            ...
                            CarrierActionUtils.onEnableRadio(intent, getApplicationContext());
                            CarrierActionUtils.onEnableAllMeteredApns(intent,
                                    getApplicationContext());
                            CarrierActionUtils.onCancelAllNotifications(getApplicationContext());
                        }
                    }
                }));
