...
public class CarrierActionUtils {
    ...
    public static final int CARRIER_ACTION_SHOW_NO_SERVICE_NOTIFICATION      = 5;
    ...
    public static void applyCarrierAction(int actionIdx, Intent intent, Context context) {
        switch (actionIdx) {
            ...
            case CARRIER_ACTION_SHOW_PORTAL_NOTIFICATION:
                ...
                break;
            case CARRIER_ACTION_SHOW_NO_SERVICE_NOTIFICATION:
                onShowNoServiceNotification(context);
                break;
    ...
    private static void onShowNoServiceNotification(Context context) {
