 ...
 * signal. This helper class loads and parses the carrier configs and return a list of
 * predefined carrier action idx for the given input signal.
 * Examples of the carrier config
 */
public class CustomConfigLoader {
    ...
    public static List<Integer> loadCarrierActionList(Context context, Intent intent) {
        ...
        if (TextUtils.isEmpty(configKey)) {
            Rlog.e(TAG, "load carrier config failure with un-configured key: " + configKey);
            return null;
        }
            ...
            if (!ArrayUtils.isEmpty(configs)) {
                for (String config : configs) {
                    ...
                    if (!actionList.isEmpty()) {
                        ...
                        // there should be only one matched entry, simply return the first one
                        return actionList;
                    }
                }
            }
