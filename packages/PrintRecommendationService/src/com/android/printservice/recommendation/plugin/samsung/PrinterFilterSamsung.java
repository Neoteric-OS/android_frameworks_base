 ...
 */
/*package-private*/ class PrinterFilterSamsung implements MDNSFilteredDiscovery.PrinterFilter {
    private static final String TAG = "PrinterFilterSamsung";

    /*package-private*/ static final Set<String> SAMSUNG_MDNS_SERVICES = new HashSet<String>() {{
