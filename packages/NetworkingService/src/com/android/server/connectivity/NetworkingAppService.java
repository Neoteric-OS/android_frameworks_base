...
public class NetworkingAppService extends Service {
    private static final String TAG = NetworkingAppService.class.getSimpleName();
    ...
    private static class ConnectivityAppConnector extends INetworkingAppConnector.Stub {
