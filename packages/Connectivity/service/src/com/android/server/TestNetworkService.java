...
class TestNetworkService extends ITestNetworkManager.Stub {
    ...
    protected TestNetworkService(@NonNull Context context) {
        ...
        try {
            ...
            mVcnManager.addVcnNetworkPolicyChangeListener(mHandler::post, mPolicyChangeListener);
        } finally {
    ...
    public class TestNetworkAgent extends NetworkAgent implements IBinder.DeathRecipient {
        ...
        private void teardown() {
            ...
            // Has to be done in TestNetworkAgent to ensure all teardown codepaths properly clean up
    ...
    private TestNetworkAgent registerTestNetworkAgent(
        ...
        final TestNetworkAgent agent = new TestNetworkAgent(context, looper,
                vcnNetworkPolicy.getNetworkCapabilities(), lp,
                new NetworkAgentConfig.Builder().build(), callingUid, binder, mNetworkProvider);
        agent.register();
        agent.markConnected();
        return agent;
    }
