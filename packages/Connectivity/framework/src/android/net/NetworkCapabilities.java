...
public final class NetworkCapabilities implements Parcelable {
    ...
    public void set(@NonNull NetworkCapabilities nc) {
        ...
        setUids(UidRange.convertToIntRanges(nc.mUids)); // Will make the defensive copy
    ...
    public @NonNull NetworkCapabilities setUids(Set<Range<Integer>> uids) {
        mUids = UidRange.convertFromIntRanges(uids);
        return this;
    }
     ...
     *
     * @return the list of UIDs this network applies to
     * @hide
     */
    @RequiresPermission(android.Manifest.permission.NETWORK_SETTINGS)
    @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
    public @NonNull Set<Range<Integer>> getUids() {
        if (mUids == null) return new ArraySet<>();

        return UidRange.convertToIntRanges(mUids);
    }
    ...
    public static final class Builder {
         ...
         * Set the list of UIDs this network applies to.
         *
         * @param uids the list of UIDs this network applies to.
         * @return this builder
         */
        @NonNull
        @RequiresPermission(android.Manifest.permission.NETWORK_FACTORY)
