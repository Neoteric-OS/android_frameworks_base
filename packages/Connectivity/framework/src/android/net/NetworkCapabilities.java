...
public final class NetworkCapabilities implements Parcelable {
     ...
     *
     * <p>Instances of NetworkCapabilities will only have this field populated if the receiver holds
     * the NETWORK_FACTORY permission. In all other cases, it will be the empty set.
     *
     * @return
     * @hide
     */
