...
public class LiveImageService extends Service implements InstallAsyncTask.InstallStatusListener {
    ...
    private static final String ACTION_START_INSTALL =
            "android.intent.action.INSTALL_LIVEIMAGE";
    ...
    static class IncomingHandler extends Handler {
        private final WeakReference<LiveImageService> mWeakService;

        IncomingHandler(LiveImageService service) {
            mWeakService = new WeakReference<>(service);
        }

        @Override
        public void handleMessage(Message msg) {
            LiveImageService service = mWeakService.get();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        } else if (ACTION_CANCEL_INSTALL.equals(intent.getAction())) {
            executeCancelCommand();
        } else if (ACTION_REBOOT_TO_LIVEIMAGE.equals(intent.getAction())) {
    ...
    public void onProgressUpdate(long installedSize) {
        ...
        postStatus(STATUS_IN_PROGRESS, -1);
    }
    ...
    private void prepareNotification() {
        ...
        Intent intentCancel = new Intent(this, LiveImageService.class);
        intentCancel.setAction(ACTION_CANCEL_INSTALL);
        mPiCancel = PendingIntent.getService(this, 0, intentCancel, 0);

        Intent intentRebootToLiveImage = new Intent(this, LiveImageService.class);
        ...
        Intent intentRebootToNormal = new Intent(this, LiveImageService.class);
    ...
    private boolean verifyRequest(Intent intent) {
        ...
        if (sVerifiedUrl == null || !sVerifiedUrl.equals(url)) {
            return false;
        }
    ...
    static void setVerifiedUrl(String url) {
        sVerifiedUrl = url;
    }
