...
public class BannerMessagePreferenceTest {
    ...
    private void assumeAndroidR() {
        ...
        OverpoweredReflectionHelper.setStaticField(BannerMessagePreference.class, "IS_AT_LEAST_S", false);
    ...
    private void assumeAndroidS() {
        ...
        OverpoweredReflectionHelper.setStaticField(BannerMessagePreference.class, "IS_AT_LEAST_S", true);
