...
public class HfpClientProfileTest {
    ...
    public void setUp() {
        ...
        doAnswer((invocation) -> {
            ...
            return null;
        }).when(mAdapter).getProfileProxy(any(Context.class), any(), eq(BluetoothProfile.HEADSET_CLIENT));

        mProfile = new HfpClientProfile(context, mAdapter, mDeviceManager, mProfileManager);
