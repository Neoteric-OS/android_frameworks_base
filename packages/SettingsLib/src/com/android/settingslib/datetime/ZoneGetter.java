    ...
    public static List<Map<String, Object>> getZonesList(Context context) {
        ...
        for (int i = 0; i < zoneCount; i++) {
            ...
            if (preferLongName) {
                ...
                // Canonicalize the zone ID for ICU. It will only return strings for zone IDs that
                // match ICUs zone IDs (which are similar but not guaranteed the same as those in
                // timezones.xml. timezones.xml and related files uses the IANA data. ICU IDs are
