...
public class CachedBluetoothDevice implements Comparable<CachedBluetoothDevice> {
    ...
    /**
     * Update the mIsSetMember as the device isn't a set member. If it is already set true,
     * keep the value without update.
     *
     * @param isSetMember true if the device is a set member of a coordinated set.
     */
     ...
     *
     * @return true, if this device supports CSIP.
     */
