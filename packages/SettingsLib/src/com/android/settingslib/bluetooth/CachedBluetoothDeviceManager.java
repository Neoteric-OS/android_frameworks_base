...
public class CachedBluetoothDeviceManager {
    ...
    /**
     * Called when we found a set member of a groupp. The function will check the groupId if
     ...
     * would not be updated. For the other case, return false to go through the normal
     * flow.
     *
     * @param device The device
     * @param bondState The new bond state
     *
     * @return true, if the bond state change for the device is handled inside this function
     * ,and would not like to update the UI. If not, return false.
     */
    public synchronized boolean onBondStateChangedIfProcess(BluetoothDevice device, int bondState) {
        ...
        if (bondState != BluetoothDevice.BOND_NONE) {
            if (findDevice(device) == null) {
                final LocalBluetoothProfileManager profileManager = mBtManager.getProfileManager();
                CachedBluetoothDevice newDevice =  new CachedBluetoothDevice(mContext,
     ...
     * @param device The device
     *
     * @return true, if the device is ongoing pair by CSIP. Otherwise, return false.
     */
