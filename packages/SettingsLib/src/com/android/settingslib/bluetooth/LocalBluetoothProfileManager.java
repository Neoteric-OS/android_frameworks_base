    ...
    synchronized void updateProfiles(ParcelUuid[] uuids, ParcelUuid[] localUuids,
        ...
        if (mHeadsetProfile != null) {
            if ((ArrayUtils.contains(localUuids, BluetoothUuid.HSP_AG)
                    ...
                    || (ArrayUtils.contains(localUuids, BluetoothUuid.HANDS_FREE_AG)
                    && ArrayUtils.contains(uuids, BluetoothUuid.HANDS_FREE))) {
        ...
        if ((mHfpClientProfile != null) &&
                ArrayUtils.contains(uuids, BluetoothUuid.HANDS_FREE_AG)
                && ArrayUtils.contains(localUuids, BluetoothUuid.HANDS_FREE)) {
