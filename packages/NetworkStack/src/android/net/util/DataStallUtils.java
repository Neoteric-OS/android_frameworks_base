...
public class DataStallUtils {
    ...
    // The default size of the {@link com.android.server.connectivity.NetworkMonitor#DnsResult}
    // that be kept for dns signal evaluation. The dns event will It's also the size of the
    // {@link com.android.server.connectivity.nano.DnsEvent} kept in the metrics. Thus, reevaluate
    // it as intending to increase the number. Larger log size may cause statsd log buffer bust and
    // have stats log lost.
