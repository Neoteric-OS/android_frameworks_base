...
public class NetworkMonitor extends StateMachine {
    ...
    /**
     * ConnectivityService notifies NetworkMonitor that user accepts partial connectivity network.
     */
     ...
     * ConnectivityService notifies NetworkMonitor that user accepts partial connectivity network.
     */
    public void notifyUsingPartialConnectivity() {
        sendMessage(EVENT_USER_ACCEPTS_PARTIAL_CONNECTIVITY);
    }
