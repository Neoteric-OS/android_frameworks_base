...
public class NetworkMonitor extends StateMachine {
    ...
    private class ValidatedState extends State {
        ...
        public void enter() {
            ...
            // If the network has partial connectivity, and the user has accepted that
            // and HTTPS probing is disabled, then mark the network as validated and partial
            // so that settings can keep informing the user that the connection is limited.
            int result = NETWORK_VALIDATION_RESULT_VALID;
            if (!mUseHttps && mEvaluationState.isPartialConnectivity()) {
    ...
    private class EvaluatingPrivateDnsState extends State {
        ...
        private boolean sendPrivateDnsProbe() {
            ...
            // EvaluatingPrivateDnsState without resetting probe. Thus, remove PROBE_PRIVDNS result
            // if it fails.
    ...
    protected CaptivePortalProbeResult isCaptivePortal() {
        ...
        if (pacUrl != null) {
            ...
            reportHttpProbeResult(NETWORK_VALIDATION_PROBE_DNS | NETWORK_VALIDATION_PROBE_HTTP,
                    result);
        } else if (mUseHttps) {
    ...
    private CaptivePortalProbeResult sendParallelHttpProbes(
        ...
        if (httpsResult.isPortal() || httpsResult.isSuccessful()) {
            reportHttpProbeResult(NETWORK_VALIDATION_PROBE_DNS | NETWORK_VALIDATION_PROBE_HTTPS,
                    httpsResult);
            return httpsResult;
        }
        ...
        if (fallbackUrl != null) {
            ...
            reportHttpProbeResult(NETWORK_VALIDATION_PROBE_DNS | NETWORK_VALIDATION_PROBE_FALLBACK,
                    fallbackProbeResult);
