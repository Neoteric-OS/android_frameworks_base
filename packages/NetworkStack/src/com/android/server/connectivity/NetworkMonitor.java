...
public class NetworkMonitor extends StateMachine {
    ...
    private int mDataStallMetricsEvaluationTypes = 0;
        ...
        public boolean processMessage(Message message) {
            switch (message.what) {
                ...
                case CMD_FORCE_REEVALUATION:
                    ...
                    if (message.arg1 != NO_UID) {
                        mDataStallMetricsEvaluationTypes |=
        ...
        public boolean processMessage(Message message) {
            switch (message.what) {
                ...
                case EVENT_DNS_NOTIFICATION:
                    mDnsStallDetector.accumulateConsecutiveDnsTimeoutCount(message.arg1);
                    if (isDataStall()) {
                        mDataStallMetricsEvaluationTypes |= DATA_STALL_EVALUATION_TYPE_DNS;
    ...
    private void writeDataStallStats(@NonNull final CaptivePortalProbeResult result) {
        ...
        int bitmask = mDataStallMetricsEvaluationTypes;
        while (bitmask != 0) {
            if ((bitmask & 1) != 0) {
        ...
        mDataStallMetricsEvaluationTypes = 0;
    }
        ...
        public boolean processMessage(Message message) {
            switch (message.what) {
                case CMD_PROBE_COMPLETE:
                    ...
                    if (mDataStallMetricsEvaluationTypes != 0) {
