...
public class NetworkMonitor extends StateMachine {
                ...
                case CMD_CAPTIVE_PORTAL_APP_FINISHED:
                    ...
                    switch (message.arg1) {
                        ...
                        case APP_RETURN_UNWANTED:
                            ...
                            notifyNetworkTested(NetworkMonitorUtils.INVALID_RESULT, null);
    ...
    private class ValidatedState extends State {
        ...
        public void enter() {
            ...
            int testResult = NetworkMonitorUtils.VALID_RESULT;
            if (mPartialConnectivityDetected) {
                testResult |= NetworkMonitorUtils.PARTIAL_RESULT;
            }
