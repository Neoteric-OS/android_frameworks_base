...
public class NetworkMonitorTest {
    ...
    public void testPrivateDnsSuccess() throws Exception {
        ...
        WrappedNetworkMonitor wnm = makeMonitor();
        wnm.notifyNetworkCapabilitiesChanged(NOT_METERED_CAPABILITIES);
    ...
    public void testPrivateDnsResolutionRetryUpdate() throws Exception {
        ...
        reset(mCallbacks);
        mFakeDns.setAnswer("dns.invalid", new String[0]);
    ...
    private NetworkMonitor runNetworkTest(NetworkCapabilities nc, int testResult) {
        ...
        // ConnectivityService always sends network capabilities before notifyNetworkConnected.
        monitor.notifyNetworkCapabilitiesChanged(nc);
