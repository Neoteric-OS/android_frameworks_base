...
public class NetworkMonitorTest {
    ...
    @Test
    public void testIsCaptivePortal_FallbackProbeIsPartial() throws IOException {
        setSslException(mHttpsConnection);
        setStatus(mHttpConnection, 500);
        setStatus(mFallbackConnection, 204);

        // Fallback probe went through, HTTPS failed -> partial
    ...
    public void testIsCaptivePortal_OtherFallbackProbeIsPortal() throws IOException {
        ...
        final NetworkMonitor monitor = runNetworkTest(
                METERED_CAPABILITIES, NETWORK_TEST_RESULT_INVALID);
    ...
    public void testIgnoreHttpsProbe() throws Exception {
        ...
        final NetworkMonitor nm = runNetworkTest(
                METERED_CAPABILITIES, NETWORK_TEST_RESULT_PARTIAL_CONNECTIVITY);
