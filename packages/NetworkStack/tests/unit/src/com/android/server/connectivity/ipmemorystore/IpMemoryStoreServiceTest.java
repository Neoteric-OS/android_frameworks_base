...
public class IpMemoryStoreServiceTest {
    ...
    private void storeBlob(final String l2Key, final Blob b, final byte[] data) {
        storeBlob("Did not complete storing private data", l2Key, b, data);
    }
    private void storeBlob(final String timeoutMessage, final String l2Key, final Blob b,
            final byte[] data) {
        b.data = data;
    ...
    public void testPrivateData() {
        ...
        storeBlob(l2Key, b, TEST_BLOB_DATA);
