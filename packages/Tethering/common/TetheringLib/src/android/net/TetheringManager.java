...
public class TetheringManager {
    ...
    public static class TetheringRequest {
        ...
        public static class Builder {
            ...
            /**
             * Start tethering with Ui or silent entitlement check if entitlement check is needed.
             * If this function is not called, by default the entitlement UI will be shown.
             */
            @RequiresPermission(android.Manifest.permission.TETHER_PRIVILEGED)
            @NonNull
    ...
    public abstract static class TetheringEventCallback {
         ...
         */
        public void onError(@NonNull String ifName, @TetheringIfaceError int error) {}
