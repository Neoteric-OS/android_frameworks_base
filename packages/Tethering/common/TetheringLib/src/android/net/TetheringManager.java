...
public class TetheringManager {
    ...
    public @interface TetheringIfaceErrorCode {
    }
    ...
    public @interface StartTetheringFailure {
    }
    ...
    public static class TetheringRequest {
        ...
        public static class Builder {
             ...
             *
             * The clientAddress must be in the serverAddress prefix. A DHCP server will be started
             * but will only be able to offer the clientAddress. Only the same prefix length of
             * serverAddress and clientAddress are supported.
             *
            ...
            @NonNull
            public Builder setStaticIpv4Addresses(@NonNull final LinkAddress serverAddress,
                    @NonNull final LinkAddress clientAddress) {
                Objects.requireNonNull(serverAddress);
                Objects.requireNonNull(clientAddress);
                if (serverAddress.getPrefixLength() != clientAddress.getPrefixLength()
                        || !serverAddress.isIpv4() || !clientAddress.isIpv4()) {
            ...
            /**
             * Start tethering with Ui or silent entitlement check if needed.
             * If this function is not set, default value is showing entitlement Ui.
             */
            @RequiresPermission(android.Manifest.permission.TETHER_PRIVILEGED)
            @NonNull
            public Builder setShowEntitlementUi(boolean showUi) {
            ...
            @Nullable
            public LinkAddress getStaticServerAddress() {
                return mBuilderParcel.localIPv4Address;
            }

            /** Get static client address. */
            @Nullable
            public LinkAddress getStaticClientAddress() {
            ...
            public boolean isShowEntitlementUi() {
    ...
    public interface StartTetheringCallback {
         ...
         *
         * @param resultCode The fail reason for tethering fail.
         */
        default void onTetheringFailed(@StartTetheringFailure final int resultCode) {}
    }
    ...
    @SystemApi(client = MODULE_LIBRARIES)
    public void startTethering(@TetheringType int type, @NonNull final Executor executor,
    ...
    public abstract static class TetheringEventCallback {
         ...
         */
        public void onError(@NonNull String ifName, @TetheringIfaceErrorCode int error) {}
