...
public class TetheringUtils {
    ...
    public static class ForwardedStats {
        ...
        public ForwardedStats(@NonNull TetherStatsParcel tetherStats) {
            this.rxBytes = tetherStats.rxBytes;
            this.rxPackets = tetherStats.rxPackets;
            this.txBytes = tetherStats.txBytes;
            this.txPackets = tetherStats.txPackets;
        }
        ...
        /** Add Tx/Rx bytes/packets. */
        public void add(@NonNull ForwardedStats other) {
        ...
        public String toString() {
            return String.format("rxBytes: %s, rxPackets: %s, txBytes: %s, txPackets: %s",
