    ...
    private void updateUpstreamIPv6LinkProperties(LinkProperties v6only, int ttlAdjustment) {
        ...
        if (v6only != null) {
            ...
            if (upstreamIfaceParams != null) {
                upstreaIfIndex = upstreamIfaceParams.index;
            }
            params = new RaParams();
            ...
            // state machines.
            mBpfCoordinator.addUpstreamNameToLookupTable(upstreaIfIndex, upstreamIface);

            // Setting index here prevents NPE when passed to updateIpv6ForwardingRules() below
            // in the case that upstreamIfaceParams are null.
            upstreaIfIndex = upstreaIfIndex;
        }
        ...
        updateIpv6ForwardingRules(mLastIPv6UpstreamIfindex, upstreaIfIndex, null);
        mLastIPv6UpstreamIfindex = upstreaIfIndex;
        if (mDadProxy != null) {
