...
public class NeighborPacketForwarder extends PacketReader {
    ...
    private final TetheringUtilsNative mNative;
...
// TODO: move to enums
    ...
    public NeighborPacketForwarder(Handler h, InterfaceParams tetheredInterface, int type, TetheringUtilsNative aNative) {
        super(h);
    ...
    private Inet6Address getIpv6DestinationAddress(byte[] recvbuf, int scopeId) {
    ...
    protected void handlePacket(byte[] recvbuf, int length) {
        ...
        Inet6Address destv6 = getIpv6DestinationAddress(recvbuf, mSendIfaceParams.index);
