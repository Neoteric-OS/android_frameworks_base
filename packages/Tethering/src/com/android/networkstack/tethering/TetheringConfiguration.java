...
public class TetheringConfiguration {
    ...
    private boolean getDeviceConfigBoolean(final String name, final boolean defaultValue) {
        ...
        // of #getBoolean. If using #getBoolean here, the test can't know that the returned boolean
        // value comes from device config or default value (because of null property string).
        // See the test case testBpfOffload{*} in TetheringConfigurationTest.java.
