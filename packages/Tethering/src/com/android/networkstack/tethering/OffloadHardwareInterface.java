...
public class OffloadHardwareInterface {
    ...
    public boolean initOffloadConfig() {
        ...
        sendNetlinkMessage(h1, new byte[StructNlMsgHdr.STRUCT_SIZE], StructNlMsgHdr.STRUCT_SIZE,
    ...
    private void sendNetlinkMessage(NativeHandle handle, byte[] msg, int length, short type,
                                    short flags) {
