...
public class TetheringNotificationUpdater {
    ...
    private boolean mCellularDataRoaming = false;
    ...
    public void onUpstreamCapabilitiesChanged(@Nullable final NetworkCapabilities capabilities) {
        final boolean isCellularDataRoaming = capabilities != null
                && !capabilities.hasCapability(NET_CAPABILITY_NOT_ROAMING)
                && capabilities.hasTransport(NetworkCapabilities.TRANSPORT_CELLULAR);
        if (mCellularDataRoaming == isCellularDataRoaming) return;
        mCellularDataRoaming = isCellularDataRoaming;
        updateRoamingNotification();
    }
    ...
    private void updateRoamingNotification() {
        ...
        if (tetheringInactive
                || !mCellularDataRoaming
                || setupRoamingNotification() == NO_NOTIFY) {
