...
public class OffloadController {
    ...
    private static final int DEFAULT_PERFORM_POLL_DELAY_MS = 5000;
    ...
    public boolean start() {
        ...
        if (!isStarted) {
            ...
            // Post to handler thread since it will access remaining alert quota.
    ...
    /**
     * Schedule polling if needed, this will be automatically stopped if offload has been
    ...
    private void maybeSchedulePollingStats() {
        ...
        mHandler.postDelayed(mSchedulePollingTask, mDeps.getPerformPollDelay());
    }
