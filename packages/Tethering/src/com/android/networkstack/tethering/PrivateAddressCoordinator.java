...
public class PrivateAddressCoordinator {
    ...
    // next subPrefix is 0.16.16.255/24 (0.16.15.255 + 0.0.1.0).
    private int getNextSubPrefix(final int subAddress, final IpPrefix conflictPrefix,
    ...
    private IpPrefix findAvailablePrefixFromRange(final int start, final int end,
        ...
        while (newSubPrefix < end) {
            ...
            newSubPrefix = getNextSubPrefix(newSubPrefix, conflictPrefix, prefixRangeMask);
        }
