...
public class BpfCoordinator {
    ...
    // a runtime resource overlay package or device configuration. Except constructor, this flag
    // is only initialized at tethering starting because it is hard to unwind all processes at
    // runtime. Especially the rule handling process. Keeping the same setting during a tethering
    // lifetime is easier to maintain. See also TetheringConfiguration.
    private boolean mUsingBpf;
    ...
    /**
     * Dump information.
     * Block the function until all the data are dumped or timed-out. The reason is that dumpsys
     * invokes this function on the thread of caller and the data may only be allowed to be
    ...
    int getPollingInterval() {
        ...
        // Ignore the config value is less than the minimum polling interval.
