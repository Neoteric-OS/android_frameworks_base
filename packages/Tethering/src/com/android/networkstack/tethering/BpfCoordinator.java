...
public class BpfCoordinator {
    ...
    public void tetherOffloadRuleAdd(
        ...
        // Must update the adding rule after calling #isAnyRulesOnUpstream because it needs to
    ...
    public void tetherOffloadRuleRemove(
        ...
        // Must remove rules before calling #isAnyRulesOnUpstream because it needs to check if
    ...
    public void tetherOffloadRuleClear(@NonNull final IpServer ipServer) {
        ...
        // Need to build a rule list because the rules map may be changed in the iteration.
    ...
    private boolean isAnyRulesOnUpstream(int upstreamIfindex) {
        for (LinkedHashMap<Inet6Address, Ipv6ForwardingRule> rules :
                mIpv6ForwardingRules.values()) {
            for (Ipv6ForwardingRule rule : rules.values()) {
