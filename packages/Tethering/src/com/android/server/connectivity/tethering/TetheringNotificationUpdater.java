...
public class TetheringNotificationUpdater {
    ...
    private void updateNoUpstreamNotification() {
        ...
        if (tetheringInactive
            ...
            getHandler().removeMessages(EVENT_SHOW_NO_UPSTREAM);
        }
    }
    ...
    private boolean setupNoUpstreamNotification() {
        ...
        // this and not all of them need this notification.
        ...
        getHandler().sendMessageDelayed(getHandler().obtainMessage(EVENT_SHOW_NO_UPSTREAM),
