...
import static android.net.cts.util.CtsTetheringUtils.isFeatureSupported;
...
public class TetheringModuleTest {
    ...
    public void testSwitchPrefixRangeWhenConflict() throws Exception {
        assumeTrue(isFeatureSupported(TETHER_ENABLE_SELECT_ALL_PREFIX_RANGES,
    ...
    private TestNetworkInterface setUpTestNetwork(final LinkAddress address) throws Exception {
        TestNetworkManager tnm = (TestNetworkManager) mContext.getSystemService(
