...
public class TetheringConfigurationTest {
    ...
    public void setUp() throws Exception {
        ...
        initDisableSelectAllPrefixRangeFlag(null /* unset */);
    ...
    private void initDisableSelectAllPrefixRangeFlag(final String value) {
        doReturn(value).when(
                () -> DeviceConfig.getProperty(eq(NAMESPACE_CONNECTIVITY),
                eq(TetheringConfiguration.TETHER_DISABLE_SELECT_ALL_PREFIX_RANGES)));
    }
