...
public class BpfCoordinatorTest {
    ...
    public void testTetheringConfigDisable() throws Exception {
        ...
        LinkedHashMap<Inet6Address, Ipv6ForwardingRule> rules = coordinator.mIpv6ForwardingRules
                .get(mIpServer);
        assertNull(rules);
        ...
        rules = coordinator.mIpv6ForwardingRules.get(mIpServer);
        assertNotNull(rules);
    ...
    public void testTetheringConfigSetPollingInterval() throws Exception {
        ...
        // [2] Expect the invalid value isn't applied. The valid range of interval is
