...
public class BpfTetheringCoordinatorTest {
    private static final long WAIT_FOR_TIMEOUT = 2 * 1000;
    ...
    private void setOffloadPollInterval(int interval) {
        mDeps = new BpfTetheringCoordinator.Dependencies() {
            @Override
            int getPerformPollInterval() {
                return interval;
            }
    ...
    private static @NonNull Entry buildTestEntry(@NonNull StatsType how,
        ...
        return new Entry(iface, how == StatsType.PER_IFACE ? UID_ALL : UID_TETHERING,
    ...
    public void testGetForwardedStats() throws Exception {
        ...
        setOffloadPollInterval(1);  // reduce the tether stats update interval.
        ...
        final NetworkStats expectedIfaceStats = new NetworkStats(0L, 2)
                .addEntry(buildTestEntry(StatsType.PER_IFACE, wlanIface, 1000, 100, 2000, 200))
                .addEntry(buildTestEntry(StatsType.PER_IFACE, mobileIface, 3000, 300, 4000, 400));

        final NetworkStats expectedUidStats = new NetworkStats(0L, 2)
                .addEntry(buildTestEntry(StatsType.PER_UID, wlanIface, 1000, 100, 2000, 200))
                .addEntry(buildTestEntry(StatsType.PER_UID, mobileIface, 3000, 300, 4000, 400));
        ...
        // The tether stats of mobile interface are accumulated.
        ...
        final NetworkStats expectedIfaceStatsDiff = new NetworkStats(0L, 2)
                .addEntry(buildTestEntry(StatsType.PER_IFACE, wlanIface, 0, 0, 0, 0))
                .addEntry(buildTestEntry(StatsType.PER_IFACE, mobileIface, 10, 20, 30, 40));

        final NetworkStats expectedUidStatsDiff = new NetworkStats(0L, 2)
                .addEntry(buildTestEntry(StatsType.PER_UID, wlanIface, 0, 0, 0, 0))
                .addEntry(buildTestEntry(StatsType.PER_UID, mobileIface, 10, 20, 30, 40));
