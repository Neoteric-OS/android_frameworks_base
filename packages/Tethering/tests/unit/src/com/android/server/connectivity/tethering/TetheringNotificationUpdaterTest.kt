...
class TetheringNotificationUpdaterTest {
     ...
     */
    fun Handler.waitForDelayedMessage(what: Int?, timeoutMs: Long): Boolean {
    ...
    fun testNotificationWithUpstreamNetworkChanged() {
        ...
        assertTrue(notificationUpdater.handler.waitForDelayedMessage(EVENT_SHOW_NO_UPSTREAM, 500L))
