...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.CAMERA_DOUBLE_TAP_POWER_GESTURE_ENABLED, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(Secure.BACK_GESTURE_ARROW, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.BERRY_BLACK_THEME, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.FACE_UNLOCK_METHOD, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.SKIP_FACE_AUTH_CONFIRMATION, BOOLEAN_VALIDATOR);
