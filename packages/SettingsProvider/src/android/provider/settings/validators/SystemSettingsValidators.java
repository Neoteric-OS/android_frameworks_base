...
public class SystemSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(System.QS_LAYOUT, NON_NEGATIVE_INTEGER_VALIDATOR);
	VALIDATORS.put(System.QS_TILE_VERTICAL_LAYOUT, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.QQS_LAYOUT, NON_NEGATIVE_INTEGER_VALIDATOR);
        VALIDATORS.put(System.USE_OLD_MOBILETYPE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(System.IMMERSIVE_GESTURES, BOOLEAN_VALIDATOR);
	VALIDATORS.put(System.FULLSCREEN_GESTURES, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(System.ALERT_SLIDER_PULSE, BOOLEAN_VALIDATOR);
    }
}
