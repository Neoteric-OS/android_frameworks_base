    ...
    companion object {
        ...
        fun data() = listOf(
                ...
                InputData(
                        ...
                        ActivityHintEvent(ActivityHintEvent.TYPE_COMPLETED, newActivityInfo()),
                        ActivityHintEvent(ActivityHintEvent.TYPE_POST_COMPLETED, newActivityInfo())),
                InputData(
                        AppIntentEvent.createDefaultIntentChanged(newActivityInfo(), newActivityInfoOther()),
                        AppIntentEvent.createDefaultIntentChanged(newActivityInfo(), newActivityInfoOther()),
                        AppIntentEvent.createDefaultIntentChanged(newActivityInfoOther(), newActivityInfo())),
                InputData(
                        PackageEvent.createReplaced(newUri(), "some package"),
                        PackageEvent.createReplaced(newUri(), "some package"),
                        PackageEvent.createReplaced(newUri(), "some other package")
                ),
                InputData(initialRequestId, cloneRequestId(initialRequestId), RequestId.nextValueForSequence()),
                InputData(
