...
class KeepSet {
 ...
 private:
  friend void WriteKeepSet(const KeepSet& keep_set, io::OutputStream* out, bool minimal_keep, bool no_location_reference);
...
void WriteKeepSet(const KeepSet& keep_set, io::OutputStream* out, bool minimal_keep, bool no_location_reference);
