...
public:
    Bundle(void)
        : mCmd(kCommandUnknown), mVerbose(false), mAndroidList(false),
          ...
          mUpdate(false), mExtending(false), mRuntimeOverlay(0),
    ...
    int getRuntimeOverlay(void) const { return mRuntimeOverlay; }
    void setRuntimeOverlay(int val) { mRuntimeOverlay = val; }
