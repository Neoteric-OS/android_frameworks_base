...
const char* const RESOURCES_MANIFEST_PACKAGE_NAMESPACE = "http://schemas.android.com/apk/res/manifest/package";
...
static const String16 RESOURCES_PREFIX_MANIFEST_PACKAGE(RESOURCES_MANIFEST_PACKAGE_NAMESPACE);
...
String16 getNamespaceResourcePackage(String16 appPackage, String16 namespaceUri, bool* outIsPublic)
{
    ...
    size_t prefixSize;
    bool isPublic = true;
    if(namespaceUri.startsWith(RESOURCES_PREFIX_MANIFEST_PACKAGE)) {
