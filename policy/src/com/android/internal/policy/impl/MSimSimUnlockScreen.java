    ...
    private abstract class CheckSimPin extends Thread {
        ...
        public void run() {
            try {
                ...
                post(new Runnable() {
                    public void run() {
// TODO-msim                        onSimLockChangedResponse(Phone.PIN_GENERAL_FAILURE);
                    }
                });
            }
        }
            ...
            void onSimLockChangedResponse(final int result) {
                mPinText.post(new Runnable() {
                    public void run() {
                        ...
                        /*
// TODO-msim                        if (result == Phone.PIN_RESULT_SUCCESS) {
                        if (true) {
...
// TODO-msim                if (result == Phone.PIN_PASSWORD_INCORRECT) {
                            if (true) {
                                try {
