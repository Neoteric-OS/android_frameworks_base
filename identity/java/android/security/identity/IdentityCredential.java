...
public abstract class IdentityCredential {
     ...
     *
     * <p>If <code>FEATURE_LEVEL_ANDROID_12</code> is selected, each X.509 certificate contains
     * an X.509 extension at OID 1.3.6.1.4.1.11129.2.1.25 which shall contain OCTET STRING with
     * the bytes of the CBOR with the following CDDL:
     * <pre>
     *   ProofOfBinding = [
     *     "ProofOfBinding",
     ...
     *
     * <p>For <code>FEATURE_LEVEL_ANDROID_11</code> this is unsupported and the method
     * fails with {@code UnsupportedOperationException}.</p>
     *
     * <p>For <code>FEATURE_LEVEL_ANDROID_12</code> the returned CBOR is the following:</p>
     * <pre>
     *     ProofOfOwnership = [
