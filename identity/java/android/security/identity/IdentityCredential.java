...
public abstract class IdentityCredential {
     ...
     *
     * <p>Applications can use {@link #getAuthenticationDataUsageCount(int)} and
     * {@link #getAuthenticationDataExpirations()} to get a picture of the usage and
     * time left of each configured authentication key. This can be used to determine how
     * urgent it is recertify new authentication keys via the
