...
public abstract class IdentityCredential {
    ...
    public static class GetEntryResult {
         ...
         * {@link #getEntries(byte[], Collection, byte[], byte[])} was {@code null}
         * or the reader ephmeral public key was never set using
         * {@link #setReaderEphmeralPublicKey(PublicKey)},  no message authencation code will
         * be produced and this method will return {@code null}.
         *
