...
public abstract class IdentityCredential {
     ...
     * {@link #getEntries(byte[], Collection, byte[], byte[])} or using a
     * {@link android.biometric.BiometricPrompt.CryptoObject} which references this object
     *
     ...
     * and use e.g. {@link android.biometric.BiometricPrompt}) to make the user authenticate using
     * a {@link android.biometric.BiometricPrompt.CryptoObject} which references this object. If
     * needed, this must be done before calling
     * {@link #getEntries(byte[], Collection, byte[], byte[], boolean)}.
     *
