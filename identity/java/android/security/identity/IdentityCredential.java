...
public abstract class IdentityCredential {
     ...
     * {@link #getEntries(byte[], Collection, byte[], Collection, byte[])}.
     *
     ...
     *                                                or {@code allowUsingExhaustedKeys} is
     *                                                {@code false} and all available authentication
    ...
    public abstract @NonNull GetEntryResult getEntries(
            ...
            InvalidReaderCertificateChainException, EphemeralPublicKeyNotFoundException;
