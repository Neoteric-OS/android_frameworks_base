...
public class CredentialDataRequest {
    ...
    public static final class Builder {
         ...
         *
         * @param deviceSignedEntriesToRequest the device-signed entries to request.
         * @param issuerSignedEntriesToRequest the issuer-signed entries to request.
         */
        public Builder() {
         ...
         * By default this is set to true.
         *
         * @param incrementUseCount whether to increment the user count of the authentication
         *                          key used.
         * @return the builder.
         */
