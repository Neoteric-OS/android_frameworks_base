...
public class IdentityCredentialStore {
    ...
    public @SecurityHardwareType int getSecurityHardwareType() {
        try {
            return mBinder.getSecurityHardwareType();
     ...
     */
    public @SecurityCertification int getSecurityHardwareCertification() {
        try {
            return mBinder.getSecurityHardwareCertification();
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to credstore", e);
            throw new AssertionError(e);
        }
    ...
    public Iterable<String> getDirectAccessDocTypes() {
        try {
            return mBinder.getDirectAccessDocTypes();
        } catch (RemoteException e) {
            Log.w(TAG, "Cannot connect to credstore", e);
            throw new AssertionError(e);
        }
     ...
     */
    public @NonNull Iterable<IdentityCredential> getCredentialsByDocType(@Nullable String docType) {
        return null;
    }
}
