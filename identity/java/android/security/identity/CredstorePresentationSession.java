...
class CredstorePresentationSession extends PresentationSession {
    ...
    public @Nullable CredentialDataResult getCredentialData(@NonNull String credentialName,
        ...
        try {
            ICredential credstoreCredential = mBinder.getCredentialForPresentation(credentialName);
            CredstoreIdentityCredential credential =
                    new CredstoreIdentityCredential(mContext, credentialName, mCipherSuite,
                                                    credstoreCredential, this);
            ...
            // Only want getCredentialData() to consume a single auth key.
            ...
            // // Now use up the auth key (it'll be the same as the previous one), if applicable.
