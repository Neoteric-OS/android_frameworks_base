...
public abstract class WritableIdentityCredential {
     ...
     * data structure containing all of the data items stored and signed by the CredentialKey.
     * The CBOR data structure is defined by {@code ProofOfProvisioning} in the following
