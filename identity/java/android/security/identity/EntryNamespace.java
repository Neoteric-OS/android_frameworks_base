...
public class EntryNamespace {
    ...
    public static class Builder {
         ...
         * TODO(swillden): Write this.
         */
        public Builder addLongEntry(String name, Collection<String> accessControlProfileNames,
                long value) {
            return addEntry(name, accessControlProfileNames, value,
                    null /* staticAuthenticationData */, false /* directlyAccessible */);
        }
         ...
         * TODO(swillden): Write this.
         */
        public Builder addIntEntry(String name, Collection<String> accessControlProfileNames,
                int value) {
            return addEntry(name, accessControlProfileNames, (long) value,
                    null /* staticAuthenticationData */, false /* directlyAccessible */);
        }
         ...
         * TODO(swillden): Write this.
         */
        public Builder addStringEntry(String name, Collection<String> accessControlProfileNames,
        ...
        Builder addLongEntry(String name, Collection<String> accessControlProfileNames,
        ...
        Builder addStringEntry(String name, Collection<String> accessControlProfileNames,
