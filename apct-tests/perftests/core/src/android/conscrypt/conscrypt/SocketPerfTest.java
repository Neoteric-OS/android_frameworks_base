...
public class ConscryptSocketTest {
    ...
    private class Config {
        SocketType a_socketType;
        UnderlyingSocketType b_underlyingSocketType;
        ServerSocketType c_serverSocketType;
        Config(SocketType socketType, UnderlyingSocketType underlyingSocketType,
                ServerSocketType serverSocketType) {
          a_socketType = socketType;
          b_underlyingSocketType = underlyingSocketType;
          c_serverSocketType = serverSocketType;
        }
        public SocketType socketType() {
            return a_socketType;
        }
        ...
        public UnderlyingSocketType underlyingSocketType() {
            return b_underlyingSocketType;
        }

        public ServerSocketType serverSocketType() {
            return c_serverSocketType;
        }
    }
    ...
    public void test_handshake(Config config) throws Exception {
        setUp(config);
